<%@ page language="C#" autoeventwireup="true" inherits="ZoomLa.WebSite.Comment.CommentFor, App_Web_cm00f0si" enableEventValidation="false" viewStateEncryptionMode="Never" %>
<!DOCTYPE HTML>
<html>
<head  >
<title>发表评论</title>
...
<form id="form1" runat="server">
  <div id="Comment">
    ...
    <div id="CommentInput" style=" margin-bottom:20px;">
