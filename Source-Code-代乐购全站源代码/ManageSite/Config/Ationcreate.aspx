<%@ page language="C#" autoeventwireup="true" inherits="ManageSite_Config_Ationcreate, App_Web_jpuabewc" enableEventValidation="false" viewStateEncryptionMode="Never" %>
...
<body>
    ...
    <div class="column">
        ...
        <table width="100%" align="center" cellpadding="3" cellspacing="3">
            ...
            <tr class="tdbg">
                <td align="right" style="width: 200px; height: 23px;">
            ...
            <tr class="tdbg">
                ...
                <td align="left">
                    ...
                    <input type="button" value="选择模板"
                        onclick="WinOpenDialog('../Template/TemplateList.aspx?OpenerText='+escape('TextBox1')+'&nid=<%=Request.QueryString["nid"] %>&FilesDir=',650,480)"
                        class="button" />
                </td>
            </tr>
            <tr>
