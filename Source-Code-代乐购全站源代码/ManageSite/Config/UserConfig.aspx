<%@ page language="C#" autoeventwireup="true" inherits="ZoomLa.WebSite.Manage.Config.UserConfig, App_Web_jpuabewc" validaterequest="false" enableEventValidation="false" viewStateEncryptionMode="Never" %>
...
<body>
    ...
    <table width="99%" cellspacing="1" cellpadding="0" class="border">
        ...
        <tr class="tdbg">
            <td align="left" style="width: 300px">
                <strong>是否开启用户Email注册：</strong></td>
            <td align="left" style="width: 500px">
        ...
        <tr class="tdbg">
            ...
            <td align="left" style="width: 500px">
                <asp:TextBox ID="TextBox6" runat="server" ></asp:TextBox>个字符
        ...
        <tr class="tdbg">
            ...
            <td align="left" style="width: 500px">
                <asp:TextBox ID="TextBox7" runat="server"></asp:TextBox>个字符
        ...
        <tr class="tdbg">
            ...
            <td align="left" style="width: 500px">
                <asp:TextBox ID="TextBox8" runat="server" Rows="6" TextMode="MultiLine" Width="300px"></asp:TextBox></td>
        </tr>
        <tr class="tdbg">
            <td align="left">
                    ...
                    <tr>
                        ...
                        <td align="left">
                            <table>
                                <tr>
                                    <td align="left">
                                        <input id="Button4" value=" >> "  class="button"  onclick="AddFields_MustFill()" title="添加所选项" type="button" /><br />
                                    ...
                                    <td align="left">
                                        <input id="Button5" value=" ︽ " class="button" onclick="UpFields_MustFill()" title="上移" type="button" /><br />
                                ...
                                <tr>
                                    <td align="left">
                                        <input id="Button3" value=" >> " class="button" onclick="AddFields_SelectFill()" title="添加所选项" type="button" /><br />
                                    ...
                                    <td align="left">
                                        <input id="Button8" value=" ︽ "  class="button" onclick="UpFields_SelectFill()" title="上移" type="button" /><br />
        ...
        <tr class="tdbg">
            ...
            <td align="left" style="width: 500px">
                <asp:TextBox ID="TextBox12" runat="server" Rows="6" TextMode="MultiLine" Width="300px"></asp:TextBox></td>
        </tr>
        ...
        <tr class="tdbg" runat="server" id="Tr1">
            ...
            <td align="left">
                <asp:TextBox runat="server" ID="tb_InformationRule"></asp:TextBox>分积分
                <asp:RegularExpressionValidator runat="server" ID="rev_2" ValidationExpression="^[1-9]\d*|0$" ControlToValidate="tb_InformationRule" ErrorMessage="只能输入非0整数"></asp:RegularExpressionValidator>
            </td>
        </tr>
        <tr class="tdbg" runat="server" id="Tr2">
            ...
            <td align="left">
                <asp:TextBox runat="server" ID="tb_CommentRule"></asp:TextBox>分积分
                <asp:RegularExpressionValidator runat="server" ID="Rev_1" ValidationExpression="^[1-9]\d*|0$" ControlToValidate="tb_CommentRule" ErrorMessage="只能输入非0整数"></asp:RegularExpressionValidator>
            </td>
        </tr>
        <tr class="tdbg" runat="server" id="Tr3">
            ...
            <td align="left">
                <asp:TextBox runat="server" ID="tb_RecommandRule"></asp:TextBox>分积分
                <asp:RegularExpressionValidator runat="server" ID="rev_3" ValidationExpression="^[1-9]\d*|0$" ControlToValidate="tb_RecommandRule" ErrorMessage="只能输入非0整数"></asp:RegularExpressionValidator>
            </td>
        </tr>
        ...
        <tr class="tdbg" runat="server" id="MoneyExchangePoint">
            ...
            <td align="left">
                ...
                元钱可兑换 <strong><asp:TextBox ID="TxtCMoneyExchangePoint" Text="1" runat="server" Columns="7" MaxLength="7" /></strong> 点点券
        ...
        <tr runat="server" class="tdbg">
            ...
            <td align="left">
                ...
                元钱可兑换 <strong>
                    <asp:TextBox ID="txtCMoneyExchangeDummyPurse" Text="1" runat="server" Columns="7" MaxLength="7" /></strong> 元虚拟金币
        ...
        <tr class="tdbg" runat="server" id="UserExpExchangePoint">
            ...
            <td align="left">
                ...
                分积分可兑换 <strong><asp:TextBox ID="TxtCUserExpExchangePoint" Text="1" runat="server" Columns="7" MaxLength="7" /></strong> 点点券
        ...
        <tr class="tdbg" runat="server" id="Tr4">
            ...
            <td align="left">
                ...
                <asp:TextBox ID="TxtCUserExpExchangePoints" Text="0" runat="server" Columns="7"
                    MaxLength="7" />
                分积分可兑换 <strong><asp:TextBox ID="TxtCUserExpExchangeMoney" Text="0" runat="server" Columns="7" MaxLength="7" /></strong> 元钱
    ...
    <br />        
    <asp:Button ID="Button1" runat="server" Text="保存设置" CssClass="button" OnClick="Button1_Click" /><br /> 
    </div>
