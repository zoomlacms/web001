<%@ page language="C#" autoeventwireup="true" inherits="ManageSite_Config_SiteManageList, App_Web_jpuabewc" enableEventValidation="false" viewStateEncryptionMode="Never" %>
    ...
    <form id="form1" runat="server">
      <div class="column">
        <div class="columntitle">
            当前位置：功能导航 >>系统频道管理</div>
        <asp:GridView ID="gvSiteList" runat="server" Width="100%"  DataKeyNames="NodeID"
              AutoGenerateColumns="False" AllowPaging="True" 
              onpageindexchanging="gvSiteList_PageIndexChanging">
            <Columns>
            <asp:TemplateField ItemStyle-HorizontalAlign="Left" HeaderText="频道名称">
            <ItemTemplate>
            <%#GetName(Eval("NodeName").ToString())%>
            </ItemTemplate>
            </asp:TemplateField>
                <asp:TemplateField HeaderStyle-Width="10%" HeaderText="操作" ItemStyle-HorizontalAlign="Center">
                    <ItemTemplate>
                        <a href="AddSite.aspx?ID=<%#Eval("NodeID") %>">修改</a>
