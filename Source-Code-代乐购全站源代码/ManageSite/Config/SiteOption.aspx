<%@ page language="C#" autoeventwireup="true" inherits="ZoomLa.WebSite.ManageSite.Config.SiteOption, App_Web_jpuabewc" enableEventValidation="false" viewStateEncryptionMode="Never" %>
    ...
    <form id="form1" runat="server">
        ...
        <table width="99%" cellspacing="1" cellpadding="0" >
                ...
                <td  align="right" style="width: 300px;">
                    <strong>Site Server (子站系统)：</strong></td>
                <td align="left">&nbsp;
        ...
        <tr class="tdbg">
                <td  align="right" style="width: 300px;">
                    <strong>主站(API)接口：</strong></td>
                <td align="left" >
                    <asp:TextBox ID="ServerApiUrl" runat="server" Width="360px" AutoPostBack="True" ontextchanged="ServerApiUrl_TextChanged"></asp:TextBox><span id="sitestart" runat="server"></span><br /><font color=red>输入主站接口地址,例子： http://xxx.xxx.xxx/API/SitePortApi.aspx</font>
                </td>
            </tr>
              <tr class="tdbg">
                <td  align="right" style="width: 300px;">
                    <strong>主站许可证：</strong></td>
                <td align="left" >
                    <asp:TextBox ID="txtSiteLicense" runat="server" TextMode="MultiLine" Width="360px" Height="60px" ></asp:TextBox>
                </td>
            </tr>
         </tbody>   
             <tr class="tdbg">
                <td align="right" style="width: 300px;">
                    <strong>开启日志：</strong></td>
                <td align="left" >
             ...
             <tr class="tdbg">
                <td align="right" style="width: 300px;">
                    <strong>保留指定天数的日志：(0-不限制)：</strong></td>
                <td align="left" >&nbsp;
                    <asp:TextBox ID="Savadaylog" runat="server"></asp:TextBox>&nbsp;天</td>
            </tr>
            <tr class="tdbg">
                <td align="right" style="width: 300px;">
                    <strong>保留指定数量的日志：(0-不限制)：</strong></td>
                <td align="left">&nbsp;
                    <asp:TextBox ID="Savanumlog" runat="server"></asp:TextBox>&nbsp;条</td>
            </tr>
            ...
            <tr class="tdbg">
                ...
                <td align="left">&nbsp;
                    <asp:RadioButton ID="RadioButton9" runat="server" GroupName="IsZone" TabIndex="1" />是
            ...
            <tr class="tdbg">
              ...
              <tr class="tdbg">
                <td align="right" style="width: 300px;">
                    <strong>子站转换功能：</strong></td>
                <td align="left">&nbsp;
                    <asp:RadioButton ID="RadioButton13" runat="server" GroupName="UrlWrite" TabIndex="1" />开启
                    <asp:RadioButton ID="RadioButton14" runat="server" GroupName="UrlWrite" TabIndex="2" />关闭</td>
            </tr>
            <tr class="tdbg">
                <td align="right" style="width: 300px;">
                    <strong>后台管理目录：</strong></td>
                <td align="left">&nbsp;
                    <asp:TextBox ID="TextBox11" runat="server"></asp:TextBox><span style="color:#1e860b;">默认目录为manage，改名后将屏蔽原路径访问，并启用新路径进入后台管理。</span>
</td>
            </tr>
            ...
            <tr class="tdbg">
                <td align="right" style="width: 300px; height: 23px;">
                    <strong>生成静态目录：</strong></td>
                <td align="left">&nbsp;
                    <asp:TextBox ID="txtCatalog" runat="server"></asp:TextBox>　目录名前后不要加斜杠"/"</td>
            </tr>
            <tr class="tdbg">
                <td align="right" style="width: 300px; height: 23px;">
                    <strong>网站首页模板：</strong></td>
                <td align="left">&nbsp;
                    <asp:TextBox ID="TextBox2" runat="server"></asp:TextBox><input type="button" value="选择模板"
            ...
            <tr class="tdbg">
                <td align="right" style="width: 300px; height: 23px;">
                    <strong>商铺首页模板：</strong></td>
                <td align="left">&nbsp;
                    <asp:TextBox ID="TextBox3" runat="server"></asp:TextBox><input type="button" value="选择模板"
            ...
            <tr class="tdbg">
                <td align="right" style="width: 300px; height: 23px;">
                    <strong>可上传附件最大值：</strong></td>
                <td align="left">&nbsp;
                    <asp:TextBox ID="TextBox19" runat="server"></asp:TextBox>KB 提示：1 KB = 1024 Byte，1
                    MB = 1024 KB</td>
            </tr>
            <tr class="tdbg">
                <td align="right" style="width: 300px;">
                    <strong>编辑器上传图片类型限制：</strong></td>
            ...
            <tr class="tdbg">
                <td align="right" style="width: 300px; height: 23px;">
                    <strong>可上传图片最大值：</strong></td>
                <td align="left">&nbsp;
                    <asp:TextBox ID="TxtUpPicSize" runat="server"></asp:TextBox>KB 提示：1 KB = 1024 Byte，1
                    MB = 1024 KB</td>
            </tr>   
            <tr class="tdbg">
                <td align="right" style="width: 300px;">
                    <strong>媒体文件类型限制：</strong></td>
            ...
            <tr class="tdbg">
                <td align="right" style="width: 300px; height: 23px;">
                    <strong>媒体文件最大值：</strong></td>
                <td align="left">&nbsp;
                    <asp:TextBox ID="TxtUpMediaSize" runat="server"></asp:TextBox>KB 提示：1 KB = 1024 Byte，1
                    MB = 1024 KB</td>
            </tr>             
            <tr class="tdbg">
                <td align="right" style="width: 300px; height: 23px;">
                    <strong>可上传Flash等媒体文件最大值：</strong></td>
                <td align="left">&nbsp;
                    <asp:TextBox ID="TxtUpFlashSize" runat="server"></asp:TextBox>KB 提示：1 KB = 1024 Byte，1
                    MB = 1024 KB</td>
            </tr>          
            <tr class="tdbg">
                <td align="right" style="width: 300px;">
                    <strong>过滤敏感词汇：</strong></td>
                <td align="left">&nbsp;
        ...
        <br />
        <asp:Button ID="Button1" runat="server" Text="保存设置" OnClick="Button1_Click"  CssClass="button" /><br />
    </div>
    </form>
</body>
</html>
