<%@ page language="C#" autoeventwireup="true" inherits="ManageSite_Config_Watermark, App_Web_jpuabewc" enableEventValidation="false" viewStateEncryptionMode="Never" %>
...
<body>
    ...
    <div class="column">
        <div class="columntitle">
          当前位置：功能导航 >><asp:Label ID="Label3" runat="server" Text="图片水印配置"></asp:Label></div>
        <table width="100%" cellspacing="1" cellpadding="0" >
            <tr class="tdbg">
                <td  align="right" style="width: 200px">
                    <strong>是否开启水印：&nbsp;</strong>
                </td>
                <td align="left">&nbsp;
            ...
            <tbody runat="server" id="tu">
                <tr class="tdbg">
                    <td  align="right" style="width: 200px">
                        <strong>水印图片文件名：&nbsp;</strong><br /> 这里请填写图片文件的相对路径。 
                    </td>
                    <td align="left">&nbsp;
                        <asp:TextBox ID="iLogo" runat="server" Width="400"></asp:TextBox>
                    </td>
                </tr>
                <tr class="tdbg">
                    <td  align="right" style="width: 200px">
                        <strong>水印图片透明度：&nbsp;</strong>
                    </td>
                    <td align="left">&nbsp;
            ...
            <tbody id="zi" runat="server">
                ...
                <tr class="tdbg">
                    ...
                    <td align="left">&nbsp;
                        ...
                        <img onclick="SelectColor(this,'txt_dfg');" src="/images/Rect.gif" align="absmiddle"
            ...
            <tr class="tdbg" runat="server" id="oox" visible="false">
                <td  align="right" style="width: 200px">
                    <strong>坐标位置： &nbsp;</strong> <br />坐标起点位置设置为手动设置时才有效。
                </td>
                <td  align="left">&nbsp;
                    X：<asp:TextBox ID="PX" runat="server" Width="50"></asp:TextBox>
                    像素 &nbsp;
                    Y：<asp:TextBox ID="PY" runat="server" Width="50"></asp:TextBox>像素 <br />&nbsp;填写的数据必须是数字！设为手动才可启用改参数<br />
                </td>
            </tr></tbody>
        </table>
        <br />
