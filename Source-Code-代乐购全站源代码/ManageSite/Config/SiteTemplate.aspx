<%@ page language="C#" autoeventwireup="true" inherits="ManageSite_Config_SiteTemplate, App_Web_jpuabewc" enableEventValidation="false" viewStateEncryptionMode="Never" %>
...
<body>
    ...
    <div class="column">
        <div class="columntitle">
            当前位置：功能导航 >><a href="SiteTemplate.aspx">新建站点向导</a></div>
        <table width="100%" cellpadding="0" cellspacing="0" border="0">
            ...
            <tr>
                <td colspan="2" align="center" style="height: 20px" valign="middle">
                    <input id="Button1" type="button" class="button" value="下一步" style="width:80px" onclick="Nest()" />
                </td>
            </tr>
        </table>
        <br />
