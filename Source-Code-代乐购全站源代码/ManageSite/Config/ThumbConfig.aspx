<%@ page language="C#" autoeventwireup="true" inherits="ZoomLa.WebSite.Manage.Config.ThumbConfig, App_Web_jpuabewc" title="Untitled Page" enableEventValidation="false" viewStateEncryptionMode="Never" %>
    ...
    <div class="column">
        <div class="columntitle">当前位置：功能导航 >>缩略图配置</div>
            ...
            <td align="left" style="width: 500px">
                <asp:TextBox ID="iwidth" runat="server"></asp:TextBox>像素&nbsp;&nbsp;设为0时，将以高度为准按比例缩小。 </td>
        </tr>
         <tr class="tdbg">
            <td  align="right"  style="width: 300px">
                <strong>上传图片默认高度：</strong></td>
            <td  align="left" style="width: 500px">
                <asp:TextBox ID="iheight" runat="server"></asp:TextBox>像素&nbsp;&nbsp;设为0时，将以宽度为准按比例缩小。都为0时，则为原图大小。</td>
        </tr>
                 <tr class="tdbg">
                ...
                <asp:RadioButtonList ID="Isuse" runat="server" RepeatColumns="2" 
                   ...
                   >
                    ...
                    <tr class="tdbg" style="display:none">
                        <td class="style1" style="background-color:#F0F6FC">
...
这里请填写图片文件的相对路径。 </strong></td>
        ...
        <div id="zi" runat="server">
         <tr class="tdbg">
            ...
            <tr class="tdbg">
            <td class="style3" style="background-color:#F0F6FC">
        ...
        <tr class="tdbg">
            ...
            <td align="left" style="width: 500px; height: 23px;">
                <asp:DropDownList ID="localP" runat="server" AutoPostBack="True" 
                    onselectedindexchanged="localP_SelectedIndexChanged" >
