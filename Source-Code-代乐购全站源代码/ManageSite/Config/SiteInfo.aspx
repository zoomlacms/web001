<%@ page language="C#" autoeventwireup="true" inherits="ManageSite_Config_SiteInfo, App_Web_jpuabewc" enableEventValidation="false" viewStateEncryptionMode="Never" %>
<!DOCTYPE HTML>
<html>
...
<div class="clearbox"></div>
    <table width="100%" cellspacing="1" cellpadding="0" class="border">
        ...
        <tr onmouseover="this.className='tdbgmouseover'" onmouseout="this.className='tdbg'" align="left">
            ...
            <td>
                <asp:TextBox ID="TextBox8" runat="server" TextMode="MultiLine" Rows="5" Columns="60" align="left"></asp:TextBox></td>
        </tr>
    </table>
    <br />
