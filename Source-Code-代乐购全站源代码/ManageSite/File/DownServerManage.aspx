<%@ page language="C#" autoeventwireup="true" inherits="manage_Plus_DownServerManage, App_Web_wmffkvwv" enableEventValidation="false" viewStateEncryptionMode="Never" %>
...
<body>
    <form id="form1" runat="server">
     <div class="column">
        ...
        <span>当前位置：功能导航 >><a href="DownServerManage.aspx">下载服务器管理</a></span>&nbsp;&nbsp;&nbsp; 【<a href="DownServer.aspx" style="color:Red">添加下载服务器</a>】&nbsp;&nbsp;&nbsp;
    </div>
        ...
        <tr>
            <td style="height: 24px" align="left">
                ...
                <asp:Button ID="btndelete" runat="server" OnClientClick="return confirm('确定要删除选中的服务器吗？')"
                    Text="批量删除" OnClick="btndelete_Click" CssClass="button" />
                &nbsp;
            </td>
        </tr>
    </table>
