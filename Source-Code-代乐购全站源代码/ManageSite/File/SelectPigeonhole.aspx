<%@ page language="C#" autoeventwireup="true" inherits="ManageSite_File_SelectPigeonhole, App_Web_wmffkvwv" enableEventValidation="false" viewStateEncryptionMode="Never" %>
    ...
    <div class="column">
        ...
        <table>
            <tr>
                ...
                <td>
                    <asp:Button ID="Button4" CssClass="button" runat="server" Text="查 找" 
                        Width="48px" onclick="Button4_Click" />&nbsp;
                </td>
            </tr>
            </table>
            </div>
