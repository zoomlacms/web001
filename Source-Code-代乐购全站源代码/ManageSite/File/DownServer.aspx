<%@ page language="C#" autoeventwireup="true" inherits="manage_Plus_DownServer, App_Web_wmffkvwv" enableEventValidation="false" viewStateEncryptionMode="Never" %>
...
<body>
    ...
    <div class="column">
        ...
        当前位置：功能导航 >>
        <a href="DownServer.aspx">
            <asp:Label ID="Label1" runat="server" Text="添加下载服务器"></asp:Label></a>
    </div>
    <table width="100%" border="0" cellpadding="2" cellspacing="1" >
        ...
        <tr class="tdbg">
            ...
            <td class="tdbg" style="text-align: left; width: 60%;">
                <asp:TextBox ID="TxtServerLogo" runat="server" Width="290px"></asp:TextBox>
            </td>
        </tr>
        <tr class="tdbg">
            <td align="left">
        ...
        <tr class="tdbg">
            <td style="text-align: center" colspan="2">
                ...
                <input name="BtnCancel" type="button" class="button" onclick="javascript:window.location.href='DownServerManage.aspx'"
                    value=" 取消 " />
            </td>
        </tr>
    </table>
