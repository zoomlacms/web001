<%@ page language="C#" autoeventwireup="true" inherits="ZoomLa.WebSite.Manage.AddOn.UploadFile, App_Web_wmffkvwv" enableEventValidation="false" viewStateEncryptionMode="Never" %>
...
<body>
    ...
    <div class="column">
        <div class="columntitle">当前位置：功能导航 >>站点文件管理
	</div>    
    <table width="100%">
        <tr>
            <td>
            ...
            <td align="right">
                <%= string.IsNullOrEmpty(m_ParentDir) ? "<a disabled=\"true\">返回上一级</a>" : "<a href=\"UploadFile.aspx?nid=" + Request.QueryString["nid"] + "&Dir=" + m_ParentDir.Replace("//","/") + "\">返回上一级</a>"%>
            </td>
        </tr>
    </table>
