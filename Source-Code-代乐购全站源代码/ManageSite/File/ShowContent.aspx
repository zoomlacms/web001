<%@ page language="C#" autoeventwireup="true" inherits="manage_Content_ShowContent, App_Web_wmffkvwv" enableEventValidation="false" viewStateEncryptionMode="Never" %>
...
<body onload="sShowTabs(<%=Request.QueryString["type"] %>)">
    ...
    <div class="column">
        ...
        当前位置：功能导航 >>
        <a href="ShowContent.aspx">
        <asp:Label ID="Label7" runat="server" Text=""></asp:Label></a><asp:HiddenField ID="HdnModelID" runat="server" /></div>
