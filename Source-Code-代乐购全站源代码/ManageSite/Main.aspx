<%@ page language="C#" autoeventwireup="true" inherits="ManageSite_Main, App_Web_rn32wzh3" enableEventValidation="false" viewStateEncryptionMode="Never" %>
<!DOCTYPE HTML>
<html>
<head>
<title>站群后台初始页</title>
...
<div class="level level_no">
    欢迎进入[<%=SiteName() %>]网站后台管理系统，<asp:Label ID="Version" runat="server" Text=""></asp:Label>。
</div>
</li>
</ul>
...
<table width="450" border="0" cellpadding="0" cellspacing="0" style="float:left">
    <tr>
        <td align="center"><a href="/ManageSite/Config/SiteInfo.aspx"><img src="/App_Themes/AdminDefaultTheme/Images/config.png" border="0" alt="网站配置" /></a></td>
...
<div id="contentBulletin_">
    <table cellspacing="1" cellpadding="2" width="90%" align="center" border="0" id="TABLE1">
        <tbody>
            <tr class="sysinfo">
                <td align="left">版权所有:上海逐浪软件科技有限公司</td>
            ...
            <tr class="sysinfo">
                ...
                <td align="left">定制开发:QQ:544472213&nbsp; &nbsp;69250566&nbsp; &nbsp;779630567</td>
            </tr>
            <tr class="sysinfo">
            ...
            <tr class="sysinfo">
                ...
                <td align="left">帮助中心:<a href="http://bbs.zoomla.cn/" target="_blank">bbs.zoomla.cn</a></td>
            </tr>
            <tr class="sysinfo">
                <td colspan="4" height="20">
                    <div align="center">&copy; 2008-2011 <a href="http://www.zoomla.cn" target="_blank">逐浪软件</a> Inc. All Rights Reserved</div>
                </td>
            </tr>
        </tbody>
    </table>
