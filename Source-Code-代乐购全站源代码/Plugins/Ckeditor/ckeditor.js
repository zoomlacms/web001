...
*/
 (function() {
    ...
    a.config = {
        ...
        filebrowserUploadUrl: a.basePath + 'Upload.aspx',
        linkUploadAllowedExtensions: 'txt|doc|rar|zip',
    ...
    i.font_names = '宋体/宋体,sans-serif;楷体_GB2312/楷体_GB2312,sans-serif;新宋体/新宋体,sans-serif;黑体/黑体,sans-serif;隶书/隶书,sans-serif;幼圆/幼圆,sans-serif;微软雅黑/微软雅黑,sans-serif;Arial/Arial, Helvetica, sans-serif;Comic Sans MS/Comic Sans MS, cursive;Courier New/Courier New, Courier, monospace;Georgia/Georgia, serif;Lucida Sans Unicode/Lucida Sans Unicode, Lucida Grande, sans-serif;Tahoma/Tahoma, Geneva, sans-serif;Times New Roman/Times New Roman, Times, serif;Trebuchet MS/Trebuchet MS, Helvetica, sans-serif;Verdana/Verdana, Geneva, sans-serif';
    i.font_defaultLabel = '';
    i.font_style = {
        element: 'span',
        styles: {
    ...
    if (c) h.prototype.hasAttribute = function(l) {
        ...
        function N(Q) {
            return Q.replace(/<!--(?!{cke_protected})[\s\S]+?-->/g, 
            function(R) {
                return '<!--' + m + '{C}' + encodeURIComponent(R).replace(/--/g, '%2D%2D') + '-->';
            });
        };
        function O(Q) {
            return Q.replace(/<!--\{cke_protected\}\{C\}([\s\S]+?)-->/g, 
            function(R, S) {
                return decodeURIComponent(S);
            });
        };
        function P(Q, R) {
            ...
            for (var V = 0; V < U.length; V++) Q = Q.replace(U[V], 
            function(W) {
                W = W.replace(T, 
                function(X, Y, Z) {
                    return S[Z];
    ...
    j.pagebreakCmd = {
        exec: function(l) {
            var m = h.createFromHtml('<span>[PageCode/]</span>');
    ...
    j.add('resize', {
        init: function(l) {
            ...
            if (m.resize_enabled) {
                ...
                o,
                p,
                q = (m.resize_dir == 'both' || m.resize_dir == 'horizontal') && m.resize_minWidth != m.resize_maxWidth,
    ...
    i.resize_dir = 'both'; (function() {
        ...
        j.add('scayt', {
            ...
            init: function(s) {
                ...
                if (E == undefined || E) s.on('instanceReady', 
                function() {
                    p.loadEngine(s);
                });
            },
            ...
            init: function(x) {
                ...
                function E(G) {
                    ...
                    function() {
                        ...
                        H.setAttribute('contentEditable', true); ! G && E(1);
                    });
                };
    ...
    a.DIALOG_RESIZE_BOTH = 3; (function() {
        ...
        a.dialog = function(M, N) {
            ...
            if (O.onOk) this.on('ok', 
            function(ac) {
                if (O.onOk.call(this, ac) === false) ac.data.hide = false;
            });
            if (O.onCancel) this.on('cancel', 
            function(ac) {
        ...
        a.dialog.prototype = {
            ...
            addPage: function(M) {
                ...
                Y._.tabs[M.id] = [U, R];
                Y._.tabIdList.push(M.id); ! M.hidden && Y._.pageCount++;
                Y._.lastTab = U;
                Y.updateStyle();
        ...
        L = function(M) {
            ...
            k.dialog = {
                uiElement: function(M, N, O, P, Q, R, S) {
                    ...
                    U.push('>', X, '</', T, '>');
                    O.push(U.join('')); (this._ || (this._ = {})).dialog = M;
                    ...
                    M.on('load', 
                    function() {
                        if (af.getInputElement()) af.getInputElement().on('focus', 
                        function() {
    ...
    a.STYLE_OBJECT = 3; (function() {
        ...
        function u(N) {
            ...
            P = N.getName(),
            Q = v(N.getOuterHtml(), O, 
            function(S, T, U) {
                return T + '</pre>' + U + '<pre>';
            }),
            R = [];
            Q.replace(/<pre\b.*?>([\s\S]*?)<\/pre>/gi, 
            function(S, T) {
                R.push(T);
            });
            return R;
        ...
        function v(N, O, P) {
            var Q = '',
            R = '';
            N = N.replace(/(^<span[^>]+_fck_bookmark.*?\/span>)|(<span[^>]+_fck_bookmark.*?\/span>$)/gi, 
            function(S, T, U) {
                T && (Q = T);
                U && (R = U);
                return '';
        ...
        var E = /#\((.+?)\)/g;
        function F(N, O) {
            for (var P in N) N[P] = N[P].replace(E, 
            function(Q, R) {
                return O[R];
            });
        };
            ...
            init: function(s) {
                ...
                function() {
                    ...
                    if (c) {
                        ...
                        if (c && b.version < 8) t.getWindow().on('blur', 
                        function(z) {
    ...
    a.editor.prototype.createFakeParserElement = function(l, m, n, o) {
        var p = this.lang.fakeobjects,
        q,
        r = new a.htmlParser.basicWriter();
        l.writeHtml(r);
        q = r.getHtml();
        var s = {
            'class': m,
