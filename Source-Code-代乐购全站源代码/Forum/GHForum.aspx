<%@ page language="C#" autoeventwireup="true" inherits="Forum_Default, App_Web_eyuwe5cq" enableEventValidation="false" viewStateEncryptionMode="Never" %>
<!DOCTYPE HTML>
<html>
<head runat="server">
<title><%Call.Label("{$SiteName/}"); %>动交流平台 Power By ZoomLa!Forum2009</title>
    ...
    <div id="footer">
        <div class="wrap s_clear">
            <div id="footlink">
                ...
                <p class="smalltext">
                    <asp:Literal ID="TimeSpan" runat="server"></asp:Literal> <span id="debuginfo">Processed in <%=pubclass.RunTime%> second(s)</span>.
                </p>
            </div>
