<%@ page language="C#" autoeventwireup="true" inherits="ZoomLa.WebSite._Login, App_Web_tcusk5nq" enableEventValidation="false" viewStateEncryptionMode="Never" %>
<!DOCTYPE HTML>
<html>
...
<div id="login">
    <ul>
      <li><b>用户名：</b><asp:TextBox ID="TxtUserName" class="dl_input" Width="95" runat="server"></asp:TextBox></li>
      <li><b>密　码：</b><asp:TextBox ID="TxtPassword" class="dl_input" runat="server" Width="95" TextMode="Password"></asp:TextBox></li>
      <li style="display:none"><asp:PlaceHolder ID="PhValCode" runat="server">验证码：<asp:TextBox ID="TxtValidateCode" MaxLength="6" Width="60" class="l_input" runat="server" onfocus="this.select();"></asp:TextBox>     <asp:Image ID="VcodeLogin" runat="server" ImageUrl="~/Common/ValidateCode.aspx" Height="20px" /></asp:PlaceHolder> 
      </li>
      <li>
      <asp:Button ID="BtnLogin" runat="server" class="dC_input" Text="登录" OnClick="BtnLogin_Click" />&nbsp;&nbsp;
