<%@ page language="C#" autoeventwireup="true" inherits="User_Info_MyPaibao, App_Web_k5eiga0l" enableEventValidation="false" viewStateEncryptionMode="Never" %>
...
<form id="form1" runat="server">
  <div class="us_topinfo">
    <div class="us_showinfo">您现在的位置：<span
                    id="YourPosition"><span><a title="网站首页" href="/" target="_parent">
      <asp:Label ID="LblSiteName"
                        runat="server" Text="Label"></asp:Label>
      </a></span><span> &gt;&gt; <a title="会员中心"  href='<%=ResolveUrl("~/User/Default.aspx" )%>' target="_parent">会员中心</a></span> &gt;&gt; <span><a href="UserInfo.aspx">账户管理</a></span><span> &gt;&gt; 我的收益信息</span></span> </div>
  ...
  <div style="display:block;border:#CCC 1px solid;margin-top:10px;">
    ...
    <div style="width:100%;text-align:center;" align="center">
      <asp:Button ID="btn" 
            runat="server" Text="充值" onclick="btn_Click" />
    </div>
  </div>
</form>
</body>
