<%@ page language="C#" autoeventwireup="true" inherits="ZoomLa.WebSite.User.UserBase, App_Web_k5eiga0l" enableEventValidation="false" viewStateEncryptionMode="Never" %>
...
<body>
    ...
    <div class="us_topinfo">
        <div class="us_pynews">
                您现在的位置：<span id="YourPosition"><span><a title="网站首页" href="/" target="_parent"><asp:Label
                    ID="LblSiteName" runat="server" Text="Label"></asp:Label></a></span><span> &gt;&gt;
                        <a title="会员中心" href='<%=ResolveUrl("~/User/Default.aspx" )%>' target="_parent">会员中心</a></span>
                    &gt;&gt; <span><a href="UserInfo.aspx">账户管理</a></span><span> &gt;&gt; </span><span>基本信息</span></span>
        </div>
        <div class="cleardiv">
        </div>
    </div>
    <div class="us_seta" style="margin-top: 10px; width: 100%; float: left; display:none;" id="manageinfos"
        runat="server">
        ...
        <table style="width: 100%; margin: 0 auto;" cellpadding="0" cellspacing="0" class="border">
            ...
            <tr>
                <td style="width: 100%; line-height: 30px; text-align: center" colspan="4">
                    <asp:Button ID="btnEdit" Text="  编辑  " runat="server" onclick="btnEdit_Click" />&nbsp;<asp:Button ID="btnSave" runat="server" Text="保存信息" Width="90px" OnClick="btnSave_Click"
                        TabIndex="12" />
                </td>
            </tr>
        </table>
