<%@ page language="C#" autoeventwireup="true" inherits="User_Info_UserDeci_Modify, App_Web_43auybqr" enableEventValidation="false" viewStateEncryptionMode="Never" %>
<!DOCTYPE HTML>
<html>
<head runat="server">
<title>编辑地址薄</title>
...
<table width="100%" cellpadding="2" cellspacing="1">
    ...
    <tr>
        <td colspan="2" align="center">
            ...
            <asp:Button ID="Button2" runat="server" Text="取消" Width="63px" OnClientClick="javascript:location.href='UserRecei';return false;" CausesValidation="False" />
        </td>
    </tr>
</table>
</form>
