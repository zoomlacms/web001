<%@ page language="C#" autoeventwireup="true" inherits="ZoomLa.WebSite.User.PeriodHis, App_Web_43auybqr" enableEventValidation="false" viewStateEncryptionMode="Never" %>
<!DOCTYPE HTML>
<html>
<head runat="server">
<title>有效期明细</title>
...
<body>
    <form id="form1" runat="server">
        <div class="us_topinfo">
                <div class="us_showinfo"></span>您现在的位置：<span id="YourPosition"><span><a title="网站首页" href="/" target="_parent"><asp:Label ID="LblSiteName" runat="server" Text="Label"></asp:Label></a></span><span> &gt;&gt; <a title="会员中心" href='<%=ResolveUrl("~/User/Default.aspx" )%>' target="_parent">
                                会员中心</a></span> &gt;&gt; <span><a href="UserInfo.aspx">账户管理</a></span><span> &gt;&gt; </span><span>有效期明细记录</span> </span>
    </div></div>
