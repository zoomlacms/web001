<%@ page language="C#" autoeventwireup="true" inherits="ZoomLa.WebSite.User.PointHis, App_Web_43auybqr" enableEventValidation="false" viewStateEncryptionMode="Never" %>
<!DOCTYPE HTML>
<html>
        ...
        <div class="us_topinfo">
            <div class="us_showinfo">
                        ...
                        &gt;&gt; <span><a href="UserInfo.aspx">账户管理</a></span><span> &gt;&gt; </span><span>
                            <asp:Literal ID="LitPointName" runat="server"></asp:Literal>明细记录</span></span>
            </div>
        </div>
