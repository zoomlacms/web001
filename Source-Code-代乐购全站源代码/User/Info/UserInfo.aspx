<%@ page language="C#" autoeventwireup="true" inherits="ZoomLa.WebSite.User.UserInfo, App_Web_k5eiga0l" enableEventValidation="false" viewStateEncryptionMode="Never" %>
...
<div class="us_pynews">
您现在的位置：<span id="YourPosition"><span><a title="网站首页" href="/" target="_parent"><asp:Label ID="LblSiteName" runat="server" Text="Label"></asp:Label></a></span><span> &gt;&gt; <a title="会员中心" href='<%=ResolveUrl("~/User/Default.aspx" )%>' target="_parent">会员中心</a></span> &gt;&gt; <span><a href="UserInfo.aspx">账户管理</a></span><span> &gt;&gt; </span><span>注册信息</span></span>
</div>
 <div class="cleardiv"> </div>
</div>
<%--class="us_seta"--%>
<div class="us_seta" id="manageinfos" runat ="server" style="height:25px;  display:none;">
...
<td style="width:200px; float:left;line-height:30px; text-align:right">等级：</td>
    <td style="width:250px;line-height:30px"><asp:Label ID="gradeTxt" runat="server" 
            Text="Label"></asp:Label></td>
    <td style="width:200px; float:left;line-height:30px; text-align:right"></td>
    <td style="width:250px;line-height:30px"></td>
<tr class="tdbg"  style="width:100%">
<td style="width:100%; margin-top:5px; text-align:center" colspan="4">
    ...
    <br />
<div style="display:none;">    <input id="Button7" type="button" value="兑换点券"  class="i_bottom"  onclick="javascript:location.href='ExchangePoint.aspx'" />&nbsp;
    ...
    &nbsp; 
    <input id="Button12" type="button"value="拍宝套餐"  class="i_bottom" onclick="javascript:location.href='MyPaibao.aspx'" />&nbsp;               </div>
</td>                   
</tr>
</table>
</div>
