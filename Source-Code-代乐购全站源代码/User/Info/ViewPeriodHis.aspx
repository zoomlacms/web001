<%@ page language="C#" autoeventwireup="true" inherits="ZoomLa.WebSite.User.Info.ViewPeriodHis, App_Web_43auybqr" enableEventValidation="false" viewStateEncryptionMode="Never" %>
<!DOCTYPE HTML>
<html>
...
<div class="us_topinfo">
	 ...
	 <span class="us_showinfo1">您好<asp:Label ID="Label1" runat="server" Text="Label"></asp:Label>！</span>您现在的位置：<span id="YourPosition"><span><a title="网站首页" href="/" target="_parent"><asp:Label ID="Label2" runat="server" Text="Label"></asp:Label></a></span><span> &gt;&gt; <a title="会员中心" href='<%=ResolveUrl("~/User/Default.aspx" )%>' target="_parent">
							会员中心</a></span> &gt;&gt; <span><a href="UserInfo.aspx">账户管理</a></span><span> &gt;&gt; </span><span>有效期明细详情</span></span> 
</div></div>
