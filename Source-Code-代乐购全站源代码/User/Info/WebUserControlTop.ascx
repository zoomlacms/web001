<%@ control language="C#" autoeventwireup="true" inherits="User_Info_WebUserControlTop, App_Web_43auybqr" %>
 <ul style="width:100%">
        ...
        <li style="width:60px; text-align:center "><a href="DredgeVip.aspx">VIP信息</a></li>
          <li style="width:80px; text-align:center "><a href="listprofit.aspx">我的收益信息</a></li>
        ...
        <li style=" text-align:center ;width:120px;"><asp:Label ID="Label4" runat="server" Text=""></asp:Label></li>
 </ul>