<%@ page language="C#" autoeventwireup="true" inherits="User_Info_AdPlan, App_Web_43auybqr" enableEventValidation="false" viewStateEncryptionMode="Never" %>
<!DOCTYPE html PUBLIC>
<html>
...
<span style="font-size:12px;">您现在的位置：</span>
...
&gt;&gt;
<a title="广告计划" href="AdPlan.aspx">广告计划</a>
<a href="AdPlanAdd.aspx">[申请广告]</a>
</div>
<div>
</div>
<div id="nocontent" runat="server" style="margin-top:10PX;">
	暂无版位信息</div>
	<div class="adplan">
