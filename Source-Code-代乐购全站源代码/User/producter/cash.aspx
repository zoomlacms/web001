<%@ page language="C#" autoeventwireup="true" inherits="User_producter_cash, App_Web_swaskqmp" enableEventValidation="false" viewStateEncryptionMode="Never" %>
<!DOCTYPE HTML>
<html>
...
<div class="us_seta" style="margin-top: 10px;" id="manageinfo" runat="server">
	...
	<li>确认金额:</li><li><asp:TextBox ID="TextBox4" runat="server"></asp:TextBox></li>		
        ...
        <asp:ImageButton ID="ImageButton1" runat="server" 
            ImageUrl="~/User/Images/button.bmp" onclick="ImageButton1_Click" />
    </div>
    ...
    <asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server" 
        ErrorMessage="开户人不能为空" ControlToValidate="TextBox1"></asp:RequiredFieldValidator>
        ...
        ErrorMessage="银行帐号不能为空" ControlToValidate="TextBox2"></asp:RequiredFieldValidator>
</div>
</form>S
</body>
</html>