<%@ page language="C#" autoeventwireup="true" inherits="User_producter_ProducterManage, App_Web_swaskqmp" enableEventValidation="false" viewStateEncryptionMode="Never" %>
<!DOCTYPE HTML>
<html>
  ...
  <div class="us_topinfo">
    <div class="us_pynews">
      <span class="us_showinfo1">您好
        ...
        ！</span>您现在的位置：<span id="YourPosition"><span><a title="网站首页" href="/" target="_parent">
        <asp:Label ID="LblSiteName" runat="server" Text="Label"></asp:Label>
        </a></span><span> &gt;&gt; <a title="会员中心" href='<%=ResolveUrl("~/User/Default.aspx" )%>' target="_parent">会员中心</a></span> &gt;&gt; 发货信息</span>
    </div>
  </div>
