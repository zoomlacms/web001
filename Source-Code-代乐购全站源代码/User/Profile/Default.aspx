<%@ page language="C#" autoeventwireup="true" inherits="User_Profile_Default, App_Web_3koasel0" enableEventValidation="false" viewStateEncryptionMode="Never" %>
<!DOCTYPE HTML>
    ...
    <div class="us_topinfo">
      <div class="us_pynews">
       您现在的位置：<span id="YourPosition"><span><a title="网站首页" href="/" target="_parent">
          ...
          </a></span><span> &gt;&gt; <a title="会员中心" href='<%=ResolveUrl("~/User/Default.aspx" )%>' target="_parent">会员中心</a></span> &gt;&gt; <span><a href="Default.aspx">我的返利</a></span></span>
      </div>
