<%@ page language="C#" autoeventwireup="true" inherits="User_Profile_Accountinfo, App_Web_3koasel0" enableEventValidation="false" viewStateEncryptionMode="Never" %>
<!DOCTYPE HTML>
<html>
<head runat="server">
<title>收款信息设置</title>
  ...
  <div class="us_topinfo" style="width: 98%">
    <div class="us_showinfo">
      您现在的位置：<span id="Span1"><a title="网站首页" href="/" target="_blank">
        ...
        </a>&gt;&gt; <a title="会员中心" href="/User/Default.aspx" target="_parent">会员中心</a> &gt;&gt; <a href="Accountinfo.aspx">收款信息设置</a></span>
    </div>
