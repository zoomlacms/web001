<%@ page language="C#" autoeventwireup="true" inherits="User_Profile_RedEnvelopeRecard, App_Web_3koasel0" enableEventValidation="false" viewStateEncryptionMode="Never" %>
<!DOCTYPE HTML>
<html>
<head runat="server">
<title>红包申请记录</title>
...
<div class="us_topinfo">
    ...
    <asp:Label ID="LblSiteName" runat="server" Text="Label"></asp:Label></a>&gt;&gt; <a title="会员中心" href='<%=ResolveUrl("~/User/Default.aspx" )%>' target="_parent">会员中心</a></span>
    &gt;&gt; <span><a href="Default.aspx">我的返利</a></span>&gt;&gt;<span><a>红包申请记录</a></span> &nbsp;</h1>
    </div>
