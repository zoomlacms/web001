<%@ page language="C#" autoeventwireup="true" inherits="User_Profile_PointRecord, App_Web_3koasel0" enableEventValidation="false" viewStateEncryptionMode="Never" %>
<!DOCTYPE HTML>
<html>
<head runat="server">
<title>我的积分</title>
    ...
    <div class="us_topinfo">
      <div class="us_pynews">
        您现在的位置：<span id="YourPosition"><span><a title="网站首页" href="/" target="_parent">
          ...
          </a>&gt;&gt; <a title="会员中心" href='<%=ResolveUrl("~/User/Default.aspx" )%>' target="_parent">会员中心</a> </span> &gt;&gt; <span><a href="PointRecord.aspx">我的积分</a></span></span>
      </div>
