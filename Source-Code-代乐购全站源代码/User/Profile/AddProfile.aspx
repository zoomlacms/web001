<%@ page language="C#" autoeventwireup="true" inherits="User_Profile_AddProfile, App_Web_3koasel0" enableEventValidation="false" viewStateEncryptionMode="Never" %>
<!DOCTYPE HTML>
<html>
<head runat="server">
<title>添加返利</title>
...
<div class="us_topinfo" style="width: 98%">
    <div class="us_showinfo">
       您现在的位置：<span id="Span1"><a title="网站首页" href="/" target="_blank"><asp:Label
         ID="LblSiteName" runat="server" Text=""></asp:Label></a>&gt;&gt; <a title="会员中心" href="/User/Default.aspx" target="_parent">会员中心</a>
           &gt;&gt; <a href="OrderManage.aspx?state=0">我的订单</a></span> &gt;&gt;<a>用户提交订单</a>
    </div>
    <div class="cleardiv">
    </div>
</div>
    ...
    <tr>
        ...
        <td class="style3">
            ...
            <asp:RegularExpressionValidator ID="RegularExpressionValidator12"
                runat="server" ControlToValidate="txtOrderMoney" ErrorMessage="订单金额必须是数字!" ValidationExpression="^(-?\d+)(\.\d+)?$"
