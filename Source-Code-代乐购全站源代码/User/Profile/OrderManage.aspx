<%@ page language="C#" autoeventwireup="true" inherits="User_Profile_OrderManage, App_Web_3koasel0" enableEventValidation="false" viewStateEncryptionMode="Never" %>
<!DOCTYPE HTML>
<html>
<head runat="server">
<title>我的订单</title>
  ...
  <div class="us_topinfo" style="width:98%">
    <div class="us_pynews">
      您现在的位置：<span id="YourPosition"><span><a title="网站首页" href="/" target="_blank">
        ...
        </a></span><span>&gt;&gt; </span><span><a title="会员中心" href='<%=ResolveUrl("~/User/Default.aspx" )%>' target="_parent"> 会员中心</a></span><span> &gt;&gt; </span><span><a title="我的订单" href="OrderManage.aspx?state=0"> 我的订单</a></span></span>
    </div>
