<%@ page language="C#" autoeventwireup="true" inherits="User_Profile_Profile, App_Web_3koasel0" enableEventValidation="false" viewStateEncryptionMode="Never" %>
<!DOCTYPE HTML>
<html>
<head runat="server">
<title>返利详情</title>
...
<div class="us_topinfo">
    <div class="us_showinfo"><h1>您现在的位置：<span id="YourPosition"><span><a title="网站首页" href="/" target="_parent"><asp:Label ID="LblSiteName" runat="server" Text="Label"></asp:Label></a>&gt;&gt; <a title="会员中心" href='<%=ResolveUrl("~/User/Default.aspx" )%>' target="_parent">会员中心</a></span> &gt;&gt; <span><a href="Default.aspx">我的返利</a></span>&nbsp;</span> </h1>
    </div>
    ...
    <div align="center">
       <table width="100%">
           <tr>
            ...
            onitemdatabound="repf_ItemDataBound">
             <ItemTemplate>
               <table width="100%">
               <tr>
