<%@ page language="C#" autoeventwireup="true" inherits="User_OrderForm_ColonelList, App_Web_hlsukwuo" enableEventValidation="false" viewStateEncryptionMode="Never" %>
<!DOCTYPE HTML>
<html>
<head runat="server">
<title>无标题页</title>
                ...
                <div class="us_showinfo">
                        ...
                        您现在的位置：<span id="YourPosition"><span><a title="网站首页" href="/" target="_blank"><asp:Label
                            ID="LblSiteName" runat="server" Text="Label"></asp:Label></a></span><span> &gt;&gt;
                                ...
                                &gt;&gt; </span><span><a title="团购信息" href="ShopCarList.aspx?menu=Cartinfo">团购信息</a></span></span>
                </div>
                <div class="cleardiv">
                </div>
            </div>
