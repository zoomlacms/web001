<%@ page language="C#" autoeventwireup="true" inherits="User_PreViewOrder, App_Web_pvpn01r3" enableEventValidation="false" viewStateEncryptionMode="Never" %>
<!DOCTYPE HTML>
<html>
...
<body>
    ...
    <!-- str -->
    <div class="us_topinfo" style="margin-top: 10px; display:none;">
    ...
    <div class="us_seta" style="margin-top: 10px;">
        ...
        <asp:Panel ID="Orderlist" runat="server" Width="100%" Visible="false">
            <ul style="background-color: Blue">
                ...
                <li style="width: 10%; float: left; line-height: 30px; text-align: center; background-color: #FFF5EC">
                    实际金额 </li>
                <li style="width: 7%; float: left; line-height: 30px; text-align: center; background-color: #FFF5EC;display:none;">
                    需要发票 </li>
                <li style="width: 7%; float: left; line-height: 30px; text-align: center; background-color: #FFF5EC; display:none;">
                    已开发票 </li>
                <li style="width: 10%; float: left; line-height: 30px; text-align: center; background-color: #FFF5EC;">
            ...
            <asp:Repeater ID="Ordertable" runat="server">
                <ItemTemplate>
                    <ul>
                        <li style="width: 15%; float: left; line-height: 28px; text-align: center; white-space: nowrap;
                        ...
                        <li style="width: 7%; float: left; line-height: 28px; text-align: center; display:none;">
