<%@ page language="C#" autoeventwireup="true" inherits="User_UserFriend_Default, App_Web_f1iyhkjt" enableEventValidation="false" viewStateEncryptionMode="Never" %>
                ...
                <div class="us_pynews">
                        您现在的位置：<span id="YourPosition"><span><a title="网站首页" href="/" target="_blank"><asp:Label
                            ID="LblSiteName" runat="server" Text="Label"></asp:Label></a></span><span> &gt;&gt;
                                ...
                                &gt;&gt; </span><span><a title="我的好友" href="/User/UserFriend/Default.aspx">我的好友</a>&gt;&gt;我的好友</span>
                </div>
                <div class="cleardiv">
                </div>
            </div>
