<%@ page language="C#" autoeventwireup="true" inherits="SearchSchool, App_Web_b5idtrk4" enableEventValidation="false" viewStateEncryptionMode="Never" %>
            ...
            <div class="us_showinfo">
                    ...
                    您现在的位置：<span id="YourPosition"><span><a title="网站首页" href="/" target="_parent"><asp:Label
                        ID="LblSiteName" runat="server" Text="Label"></asp:Label></a></span><span> &gt;&gt;
                            ...
                            &gt;&gt; </span><span><a title="我的好友" href="/User/UserFriend/Index.aspx">我的好友</a></span></span>
                    &gt;&gt; 搜索好友
            </div>
