<%@ page language="C#" autoeventwireup="true" inherits="Friendsearch_quick, App_Web_arckvgsf" enableeventvalidation="true" viewStateEncryptionMode="Never" %>
                        ...
                        <div style="padding: 10px; width: 600px !important; border:0px;">
                            ...
                            <tr>
                                <td align="center">
                                    ...
                                    <asp:LinkButton ID="FristPage" runat="server" Text="首页" 
                                        onclick="FristPage_Click"></asp:LinkButton>
                                    &nbsp;<asp:LinkButton ID="TopPage" runat="server" onclick="TopPage_Click" 
                                        Text=" 上一页"></asp:LinkButton>
                                    &nbsp;<asp:LinkButton ID="NextPage" runat="server" onclick="NextPage_Click" 
                                        Text=" 下一页"></asp:LinkButton>
                                    &nbsp;<asp:LinkButton ID="LastPage" runat="server" onclick="LastPage_Click" 
                                        Text="尾页"></asp:LinkButton>
                                    <asp:Label ID="pageMessageLB1" runat="server" Text=""></asp:Label>
                                    <asp:DropDownList ID="DropPage"  runat="server" 
                                         AutoPostBack="true" 
                                        ontextchanged="DropPage_TextChanged">
                                    </asp:DropDownList>
                                    页
                                </td>
                            </tr>
