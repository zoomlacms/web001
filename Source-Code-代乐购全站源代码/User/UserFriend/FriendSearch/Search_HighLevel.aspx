<%@ page language="C#" autoeventwireup="true" inherits="User_UserFriend_FriendSearch_Search_HighLevel, App_Web_arckvgsf" enableEventValidation="false" viewStateEncryptionMode="Never" %>
...
<div style="margin: auto; width: 100%">
        <div class="us_topinfo">
            ...
            您现在的位置：<span id="YourPosition"><span><a title="网站首页" href="/" target="_blank"><asp:Label
                ID="LblSiteName" runat="server" Text=""></asp:Label></a></span><span> &gt;&gt; </span>
