<%@ page language="C#" autoeventwireup="true" inherits="Friendsearch_quick, App_Web_b5idtrk4" enableeventvalidation="true" viewStateEncryptionMode="Never" %>
            ...
            <div class="us_pynews">
                        ...
                        您现在的位置：<span id="YourPosition"><span><a title="网站首页" href="/" target="_blank"><asp:Label
                            ID="LblSiteName" runat="server" Text="Label"></asp:Label></a></span><span> &gt;&gt;
                                ...
                                &gt;&gt; </span><span><a title="我的好友" href="/User/UserFriend/Default.aspx">我的好友</a></span></span>&gt;&gt;搜索好友
                </div>
                <div class="cleardiv">
                </div>
            </div>
                                            ...
                                            <tr>
                                                <td align="center" height="143">
                                                    <a href="../User/Usershow.aspx?userid=<%#DataBinder.Eval(Container.DataItem,"UserID") %>">
                                                        ...
                                                        ImageUrl='<%#GetPic(Eval("UserID","{0}").ToString()) %>' /></a></td>
                                                <td valign="top">
