<%@ page language="C#" autoeventwireup="true" inherits="User_UserFriend_FriendAdd, App_Web_f1iyhkjt" enableEventValidation="false" viewStateEncryptionMode="Never" %>
...
<div class="s_bright">
	...
	<div class="us_topinfo">
	  <div class="us_pynews">
		  您现在的位置：<span id="YourPosition"><span><a title="网站首页" href="/" target="_blank"><asp:Label ID="LblSiteName" runat="server" Text="Label"></asp:Label></a></span><span> &gt;&gt; </span><span><a title="会员中心" href="/User/Default.aspx" target="_parent">会员中心</a></span><span> &gt;&gt; </span><span><a title="我的好友" href="/User/UserFriend/Index.aspx">我的好友</a></span></span>&gt;&gt;好友管理
	  </div>  
