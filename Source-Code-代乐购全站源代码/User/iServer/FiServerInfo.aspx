<%@ page language="C#" autoeventwireup="true" validaterequest="false" inherits="manage_iServer_FiServerInfo, App_Web_rgrpughb" enableEventValidation="false" viewStateEncryptionMode="Never" %>
<!DOCTYPE HTML>
<html>
<head runat="server">
    <title>问题详情</title>
...
<body>
    ...
    <div class="us_topinfo">
        <div class="us_showinfo">
            <strong>您现在的位置：</strong><span id="YourPosition"><span><a title="网站首页" href="/" target="_blank"><asp:Label
                    ...
                    <table width="100%" cellpadding="2" cellspacing="1" class="border" style="background-color: white;">
                        ...
                        <tr>
                            <td align="center" colspan="2">
                                <asp:Button ID="Button1" class="i_bottom" runat="server" Text="添加" OnClick="Button1_Click" />
                            </td>
                        </tr>
                    </table>
                    </div>
