<%@ page language="C#" autoeventwireup="true" inherits="User_Guild_Zone_MyPresent, App_Web_h4dhwlm1" enableEventValidation="false" viewStateEncryptionMode="Never" %>
<!DOCTYPE HTML>
<html>
...
<tr>
<td style="height:5px">收到：<%#GetUserName(Eval("GiftUserID").ToString())%>&nbsp;&nbsp;<%#Eval("GiftTime")%></td>
<td></td>
</tr>
<tr>
