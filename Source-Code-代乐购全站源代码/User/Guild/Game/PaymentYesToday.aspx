<%@ page language="C#" autoeventwireup="true" inherits="ZoomLa.WebSite.User.Payment, App_Web_evgxeaxi" enableEventValidation="false" viewStateEncryptionMode="Never" %>
<!DOCTYPE HTML>
<html>
...
<body>
    ...
    <div class="r_navigation">
        <span>游戏管理</span> &gt;&gt;<span>昨天所有成功订单</span>
        <br />     
    </div>
