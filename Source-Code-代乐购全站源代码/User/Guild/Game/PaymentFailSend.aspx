<%@ page language="C#" autoeventwireup="true" inherits="ZoomLa.WebSite.User.Payment, App_Web_quwimlll" enableEventValidation="false" viewStateEncryptionMode="Never" %>
<!DOCTYPE HTML>
<html>
...
<body>
    ...
    <div class="r_navigation">
         <span>游戏管理</span> &gt;&gt;<span>发送失败订单</span>
        <br />
    </div>
    ...
    <table width="100%" border="0" cellpadding="2" cellspacing="1" class="border" style="margin: 0 auto;">
      <tr align="center">
        ...
        <td width="10%" class="title">所走通道</td>
      ...
      <tr class="tdbg" onmouseover="this.className='tdbgmouseover'" onmouseout="this.className='tdbg'">
         ...
         <td height="22" align="center"><a href="PaymentFailSend.aspx?paymentNum=<%#Eval("paymentNum") %>">转入未发送</a></td>
