<%@ page language="C#" autoeventwireup="true" debug="true" inherits="User_Usertalk_ImgUpdateLoad, App_Web_hbxcfih3" enableEventValidation="false" viewStateEncryptionMode="Never" %>
<!DOCTYPE HTML>
<html>
	...
	<div class="us_showinfo">
			您现在的位置：<span id="YourPosition"><span><a title="网站首页" href="/" target="_blank"><asp:Label
				ID="LblSiteName" runat="server" Text="Label"></asp:Label></a></span><span> &gt;&gt;
					...
					会员中心</a></span><span> &gt;&gt; </span><span>我的相册</span>
	</div>
		   ...
		   <tr>
				<td align="center">
					<li style="height: 30px; text-align: center">共<asp:Label ID="Allnum1" runat="server"
						...
						页次：<asp:Label ID="Nowpage1" runat="server" Text=""></asp:Label>/<asp:Label ID="PageSize1"
							runat="server" Text=""></asp:Label>页
