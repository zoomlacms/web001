<%@ page language="C#" autoeventwireup="true" inherits="User_UserShop_AddFloGoods, App_Web_iincli3c" enableEventValidation="false" viewStateEncryptionMode="Never" %>
<!DOCTYPE HTML>
<html>
<head>
<title>编辑运货方式</title>
...
<div class="us_showinfo">
	您现在的位置：<span id="Span1"><span><a title="网站首页" href="/" target="_blank"><asp:Label
		ID="LblSiteName" runat="server" Text="Label"></asp:Label></a></span><span> &gt;&gt;
		   ...
		   <span> &gt;&gt;</span><span><a title="运货方式管理" href="FloGoodsManage.aspx">运货方式管理</a></span>
		   <span>&gt;&gt;</span><span id="li" runat="server">添加运货方式</span></span>
</div>
