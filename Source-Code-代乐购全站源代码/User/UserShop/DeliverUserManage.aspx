<%@ page language="C#" autoeventwireup="true" inherits="User_UserShop_DeliverUserManage, App_Web_iincli3c" enableEventValidation="false" viewStateEncryptionMode="Never" %>
<!DOCTYPE HTML>
<html>
<head runat="server">
<title>送货员管理</title>
...
您现在的位置：<span id="Span1"><span><a title="网站首页" href="/" target="_blank"><asp:Label
    ID="LblSiteName" runat="server" Text="Label"></asp:Label></a></span><span> &gt;&gt;
        ...
        <span> &gt;&gt; </span><span><a title="送货员管理" href="DeliverUserManage.aspx">送货员管理</a></span></span><</div>
</div>
 ...
 <asp:Label ID="lbltips" runat="server" style="color:Green;font-size:14px;font-weight:bold">添加送货员</asp:Label>
    ...
    姓名：<asp:TextBox ID="txtname" runat="server"></asp:TextBox> &nbsp;&nbsp;手机号码：<asp:TextBox ID="txtMobile" runat="server"></asp:TextBox>
     <asp:RegularExpressionValidator runat="server" ID="RegularExpressionValidator4" ValidationExpression="^1[(0-9)]{10}$"
                   ControlToValidate="txtMobile" ErrorMessage="按照手机号规则输入"></asp:RegularExpressionValidator>
