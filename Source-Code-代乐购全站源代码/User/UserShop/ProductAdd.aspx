<%@ page language="C#" autoeventwireup="true" inherits="User_UserShop_ProductAdd, App_Web_kclya3kn" validaterequest="false" enableviewstate="False" enableEventValidation="false" viewStateEncryptionMode="Never" %>
    ...
    //]]>
                                ...
                                <tbody id="Tabs4" style="display: none">
                                    ...
                                    <tr class="tdbg">
                                        ...
                                        <td>
                                            购买一件此商品可以得到
                                            <asp:TextBox ID="Integral" runat="server" />
                                            积分
                                    ...
                                    <asp:Literal ID="ModelHtml" runat="server"></asp:Literal></tbody><tbody id="Tabs6"
                                        ...
                                        <tr class="tdbg">
                                            ...
                                            <td>
                                                ...
                                                <input type="button" value="选择模板" onclick="WinOpenDialog('../../manage/Template/TemplateList.aspx?OpenerText='+escape('ModeTemplate')+'&FilesDir=',650,480)"
                                                    class="btn" />
                                            </td>
                                        </tr>
                                    </tbody>
