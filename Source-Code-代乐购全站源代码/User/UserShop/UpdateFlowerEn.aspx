<%@ page language="C#" autoeventwireup="true" inherits="User_UserShop_UpdateFlowerEn, App_Web_iincli3c" enableEventValidation="false" viewStateEncryptionMode="Never" %>
<!DOCTYPE HTML>
<html>
<head runat="server">
<title></title>
...
<div class="us_showinfo">
        您现在的位置：<span id="Span1"><span><a title="网站首页" href="/" target="_blank"><asp:Label
            ...
            <span>&gt;&gt; </span><span><a title="花材管理" href="UpdateFlowerEn.aspx">设定花材是否充足</a></span></span>
</div>
