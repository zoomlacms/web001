<%@ page language="C#" autoeventwireup="true" inherits="User_UserShop_Pay_Add, App_Web_iincli3c" enableEventValidation="false" viewStateEncryptionMode="Never" %>
...
<div class="us_topinfo">
      您现在的位置：<span id="YourPosition"><span><a title="网站首页" href="/" target="_blank">
        <asp:Label ID="LblSiteName" runat="server" Text="Label">逐浪CMS</asp:Label>
        </a></span><span>&gt;&gt; </span><span><a title="会员中心" href='<%=ResolveUrl("~/User/Default.aspx" )%>' target="_parent">会员中心
</a></span><span> &gt;&gt; </span><span><asp:Label  ID="LblAction" runat="server" Text="添加支付平台"></asp:Label></span></span>
    </div>
            ...
            <table border="0" cellpadding="0" cellspacing="0" width="100%">
                <tr>
                    <td align="center">
                        ...
                        &nbsp;
                        <input name="Cancel" type="button" id="BtnCancel" value="取消" onclick="window.location.href='PayPlatManage.aspx'" class="i_bottom" />
                    </td>
                </tr>
            </table>
        </ContentTemplate>
