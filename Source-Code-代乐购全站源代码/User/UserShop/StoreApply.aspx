<%@ page language="C#" autoeventwireup="true" inherits="User_UserShop_StoreApply, App_Web_kclya3kn" enableEventValidation="false" viewStateEncryptionMode="Never" %>
...
<ul class="us_seta" style="margin-top: 10px;" id="add" runat="server">
	...
	<li style="width: 20%;">&nbsp;<asp:DropDownList ID="DropDownList1" runat="server"
