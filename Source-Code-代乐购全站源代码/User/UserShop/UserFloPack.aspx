<%@ page language="C#" autoeventwireup="true" inherits="User_UserShop_UserFloPack, App_Web_kclya3kn" enableEventValidation="false" viewStateEncryptionMode="Never" %>
...
<div class="us_showinfo">
        您现在的位置：<span id="Span1"><span><a title="网站首页" href="/" target="_blank"><asp:Label
            ID="LblSiteName" runat="server" Text="Label"></asp:Label></a></span><span> &gt;&gt;
               ...
               <span> &gt;&gt; </span><span><a title="用户包装管理" href="UserFloPack.aspx">用户包装管理</a></span>
               [<span><a title="添加包装" href="AddFlowerPack.aspx">添加包装</a></span>]
                </span>
</div>
<div style="width:100%">
