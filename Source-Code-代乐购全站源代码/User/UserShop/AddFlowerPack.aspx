<%@ page language="C#" autoeventwireup="true" inherits="User_UserShop_AddFlowerPack, App_Web_iincli3c" enableEventValidation="false" viewStateEncryptionMode="Never" %>
<!DOCTYPE HTML>
<html>
<head runat="server">
<title>添加花束包装</title>
...
<div class="us_showinfo">
	您现在的位置：<span id="Span1"><span><a title="网站首页" href="/" target="_blank"><asp:Label
		...
		<span>&gt;&gt;</span><span id="li" runat="server">添加包装</span></span>
</div>
