<%@ page language="C#" autoeventwireup="true" inherits="User_UserShop_UserOrderlist, App_Web_iincli3c" enableEventValidation="false" viewStateEncryptionMode="Never" %>
<!DOCTYPE HTML>
<html>
<head runat="server">
...
<div class="us_showinfo">
        您现在的位置：<span id="Span1"><span><a title="网站首页" href="/" target="_blank"><asp:Label
            ID="LblSiteName" runat="server" Text="Label"></asp:Label></a></span><span> &gt;&gt;
               ...
               <span> &gt;&gt; </span><span><a title="店铺订单管理" href="UserOrderlist.aspx">店铺订单管理</a></span>
                </span>
</div>
