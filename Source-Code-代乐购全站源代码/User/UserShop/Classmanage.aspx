<%@ page language="C#" autoeventwireup="true" inherits="User_UserShop_Classmanage, App_Web_kclya3kn" enableEventValidation="false" viewStateEncryptionMode="Never" %>
    ...
    <form id="form1" runat="server">
		...
		您现在的位置：<span id="Span1"><span><a title="网站首页" href="/" target="_blank"><asp:Label
			ID="LblSiteName" runat="server" Text="Label"></asp:Label></a></span><span> &gt;&gt;
				...
				&gt;&gt; </span><span><a title="修改密码" href="Classmanage.aspx">分类管理</a></span></span>
        </div>
