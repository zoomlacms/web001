<%@ page language="C#" autoeventwireup="true" inherits="User_Message_MessageOutbox, App_Web_tfavzhrg" enableEventValidation="false" viewStateEncryptionMode="Never" %>
<!DOCTYPE HTML>
<html>
<head runat="server">
<title>发件箱</title>
	...
	<div class="us_infoa">
	  <div class="us_seta" style="margin-top:5px;">
			...
			<div class="us_pynews">
				...
				<asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" OnRowEditing="GridView1_RowEditing" Width="100%" AllowPaging="True" DataKeyNames="MsgID" OnRowCommand="Row_Command"  OnPageIndexChanging="GridView1_PageIndexChanging"  >
	<Columns>
...
<ItemStyle HorizontalAlign="Center"></ItemStyle>
		...
		<asp:TemplateField HeaderText="主题">
			...
			<ItemTemplate>                    
					<%# Eval("Title", "{0}")%>（<%#getStatus(Eval("status","{0}"))%>)
			</ItemTemplate>
