<%@ page language="C#" autoeventwireup="true" inherits="User_Message_Mobile, App_Web_tfavzhrg" enableEventValidation="false" viewStateEncryptionMode="Never" %>
<!DOCTYPE HTML>
<html>
...
<form id="form1" runat="server">
        ...
        <td><table id="TblAddMessage" width="100%" visible="true" runat="server">
            <tr>
              ...
              (多条信息发送以半角逗号区隔，最多支持100个/次超100个请自行做循环)
                <asp:RequiredFieldValidator ControlToValidate="TxtInceptUser" runat="server">手机号码不能为空 </asp:RequiredFieldValidator>
                 </td>
              <td></td>
            </tr>
          </table></td>
  ...
  提示：系统支持以Mobile.aspx?MB=[手机号码]方式GET将手机号码传值发送，如：Mobile.aspx?MB=13177777714
