<%@ page language="C#" autoeventwireup="true" inherits="User_Project_Detail, App_Web_bqmdjxko" enableEventValidation="false" viewStateEncryptionMode="Never" %>
<!DOCTYPE HTML>
<html>
<head runat="server">
<title>项目详细内容</title>
...
您现在的位置：<span id="YourPosition"><span><a title="网站首页" href="/" target="_blank"><asp:Label ID="LblSiteName" runat="server" Text="Label"></asp:Label></a></span><span> &gt;&gt; </span><span><a title="会员中心" href="/User/Default.aspx" target="_parent">会员中心</a></span><span> &gt;&gt; </span><span><a title="项目详细内容" href="/User/Detail.aspx">项目详细内容</a></span></span>
</div>
