<%@ page language="C#" autoeventwireup="true" inherits="Zoomla.Website.page.Shop.AddProduct, App_Web_jzrthtdl" enableEventValidation="false" viewStateEncryptionMode="Never" %>
<!DOCTYPE HTML>
<html>
...
<div class="us_pynews">
<div class="us_seta">
    您的位置：<span id="YourPosition"><span><a title="网站首页" href="/" target="_top"><asp:Label ID="LblSiteName" runat="server" Text="Label"></asp:Label></a></span>
    <span> &gt;&gt; </span><span><a title="会员中心" href="/User/Default.aspx" target="_parent">会员中心</a></span><span> &gt;&gt; </span><span>投稿管理</span></span>
    <span> &gt;&gt; </span><span><asp:Label ID="lblNodeName" runat="server" Text="Label"></asp:Label></span>
</div>
</div>          
