<%@ page language="C#" autoeventwireup="true" inherits="User_Pages_ClassManage, App_Web_jzrthtdl" enableEventValidation="false" viewStateEncryptionMode="Never" %>
<!DOCTYPE HTML>
<html>
  ...
  <div class="us_topinfo" style="width:98%">
    <div class="us_pynews">
      您现在的位置：<span id="Span1"><span><a title="网站首页" href="/" target="_blank">
        ...
        </a></span><span> &gt;&gt; </span><span><a title="会员中心" href="/User/Default.aspx" target="_parent">会员中心</a></span><span> &gt;&gt; </span><span><a title="配置黄页" href="/User/Pages/ClassManage.aspx">栏目管理</a></span></span> <a href="Addnode.aspx" style="color:Black">[添加栏目]</a>
    </div>
