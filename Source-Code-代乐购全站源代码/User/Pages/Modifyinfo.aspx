<%@ page language="C#" autoeventwireup="true" inherits="User_Pages_Modifyinfo, App_Web_jzrthtdl" enableEventValidation="false" viewStateEncryptionMode="Never" %>
<!DOCTYPE HTML>
<html>
<head runat="server">
<title>修改黄页信息</title>
...
<div class="us_pynews">
    ...
    </a></span><span> &gt;&gt; </span><span><a title="会员中心" href="/User/Default.aspx" target="_parent">会员中心</a></span><span> &gt;&gt; </span><span><a title="配置黄页" href="/User/Pages/Modifyinfo.aspx">配置黄页</a></span></span>
</div>
