<%@ page language="C#" autoeventwireup="true" inherits="User_Pages_addnode, App_Web_jzrthtdl" enableEventValidation="false" viewStateEncryptionMode="Never" %>
<!DOCTYPE HTML>
<html>
...
<form id="form1" runat="server">
  <div class="us_topinfo" style="width: 98%">
    <div class="us_showinfo">
      您现在的位置：<span id="Span1"><span><a
                    title="网站首页" href="/" target="_blank">
        <asp:Label ID="LblSiteName" runat="server" Text=""></asp:Label>
        </a></span><span> &gt;&gt; </span><span><a title="会员中心" href="/User/Default.aspx" target="_parent">会员中心</a></span><span> &gt;&gt; </span><span></span><span><a title="栏目管理" href="/User/Pages/ClassManage.aspx"> 栏目管理</a></span><span> &gt;&gt; </span><span><a title="添加栏目" href="/User/Pages/Modifyinfo.aspx"> 添加栏目</a></span></span>
    </div>
