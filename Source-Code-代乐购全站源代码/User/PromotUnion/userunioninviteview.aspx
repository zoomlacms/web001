<%@ page language="C#" autoeventwireup="true" inherits="User_PromotUnion_userunioninviteview, App_Web_wpotsezs" enableEventValidation="false" viewStateEncryptionMode="Never" %>
<!DOCTYPE HTML>
<html>
<head runat="server">
<title>已邀请到的好友</title>
...
<body>
<div>
 <div class="us_showinfo">您现在的位置：<span id="YourPosition"><span><a title="网站首页" href="/" target="_parent"><asp:Label ID="LblSiteName" runat="server" Text="Label"></asp:Label></a>&gt;&gt; <a title="会员中心" href='<%=ResolveUrl("~/User/Default.aspx" )%>' target="_parent">会员中心</a></span> &gt;&gt; <span><a href="userunioninviteview.aspx">我的赚钱记录</a></span>&nbsp;</span> 
	</div>
