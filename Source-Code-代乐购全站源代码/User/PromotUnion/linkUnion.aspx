<%@ page language="C#" autoeventwireup="true" inherits="User_PromotUnion_linkUnion, App_Web_wpotsezs" enableEventValidation="false" viewStateEncryptionMode="Never" %>
<!DOCTYPE HTML>
<html>
<head runat="server">
<title>链接推广</title>
    ...
    <div style="font-size:12px; color:#313131;">&nbsp;<a href="Default.aspx">推广联盟首页</a>
     ...
     <div class="MyMoneyTitle" id="unionact">
                <div style="float:left; margin-left:24px;">
                    ...
                    <div class="Text" style="line-height:1.8; width:830px;">--把包含您ID 的链接发在博客、论坛等地方，每邀请1位朋友成功注册返利网，您就能获得最高3元现金奖励！<br />
</div>
                </div>
