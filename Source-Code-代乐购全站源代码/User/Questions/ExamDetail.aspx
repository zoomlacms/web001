<%@ page language="C#" autoeventwireup="true" inherits="User_Questions_ExamDetail, App_Web_5rmditay" enableEventValidation="false" viewStateEncryptionMode="Never" %>
<!DOCTYPE html>
<html>
...
<body ondragstart="window.event.returnValue=false" oncontextmenu="window.event.returnValue=false"
    onselectstart="event.returnValue=false" onkeydown="KeyDown()" onkeyup="KeyDown()">
