<%@ page language="C#" autoeventwireup="true" inherits="User_Questions_ApplicationCourese, App_Web_5rmditay" enableEventValidation="false" viewStateEncryptionMode="Never" %>
  ...
  <div class="us_topinfo" style="width: 97%">
    <div class="us_pynews">
      您现在的位置：<span id="Span1"><a title="网站首页" href="/" target="_blank">
        ...
        </a>&gt;&gt; <a title="会员中心" href="/User/Default.aspx" target="_parent">会员中心</a> &gt;&gt; <a href="ApplicationCourese.aspx">申请课程</a></span>
    </div>
