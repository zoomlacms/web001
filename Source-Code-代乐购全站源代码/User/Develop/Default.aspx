<%@ page language="C#" autoeventwireup="true" inherits="_Default, App_Web_tc5e3hz4" enableEventValidation="false" viewStateEncryptionMode="Never" %>
<!DOCTYPE html>
<html>
<head runat="server">
...
<body style="overflow: hidden;" onload="GetHeight();SetNodeID();GaugeBrowser()" onresize="GetHeight()"
    onclick="GetNodeID()">
    <%--ondragstart="window.event.returnValue=false" oncontextmenu="window.event.returnValue=false"
    onselectstart="event.returnValue=false"  onload="PageOnLoad()"--%>
    <div class="nav">
        <div class="menu">
            <ul>
