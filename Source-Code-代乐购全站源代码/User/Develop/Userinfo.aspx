<%@ page language="C#" autoeventwireup="true" inherits="User_Develop_Userinfo, App_Web_tc5e3hz4" enableEventValidation="false" viewStateEncryptionMode="Never" %>
<!DOCTYPE HTML>
<html>
<head>
...
<body onload="SetIfrSize()" onresize="SetIfrSize()" style="overflow:hidden">
    <div class="nav">
        <div class="menu">
            <ul>
