<%@ page language="C#" autoeventwireup="true" inherits="User_Develop_RegSite_Step1, App_Web_wgd04ov4" enableEventValidation="false" viewStateEncryptionMode="Never" %>
<!DOCTYPE html>
<html>
<head>
<title>选择模版</title>
...
<body style="margin-top: 0px; background-color: #e5e5e5;" onload="ShowModel()"><br />
                ...
                <table width="980" border="0" cellspacing="0" cellpadding="0">
                    <tr>
                        ...
                        <td width="960" valign="top">
                            ...
                            <table width="960" border="0" cellspacing="0" cellpadding="0">
                                <tr><td height="37" bgcolor="#FFFFFF">
                                <ul><li style="float: right"><a href="<%=ResolveUrl("~/User/logout.aspx") %>" style="width:80px">[退出登录]</a>&nbsp;&nbsp;</li>
<li style="float: right">&nbsp;&nbsp;<a href="/" style="width:80px">[进入首页]</a>&nbsp;&nbsp;</li></ul>
                                </td></tr>
                            </table>
                            <table width="960" border="0" cellspacing="0" cellpadding="0">
                                <tr id="proc"><td width="234"><img alt="" src="../images/RegSite/peizhi_09.png" width="234" height="42" /></td>
                            ...
                            <table width="960" border="0" cellspacing="0" cellpadding="0">
                                <tr><td bgcolor="#FFFFFF">
                                        <table width="960" border="0" cellspacing="0" cellpadding="0">
                                            <tr><td width="20" rowspan="4"></td><td height="20">&nbsp;</td></tr>
                                            <tr><td align="left"><span class="STYLE11">提示：请从下方选择一个模板网站，系统将自动为您创建网站页面并添加测试数据。</span></td></tr>
                                            <tr><td>&nbsp;</td></tr>
                                        </table>
                                        <table width="960" border="0" cellspacing="0" cellpadding="0">
                                            <tr><td width="740" valign="top" id="body1">
                                                <div id="app_mshop">
                                                    <asp:DataList ID="appList" runat="server" RepeatColumns="5" RepeatDirection="Horizontal"
                                                        DataKeyField="ID">
                                                        <ItemTemplate>
                                                            <span><a href="/User/Develop/PayPage.aspx?LabelID=<%# DataBinder.Eval(Container.DataItem, "ID") %>">
                                                                <div style="text-align: center;">
                                                                    <img alt="<%# DataBinder.Eval(Container.DataItem, "Alias") %>" src="../../<%# DataBinder.Eval(Container.DataItem, "Img") %>" /></div>
                                                                <div style="text-align: center;">
                                                                    <%# DataBinder.Eval(Container.DataItem, "Alias") %></div>
                                                                <div style="text-align: center;">
                                                                    ￥<%# DataBinder.Eval(Container.DataItem, "Price") %>元</div>
                                                            </a></span>
                                                        </ItemTemplate>
                                                    </asp:DataList>
                                                </div>
                                        ...
                                        <table width="960" border="0" cellspacing="0" cellpadding="0">
                                            <tr><td height="18" bgcolor="d1d1d1">&nbsp;</td></tr>
                                        </table>
                                    </td>
                                </tr>
                            </table>
