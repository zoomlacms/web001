...
<iframe frameborder="0" marginwidth="0" marginheight="0" scrolling="no"
				...
				overflow-x: hidden; width:720px; height:735px;" src="MyInfo.aspx" onload="loadaction()"></iframe>
 </div>
<div class="right" style="float:left;">
<div class="Personall-t">我的代乐购<span>Summary</span><br />
</div>
<div class="right-c2">
<div class="right-c2-title">购物<span style="font-family:Arial, Helvetica, sans-serif; font-size:18px; color:#f0e2d9;"> My order
</span></div>
<div class="right-c2-nr">
<ul>
<li><a href="/NodeElite.aspx?NodeID=39" target="main_right">我要代购</a></li>
<li><a href="/user/PreViewOrder.aspx?menu=Cartinfo" target="main_right">我的购物车</a></li>
<li><a href="/User/Content/MyFavite_Shop.aspx?type=1" target="main_right">我的收藏夹</a></li>
<li><a href="/user/PreViewOrder.aspx?menu=Orderinfo" target="main_right">我的订单</a></li>
</ul>
</div>
<div class="right-c2-title" style="display:none;">送货<span style="font-family:Arial, Helvetica, sans-serif; font-size:18px; color:#f0e2d9;"> Delivery
</span></div>
<div class="right-c2-nr" style="display:none;">
<ul>
<li><a href="ordercart.aspx" target="main_right">我的送货车</a></li>
<li><a href="trafficlist.aspx" target="main_right">我的运单</a></li>
</ul>
</div>
<div class="right-c2-title">账户管理<span style="font-family:Arial, Helvetica, sans-serif; font-size:18px; color:#f0e2d9;"> My Account

</span></div>
<div class="right-c2-nr">
<ul>
<li><a href="/user/Info/UserInfo.aspx" target="main_right">我的账户</a></li>
<li><a href="/user/Info/MoneyInfo.aspx" target="main_right">消费记录</a></li>
<li><a href="/user/Message/Message.aspx" target="main_right">短信箱</a></li>
<li><a href="/user/info/UserRecei.aspx" target="main_right">收货地址薄</a></li>
</ul>
</div>
<div class="right-c2-title">积分管理<span style="font-family:Arial, Helvetica, sans-serif; font-size:18px; color:#f0e2d9;"> My Points</span></div>
<div class="right-c2-nr">
<ul>
<li><a href="/user/Info/ExpHis.aspx"  target="main_right">我的积分</a></li>
</ul>
</div>
<div class="right-c2-title">个人信息 <span style="font-family:Arial, Helvetica, sans-serif; font-size:18px; color:#f0e2d9;">My Profiles
</span></div>
<div class="right-c2-nr">
<ul>
<li><a href="/user/Info/UserBase.aspx"  target="main_right">编辑个人档案</a></li>
<li style="display:none;"><a href="/user/ChangPSW.aspx" target="main_right">修改Email地址</a></li>
<li><a href="/user/ChangPSW.aspx" target="main_right">修改密码</a></li>
</ul>
</div>
</div>
<div class="right-b"><a href="/">快速返回首页</a></div>
</div>
