<%@ page language="C#" autoeventwireup="true" inherits="User_UserInfo_UserReg_Move1, App_Web_mxwrgpco" enableEventValidation="false" viewStateEncryptionMode="Never" %>
...
<form id="form1" runat="server">
  <div style="width: 100%"> 
    <div class="us_topinfo" style="width: 98%">
      ...
      <div class="us_pynews">
        您现在的位置：<span id="YourPosition"><span><a title="网站首页" href="/" target="_top">
          <asp:Label ID="LblSiteName" runat="server" Text="Label"></asp:Label>
          </a></span><span>&gt;&gt; </span><span><a title="会员中心" href='<%=ResolveUrl("~/User/Default.aspx")%>' target="_parent"> 会员中心</a></span>&gt;&gt;我的基本资料</span>
      </div>
      <div class="cleardiv"> </div>
    </div>
