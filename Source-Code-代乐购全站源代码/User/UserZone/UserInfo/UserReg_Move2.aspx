<%@ page language="C#" autoeventwireup="true" inherits="UserReg_Move2, App_Web_mxwrgpco" enableEventValidation="false" viewStateEncryptionMode="Never" %>
...
<form id="form1" runat="server">
  <div style="width: 100%"> 
    <div class="us_topinfo" style="width: 98%">
      ...
      <div class="us_pynews" style="width: 98%">
        您现在的位置：<span id="YourPosition"><span><a title="网站首页" href="/" target="_blank">
          ...
          </a></span> &gt;&gt; </span><span><a title="会员中心" target="_parent" href='<%=ResolveUrl("~/User/Default.aspx")%>'> 会员中心</a></span>&gt;&gt;我的择偶条件 
      </div>
      <div class="cleardiv"> </div>
    </div>
