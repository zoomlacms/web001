<%@ page language="C#" autoeventwireup="true" inherits="User_UserInfo_UserReg_Move7, App_Web_mxwrgpco" enableEventValidation="false" viewStateEncryptionMode="Never" %>
    ...
    <div class="us_topinfo">
      <div class="us_pynews">
        您现在的位置：<span id="YourPosition"><span><a title="网站首页" href="/" target="_blank">
          ...
          </a></span><span> &gt;&gt; </span><span><a title="会员中心" target="_parent" href='<%=ResolveUrl("~/User/Default.aspx")%>'> 会员中心</a></span>&gt;&gt;我的爱好
      </div>
