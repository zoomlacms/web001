<%@ page language="C#" autoeventwireup="true" inherits="UserReg_Move4, App_Web_mxwrgpco" enableEventValidation="false" viewStateEncryptionMode="Never" %>
...
<form id="form1" runat="server">
  <div style="margin: auto; width: 100%">
    <div class="us_topinfo">
      <div class="us_pynews"> 您现在的位置：<span id="YourPosition"></span><span><a title="网站首页" href="/" target="_blank">
        <asp:Label ID="LblSiteName" runat="server" Text="Label"></asp:Label>
        </a></span><span> &gt;&gt; </span><span><a title="会员中心" target="_parent" href='<%=ResolveUrl("~/User/Default.aspx")%>'> 会员中心</a></span>&gt;&gt;上传照片 </div>
