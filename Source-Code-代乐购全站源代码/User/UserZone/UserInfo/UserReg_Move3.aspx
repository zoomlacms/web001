<%@ page language="C#" autoeventwireup="true" inherits="UserReg_Move3, App_Web_mxwrgpco" enableEventValidation="false" viewStateEncryptionMode="Never" %>
  ...
  <div style="margin: auto; width: 100%">
    <div class="us_topinfo">
      <div class="us_pynews"> 您现在的位置：<span id="YourPosition"><span><a title="网站首页" href="/" target="_blank">
        ...
        </a></span><span> &gt;&gt; </span><span><a title="会员中心" target="_parent" href='<%=ResolveUrl("~/User/Default.aspx")%>'>会员中心</a></span>&gt;&gt;我的详细资料 </div>
