<%@ page language="C#" autoeventwireup="true" inherits="User_UserZone_Pcutlist, App_Web_n1qmci5q" enableEventValidation="false" viewStateEncryptionMode="Never" %>
<!DOCTYPE html>
<html>
<head>
<title>剪刀列表</title>
...
<link href="../../Skin/User_Main.css" rel="stylesheet" type="text/css" />
<link href="../../Skin/user_user.css" rel="stylesheet" type="text/css" />
...
<body>
    ...
    <div class="us_pynews">
        <a href="~/">逐浪CMS</a>&gt;&gt;<a href="../../Default.aspx">会员中心</a> &gt;&gt;<a href="List.aspx">网页剪刀</a>&nbsp;
        <font color="red">[<a href="Home.aspx" style="color: Red" target="_blank">添加组件</a>]</font></div>
  <div class="clearbox">
</div>    
