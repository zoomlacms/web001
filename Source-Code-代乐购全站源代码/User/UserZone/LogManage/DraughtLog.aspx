<%@ page language="C#" autoeventwireup="true" inherits="DraughtLog, App_Web_ji2gmtgy" enableEventValidation="false" viewStateEncryptionMode="Never" %>
    ...
    <div class="us_topinfo">
      ...
      <div class="us_pynews">
        您现在的位置：<span id="YourPosition"><span><a title="网站首页" href="/" target="_blank">
          ...
          </a></span><span> &gt;&gt; </span><span><a title="会员中心" href='<%=ResolveUrl("~/User/Default.aspx")%>' target="_parent"> 会员中心</a></span><span> &gt;&gt; </span><span><a title="我的日志" href='<%=ResolveUrl("~/User/UserZone/LogManage/SelfLogManage.aspx")%>'> 我的日志</a></span></span>&gt;&gt;我的草稿箱
      </div>
