<%@ page language="C#" autoeventwireup="true" inherits="ShowLabelName, App_Web_uvhce0we" enableEventValidation="false" viewStateEncryptionMode="Never" %>
                ...
                <div class="us_showinfo">
                        您现在的位置：<span id="YourPosition"><span><a title="网站首页" href="/" target="_blank"><asp:Label
                            ID="LblSiteName" runat="server" Text="Label"></asp:Label></a></span><span> &gt;&gt;
                                ...
                                会员中心</a></span><span> &gt;&gt; </span><span>标签</span></span>
                </div>
            </div>
