<%@ page language="C#" autoeventwireup="true" inherits="BookList, App_Web_uvhce0we" enableEventValidation="false" viewStateEncryptionMode="Never" %>
  ...
  <div style="margin: auto; width: 100%">
    <div class="us_topinfo">
      <div class="us_pynews"> 您现在的位置：<a title="网站首页" href="/" target="_blank">
        ...
        </a><a title="会员中心" href='<%=ResolveUrl("~/User/Default.aspx") %>' target="_parent"> 会员中心</a>读书</div>
