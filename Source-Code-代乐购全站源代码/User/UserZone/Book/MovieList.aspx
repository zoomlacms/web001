<%@ page language="C#" autoeventwireup="true" inherits="MovieList, App_Web_uvhce0we" title="电影" enableEventValidation="false" viewStateEncryptionMode="Never" %>
  ...
  <div style="margin: auto; width: 100%">
    <div class="us_topinfo">
      <div class="us_pynews"> 您现在的位置：<span id="YourPosition"><span><a title="网站首页" href="/" target="_blank">
        <asp:Label
                        ID="LblSiteName" runat="server" Text="Label"></asp:Label>
        </a></span><span> &gt;&gt; </span><span><a title="会员中心" href='<%=ResolveUrl("~/User/Default.aspx") %>' target="_parent"> 会员中心</a></span><span> &gt;&gt; </span><span>电影</span> 会员中心</a></span><span> &gt;&gt; </span><span>音乐</span> </div>
