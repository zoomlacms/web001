<%@ page language="C#" autoeventwireup="true" inherits="MusicAdd, App_Web_qm2ypcae" title="音乐" enableEventValidation="false" viewStateEncryptionMode="Never" %>
...
<form id="form1" runat="server">
  <div style="width: 100%"> 
    <div class="us_topinfo" style="width: 98%">
      <div class="us_pynews" style="width: 98%"> 您现在的位置：<a title="网站首页" href="/" target="_blank">
        <asp:Label ID="LblSiteName" runat="server" Text="Label"></asp:Label>
        </a><a title="会员中心" href='<%=ResolveUrl("~/User/Default.aspx") %>' target="_parent"> 会员中心</a>音乐</div>
