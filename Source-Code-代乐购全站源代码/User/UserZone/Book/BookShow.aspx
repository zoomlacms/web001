<%@ page language="C#" autoeventwireup="true" inherits="BookAdd, App_Web_uvhce0we" enableEventValidation="false" viewStateEncryptionMode="Never" %>
...
<div class="us_topinfo">
  ...
  <div class="us_showinfo"> 您现在的位置：<a title="网站首页" href="/" target="_blank">
    ...
    </a><a title="会员中心" href='<%=ResolveUrl("~/User/Default.aspx") %>' target="_parent"> 会员中心</a>书籍</div>
</div>
