<%@ page language="C#" autoeventwireup="true" inherits="MovieAdd, App_Web_qm2ypcae" enableEventValidation="false" viewStateEncryptionMode="Never" %>
...
<form id="form1" runat="server">
  ...
  <div class="us_topinfo" style="width: 98%">
    ...
    <div class="us_pynews" style="width: 98%"> 您现在的位置：<span id="YourPosition"><span><a title="网站首页" href="/" target="_blank">
      <asp:Label ID="LblSiteName" runat="server" Text="Label"></asp:Label>
      </a><<a title="会员中心" href='<%=ResolveUrl("~/User/Default.aspx") %>' target="_parent"> 会员中心</a>电影</div>
    <div class="cleardiv"></div>
  </div>
        ...
        <td style="height: 92px"><table width="100%" height="246" border="0" cellpadding="0" cellspacing="0">
            <tr>
              ...
              <td width="71%">&nbsp;
                ...
                <asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server" ControlToValidate="titletxt"
            ...
            <tr>
              ...
              <td>&nbsp;
                ...
                <asp:RequiredFieldValidator ID="RequiredFieldValidator4" runat="server" ControlToValidate="antxt"
									ErrorMessage="不能为空"></asp:RequiredFieldValidator></td>
            </tr>
            <tr>
              ...
              <td>&nbsp;
                ...
                <asp:RequiredFieldValidator ID="RequiredFieldValidator3" runat="server" ControlToValidate="isbntxt"
									ErrorMessage="不能为空"></asp:RequiredFieldValidator></td>
            </tr>
            <tr>
