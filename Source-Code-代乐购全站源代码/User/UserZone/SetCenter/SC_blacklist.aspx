<%@ page language="C#" autoeventwireup="true" inherits="User_UserZone_SetCenter, App_Web_qb5vihlz" enableEventValidation="false" viewStateEncryptionMode="Never" %>
    ...
    <div style="margin: auto; width: 100%">
        <div class="us_topinfo">
            <div class="us_pynews">
                    ...
                    <span><a title="会员中心" href='<%=ResolveUrl("~/User/Default.aspx")%>' target="_parent">会员中心</a></span>&gt;&gt;设置中心&gt;&gt;黑名单
            </div>
            <div class="cleardiv">
            </div>
        </div>
