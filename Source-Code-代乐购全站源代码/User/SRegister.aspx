<%@ page language="C#" autoeventwireup="true" inherits="ZoomLa.WebSite.User.User_Registers, App_Web_ea4g3xou" enableEventValidation="false" viewStateEncryptionMode="Never" %>
<!DOCTYPE HTML>
<html>
<head>
<title>注册会员</title>
...
<script type="text/javascript" src="/js/RiQi.js"></script>
    ...
    <div id="m_top">
        ...
        <h1 style="float: right;">
            <ul>
			<li><a href="/">首页</a></li><li><a href="###">新闻</a></li><li><a href="###">图库</a></li>
			<li><a href="#">下载</a></li><li><a href="###">商城</a></li><li><a href="###">论坛</a></li>
        ...
        <div class="s_bleft">
            <div class="i_whyj">
                ...
                <h2>
                    站长通道</h2>
                <h3>
                    <a href="/manage/login.aspx" target="_blank">进入后台管理</a></h3>
            </div>
        </div>
        <!-- 左边结束 -->
        <!-- 右边开始 -->
            ...
            <div class="rg_inout">
                ...
                <asp:Panel ID="PnlRegStep1" runat="server" Visible="false" Width="100%">
                    <h1>
                        注册会员</h1>
                    <h2>
                        第一步：服务条款和声明<img src="/user/images/regl1.gif" width="242" height="14" /></h2>
                    <textarea name="textarea" cols="20" rows="2" readonly="readonly" style="font-weight: normal;
                        font-size: 9pt; width: 98%; line-height: normal; font-style: normal; height: 310px;
...
//                    Sys.WebForms.PageRequestManager.getInstance().add_endRequest(EndRequestHandler);
                    ...
                    <h1>
                        注册会员</h1>
                    <h2>
                        第二步：填写会员信息<img src="/user/images/regl2.gif" width="242" height="14" alt="" /></h2>
                    <div id="reg" style="width: 90%; height: auto">
                        <table id="TableRegisterMust" runat="server" style="border-collapse: collapse" cellspacing="1"
                            ...
                            <tr>
                                ...
                                <td valign="middle" style="width: 221px">
                                    <asp:TextBox ID="TxtUserName" class="input1" runat="server" onmouseup="value=value.replace(/[^\u4E00-\u9FA5]/g,'')"
                            ...
                            <tr>
                                ...
                                <td valign="middle" style="width: 85%">
                                    <input id="CheckUserName" style="float: left;" type="button" value="检查真实姓名是否可用" onclick="CheckUser()" /><span
                            ...
                            <tr>
                                ...
                                <td valign="middle" style="width: 221px">
                                    ...
                                    <asp:RequiredFieldValidator ID="ReqTxtPassword" runat="server" ControlToValidate="TxtPassword"
                                        SetFocusOnError="false" ErrorMessage="密码不能为空" Display="Dynamic"></asp:RequiredFieldValidator><font color=red>*</font>
                                </td>
                            </tr>
                            <tr>
                                <td class="tdbgleft" style="width: 15%">
                                ...
                                <td style="width: 221px">
                                    ...
                                    <asp:RequiredFieldValidator ID="ReqTxtPwdConfirm" runat="server" ControlToValidate="TxtPwdConfirm"
                                        SetFocusOnError="false" Display="Dynamic" ErrorMessage="确认密码不能为空"></asp:RequiredFieldValidator><asp:CompareValidator
                                            ...
                                            Operator="Equal" SetFocusOnError="false" ErrorMessage="两次密码输入不一致" Display="Dynamic"></asp:CompareValidator><font color=red>*</font>
                                </td>
                            </tr>
                            <tr>
                                <td class="tdbgleft" style="width: 15%">
                                    <strong>防注册机问题：</strong>
                                </td>
                                <td style="width: 221px">
                                    <asp:Label ID="regtxt" runat="server" Text=""></asp:Label><asp:TextBox ID="regnum" class="input1" runat="server" Width="67px"></asp:TextBox>
                                    
                                    
                                    <asp:TextBox ID="hidnum" class="input1" runat="server" Width="67px" style="display:none"></asp:TextBox>防止注册机注册请将答案 
                                    <asp:Label ID="Label1" runat="server" ForeColor="Red"></asp:Label> 输入输入框
                                    <asp:CompareValidator ID="CompareValidator1" runat="server" 
                                        ControlToCompare="regnum" ControlToValidate="hidnum" 
                                        ErrorMessage="防注册机问题答案错误！请输入正确答案"></asp:CompareValidator>
                                </td>
                            </tr>
                            ...
                            <tr>
                                ...
                                <td style="width: 221px">
                                    <asp:TextBox ID="TxtQuestion" class="input1" runat="server"></asp:TextBox>
                                </td>
                            </tr>
                            <tr>
                                <td class="tdbgleft" style="width: 15%">
                            ...
                            <tr id="tr2">
                                ...
                                <td>
                                    <asp:TextBox ID="TxtAddress" runat="server" class="input1"></asp:TextBox>
                                </td>
                            </tr>
                            <tr id="tr3">
                                <td style="width: 15%" class="tdbgleft">
                                ...
                                <td>
                                    <asp:TextBox ID="TxtOfficePhone" runat="server" class="input1"></asp:TextBox>
                                </td>
                            </tr>
                            <tr id="trMobile">
                                <td style="width: 15%" class="tdbgleft">
                                ...
                                <td>
                                    <asp:TextBox ID="TxtMobile" runat="server" class="input1"></asp:TextBox>
                                    <asp:RequiredFieldValidator ID="RequiredFieldValidator2" runat="server" 
                                        ErrorMessage="手手机号码不能为空" ControlToValidate="TxtMobile" Display="Dynamic"></asp:RequiredFieldValidator><asp:RegularExpressionValidator ID="RegularExpressionValidator3" runat="server" 
                                        ControlToValidate="TxtMobile" ErrorMessage="手机号码格式不正确" 
                                        ValidationExpression="1[3,5]{1}[0-9]{1}[0-9]{8}|01[3,5]{1}[0-9]{1}[0-9]{8}" Display="Dynamic"></asp:RegularExpressionValidator><font color=red>*</font></td>
                            </tr>
                            <tr id="trIDCard">
                                <td style="width: 15%" class="tdbgleft">
                                    <b>身份证号码：</b>
                                ...
                                <td>
                                    <asp:TextBox ID="TxtIDCard" runat="server" class="input1"></asp:TextBox>
                                ...
                                <td class="tdbgleft" colspan="2">
                                    <table id="DivCompany" runat="server" style="border-collapse: collapse; display: none"
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <asp:TextBox ID="txtCompanyName" class="input1" runat="server">未填写企业名</asp:TextBox><asp:RequiredFieldValidator
                                                    ID="RFCompanyName" runat="server" ErrorMessage="请输入企业名称" ControlToValidate="txtCompanyName"></asp:RequiredFieldValidator>
                                            </td>
                                        </tr>
                                        <tr>
                                            <td style="width: 15%" class="tdbgleft">
                        ...
                        <table style="border-collapse: collapse" cellspacing="1" cellpadding="2" width="100%"
                            ...
                            <tr id="trVcodeRegister" runat="server" visible="false">
                                ...
                                <td style="width: 221px">
                                    <asp:TextBox ID="TxtValidateCode" class="input1" MaxLength="6" runat="server" onfocus="this.select();"></asp:TextBox>
                ...
                <asp:Panel ID="PnlStep3" runat="server" Visible="false" Width="100%">
                    <h1>
                        注册会员</h1>
                    <h2>
                        第三步：注册结果<img src="/user/images/regl3.gif" width="242" height="14" alt="" /></h2>
                    <asp:Literal ID="LitRegResult" runat="server"></asp:Literal></asp:Panel>
            </div>
        </div>
        <!-- 右边结束 -->
    </div>
