<%@ page language="C#" autoeventwireup="true" inherits="WebShop_UserCart, App_Web_tcusk5nq" enableEventValidation="false" viewStateEncryptionMode="Never" %>
<!DOCTYPE HTML>
<html>
<head>
<title>加入购物车</title>
...
<body>
    ...
    <div class="s_body">
        ...
        <div class="s_bright">
            <div class="rg_inout">
                <h1>购物车</h1>
                <h2>第一步:加入购物车&nbsp;<img alt="" src="/user/images/regl1.gif" width="242" height="14" /></h2>
                ...
                <ul style="background-color: GrayText; width: 100%">
                    ...
                    <li style="width: 10%; text-align: center; color: White">当前价格</li>
                ...
                <asp:Repeater ID="cartinfo" runat="server" OnItemDataBound="cartinfo_ItemDataBound">
                    <ItemTemplate>
                        <div <%#(Eval("Bindpro","{0}")=="")?"":"style=background-color:#E6E6E6"%> style="margin-top: 5px; width: 100%; height: 48px">
                            <li style="width: 9.5%; text-align: center;">
                                <%#getproimg(Eval("proid","{0}"))%></li>
                            ...
                            <li style="width: 10%; text-align: center;">
                                <input onkeydown="if(event.keyCode==13){ keydo('<%#Eval("id") %>');return false;}"
                                    id='num<%#Eval("id") %>' value='<%#DataBinder.Eval(Container, "DataItem.pronum", "{0}")%>'
                            ...
                            <li style="width: 10%; text-align: center;"><span id='currentpri<%#Eval("id") %>'>
                            ...
                            <li style="width: 10%; text-align: center;"><span id='price<%#Eval("id") %>'>
                                <%#getprojia(Eval("ID", "{0}"), DataBinder.Eval(Container, "DataItem.pronum", "{0}"))%></span></li>
                            <li style="width: 10%; text-align: center;"><a href="UserCart.aspx?menu=del&cid=<%#Eval("id")%>"
                        ...
                        <asp:Repeater ID="Repeater2" runat="server">
                            <ItemTemplate>
                                <div style="background-color: #F6F6F6">
                                    ...
                                    <li style="width: 10.5%; text-align: center;">
                                        <%#getjiage(Eval("proclass", "{0}"), "1", DataBinder.Eval(Container, "DataItem.id", "{0}"), DataBinder.Eval(Container, "DataItem.pronum", "{0}"))%></li>
                                    <li style="width: 10.5%; text-align: center;">
                                        <%#getjiage(Eval("proclass", "{0}"), "2", DataBinder.Eval(Container, "DataItem.id", "{0}"), DataBinder.Eval(Container, "DataItem.pronum", "{0}"))%></li>
                                    <li style="width: 10.5%; text-align: center;">
                                        <%#getprojia(Eval("ID", "{0}"), DataBinder.Eval(Container, "DataItem.pronum", "{0}"))%></li>
                                    <li style="width: 10.5%; text-align: center;"><a href="UserCart.aspx?menu=del&cid=<%#Eval("id")%>"
                                        onclick="return confirm('不可恢复性删除数据,你确定将该数据删除吗？');">删除</a></li>
                                </div>
                            </ItemTemplate>
                        </asp:Repeater>
    ...
    <div class="m_copyright">
        <ul>
            <li><a href="#">关于我们</a> | <a href="#">常见问题</a> | <a href="#">使用条款</a> | <a href="#">
