<%@ page language="C#" autoeventwireup="true" inherits="ShopAuction, App_Web_tcusk5nq" enableEventValidation="false" viewStateEncryptionMode="Never" %>
<!DOCTYPE HTML>
<html>
<head>
<title>竞拍商品</title>
...
<div id="m_top">
    ...
    <h1 style="float: right;">
        <ul>
			...
			<a href="javascript:alert('设为首页');">设为首页</a> | <a href="javascript:alert('加入收藏');">加入收藏</a></li>
        </ul>
    </h1>
</div>
<!-- 正文布局 -->
                    ...
                    <li style="text-align: center; width: 280px; margin-top: 10px">
                        ...
                        <li style="width: 200px">
                            <ul style="width: 200px">
                                ...
                                <li style="float: left; width: 200px; height: 30px">距离结束时间：<asp:Label ID="lblTimer"
                                    runat="server" Text="" ForeColor="Red"></asp:Label></li>
                                    <li style="float: left; width: 200px; height: 30px" id="linum" runat="server">参与人数：<asp:Label ID="lblnum"
                                    runat="server" Text="0"></asp:Label>&nbsp;人</li>
                                <li>
                                      <asp:Label ID="Label1" runat="server" BorderWidth="0px" ForeColor="Red"></asp:Label>&nbsp;
                                </li>
                                <li style="width: 200px; height: 30px;" id="liMoney" runat="server">&nbsp;出&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;价&nbsp;：<asp:TextBox
                                    ID="txtMoney" Width="100px" runat="server"></asp:TextBox></li>
