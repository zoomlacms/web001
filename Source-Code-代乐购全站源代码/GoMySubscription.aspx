<%@ page language="C#" autoeventwireup="true" inherits="GoMySubscription, App_Web_tcusk5nq" enableEventValidation="false" viewStateEncryptionMode="Never" %>
<!DOCTYPE HTML>
<html>
...
<div id="m_top">
    ...
    <div class="s_bright" style="float:none; margin:auto; text-align:center; width:960px;">
            ...
            <div class="us_showinfo">
                    ...
                    您现在的位置：<span id="YourPosition"><span><a title="网站首页" href="/" target="_blank"><asp:Label
                        ID="LblSiteName" runat="server" Text="Label"></asp:Label></a></span><span> &gt;&gt;
                            ...
                            &gt;&gt; </span><span><a title="我的订阅添加" href="GoMySubscription.aspx">
                                我的订阅添加</a></span></span>
            </div>
        ...
        <div class="us_seta" style="margin-top: 10px; margin-left:auto; margin-right:auto;">
            <h1 style="text-align: center">
                ...
                onrowcancelingedit="GridView1_RowCancelingEdit" >
                    ...
                    <ItemTemplate>
                     <%# GetReference(Eval("Reference_ID"))%>
                    </ItemTemplate>
                    <EditItemTemplate>
                      <%# GetReference(Eval("Reference_ID"))%>
...
<div>
  <asp:Button ID="Button1" runat="server" Text="确定订阅" onclick="Button1_Click" OnClientClick="return confirm('确实要订阅吗？');"/>&nbsp;&nbsp;&nbsp;
                ...
                </ul>--%><%-- <%-- <asp:Panel ID="Orderlist" runat="server" Width="100%">
                <table>
                    <tr>
                        <td>订阅内容：</td>
