<%@ page language="C#" autoeventwireup="true" enableviewstatemac="false" inherits="ShopCar, App_Web_tcusk5nq" enableEventValidation="false" viewStateEncryptionMode="Never" %>
<!DOCTYPE HTML>
<html>
<head>
<title>加入购物车</title>
...
<body onload="shop()">
<div>loading......</div>
<form id="form1" runat="server"><div style="display:none">
<!-- 顶部代码布局 -->
<div id="m_top">
    <h1 class="m_logo"></h1>
        ...
        <div class="rg_inout">
            ...
            <ul>
                ...
                <li>&nbsp;</li><li style="width: 250px; text-align: left;">
                    <asp:Button ID="Button1" runat="server" Text="去收银台结帐" OnClientClick="keydo()" OnClick="Button2_Click" />
...
<div class="m_copyright">
    <ul><a href="#">关于我们</a> | <a href="#">常见问题</a> | <a href="#">使用条款</a> | <a href="#">隐私声明</a>
        | <a href="#">安全提示</a> | <a href="#">意见反馈</a> | <a href="#">联系我们</a> | <a href="#">招聘信息</a></ul>
    <h1>&copy;2011 <a href="<%Call.Label("{$SiteURL/}"); %>" target="_blank"/>
            <%Call.Label("{$SiteName/}"); %> </a>版权所有。</h1>
</div></div>
