<%@ page language="C#" autoeventwireup="true" inherits="ZoomLa.WebSite.Shop.SelectPayPlat, App_Web_1qdwsu1g" enableEventValidation="false" viewStateEncryptionMode="Never" %>
<!DOCTYPE HTML>
<html>
<head runat="server">
        ...
        <table width="500px" cellspacing="1" cellpadding="2" style="background-color: #CCCCCC;">
            ...
            <tr class="tdbg">
                ...
                <td style="text-align: left;">
                    <asp:DropDownList ID="DDLPayPlat" runat="server" Width="">
                    </asp:DropDownList></td>
            </tr>
            <tr class="tdbg">
