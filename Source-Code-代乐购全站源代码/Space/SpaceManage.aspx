<%@ page language="C#" autoeventwireup="true" inherits="Space_SpaceManage, App_Web_kwzuzjuh" enableEventValidation="false" viewStateEncryptionMode="Never" %>
<!DOCTYPE HTML>
<html>
<head runat="server">
<title>我的聚合页</title>
...
<form id="form1" runat="server">
  ...
  <div class="cleardiv"> </div>
  <asp:GridView ID="Egv" runat="server" AutoGenerateColumns="False" DataKeyNames="GeneralID" PageSize="10" OnRowCommand="Lnk_Click" Width="100%" CellPadding="4" ForeColor="#333333" GridLines="None" OnRowDataBound="Egv_RowDataBound"  >
    <Columns>
