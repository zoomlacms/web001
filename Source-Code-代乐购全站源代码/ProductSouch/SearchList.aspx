<%@ page language="C#" autoeventwireup="true" inherits="ZoomLa.WebSite.SearchList, App_Web_n30yf0az" enableEventValidation="false" viewStateEncryptionMode="Never" %>
<!DOCTYPE HTML>
<html>
<head runat="server">
<title>搜索结果</title>
...
<form id="form1" runat="server">
    <div class="us_seta">
        <ul class="us_seta">
            您现在的位置：<a title="网站首页" href="/"><asp:Label ID="sitename" runat="server" Text="Label"></asp:Label></a><span>
                &gt;&gt; 信息搜索</span>
        </ul>
