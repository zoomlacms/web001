<%@ page language="C#" autoeventwireup="true" inherits="StockOrderOver, App_Web_cl0kvpgp" enableEventValidation="false" viewStateEncryptionMode="Never" %>
<!DOCTYPE HTML>
<html>
<head>
<title>完成订单提交</title>
...
<div class="s_bright">
	<div class="rg_inout">
		<h1>完成提交</h1>
		<h2>第三步:完成订单提交&nbsp;<img src="/user/images/regl3.gif" width="242" height="14" /></h2>
		<div class="cleardiv"></div>
	    <ul>
	        <li>
	        <p><asp:Label ID="Label1" runat="server" BorderWidth="0px" ForeColor="Red"></asp:Label>&nbsp;</p>
            </li>
	    </ul>
	    	<ul>
