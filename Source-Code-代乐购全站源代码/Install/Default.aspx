<%@ page language="C#" autoeventwireup="true" inherits="Install_Default, App_Web_q4p3bl2f" responseencoding="utf-8" enableEventValidation="false" viewStateEncryptionMode="Never" %>
<!DOCTYPE HTML>
<html>
...
<iframe src="http://www.zoomla.cn/Search/iSearch.aspx" target="_blank" marginwidth="1" marginheight="1" scrolling="no" border="0" frameborder="0"></iframe>
<ul>
...
<div class="insbox_txt">欢迎您安装Zoomla!逐浪CMS，本向导将引导您安装部署Zoomla!逐浪CMS系统。<br />
 建议您在运行本向导前仔细阅读程序包中的《安装说明》文档，如果您已经阅读过并确认<font color="yellow">非虚拟目录</font>，请点击下一步。</div>
<textarea id="TxtLicense" cols="100" rows="12" runat="server" readonly="readonly"></textarea>
<div class="lbot">
...
<div id="bottom">
 &copy; Corpright 2003-<Script type="text/javascript">
<!--
	var year = "";
	mydate = new Date();
