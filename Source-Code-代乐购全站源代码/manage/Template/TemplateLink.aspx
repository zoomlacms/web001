<%@ page language="C#" autoeventwireup="true" inherits="manage_Template_TemplateLink, App_Web_fwjvbhkc" enableEventValidation="false" viewStateEncryptionMode="Never" %>
<!DOCTYPE HTML>
<html>
...
<div id="Div1">
    <ul>
        <li id="Guide_top">
            <div id="Guide_toptext">模板风格标签管理</div>
        </li>
        <li id="Guide_main">
            <div id="Guide_box">
                <div class="guideexpand" onclick="Switch(this)">模板风格标签管理</div>                    
                <div class="guide">
                <ul>
                <li class="guideli" onmouseover="this.className='guidelihover'" onmouseout="this.className='guideli'"><a href="../Template/TemplateSet.aspx" target="main_right">方案设置</a></li>                        
                ...
                <li class="guideli" onmouseover="this.className='guidelihover'" onmouseout="this.className='guideli'"><a href="../Template/CSSManage.aspx" target="main_right">风格管理</a></li>
...
<input type="button" onclick="search()" value="搜索" class="C_input" Style=""/>
</div>
</form>
</body>
</html>