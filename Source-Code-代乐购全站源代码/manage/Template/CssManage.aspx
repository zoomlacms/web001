<%@ page language="C#" autoeventwireup="true" inherits="ZoomLa.WebSite.Manage.Template.CssManage, App_Web_ph3al4wl" enableEventValidation="false" viewStateEncryptionMode="Never" %>
<!DOCTYPE HTML>
<html>
<head runat="server">
<title>风格管理</title>
...
<script type="text/javascript" src="/JS/videobox_1.1/js/mootools.js"></script>
<script type="text/javascript" src="/JS/videobox_1.1/js/swfobject.js"></script>
<script type="text/javascript" src="/JS/videobox_1.1/js/videobox.js"></script>
</head>
<body>
<form id="form1" runat="server">
<div class="r_navigation">后台管理&gt;&gt;系统设置 &gt;&gt;<a href="CssManage.aspx">风格管理</a></div>
<table width="100%">
    <tr>
        <td align="left">
    ...
    <table width="100%" border="0" cellpadding="2" cellspacing="1" class="border" align="center">
        <tr class="tdbg">
            ...
            <td width="10%">
                <asp:Button ID="btnTemplateUpLoad" class="C_input" runat="server" Text="上传风格" OnClientClick="return confirm('即将覆盖同名风格，是否继续？');"
