<%@ page language="C#" autoeventwireup="true" inherits="manage_UserShopManage_ApplyStyleEdit, App_Web_t0xdissq" enableEventValidation="false" viewStateEncryptionMode="Never" %>
...
<body>
    ...
    <div class="r_navigation">
		...
		<span>后台管理</span> &gt;&gt; 店铺管理 &gt;&gt; <a href="ApplyStyle.aspx">店铺申请设置</a> &gt;&gt; <span>样式字段列表</span>        
	</div>
    <div class="clearbox"></div>
    <table width="100%" cellspacing="1" cellpadding="0" class="border" align="center">
        <tr class="bgleft">
            <td align="left" style="height: 20px">
                当前申请模型:[<asp:Literal ID="LModelName" runat="server"></asp:Literal>] &nbsp;
                &nbsp;&nbsp; <a href="FiledAdd.aspx?ModelID=<%=Request.QueryString["ModelID"] %>">添加字段</a>
            </td>
        </tr>
    </table>
    <div class="clearbox"></div>
