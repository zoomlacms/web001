<%@ page language="C#" autoeventwireup="true" inherits="manage_UserShopManage_ManageModel, App_Web_t0xdissq" enableEventValidation="false" viewStateEncryptionMode="Never" %>
...
<head id="Head1" runat="server">
    ...
    <script language="javascript" type="text/javascript">
        function getinfo(id) {
            location.href = "AddModel.aspx?ModelID="+id+"";
            }</script>
</head>
<body>
    ...
    <div class="r_navigation">
		...
		<span>后台管理</span> &gt;&gt; <span>店铺管理</span> &gt;&gt; <a href="ManageModel.aspx">商品模型管理</a>
	</div>
    ...
    <table width="100%" border="0" cellpadding="0" cellspacing="1" class="border" align="center">
        <tbody>
            ...
            <asp:Repeater ID="Repeater1" runat="server" OnItemCommand="Repeater1_ItemCommand">
                <ItemTemplate>
                    <tr class="tdbg" align="center" onmouseover="this.className='tdbgmouseover'" onmouseout="this.className='tdbg'" style="height:25px;" id="<%# Eval("ModelID") %>" ondblclick="getinfo(this.id)">                        
                        <td>
