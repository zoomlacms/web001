<%@ page language="C#" autoeventwireup="true" inherits="manage_UserShopManage_FiledAdd, App_Web_t0xdissq" enableEventValidation="false" viewStateEncryptionMode="Never" %>
...
<body>
    ...
    &gt;&gt; <a href="PageField.aspx?ModelID=<%=Request.QueryString["ModelID"] %>">字段列表</a>
    ...
    <table class="border" cellspacing="1" cellpadding="0" width="99%" border="0" align="center">
            <tr class="tdbg">
                ...
                <td>
                    <asp:TextBox ID="Alias" runat="server" MaxLength="20" CssClass="l_input"></asp:TextBox><font
            ...
            <tr class="tdbg">
                ...
                <td>
                    <asp:TextBox ID="Name"  CssClass="l_input" MaxLength="50" runat="server"></asp:TextBox><font
            ...
            <tr class="tdbg">
                ...
                <td>
                    <asp:TextBox ID="Tips"  CssClass="l_input" MaxLength="50" runat="server"></asp:TextBox><span class="tips">显示在字段别名下方作为重要提示的文字</span>
                </td>
            </tr>
            <tr class="tdbg">
                <td class="tdbgleft">
                ...
                <td>
                    <asp:TextBox ID="Description"  CssClass="l_input" runat="server" Columns="40" Rows="6" TextMode="MultiLine"></asp:TextBox></td>
            </tr>
            <tr class="tdbg">
                <td class="tdbgleft">
                    是否必填：
            ...
            <tbody id="DivTextType">
                <tr class="tdbg">
                    ...
                    <td><asp:TextBox ID="TitleSize"  CssClass="l_input" runat="server" Columns="10" MaxLength="4">35</asp:TextBox></td>
                </tr>
                <tr class="tdbg">
                ...
                <tr class="tdbg">
                    ...
                    <td><asp:TextBox ID="TextType_DefaultValue"  CssClass="l_input" runat="server" Columns="10"></asp:TextBox></td>
                </tr>
            </tbody>
            <!--  多行文本(不支持Html)    -->
            <tbody id="DivMultipleTextType" style="display:none">
                <tr class="tdbg">
                    ...
                    <td><asp:TextBox ID="MultipleTextType_Width"  CssClass="l_input" runat="server" Columns="10" MaxLength="4">500</asp:TextBox>px</td>
                </tr>
                <tr class="tdbg">
                    <td class="tdbgleft">显示的高度：</td>
                    <td><asp:TextBox ID="MultipleTextType_Height"  CssClass="l_input" runat="server" Columns="10" MaxLength="4">200</asp:TextBox>px</td>
                </tr>
            </tbody>
            <!--  多行文本(支持Html)    -->
            <tbody id="DivMultipleHtmlType" style="display:none">
                ...
                <tr class="tdbg">
                    <td class="tdbgleft">显示的宽度：</td>
                    <td><asp:TextBox ID="MultipleHtmlType_Width"  CssClass="l_input" runat="server" Columns="10" MaxLength="4">715</asp:TextBox>px</td>
                </tr>
                <tr class="tdbg">
                    <td class="tdbgleft">显示的高度：</td>
                    <td><asp:TextBox ID="MultipleHtmlType_Height"  CssClass="l_input" runat="server" Columns="10" MaxLength="4">400</asp:TextBox>px</td>
                </tr>
            </tbody>
            <!--  单选项    -->
            <tbody id="DivOptionType" style="display:none">
                <tr class="tdbg">
                    ...
                    <td><input id="Button3" type="button" value="从数据字典中选择选项" class="C_input" onclick="SelectDictionary('RadioType_Content')" /><input 
                        ...
                        <asp:TextBox ID="RadioType_Content"  CssClass="l_input" runat="server" TextMode="MultiLine" Columns="40" Rows="6"></asp:TextBox> <span style="color: red">*</span></td>
                </tr>
                <tr class="tdbg">
                    <td class="tdbgleft">默认值：</td>
                    <td><asp:TextBox ID="RadioType_Default"  CssClass="l_input" runat="server"></asp:TextBox> 注：没有数据录入的默认值，与前台显示无关.</td>
                </tr>
                <tr class="tdbg">
            ...
            <tbody id="DivPicType" style="display:none">
                ...
                <tr class="tdbg">
                    <td class="tdbgleft">
                        允许上传的图片大小：</td>
                    <td>
                        <asp:TextBox ID="TxtSPicSize"  CssClass="l_input" runat="server" Columns=5>1024</asp:TextBox>KB <span style="color: blue">
                ...
                <tr class="tdbg">
                    <td class="tdbgleft">
                        允许上传的图片类型：</td>
                    <td>
                        <asp:TextBox ID="TxtPicExt"  CssClass="l_input" runat="server" Columns="30"></asp:TextBox><span style="color: red">*</span>
            ...
            <tbody id="DivMultiPicType" style="display:none">
                <tr class="tdbg">
                    ...
                    <td>
                        ...
                        <asp:TextBox ID="TxtThumb"  CssClass="l_input" runat="server" Columns="20"></asp:TextBox><span style="color:Red;display:none;">保存缩略图地址字段名不能与主字段名重复！</span></td>
                </tr>
                <tr class="tdbg">
                    <td class="tdbgleft">图片是否加水印：</td>
                    <td>
                ...
                <tr class="tdbg">
                    <td class="tdbgleft">
                        允许上传的图片大小：</td>
                    <td>
                        <asp:TextBox ID="TxtPicSize"  CssClass="l_input" runat="server" Columns=5>1024</asp:TextBox>KB <span style="color: blue">
                            提示：1 KB = 1024 Byte，1 MB = 1024 KB</span> <span style="color: red">*</span></td>
                </tr>
                <tr class="tdbg">
                    <td class="tdbgleft">
                        允许上传的图片类型：</td>
                    <td>
                        <asp:TextBox ID="TextImageType"  CssClass="l_input" runat="server" Columns="30"></asp:TextBox> <span style="color: red">*</span>
                    <span style="color: Blue">注：允许多个类型请用“|”号分割，如：jpg|gif|bmp等等</span></td>
                </tr>
            </tbody>            
            <!--  文件类型    -->
            <tbody id="DivFileType" style="display:none">
                ...
                <tr class="tdbg">
                    <td class="tdbgleft">
                        允许上传的文件大小：</td>
                    <td>
                        <asp:TextBox ID="TxtMaxFileSize"  CssClass="l_input" runat="server" Columns=5>1024</asp:TextBox>KB <span style="color: blue">
                            提示：1 KB = 1024 Byte，1 MB = 1024 KB</span> <span style="color: red">*</span></td>
                </tr>
                <tr class="tdbg">
                    <td class="tdbgleft">
                        允许上传的文件类型：</td>
                    <td>
                        <asp:TextBox ID="TxtUploadFileType"  CssClass="l_input" runat="server" Columns="30"></asp:TextBox> <span style="color: red">*</span>
                    <span style="color: Blue">注：允许多个类型请用“|”号分割，如：jpg|gif|bmp等等</span></td>
                </tr>
            </tbody>
            <!--  运行平台    -->
            <tbody id="DivOperatingType" style="display:none">
                <tr class="tdbg">
                    <td class="tdbgleft">分行键入&nbsp;&nbsp;<br />
                        每个平台选项：</td>
                    <td>
                        <asp:TextBox ID="TxtOperatingOption"  CssClass="l_input" runat="server" TextMode="MultiLine" Columns="40" Rows="6"></asp:TextBox> <span style="color: red">*</span> <span style="color: blue">注：一行一个默认项</span></td>
                </tr>
                <tr class="tdbg">
                    <td class="tdbgleft">文本框长度：</td>
                    <td><asp:TextBox ID="OperatingType_TitleSize"  CssClass="l_input" runat="server" Columns="10" MaxLength="4">35</asp:TextBox><span style="color: red">*</span></td>
                </tr>
                <tr class="tdbg">
                    <td class="tdbgleft">默认值：</td>
                    <td><asp:TextBox ID="OperatingType_DefaultValue"  CssClass="l_input" runat="server" Columns="30"></asp:TextBox><span style="color: green">例：Win2000|XP|Win2003</span> </td>
                </tr>
            </tbody>
            <!--  超链接    -->
            <tbody id="DivSuperLinkType" style="display:none">
                <tr class="tdbg">
                    <td class="tdbgleft">文本框长度：</td>
                    <td><asp:TextBox ID="SuperLinkType_TitleSize"  CssClass="l_input" runat="server" Columns="10" MaxLength="4">50</asp:TextBox></td>
                </tr>
                <tr class="tdbg">
                    <td class="tdbgleft">默认值：</td>
                    <td><asp:TextBox ID="SuperLinkType_DefaultValue"  CssClass="l_input" runat="server" Columns="30"></asp:TextBox><span style="color: green">例：http://127.0.0.1/</span></td>
                </tr>
            </tbody> 
            <!--  多级选项    -->
            ...
            <tbody id="DivNumType" style="display:none">
                <tr class="tdbg">
                    <td class="tdbgleft">文本框长度：</td>
                    <td><asp:TextBox ID="NumberType_TitleSize"  CssClass="l_input" runat="server" Columns="10" MaxLength="4">35</asp:TextBox></td>
                </tr>
                <tr class="tdbg">
                ...
                <tr class="tdbg">
                    <td class="tdbgleft">默认值：</td>
                    <td><asp:TextBox ID="NumberType_DefaultValue"  CssClass="l_input" runat="server" Columns="10"></asp:TextBox></td>
                </tr>
                <tr class="tdbg">
                    <td class="tdbgleft">
                    搜索设置：
                ...
                <tr class="tdbg">
                    ...
                    <td>
                        <table cellspacing="0" cellpadding="0" width="100%" border="0" align="center">
                            ...
                            <tr class="tdbg">
                                <td>
                                    <asp:TextBox ID="NumSearchRange"  CssClass="l_input" runat="server" TextMode="MultiLine" Columns="40" Rows="6"></asp:TextBox><br />                                    
                                </td>
                                <td>
            ...
            <tr class="tdbg">
                ...
                <td>
                    <asp:TextBox ID="ColorDefault" runat="server" MaxLength="7"  CssClass="l_input"  Columns="7" style="font-size: 9pt; height: 15px;"></asp:TextBox>
            ...
            <tr class="tdbg">
                ...
                <td height="50">
                    <asp:Button ID="Button1" runat="server" Text=" 添加字段 " CssClass="C_input" OnClientClick="return isok()" OnClick="Button1_Click" />
                    &nbsp;&nbsp;
                    <input id="Button2" type="button" value=" 返回字段列表 " class="C_input" onclick="javascript:window.location.href='ModelField.aspx?ModelID=<%=Request.QueryString["ModelID"] %>'" />
                    <asp:HiddenField ID="HdfModelIDf" runat="server" /><asp:HiddenField ID="HdfTableName" runat="server" />
                </td>
            </tr>
        </table>
