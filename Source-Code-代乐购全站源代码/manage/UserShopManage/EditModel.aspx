<%@ page language="C#" autoeventwireup="true" inherits="manage_UserShopManage_EditModel, App_Web_t0xdissq" enableEventValidation="false" viewStateEncryptionMode="Never" %>
...
<body>
    ...
    <div class="r_navigation">
		...
		<span>后台管理</span> &gt;&gt;<span>商城管理</span> &gt;&gt; <a href="ManageModel.aspx">商城模型管理</a> &gt;&gt; <span>模型字段列表</span>&nbsp;&nbsp;&nbsp;当前模型:
    ...
    <table width="100%" cellspacing="1" cellpadding="0" class="border" align="center">
        <tr class="bgleft">
            <td align="left" style="height: 20px">
                ...
                &nbsp;&nbsp; <a href="AddModelCum.aspx?ModelID=<%=Request.QueryString["ModelID"] %>">添加字段</a>                
            </td>
        </tr>
    </table>
    <div class="clearbox"></div>
