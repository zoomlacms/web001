<%@ page language="C#" autoeventwireup="true" inherits="manage_UserShopManage_AddModel, App_Web_t0xdissq" enableEventValidation="false" viewStateEncryptionMode="Never" %>
...
<body>
    ...
    <div class="r_navigation">
		...
		<span>后台管理</span> &gt;&gt; <span>店铺管理</span> &gt;&gt; <a href="ManageModel.aspx">商品模型管理</a> &gt;&gt; <span><asp:Literal ID="LNav" runat="server" Text="添加商品模型"></asp:Literal></span>
	</div>
    ...
    <table class="border" width="100%" cellpadding="2" cellspacing="1">
        ...
        <tr class="tdbg" onmouseover="this.className='tdbgmouseover'" onmouseout="this.className='tdbg'">
            ...
            <td>
                <asp:Label ID="LblTablePrefix" runat="server" Text="ZL_S_" />
        ...
        <tr class="tdbgbottom">
            ...
            <asp:HiddenField ID="HdnModelId" runat="server" />
                ...
                &nbsp;&nbsp;
                <input name="Cancel" type="button" class="C_input" id="Cancel" value="取消" onclick="window.location.href='ManageModel.aspx';" />                
            </td>
        </tr>
    </table>
