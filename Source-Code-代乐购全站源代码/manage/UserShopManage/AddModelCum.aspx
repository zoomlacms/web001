<%@ page language="C#" autoeventwireup="true" inherits="manage_UserShopManage_AddModelCum, App_Web_t0xdissq" enableEventValidation="false" viewStateEncryptionMode="Never" %>
...
<body>
    ...
    <div class="r_navigation">
		...
		<span>后台管理</span> &gt;&gt; <span>商城管理</span> &gt;&gt; 模型管理
    &gt;&gt; <a href="EditModel.aspx?ModelId=<%=Request.QueryString["ModelID"] %>">字段列表</a>
    ...
    <table class="border" cellspacing="1" cellpadding="0" width="99%" border="0" align="center">
            ...
            <tbody id="DivOptionType" style="display:none">
                ...
                <tr class="tdbg">
                    <td class="tdbgleft">默认值：</td>
                    <td><asp:TextBox ID="RadioType_Default" runat="server"></asp:TextBox> <span style="color: #808000">注：没有数据录入的默认值，与前台显示无关.</span></td>
                </tr>
                <tr class="tdbg">
        ...
        <tbody id="DivFileType" style="display: none"  runat="server">
            ...
            <tr class="tdbg">
                ...
                <td height="50">
                    ...
                    &nbsp;&nbsp;
                    <input id="Button2" type="button" value=" 返回字段列表 " class="btn" onclick="javascript:window.location.href='EditModel.aspx?ModelID=<%=Request.QueryString["ModelID"] %>'" />
