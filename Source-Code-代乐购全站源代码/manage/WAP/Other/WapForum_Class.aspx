<%@ page language="C#" autoeventwireup="true" inherits="manage_WAP_Other_WapForum_Class, App_Web_1jjr0mmi" enableEventValidation="false" viewStateEncryptionMode="Never" %>
...
<body>
    ...
    <div class="r_navigation">
        ...
        <span>后台管理</span> &gt;&gt; <span>Wap管理</span> &gt;&gt; <span><a href="WapForum_Class.aspx">
            论坛板块信息</a></span> <span><a href="WapForum_Class_Edit.aspx?menu=add">[添加论坛板块]</a></span>
    </div>
    <div class="clearbox">
    </div>
