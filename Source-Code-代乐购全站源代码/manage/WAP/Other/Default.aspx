<%@ page language="C#" autoeventwireup="true" inherits="manage_WAP_Other_Default, App_Web_1jjr0mmi" enableEventValidation="false" viewStateEncryptionMode="Never" %>
...
<body>
    ...
    <div class="r_navigation">
        ...
        <span>后台管理</span> &gt;&gt; <span>Wap管理</span> &gt;&gt; <span><a href="FSLinks.aspx">
            文章页管理</a></span> <span><a href="Default_Add.aspx?menu=add">[添加文章页]</a></span>
    </div>
    <div class="clearbox">
    </div>
