<%@ page language="C#" autoeventwireup="true" inherits="manage_WAP_Other_Part_timeInfo, App_Web_1jjr0mmi" enableEventValidation="false" viewStateEncryptionMode="Never" %>
...
<body>
    ...
    <div class="r_navigation">
        ...
        <span>后台管理</span> &gt;&gt; <span>Wap管理</span> &gt;&gt; <span><a href="Part-timeInfo.aspx">
            兼职信息管理</a></span> <span><a href="Part-timeEdit.aspx?menu=add">[添加兼职信息]</a></span>
    </div>
    <div class="clearbox">
    </div>
