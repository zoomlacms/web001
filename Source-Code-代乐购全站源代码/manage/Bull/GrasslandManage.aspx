<%@ page language="C#" autoeventwireup="true" inherits="manage_Bull_GrasslandManage, App_Web_gc1f3y0r" enableEventValidation="false" viewStateEncryptionMode="Never" %>
...
<body>
    ...
    <div class="r_navigation">
        ...
        <span>后台管理</span> &gt;&gt; 斗牛场管理 &gt;&gt; <a href="GrasslandManage.aspx">草场管理</a></div>
    <div class="clearbox">
    </div>
    <table width="100%" cellpadding="2" cellspacing="1" class="border" style="background-color: white;">
        <tbody id="Tbody1">
            <tr class="tdbg">
                <td align="center" colspan="12" class="title" width="100%">
                    草场管理
                </td>
            </tr>
            <tr class="tdbg">
                <td width="5%" class="tdbgleft" style="height: 24px; width: 2%; font-weight: bold">
                ...
                <td align="center" class="tdbgleft" style="height: 24px;width: 8%; font-weight: bold">
                    公会ID
                </td>
                <td align="center" class="tdbgleft" style="height: 24px;width: 5%; font-weight: bold">
                    当前等级
            ...
            <asp:Repeater ID="Repeater1" runat="server">
                <ItemTemplate>
                    <tr class="tdbg">
                        ...
                        <td align="center" class="tdbg" style="height: 24px;">
                           <%#GetUserLeave(Eval("Uid").ToString())%>
                        </td>
                        <td align="center" class="tdbg" style="height: 24px;">
                            <%#GetUserExperience(Eval("Uid").ToString())%>
                        </td>
                        <td align="center" class="tdbg" style="height: 24px;">
                           <%#GetUserMoney(Eval("Uid").ToString())%>
                        </td>
                        <td align="center" class="tdbg" style="height: 24px;">
            ...
            <tr class="tdbg">
                <td align="center" class="tdbg" style="height: 24px;" colspan="12">
                    共
