<%@ page language="C#" autoeventwireup="true" inherits="manage_Bull_GrassManage, App_Web_gc1f3y0r" enableEventValidation="false" viewStateEncryptionMode="Never" %>
...
<body>
    ...
    <div class="r_navigation">
        ...
        <span>后台管理</span> &gt;&gt; 斗牛场管理 &gt;&gt; <a href="GrassManage.aspx">管理草</a>　[<a href="AddGrass.aspx">添加草</a>]</div>
    <div class="clearbox">
    </div>
    <table width="100%" cellpadding="2" cellspacing="1" class="border" style="background-color: white;">
        <tbody id="Tbody1">
            <tr class="tdbg">
                <td align="center" colspan="9" class="title" width="100%">
                    草管理</td>
            </tr>
            <tr class="tdbg">
            ...
            <asp:Repeater ID="Repeater1" runat="server">
                <ItemTemplate>
                    <tr class="tdbg" onmouseover="this.className='tdbgmouseover'" onmouseout="this.className='tdbg'">
                        ...
                        <td align="center" style="height: 24px;">
                           <%#Eval("Experience","{0:F2}")%>
                        </td>
                        <td align="center" style="height: 24px;">
                           <%#Eval("Season")%>
                        </td>
                        <td align="center" style="height: 24px;">
                           <a href="AddGrass.aspx?menu=edit&id=<%#Eval("ID") %>">修改</a>　<a href="?menu=delete&id=<%#Eval("ID") %>" onclick="return confirm('你确定要将所有选择删除吗？');">删除</a>
                        </td>
                    </tr>
                </ItemTemplate>
            </asp:Repeater>
