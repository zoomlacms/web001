<%@ page language="C#" autoeventwireup="true" inherits="manage_Bull_Equipment, App_Web_gc1f3y0r" enableEventValidation="false" viewStateEncryptionMode="Never" %>
...
<body>
    ...
    <div class="r_navigation">
        ...
        <span>后台管理</span> &gt;&gt; 斗牛场管理 &gt;&gt; <a href="GrasslandManage.aspx">装备管理</a> [<a href="AddEquipment.aspx">添加装备</a>]</div>
    <div class="clearbox">
    </div>
    <table width="100%" cellpadding="2" cellspacing="1" class="border" style="background-color: white;">
        <tbody id="Tbody1">
            <tr class="tdbg">
                <td align="center" colspan="10" class="title" width="100%">
                    装备管理
                </td>
            </tr>
            <tr class="tdbg">
            ...
            <tr class="tdbg">
                <td align="center" class="tdbg" style="height: 24px;" colspan="10">
                    共
