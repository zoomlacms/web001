<%@ page language="C#" autoeventwireup="true" inherits="manage_Bull_RankMange, App_Web_gc1f3y0r" enableEventValidation="false" viewStateEncryptionMode="Never" %>
...
<body>
    ...
    <div class="r_navigation">
        ...
        <span>后台管理</span> &gt;&gt; 斗牛场管理 &gt;&gt; <a href="SceneManage.aspx">管理等级</a> &gt;&gt;
        <a href="AddRank.aspx">[添加等级]</a></div>
    <div class="clearbox">
    </div>
                ...
                <ItemTemplate>
                    <tr class="tdbg">
                        ...
                        <td align="center" class="tdbg">
                            <a href="AddRank.aspx?menu=edit&id=<%#Eval("ID") %>">修改</a> <a href="?menu=delete&id=<%#Eval("ID") %>"
        ...
        <tr>
            <td>
                <asp:Button ID="BatchDel" Style="width: 100px" class="C_input" runat="server" OnClientClick="return confirm('不可恢复性删除数据,你确定将该数据删除吗？');"
                    Text="批量删除" OnClick="BatchDel_Click" />&nbsp;
            </td>
        </tr>
    </table>
    </form>
