<%@ page language="C#" autoeventwireup="true" inherits="ZoomLa.WebSite.Manage.AddOn.PayPlatManage, App_Web_t05qjb42" enableEventValidation="false" viewStateEncryptionMode="Never" %>
<!DOCTYPE HTML>
<html>
<head runat="server">
<title>支付平台管理</title>
...
<div class="r_navigation">	
	<span>后台管理</span>&gt;&gt;<span>系统管理</span> &gt;&gt;<span>支付平台管理</span>[<span>&nbsp;<a href="AddPayPlat.aspx">添加支付平台</a></span>]
</div>
    ...
    <Columns>
        ...
        <asp:TemplateField HeaderText="操作" >
            <ItemTemplate>
                ...
                <asp:LinkButton ID="LinkButton6" runat="server" CommandName="Delete" CommandArgument='<%# Eval("PayPlatID") %>'>删除</asp:LinkButton>
              </ItemTemplate>                  
              <ItemStyle  HorizontalAlign="Center" />
        </asp:TemplateField>            
    </Columns>
