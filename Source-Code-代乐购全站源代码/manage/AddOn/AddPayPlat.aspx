<%@ page language="C#" autoeventwireup="true" inherits="ZoomLa.WebSite.Manage.AddOn.AddPayPlat, App_Web_t05qjb42" enableEventValidation="false" viewStateEncryptionMode="Never" %>
...
后台管理&gt;&gt;<span>系统设置</span> &gt;&gt;<a href="PayPlatManage.aspx">在线支付平台管理</a>&gt;&gt;<span><asp:Label  ID="LblAction" runat="server" Text="添加支付平台"></asp:Label></span>
</div>
        ...
        <ContentTemplate>
            <table width="100%" border="0" cellpadding="2" cellspacing="1" class="border" style="margin: 0 auto;">
                ...
                <tr class="tdbg" onmouseover="this.className='tdbgmouseover'" onmouseout="this.className='tdbg'">
                    ...
                    <td>
                        <asp:TextBox ID="TxtRate" runat="server" Text="0" class="l_input" />%&nbsp;&nbsp<span
                            style="color: black">*此项如设置为10%，则商户得到90%</span>
                ...
                <tr onmouseover="this.className='tdbgmouseover'" onmouseout="this.className='tdbg'">
                    ...
                    <td>
                        <table>
                            <tr>
                                <td>
                                    <asp:ListBox ID="groupList" runat="server" DataTextField="GroupName" DataValueField="GroupID" SelectionMode="Multiple" Width="130px"></asp:ListBox>
                                    <asp:Button ID="groupOK" runat="server" OnClick="groupOK_Click" Text="选定用户组" CausesValidation="False" class="C_input" />
                                    <asp:RequiredFieldValidator ID="RequiredFieldValidator4" runat="server" ControlToValidate="groupTB"  ErrorMessage="请从左边选择用户组"></asp:RequiredFieldValidator>
                                </td>
                            </tr>
                            <tr>
                                <td>
                                    <input id="groupTB" runat="server" backcolor="Gray" readonly="true" />
                                    <span style="color: black">* 不用输入，在上面选择，此项为了给不同用户组分配不同的分成</span>
                                </td>
                            </tr>
                        </table>
                    </td>
