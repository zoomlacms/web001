<%@ page language="C#" autoeventwireup="true" inherits="manage_AddOn_AddUpdateProject, App_Web_tffgei3l" enableEventValidation="false" viewStateEncryptionMode="Never" %>
<!DOCTYPE HTML>
<html>
<head runat="server">
...
<table width="100%" border="0" cellpadding="2" cellspacing="1" class="border" style="margin: 0 auto;">
	<tbody id="Tabs0">
		...
		<tr class="tdbg" onmouseover="this.className='tdbgmouseover'" onmouseout="this.className='tdbg'">
			...
			<td>
				...
				<asp:RequiredFieldValidator ID="rfv" runat="server" 
					ControlToValidate="TxtProName" Display="Dynamic" ErrorMessage="项目名称不可为空">项目名称不可为空</asp:RequiredFieldValidator>
			</td>
		</tr>
		<tr class="tdbg" onmouseover="this.className='tdbgmouseover'" onmouseout="this.className='tdbg'">
			...
			<td><asp:DropDownList ID="DDListType" runat="server" Width="145px"></asp:DropDownList>
				<asp:LinkButton ID="LkBtn" runat="server" PostBackUrl="ProjectsAddType.aspx" 
					CausesValidation="False">新增项目类型</asp:LinkButton>
			</td>
		</tr>
		<tr class="tdbg" onmouseover="this.className='tdbgmouseover'" onmouseout="this.className='tdbg'">
			<td class="style3"><strong>关联订单：</strong><br />相关联的订单ID</td>
			<td><asp:TextBox ID="TxtOrderID" class="l_input" runat="server" Width="222px" />
				<asp:RangeValidator ID="Rv" runat="server" ControlToValidate="TxtOrderID" 
					Display="Dynamic" ErrorMessage="*" MaximumValue="9999" MinimumValue="0">请输入数字1-9999</asp:RangeValidator>
			</td>
		</tr>        
		<tr class="tdbg" onmouseover="this.className='tdbgmouseover'" onmouseout="this.className='tdbg'">
		...
		<tr class="tdbg" onmouseover="this.className='tdbgmouseover'" onmouseout="this.className='tdbg'">
			...
			<td class="style2"><asp:TextBox ID="TxtRating" class="l_input" runat="server" 
					Width="222px"/>
		...
		<tr class="tdbg" onmouseover="this.className='tdbgmouseover'" onmouseout="this.className='tdbg'">
			...
			<td><asp:TextBox ID="TxtApplicationTime" class="l_input" runat="server" 
					Width="222px" onfocus="calendar(this)" ToolTip="选择申请时间" /></td>
		</tr>
