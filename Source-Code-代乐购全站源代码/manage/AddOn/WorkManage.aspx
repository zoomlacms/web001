<%@ page language="C#" autoeventwireup="true" inherits="manage_AddOn_WorkManage, App_Web_t05qjb42" enableEventValidation="false" viewStateEncryptionMode="Never" %>
<!DOCTYPE HTML>
<html>
<head runat="server">
...
<div class="r_navigation">后台管理&nbsp;&gt;&gt;CRM应用&nbsp;&gt;&gt;<a href="Projects.aspx">项目管理</a>&gt;&gt;<a href="WorkManage.aspx">流程管理</a>&nbsp;[<a ref="AddWork.aspx">添加流程</a>]
