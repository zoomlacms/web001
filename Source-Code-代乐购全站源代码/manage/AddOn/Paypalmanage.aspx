<%@ page language="C#" autoeventwireup="true" inherits="ZoomLa.WebSite.Manage.AddOn.Paypalmanage, App_Web_tffgei3l" enableviewstate="False" enableEventValidation="false" viewStateEncryptionMode="Never" %>
...
<span>后台管理</span>&gt;&gt;<span>系统设置</span> &gt;&gt;<a href="Paypalmanage.aspx">PayPal在线支付平台管理</a>&gt;&gt;<span><asp:Label ID="LblAction" runat="server" Text="Paypal支付平台"></asp:Label></span>
</div>
<div class="clearbox"></div>
   ...
   <tr class="tdbg" onmouseover="this.className='tdbgmouseover'" onmouseout="this.className='tdbg'">
    ...
    <tr class="tdbg" onmouseover="this.className='tdbgmouseover'" onmouseout="this.className='tdbg'">
        <td class="tdbgleft">
            <strong>支持交易货币：</strong></td>
        <td class="style3">
        <asp:CheckBoxList ID="CheckBoxList1" runat="server" Height="83px" RepeatColumns="8" 
                Width="586px" AutoPostBack="True">                     
