<%@ page language="C#" autoeventwireup="true" inherits="manage_AddOn_ProjectsList, App_Web_tffgei3l" enableEventValidation="false" viewStateEncryptionMode="Never" %>
<!DOCTYPE HTML>
<html>
<head runat="server">
<title>项目列表</title>
...
<form id="form1" runat="server">
  <div class="us_topinfo">
    <span class="us_pynews">您现在的位置：<span
                id="YourPosition"><span><a title="网站首页" href="/" target="_parent">
      <asp:Label ID="LblSiteName" runat="server" Text="Label"></asp:Label>
      </a></span><span> &gt;&gt; <a title="会员中心"
                href='<%=ResolveUrl("~/User/Default.aspx" )%>' target="_parent">会员中心</a></span>&gt;&gt; <span><span>查看项目</span> </span>
  </div>
