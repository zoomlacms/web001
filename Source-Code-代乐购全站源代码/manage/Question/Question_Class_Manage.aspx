<%@ page language="C#" autoeventwireup="true" inherits="manage_Question_Question_Class_Manage, App_Web_v4rgpiyp" enableEventValidation="false" viewStateEncryptionMode="Never" %>
...
<body>
    ...
    <div class="r_navigation">
        ...
        <span>后台管理</span> &gt;&gt; <span>扩展功能</span> &gt;&gt; <span>分类管理</span> <a href="AddQuestion_Class.aspx?menu=Add&C_id=0">
            [添加分类组]</a>
    </div>
    <div class="clearbox">
    </div>
