<%@ page language="C#" autoeventwireup="true" inherits="manage_Question_QuestionManage, App_Web_v4rgpiyp" enableEventValidation="false" viewStateEncryptionMode="Never" %>
...
<body>
    ...
    <div class="r_navigation">
        ...
        <span>后台管理</span> &gt;&gt; <span>扩展功能</span> &gt;&gt; <span><a href="QuestionManage.aspx">
            系统试题管理</a></span> <a href="AddQuestion.aspx?Operation=Add">[添加试题]</a>
    </div>
    <div class="clearbox">
    </div>
