<%@ page language="C#" autoeventwireup="true" inherits="manage_Guild_AddBourn, App_Web_sv0rahya" enableEventValidation="false" viewStateEncryptionMode="Never" %>
...
<body>
   ...
   <div class="r_navigation">
        ...
        <span>后台管理</span>  &gt;&gt; <span>OIEM管理</span> &gt;&gt; <span>公会管理</span> &gt;&gt;
         <span><a href="BournManage.aspx">境界管理</a>  </span> &gt;&gt; <span>添加境界信息</span>
                ...
                <tr class="tdbg" onmouseover="this.className='tdbgmouseover'" onmouseout="this.className='tdbg'">
                    ...
                    <td>
                        <asp:TextBox ID="txtBournNamee" runat="server" class="l_input"></asp:TextBox><asp:RequiredFieldValidator
                            ID="RequiredFieldValidator1" runat="server" ErrorMessage="*请输入境界名称" 
                    ...
                    <td>
                        <asp:TextBox ID="txtCount" runat="server" class="l_input" MaxLength="9999"></asp:TextBox>
