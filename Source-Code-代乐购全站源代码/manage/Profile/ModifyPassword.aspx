<%@ page language="C#" autoeventwireup="true" inherits="ZoomLa.WebSite.ModifyPassword, App_Web_4kwtbvix" enableEventValidation="false" viewStateEncryptionMode="Never" %>
...
<body>
    ...
    <table width="100%" border="0" cellpadding="2" cellspacing="1" class="border">
        ...
        <tr class="tdbg" onmouseover="this.className='tdbgmouseover'" onmouseout="this.className='tdbg'">
            ...
            <td>
                <asp:TextBox ID="TxtOldPassword" class="l_input" runat="server" TextMode="Password" />
        ...
        <tr class="tdbg" onmouseover="this.className='tdbgmouseover'" onmouseout="this.className='tdbg'">
            ...
            <td>
                <asp:TextBox ID="TxtPassword" class="l_input" runat="server" TextMode="Password" />
                ...
                <asp:RegularExpressionValidator ID="RegularExpressionValidatorPassword" runat="server"
                            ControlToValidate="TxtPassword" SetFocusOnError="false" 
                    Display="None" ValidationExpression="\w{6,18}"
                            ErrorMessage="密码至少6位并且不能超过18位"></asp:RegularExpressionValidator>                
            </td>
        </tr>
        <tr class="tdbg" onmouseover="this.className='tdbgmouseover'" onmouseout="this.className='tdbg'">
            <td class="tdbgleft" align="right">
            ...
            <td>
                <asp:TextBox ID="TxtPassword2" class="l_input" runat="server" TextMode="Password" />
        ...
        <tr class="tdbgbottom">
            <td colspan="2">
                <asp:Button ID="BtnSubmit" runat="server" class="C_input" Text="修改" OnClick="BtnSubmit_Click" />
                &nbsp;&nbsp;
