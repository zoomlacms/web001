<%@ page language="C#" autoeventwireup="true" inherits="ZoomLa_WebSite_Manages_Worktable, App_Web_4kwtbvix" enableEventValidation="false" viewStateEncryptionMode="Never" %>
<!DOCTYPE HTML>
<html>
...
.DayButton { font-size: 9pt; font-weight: bold; color: #243F65; cursor: hand; text-decoration: none; }
    ...
    <form id="form1" runat="server">
      ...
      <div class="r_navigation"> 后台管理&gt;&gt; 工作台 &gt;&gt; 管理员首页</span>&nbsp;&nbsp;&nbsp <strong>
        <asp:Literal runat="server" ID="litUserName"></asp:Literal>
        </strong>&nbsp;您好！今天是：
        <asp:Literal runat="server" ID="litDate"></asp:Literal>
        <span id="times" name="times"></span> </div>

      <table id="ShortCutTable" class="border" cellspacing="1" width="100%" cellpadding="2" align="center" border="0">
        <tbody>
          <tr class="title">
            <td align="left" style="height: 25px;padding-left:5px;">&nbsp;欢迎进入<%=SiteName() %>网站后台管理系统，<asp:Label ID="Version" runat="server" Text=""></asp:Label>[您可按以下步骤快速配置]。</td>
          </tr>
          <tr>
            <td style="height: 22px"><table width="450" border="0" cellpadding="0" cellspacing="0">
                <tr>
                <td align="center"><a href="../Config/SiteInfo.aspx"><img src="../../App_Themes/AdminDefaultTheme/Images/config.png" alt="网站配置" /></a></td>
                <td align="center"><a href="../Content/ModelManage.aspx"><img src="../../App_Themes/AdminDefaultTheme/images/generic.png" alt="内容模型管理" /></a></td>
                <td align="center"><a href="../Content/NodeManage.aspx"><img src="../../App_Themes/AdminDefaultTheme/Images/cpanel.png" alt="节点设置" /></a></td>
                <td align="center"><a href="../Template/LabelManage.aspx"><img src="../../App_Themes/AdminDefaultTheme/Images/mediamanager.png"  alt="标签设置" /></a></td>
                <td align="center"><a href="../Template/TemplateSet.aspx"><img src="../../App_Themes/AdminDefaultTheme/Images/templatemanager.png"  alt="模板设置" /></a></td>
                <td align="center"><a href="../User/AdminManage.aspx"><img src="../../App_Themes/AdminDefaultTheme/Images/support.png" alt="管理员管理" /></a></td>
              </tr>
                <tr>
                <td height="24" align="center"><a href="../Config/SiteInfo.aspx" target="_blank">网站配置</a></td>
                <td align="center"><a href="../Content/ModelManage.aspx" target="_blank">内容模型管理</a></td>
                <td align="center"><a href="../Content/NodeManage.aspx" target="_blank">节点设置</a></td>
                <td align="center"><a href="../Template/LabelManage.aspx" target="_blank">标签设置</a></td>
                <td align="center"><a href="../Template/TemplateSet.aspx" target="_blank">模板设置</a></td>
                <td align="center"><a href="../User/AdminManage.aspx" target="_blank">管理员管理</a></td>
              </tr>
              </table></td>
          </tr>
        </tbody>
      ...
      <table width="100%" cellpadding="2" cellspacing="1" border="0">
        <tr>
          <td align="left" width="322px"><table style="width:100%;" class="border">
              <tr align="left">
              <td colspan="2" class="spacingtitle"><asp:Label ID="LblTitle" runat="server" Text="日历" Font-Bold="True"></asp:Label><a href="../../Common/SelectChinaDay.html">[万年历]</a></td>
            </tr>
              <tr class="tdbg">
...
<script language="javascript" type="text/javascript">
		...
		function buttonOut() {
			...
			window.setTimeout(function() { obj.runtimeStyle.cssText = ""; }, 300);
                  ...
                  <thead>
                      ...
                      <td colspan="7" class="title"><a href="javaScript:subMonth();" title="上一月" class="DayButton">上一月</a>
                          ...
                          月 <a href="JavaScript:addMonth();" title="下一月" class="DayButton">下一月</a></td>
                    </tr>
                      <tr align="center" valign="middle"> 
		...
		<script language="JavaScript">
          ...
          <td align="right"><table style="width: 100%" class="border">
              <tr align="left">
              <td colspan="2" class="spacingtitle"><asp:Label ID="Label1" runat="server" Text="备忘录" Font-Bold="True"></asp:Label></td>
            </tr>
              <tr class="tdbg">
              <td class="tdbgleft" colspan="2" align="left"><asp:UpdatePanel ID="UpdatePanel1" runat="server">
                  ...
                  <br />
                  <font color="red">*提示:记录随本地Cookies删除而消失，重要信息请进入<a href="../AddOn/ProjectAffairsCenter.aspx">[事务中心]</a>进行记录交流</font> <br /></td>
            </tr>
            </table></td>
        </tr>
      </table>
      ...
      <table width="100%">
        <tr>
          <td style="width: 320px"><table class="border" cellspacing="0" cellpadding="2" width="100%" align="center"  border="0">
              <tr class="title">
              <td height="25" align="left" colspan="2">&nbsp;<b>浏览信息</b></td>
            </tr>
              <tr class="sysinfo"  >
