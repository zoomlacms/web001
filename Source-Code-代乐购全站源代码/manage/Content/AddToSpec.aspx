<%@ page language="C#" autoeventwireup="true" inherits="Zoomla.WebSite.Manage.Content.AddToSpec, App_Web_ptrmnxxy" enableEventValidation="false" viewStateEncryptionMode="Never" %>
<!DOCTYPE HTML>
<html>
<head runat="server">
<title>添加到其他专题</title>
...
<table style="width: 100%; margin: 0 auto;" cellpadding="2" cellspacing="1" class="border">
	...
	<tr class="tdbg">
		...
		<td>
			...
			<br />
			<input id="Button1" onclick="SelectAll()" type="button" class="C_input"  
				style="width:134px;"  value="  选定所有专题  " />
			<input id="Button2" onclick="UnSelectAll()" type="button"class="C_input"  
				style="width:135px;"  value="取消选定所有专题" />
		</td>
	</tr>
	<tr>
