<%@ page language="C#" autoeventwireup="true" validaterequest="false" inherits="ZoomLa.WebSite.Manage.Content.AddContent, App_Web_ptrmnxxy" enableEventValidation="false" viewStateEncryptionMode="Never" %>
...
<script type="text/javascript">
    ...
    function AddRow(nodename, nodeid, tableid, text, index) {
        ...
        oNewCell2.innerHTML = "&nbsp;<input type=button class=\"C_input\" name=Del" + nodeid + " style=\"width:80px\" value='移除" + text + "'" + "onclick=\"if(confirm('你确定要从" + text + "中移除吗？'))DelCurrentRow(" + nodeid + "," + index + ");\">";
    ...
    <table style="width: 100%; margin: 0 auto;" cellpadding="2" cellspacing="1" class="border">
        <tbody id="Tabs0">
            <tr class="tdbg">
                ...
                <td class="bqright" onmouseover="this.className='tdbgmouseover'" onmouseout="this.className='tdbg'">
                    <asp:TextBox ID="txtNode" class="l_input" runat="server" Width="250px" Enabled="false"
                        Text="内容中心"></asp:TextBox>&nbsp;<input id="Button3" type="button" value="更改节点" onclick="AddNode('link')"
                            class="C_input" style="width: 110px;" />&nbsp;<input id="Button4" type="button" value="添加到其他节点"
                                onclick="AddNode('check')" class="C_input" style="width: 110px;" />
                ...
                <td>
                    ...
                    <table border="0" cellpadding="0" cellspacing="0">
                        <tr>
                            ...
                            <td valign="top">
                                &nbsp;<input type="button" id="Button5" value="添加到专题" onclick="AddToSpecial()" class="C_input"
                                    style="width: 110px;" />
            ...
            <tr class="tdbg" onmouseover="this.className='tdbgmouseover'" onmouseout="this.className='tdbg'"
                ...
                <td class="tdbg">
                    <asp:TextBox ID="Titlecolor" runat="server" Text='' class="l_input" Width="10%"></asp:TextBox>
            ...
            <tr class="tdbg" onmouseover="this.className='tdbgmouseover'" onmouseout="this.className='tdbg'">
                ...
                <td class="tdbg">
                    <asp:TextBox ID="PYtitle" runat="server" Text='' Width="10%" class="l_input" Height="19px"></asp:TextBox>
                </td>
            </tr>
            <tr class="tdbg" onmouseover="this.className='tdbgmouseover'" onmouseout="this.className='tdbg'">
                <td class="tdbgleft" style="width: 20%" align="right">
                ...
                <td class="tdbg">
                    <asp:TextBox ID="txtTitle" class="l_input" onblur="getstrKeys()" onkeyup="isgoEmpty('txtTitle','span_txtTitle');query('txtTitle','PYtitle')"
                        runat="server" Text='' MaxLength="255" Style="width: 41%; background-image: url(/Images/bg.gif);
                        font-family: 宋体"></asp:TextBox>
                    <span id="span_txtTitle" name="span_txtTitle"></span><span><font color="red">*</font></span>&nbsp;<input
                        id="Button1" type="button" value="标题属性" onclick="open_style()" class="C_input" />
            ...
            <tr class="tdbg" onmouseover="this.className='tdbgmouseover'" onmouseout="this.className='tdbg'">
                ...
                <td class="bqright">
                    <asp:TextBox ID="TxtTagKey" runat="server" Text='' Width="41%" Height="22px" class="l_input"></asp:TextBox>
                    <input id="Button7" type="button" value="提取关键字" onclick="getstrKeys()" class="C_input"
                        style="width: 110px;" />&nbsp;<span style="color: #0000ff">【</span><a href="#" onclick="SelectKey();"><span
            ...
            <tr class="tdbg" onmouseover="this.className='tdbgmouseover'" onmouseout="this.className='tdbg'">
                ...
                <td class="bqright">
                    <asp:TextBox ID="Subtitle" runat="server" Text='' Width="400px" class="x_input" Height="52px"
        ...
        <tbody id="Tabs1" style="display: none">
            <tr class="tdbg" onmouseover="this.className='tdbgmouseover'" onmouseout="this.className='tdbg'">
                ...
                <td class="bqright">
                    <asp:TextBox ID="txtInputer" runat="server" class="l_input"></asp:TextBox>
                </td>
            </tr>
            <tr class="tdbg" onmouseover="this.className='tdbgmouseover'" onmouseout="this.className='tdbg'">
                <td class="tdbgleft" style="width: 20%" align="right">
                ...
                <td class="bqright">
                    ...
                    &nbsp;<input id="Radio2" type="radio" name="date" runat="server" value="2" />自定义&nbsp;&nbsp;<asp:TextBox
                        ID="txtdate" runat="server" Text="" onclick="calendar('txtdate');parent.document.getElementById('main_right').height = document.body.offsetHeight+400;"
                        Width="20%" class="l_input">
            ...
            <tr class="tdbg" onmouseover="this.className='tdbgmouseover'" onmouseout="this.className='tdbg'">
                ...
                <td class="bqright">
                    <asp:TextBox ID="txtNum" runat="server" Text="0" class="l_input"></asp:TextBox>
                </td>
            </tr>
            <tr class="tdbg" onmouseover="this.className='tdbgmouseover'" onmouseout="this.className='tdbg'">
                <td class="tdbgleft" style="width: 20%" align="right">
        ...
        <tbody id="Tabs2" style="display: none">
            ...
            <tr class="tdbg" id="contentsk" runat="server" onmouseover="this.className='tdbgmouseover'"
            ...
            <tr class="tdbg" onmouseover="this.className='tdbgmouseover'" onmouseout="this.className='tdbg'">
                ...
                <td class="bqright">
                    ...
                    <div id="changeins" style="display: none">
                        我想要<asp:TextBox ID="pronum" Width="30px" runat="server" class="l_input">0</asp:TextBox>
                        个方案，每个
        ...
        <tr class="tdbgbottom">
            <td colspan="2">
               ...
               <input type="button" class="C_input" id="Editdown" name="Editdown" value="编辑下一项" onclick="ShowTable()" />--%>
                <asp:Button ID="EBtnSubmit" class="C_input" Text="添加项目" OnClick="EBtnSubmit_Click" runat="server" />
                &nbsp;<asp:Button ID="Button6" class="C_input" runat="server" OnClick="Button6_Click"  Text="存为草稿" />
