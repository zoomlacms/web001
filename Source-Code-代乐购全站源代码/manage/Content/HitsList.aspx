<%@ page language="C#" autoeventwireup="true" inherits="manage_Content_HitsList, App_Web_2go44ezt" enableEventValidation="false" viewStateEncryptionMode="Never" %>
<!DOCTYPE html>
<html >
<head runat="server">
<title>评价列表</title>
...
<div class="r_navigation navheight">后台管理&gt;&gt;内容管理 &gt;&gt;访问评价&gt;&gt;评价列表</div>

    <div style=" margin-left:30px; float:left;"> 信息标题： <asp:TextBox ID="txtTitle" ToolTip="支持模糊查询" runat="server" Width="100px" CssClass="l_input"></asp:TextBox>&nbsp;&nbsp;&nbsp;
            月份：<asp:TextBox ID="txtTime" runat="server" Width="100px" CssClass="l_input" onclick="calendar();"   ></asp:TextBox>
            <asp:Button ID="btnSeach" runat="server" class="C_input" Text="查询" Width="80px" onclick="btnSeach_Click" />
    </div>
    <div style=" margin-right:150px; float:right;">IP数统计：<asp:Label ID="txtIpCount" runat="server" ></asp:Label></div>
