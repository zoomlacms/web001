<%@ page language="C#" autoeventwireup="true" inherits="ZoomLa.WebSite.Manage.Content.AuditingState, App_Web_ptrmnxxy" enableEventValidation="false" viewStateEncryptionMode="Never" %>
<!DOCTYPE HTML>
<html>
<head runat="server">
<title>工作流配置</title>
...
<span>后台管理</span>&gt;&gt;<span>系统设置</span> &gt;&gt;<span><a href="AuditingState.aspx">工作流配置</a></span>
</div>
<div class="clearbox">
</div>
<div>
