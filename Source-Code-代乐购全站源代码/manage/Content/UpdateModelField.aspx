<%@ page language="C#" autoeventwireup="true" inherits="ZoomLa.WebSite.Manage.UpdateModelField, App_Web_ptrmnxxy" enableEventValidation="false" viewStateEncryptionMode="Never" %>
...
<body>
    ...
    <div class="r_navigation">
        ...
        <span>后台管理</span>&gt;&gt;<span>系统设置</span> &gt;&gt;<a href="ModelManage.aspx">模型管理</a> &gt;&gt; <a href="ModelField.aspx?ModelId=<%= MID %>">字段列表</a> &gt;&gt; 修改[<asp:Label ID="lblModel" runat="server" Text="Label"></asp:Label>模型]字段
    </div>
    <div class="clearbox">
    </div>
    ...
    <table class="border" cellspacing="1" cellpadding="0" width="100%" border="0" align="center">
        <tr class="tdbg">
            ...
            <td>
                <asp:TextBox ID="Alias" class="l_input"  runat="server" MaxLength="20"></asp:TextBox><font color="#ff0066">*</font><span class="tips"> 如：文章标题</span>
            </td>
        </tr>
        <tr class="tdbg" onmouseover="this.className='tdbgmouseover'" onmouseout="this.className='tdbg'">
            ...
            <td>
                <asp:TextBox ID="Name" class="l_input"  MaxLength="50" runat="server"></asp:TextBox><font color="#ff0066">*</font><span class="tips">字段名由字母、数字、下划线组成，不接受空格</span>
            </td>
        </tr>
        <tr class="tdbg" onmouseover="this.className='tdbgmouseover'" onmouseout="this.className='tdbg'">
            <td class="tdbgleft">
      ...
      <tr class="tdbg" onmouseover="this.className='tdbgmouseover'" onmouseout="this.className='tdbg'">
        ...
        <tr class="tdbg">
            ...
            <td>
                <asp:RadioButtonList ID="Type" runat="server" RepeatColumns="5" RepeatDirection="Horizontal" onclick="SelectModelType()">
                    ...
                    <asp:ListItem Value="GoogleMapType">谷歌地图</asp:ListItem>
                </asp:RadioButtonList>
            </td>
        </tr>
        <!--  单行文本   -->
        ...
        <tbody id="DivOptionType" style="display: none" runat="server">
            <tr class="tdbg">
                ...
                <td>
                    <input id="Button3" type="button" value="从数据字典中选择选项" class= "C_input" onclick="SelectDictionary('RadioType_Content')" /><input id="Button5" type="button" class="C_input" value="添加数据字段" onclick='SubPage("RadioType_Content")' /><br />
        ...
        <tbody id="DivListBoxType" style="display: none" runat="server">
            <tr class="tdbg" onmouseover="this.className='tdbgmouseover'" onmouseout="this.className='tdbg'">
                ...
                <td>
                    <input id="Button4" type="button" value="从数据字典中选择选项" class="C_input" onclick="SelectDictionary('ListBoxType_Content')" /><input id="Button2" type="button" class="C_input" value="添加数据字段" onclick='SubPage("ListBoxType_Content")' /><br />
        ...
        <!-------->
          <!--Office转换为falsh-->
         <tbody id="DivUpload" style="display: none" runat="server"> 
            <tr class="tdbg" onmouseover="this.className='tdbgmouseover'" onmouseout="this.className='tdbg'">
                <td class="tdbgleft">
                    <strong>允许上传的文件大小：</strong>
                </td>
        ...
        <tbody id="DivGoogleMapType" runat="server" style="display: none">
            <tr class="tdbg" onmouseover="this.className='tdbgmouseover'" onmouseout="this.className='tdbg'">
                <td class="tdbgleft">
                    <strong>显示的宽度：</strong>
                </td>
                <td>
                    <asp:TextBox ID="WidthTxt" class="l_input" runat="server" Columns="10" MaxLength="4">500</asp:TextBox>px
                </td>
            </tr>
            <tr class="tdbg" onmouseover="this.className='tdbgmouseover'" onmouseout="this.className='tdbg'">
                <td class="tdbgleft">
                ...
                <td>
                    <asp:TextBox ID="HeigthTxt" class="l_input" runat="server" Columns="10" MaxLength="4">200</asp:TextBox>px
                </td>
            </tr>
        </tbody>
        <!--------------------->
        ...
        <tr class="tdbg">
            ...
            <td height="50">
                <asp:Button ID="Button1" runat="server" Text=" 修改字段 " class="C_input"  OnClientClick="return isok()" OnClick="Button1_Click" />
                &nbsp;&nbsp;
                <asp:Button ID="BtnBack" runat="server" Text="返回字段列表" class="C_input"  OnClick="BtnBack_Click" UseSubmitBehavior="False" CausesValidation="False" />
