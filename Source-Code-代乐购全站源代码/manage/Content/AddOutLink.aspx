<%@ page language="C#" autoeventwireup="true" inherits="ZoomLa.WebSite.Manage.Content.AddOutLink, App_Web_eslo4wtw" enableEventValidation="false" viewStateEncryptionMode="Never" %>
<!DOCTYPE HTML>
<html>
...
<div class="r_navigation">
	<span>后台管理</span> &gt;&gt; <span>系统设置</span> &gt;&gt; <a href="NodeManage.aspx">节点管理</a> &gt;&gt; <span>添加外部链接</span>
</div>
<div class="clearbox">
</div>
	...
	<tr class="tdbg" onmouseover="this.className='tdbgmouseover'" onmouseout="this.className='tdbg'">
		...
		<td>
			<asp:TextBox ID="TxtTips" class="l_input" runat="server" Columns="60" 
				Height="68px" Width="500px" Rows="2" TextMode="MultiLine"></asp:TextBox>
		</td>
	</tr>
</table>
