<%@ page language="C#" autoeventwireup="true" inherits="ZoomLa.WebSite.Manage.Content.ModelField, App_Web_eslo4wtw" enableEventValidation="false" viewStateEncryptionMode="Never" %>
<!DOCTYPE HTML>
<html>
...
后台管理&gt;&gt;系统设置 &gt;&gt;<a href="ModelManage.aspx">内容模型管理</a>&gt;&gt;模型字段列表&nbsp;<span class="red"><a href="AddModelField.aspx?ModelID=<%=Request.QueryString["ModelID"] %>">[添加字段]</a></span> &nbsp;&nbsp;&nbsp;当前模型:
<asp:Literal ID="LModelName" runat="server"></asp:Literal>&nbsp; <asp:Label ID="Label1" runat="server" Text=""></asp:Label>&nbsp; 
</div>
<table border="0" cellpadding="0" cellspacing="1" class="border" style=" text-align:center; width:100%">
	<tr class="gridtitle" align="center" style="height: 25px;">
		...
		<td style="width:8%"><strong>字段级别</strong></td>
		<td style="width:5%"><strong>是否必填</strong></td>
		<td style="width:5%"><strong>是否显示</strong></td>
		<td style="width:5%"><strong>可复制</strong></td>
	    <td style="width:7%"><strong>批量添加</strong></td>
		<td style="width:10%"><strong>排序</strong></td>
		<td style="width:10%"><strong>操作</strong></td>
		<td style="width:15%"><strong>编辑</strong></td>
	</tr>
			...
			<tr class="tdbg" onmouseover="this.className='tdbgmouseover'" onmouseout="this.className='tdbg'">
				...
				<td align="center">
				   <asp:LinkButton ID="LinkButton4" runat="server" CommandName="IsPlay" CommandArgument='<%# Eval("FieldID") %>' Visible='<%# Get_sum(Eval("Sys_type","{0}")) ? true:false %> '>
						<%# Eval("ShowList","{0}")=="True" ? "显示" : "不显示"%> 
				   </asp:LinkButton>
				</td>
				<td align="center">
					<a href="UpdateModelField.aspx?FieldID=<%# Eval("FieldID") %>&ModeID=<%# Eval("ModelID") %>">修改</a>
...
<table border="0" cellpadding="2" cellspacing="1" class="border" style=" text-align:center;width:100%">
	<tr class="tdbg">
		<td style="width:30%">
