<%@ page language="C#" autoeventwireup="true" inherits="ZoomLa.WebSite.Manage.Content.AddModelField, App_Web_ptrmnxxy" enableEventValidation="false" viewStateEncryptionMode="Never" %>
<!DOCTYPE HTML>
<html>
<script>
    //<!-- <asp:ListItem Value="Upload">在线浏览</asp:ListItem>--->
</script>
...
<body>
    ...
    <div class="r_navigation">
        <span>后台管理</span> &gt;&gt; <span>系统设置</span> &gt;&gt; <a href="ModelManage.aspx">模型管理</a> &gt;&gt; <a href="ModelField.aspx?ModelId=<%=Request.QueryString["ModelID"] %>">字段列表 </a>&gt;&gt; 添加[<asp:Label ID="lblModel" runat="server" Text="Label"></asp:Label>模型]字段 &nbsp; &nbsp; 当前表:<asp:Label ID="Label1" runat="server" Text=""></asp:Label>
    </div>
    <div class="clearbox">
    </div>
    <div class="clearbox">
    ...
    <table class="border" cellspacing="1" cellpadding="0" width="99%" border="0" align="center">        
       ...
       <tr class="tdbg" onmouseover="this.className='tdbgmouseover'" onmouseout="this.className='tdbg'">
        ...
        <tr class="tdbg" onmouseover="this.className='tdbgmouseover'" onmouseout="this.className='tdbg'">
            ...
            <td>
                <asp:RadioButtonList ID="Type" runat="server" RepeatColumns="5" RepeatDirection="Horizontal" onclick="SelectModelType()">
                   ...
                   <asp:ListItem Value="Upload">在线浏览</asp:ListItem>
                   <asp:ListItem Value="GoogleMapType">Google地图</asp:ListItem>
                </asp:RadioButtonList>
            </td>
        </tr>
        <!--  单行文本   -->
        ...
        <!----google地图---->
          <tbody id="DivGoogleMapType" style="display: none">
            <tr class="tdbg" onmouseover="this.className='tdbgmouseover'" onmouseout="this.className='tdbg'">
                <td class="tdbgleft">
                    <strong>显示的宽度：</strong>
                </td>
