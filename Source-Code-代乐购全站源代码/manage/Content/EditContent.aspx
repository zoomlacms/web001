<%@ page language="C#" autoeventwireup="true" validaterequest="false" inherits="ZoomLa.WebSite.Manage.Content.EditContent, App_Web_2go44ezt" enableEventValidation="false" viewStateEncryptionMode="Never" %>
...
<style>.elong_con_new .new_con_2 .new_con_d li {width:auto; padding-left:8px; padding-right:7px;}
.elong_con_new .new_con_2 .new_con_d #thz{ background-position:-296px -53px; margin-left:8px; padding-left:0;}
</style>
...
<cc1:ZoomLaAjaxBase ID="ZoomLaAjaxBase1" runat="server" />
    <script type="text/javascript">
        ...
        function AddRowNode(nodename, nodeid, tableid, text, index) {
            ...
            oNewCell2.innerHTML = "&nbsp;<input type=button class=\"C_input\" name=btnDel" + nodeid + " style=\"width:80px\" value='移除" + text + "'" + "onclick=\"if(confirm('你确定要从" + text + "中移除吗？'))DelCurrentRow(" + nodeid + "," + index + ");\">";
    ...
    <table width="100%" border="0" cellpadding="0" cellspacing="0">
        <tr align="center">
            ...
            <td id="Td1" class="tabnone">
               <img src="/images/up.gif" title="上一项" onclick="EditUp()" />
            </td>
            <td id="Td2" class="tabnone">
               <img src="/images/down.gif" title="下一项" onclick="EditDown()" />
            </td>
            <td>&nbsp;</td>
        </tr>
    </table>
    <table style="width: 100%; margin: 0 auto;" cellpadding="2" cellspacing="1" class="border">
        <tbody id="Tabs0">
            <tr class="tdbg" onmouseover="this.className='tdbgmouseover'" onmouseout="this.className='tdbg'">
                ...
                <td class="bqright">
                    <asp:TextBox ID="txtNode" class="l_input" runat="server" Width="250px" Enabled="false" Text="">
                    </asp:TextBox>&nbsp;<input id="Button2" class="C_input" type="button" value="更改节点" style="width: 80px" onclick="AddNode('link')" />&nbsp;
...
<tr class="tdbg" onmouseover="this.className='tdbgmouseover'" onmouseout="this.className='tdbg'" style="display:none">
                ...
                <td class="bqright">
                    <asp:TextBox ID="Titlecolor" class="l_input" runat="server" Text='' Width="10%"></asp:TextBox>
                    ...
                    &nbsp;<span id="spanbgcolor"><img onclick="SelectColor(this,'Titlecolor');" src="/App_Themes/AdminDefaultTheme/images/selectclolor.gif"
                        align="absmiddle" style="border-width: 0px; cursor: pointer" /></span>
                </td>
            </tr>  
           <tr class="tdbg" onmouseover="this.className='tdbgmouseover'" onmouseout="this.className='tdbg'">
                <td class="tdbgleft" style="width: 20%" align="right">
                ...
                <td class="bqright">
                    <asp:TextBox ID="PYtitle" runat="server" Text='' Width="10%" class="l_input" 
            ...
            <tr class="tdbg" onmouseover="this.className='tdbgmouseover'" onmouseout="this.className='tdbg'">
                <td class="tdbgleft" style="width: 20%" align="right">
                 ...
                 <td class="tdbg">            
                     <asp:TextBox id="txtTitle" class="l_input"  onblur="getstrKeys()" onkeyup="isgoEmpty('txtTitle','span_txtTitle');query('txtTitle','PYtitle')" runat="server" Text='' MaxLength="255" style="width:41%;background-image:url(/Images/bg.gif);"></asp:TextBox>
                     <span id="span_txtTitle" name="span_txtTitle"></span><span><font color="red">*</font></span>&nbsp;<input
                         id="Button3" type="button" value="标题属性" onclick="open_style()" class="C_input" />
                    
                    <asp:HiddenField ID="ThreadStyle" runat="server" />&nbsp;<asp:RequiredFieldValidator ID="RequiredFieldValidator1"
            ...
            <tr class="tdbg" onmouseover="this.className='tdbgmouseover'" onmouseout="this.className='tdbg'">
                ...
                <td class="bqright">
                    <asp:TextBox ID="TxtTagKey" class="l_input" runat="server" Text='' Width="50%"></asp:TextBox>
                    &nbsp;<span style="color: #0000ff"><input id="Button7" type="button" value="提取关键字"  onclick="getstrKeys()" class="C_input" style="width: 110px;" />【</span><a href="#" onclick="SelectKey();"> <span style="text-decoration: underline; color: Green;">选择关键字</span></a><span style="color: #0000ff">】</span>
                    (使用空格分隔每个关键字)
                </td>
            </tr>
           <tr class="tdbg" onmouseover="this.className='tdbgmouseover'" onmouseout="this.className='tdbg'">
                ...
                <td class="bqright">
                    <asp:TextBox ID="Subtitle" runat="server" Text='' Width="400px" class="l_input"  Height="52px" TextMode="MultiLine"></asp:TextBox>
                </td>
            </tr>            
            <asp:Literal ID="ModelHtml" runat="server"></asp:Literal>    
             <tr class="tdbg">
                <td class="tdbgleft" style="width: 20%;line-height:100px; height:100px" align="right">
                 <div style="float:left; height:100px; width:150px; text-align:center;"><label id="picview" name="picview"></label></div>
        ...
        <tbody id="Tabs1" style="display: none">
            <tr class="tdbg" onmouseover="this.className='tdbgmouseover'" onmouseout="this.className='tdbg'">
                ...
                <td class="bqright">
                    <asp:TextBox ID="txtInputer" class="l_input" runat="server"></asp:TextBox>
                </td>
            </tr>
            <tr class="tdbg" onmouseover="this.className='tdbgmouseover'" onmouseout="this.className='tdbg'">
                <td class="tdbgleft" style="width: 20%" align="right">
                ...
                <td class="bqright">
                    <asp:TextBox ID="txtAddTime" class="l_input" runat="server" onclick="calendar();"></asp:TextBox>
                </td>
            </tr>
            <tr class="tdbg" onmouseover="this.className='tdbgmouseover'" onmouseout="this.className='tdbg'">
                <td class="tdbgleft" style="width: 20%" align="right">
                ...
                <td class="bqright">
                    ...
                    <br />
                    &nbsp;<input id="Radio2" type="radio" name="date" runat="server" value="2" />自定义&nbsp;&nbsp;<asp:TextBox class="l_input" ID="txtdate" runat="server" Text="" onclick="calendar()" Width="20%">
            ...
            <tr class="tdbg" onmouseover="this.className='tdbgmouseover'" onmouseout="this.className='tdbg'">
                ...
                <td class="bqright">
                    <asp:TextBox ID="txtNum" class="l_input" runat="server"></asp:TextBox>
                </td>
            </tr>
            <tr class="tdbg" onmouseover="this.className='tdbgmouseover'" onmouseout="this.className='tdbg'">
                <td class="tdbgleft" style="width: 20%" align="right">
         ...
         <tr class="tdbg" onmouseover="this.className='tdbgmouseover'" onmouseout="this.className='tdbg'">
                ...
                <td class="bqright">
                    ...
                    <div id="changeins" style="display:none">我想要 
                        <asp:TextBox ID="pronum" Width="30px" runat="server" class="l_input">0</asp:TextBox> 个方案，每个 <asp:TextBox ID="bidmoney" Width="30px" runat="server" class="l_input">0</asp:TextBox> 元
                    </div>
                </td>
            </tr>
             <tr id="bidmoneytable" class="tdbg" onmouseover="this.className='tdbgmouseover'" onmouseout="this.className='tdbg'">
                ...
                <td class="bqright">
                    <asp:TextBox ID="proweek" runat="server" Width="30px" class="l_input">0</asp:TextBox> 天
                </td>
            </tr>
        </tbody>
        <tr class="tdbgbottom">
            <td colspan="2">
               ...
               <input type="button" class="C_input" id="DownButton" name="DownButton" value="编辑下一项" onclick="EditDown()" />--%>
                <asp:Button ID="EBtnSubmit" class="C_input" Text="保存项目" OnClick="EBtnSubmit_Click" runat="server" />&nbsp;
                <asp:Button ID="Button1" class="C_input" Text="添加为新项目" runat="server" OnClick="Button1_Click" />&nbsp;
