<%@ page language="C#" autoeventwireup="true" inherits="manage_Content_AddAudit, App_Web_2go44ezt" enableEventValidation="false" viewStateEncryptionMode="Never" %>
<!DOCTYPE HTML>
<html>
<head runat="server">
<title>编辑预审核内容</title>
...
<div class="r_navigation">
	...
	<span>后台管理</span> &gt;&gt; <span>内容管理</span> &gt;&gt; <span>
	<a href="AuditManage.aspx">
		内容预审核管理</a></span> &gt;&gt;<span>编辑内容</span></div>
<div class="clearbox">
</div>
				...
				<tbody id="Tabs0">
					<tr class="tdbg">
						...
						<td style="height: 26px;">
							<asp:TextBox ID="txtNode" runat="server" class="l_input" Width="20%"
								Height="20px"></asp:TextBox>
						<input id="Button3" type="button" value="选择节点" onclick="AddNode('link')"
						class="C_input" style="width: 110px;" /><asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server" ErrorMessage="节点内容不能为空！"
								ControlToValidate="txtNode"></asp:RequiredFieldValidator>
...
<table border="0" cellpadding="0" cellspacing="0" width="100%" id="TABLE1">
	<tr>
		<td align="left" style="height: 59px">
			...
			<input type="button" class="C_input" name="Button2" value="返回列表" onclick="location.href='AuditManage.aspx'"
				id="Button2" /> </td>
	</tr>
</table>
</form>
