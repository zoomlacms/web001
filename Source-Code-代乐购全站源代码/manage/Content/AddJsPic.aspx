<%@ page language="C#" autoeventwireup="true" inherits="ZoomLa.WebSite.Manage.Content.AddJsPic, App_Web_ptrmnxxy" enableEventValidation="false" viewStateEncryptionMode="Never" %>
<!DOCTYPE HTML>
<html>
<head runat="server">
...
<body>
    ...
    <center>
        ...
        <asp:Button ID="Button2" runat="server" CssClass="C_input" Text="返回" CausesValidation="false"
