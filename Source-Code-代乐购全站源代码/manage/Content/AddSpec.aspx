<%@ page language="C#" autoeventwireup="true" inherits="ZoomLa.WebSite.Manage.Content.AddSpec, App_Web_ptrmnxxy" enableEventValidation="false" viewStateEncryptionMode="Never" %>
<!DOCTYPE HTML>
<html>
...
<body>
    ...
    <div class="r_navigation">
        <span>后台管理</span> &gt;&gt; <span>系统设置</span> &gt;&gt; <a href="SpecialManage.aspx">专题类别管理</a> &gt;&gt; <span>
            <asp:Label ID="Label1" runat="server" Text="添加专题"></asp:Label></span>
    </div>
    <div class="clearbox">
    </div>
    ...
    <table width="100%" border="0" cellpadding="2" cellspacing="1" class="border" style="margin: 0 auto;">
     <tbody id="Tabs0">
        ...
        <tr class="tdbg" onmouseover="this.className='tdbgmouseover'" onmouseout="this.className='tdbg'">
            ...
            <td>
                     <asp:TextBox ID="TxtSpeacTips"  class="l_input" runat="server" Columns="60" 
        ...
        <tr class="tdbg" onmouseover="this.className='tdbgmouseover'" onmouseout="this.className='tdbg'">
            <td class="tdbgleft">
                ...
                专题说明：</strong></td>
            <td>
                <asp:TextBox ID="TxtSpecDesc" class="l_input" runat="server" Columns="50" 
            ...
            <td>
                <asp:TextBox ID="TxtSpeacKeyword" class="l_input" runat="server"  Height="65" Width="500" Columns="60"
            ...
            <td>
                <asp:TextBox ID="TxtSpeacDescriptive" class="l_input" runat="server"  Height="65" Width="500" Columns="60"
                                    Rows="4" TextMode="MultiLine"  />
            </td>
        </tr>
        </tbody>
