<%@ page language="C#" autoeventwireup="true" inherits="ZoomLa.WebSite.Manage.Content.AddAuditingState, App_Web_eslo4wtw" enableEventValidation="false" viewStateEncryptionMode="Never" %>
<!DOCTYPE HTML>
<html>
<head runat="server">
<title>审核状态</title>
...
<span>后台管理</span>&gt;&gt;<span>系统设置</span> &gt;&gt;<span><a href="SpecialManage.aspx">添加审核状态</a></span>
</div>
<div class="clearbox">
</div>
<div>
			...
			<tr onmouseover="this.className='tdbgmouseover'" onmouseout="this.className='tdbg'">
				...
				<td  align="left">
					...
					<asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server" 
						ControlToValidate="stateName" ErrorMessage="状态名称不能为空"></asp:RequiredFieldValidator>
				</td>
			</tr>
			<tr><td colspan="2" align="center"><asp:Button ID="btnSave" runat="server" 
					Text="保存状态码" onclick="btnSave_Click" class="C_input"  style="width:100px;"  /></td></tr>
		</tbody>
	</table>
</div>
</form>
