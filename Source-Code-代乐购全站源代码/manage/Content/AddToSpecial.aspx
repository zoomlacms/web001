<%@ page language="C#" autoeventwireup="true" inherits="ZoomLa.WebSite.Manage.Content.AddToSpecial, App_Web_2go44ezt" enableEventValidation="false" viewStateEncryptionMode="Never" %>
<!DOCTYPE HTML>
<html>
...
<div class="r_navigation">
	<span>后台管理</span> &gt;&gt; <span>内容管理</span> &gt;&gt; <span>批量添加内容到专题</span>
</div>
<div class="clearbox">
</div>
<table style="width: 100%; margin: 0 auto;" cellpadding="2" cellspacing="1" class="border">
	...
	<tr class="tdbg" onmouseover="this.className='tdbgmouseover'" onmouseout="this.className='tdbg'">
		...
		<td class="bqright">
			<asp:TextBox ID="TxtContentID" class="l_input" runat="server" Width="298px" 
	...
	<tr class="tdbg">
		...
		<td class="bqright">
			...
			<br />
			<br />
			<input id="Button2" onclick="SelectAll()" type="button"class="C_input"  
				style="width:137px;"  value="  选定所有专题  " />&nbsp;
			<input id="Button3" onclick="UnSelectAll()" type="button" class="C_input"  
				style="width:146px;"  value="取消选定所有专题" />
		</td>
	</tr>
	<tr class="tdbg">
