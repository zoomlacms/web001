<%@ page language="C#" autoeventwireup="true" inherits="ZommLa.WebSite.Manage.Content.EditNode, App_Web_2go44ezt" validaterequest="false" enableEventValidation="false" viewStateEncryptionMode="Never" %>
<!DOCTYPE HTML>
<html>
...
<div class="r_navigation">
	<span>后台管理</span>&gt;&gt;<span>系统设置</span> &gt;&gt;<a href="NodeManage.aspx">节点管理</a>&gt;&gt;<span>编辑栏目节点</span>
</div>
<div class="clearbox">
</div>
<table width="100%" border="0" cellpadding="0" cellspacing="0">
	<tr align="center">
		...
		<td id="TabTitle2" class="tabtitle" onclick="ShowTabs(2)">收费设置</td>
		<td id="TabTitle3" class="tabtitle" onclick="ShowTabs(3)">模板选项</td>
		<td id="TabTitle4" class="tabtitle" onclick="ShowTabs(4)">生成选项</td>
		<td id="TabTitle5" class="tabtitle" onclick="ShowTabs(5)">自设内容</td>
		<td id="TabTitle7" class="tabtitle" onclick="ShowTabs(7)">浏览权限</td>
		<td id="TabTitle6" class="tabtitle" onclick="ShowTabs(6)">操作权限</td>
		<td id="TabTitle8" class="tabtitle" onclick="ShowTabs(8)">方案配置</td>
		<td>&nbsp;</td>
	</tr>
</table>
			...
			<table width="100%" cellpadding="2" cellspacing="1" style="background-color: white;">
					...
					<tr class="tdbg" onmouseover="this.className='tdbgmouseover'" onmouseout="this.className='tdbg'">
						...
						<td>
							<asp:TextBox ID="TxtTips" class="l_input"   runat="server" Columns="60" 
								Height="60px" Width="500px" Rows="2" TextMode="MultiLine"></asp:TextBox>
						</td>
					</tr>
					<tr class="tdbg" onmouseover="this.className='tdbgmouseover'" onmouseout="this.className='tdbg'">
						<td class="tdbgleft">
						...
						<td>
							<asp:TextBox ID="TxtDescription" class="l_input"  runat="server" Columns="60" 
								Height="58px" Width="500px" Rows="2" TextMode="MultiLine"></asp:TextBox>
						</td>
					</tr>
					<tr class="tdbg" onmouseover="this.className='tdbgmouseover'" onmouseout="this.className='tdbg'">
						<td class="tdbgleft">
						...
						<td>
							<asp:TextBox ID="TxtMetaKeywords" class="l_input"   runat="server"  
								Width="500px" Columns="60" Rows="4" TextMode="MultiLine" Height="61px"></asp:TextBox>
						</td>
					</tr>
					<tr class="tdbg" onmouseover="this.className='tdbgmouseover'" onmouseout="this.className='tdbg'">
						<td class="tdbgleft">
				...
				<tbody id="Tabs2" style="display: none">
					...
					<tr class="tdbg"  onmouseover="this.className='tdbgmouseover'" onmouseout="this.className='tdbg'">
						...
						<td>
							...
							<input id="Radio2" name="ConsumeType" runat="server" value="1" type="radio" />距离上次收费时间<asp:TextBox ID="TxtConsumeTime" class="l_input"   runat="server" Columns="5">0</asp:TextBox>小时后重新收费<br />
							<input id="Radio3" name="ConsumeType" runat="server" value="2" type="radio" />会员重复阅读此文章<asp:TextBox ID="TxtConsumeCount" class="l_input"  runat="server" Columns="5">0</asp:TextBox>次后重新收费<br />
					...
					<tr class="tdbg" onmouseover="this.className='tdbgmouseover'" onmouseout="this.className='tdbg'">
						...
						<td>
							<asp:TextBox ID="TxtAddMoney" class="l_input" runat="server" Columns="8">0</asp:TextBox> 元 <asp:TextBox ID="TxtAddPoint" class="l_input" runat="server" Columns="8">0</asp:TextBox> 点券
                             <asp:TextBox ID="txtAddExp" class="l_input" runat="server" Columns="8">0</asp:TextBox> 积分
						</td>
					</tr>
					...
					<tr class="tdbg" onmouseover="this.className='tdbgmouseover'" onmouseout="this.className='tdbg'">
						...
						<td>
							<asp:TextBox ID="txtDeducExp" class="l_input" runat="server" Columns="8">0</asp:TextBox> 积分
						</td>
					</tr>
				</tbody>
				<%--模板选项--%>
				...
				<tbody id="Tabs5" style="display: none">
					...
					<tr class="tdbg" id="Custom20" runat="server" style="display: none" onmouseover="this.className='tdbgmouseover'" onmouseout="this.className='tdbg'">
						<td class="tdbgleft">
							<strong>自设内容20：</strong><br />在列表模板页面插入{PH.Label id="自设节点内容" nodeid="@Request_id" num="20"/}
						</td>
						<td>
							<asp:TextBox ID="TextBox20" class="l_input" runat="server" TextMode="MultiLine" 
				...
				<!--前台权限--->
				 <tbody id="Tabs7" style="display: none">
					 <tr class="tdbg" onmouseover="this.className='tdbgmouseover'" onmouseout="this.className='tdbg'">
						...
						<td>
							<asp:RadioButton ID="allUser" GroupName="group" runat="server" />开放栏目 任何人（包括游客）可以浏览和查看此栏目下的信息。 <br />
...
游客没有发表信息权限。
						...
						<td>
							<asp:CheckBoxList ID="input" runat="server" RepeatDirection="Horizontal" RepeatColumns="5" Width="100%">
								<asp:ListItem Value="-2">待验证会员</asp:ListItem>
								<asp:ListItem Value="-1">已验证会员</asp:ListItem>
							</asp:CheckBoxList>
					</tr>
...
<table border="0" cellpadding="0" cellspacing="0" width="100%">
	<tr>
		<td align="center">
			&nbsp; &nbsp;
			<asp:Button ID="EBtnSubmit" class="C_input"  Text="保存" OnClick="EBtnSubmit_Click" Width="65px" runat="server" />&nbsp; &nbsp;
