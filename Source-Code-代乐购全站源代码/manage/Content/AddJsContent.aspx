<%@ page language="C#" autoeventwireup="true" inherits="ZoomLa.WebSite.Manage.Content.AddJsContent, App_Web_2go44ezt" enableEventValidation="false" viewStateEncryptionMode="Never" %>
<!DOCTYPE HTML>
<html>
<head runat="server">
...
<div class="r_navigation">
	...
	生成发布 &gt;&gt; <a href="ManageJsContent.aspx">文章JS文件管理</a> &gt;&gt; 添加新的JS文件</div>
<div class="clearbox">
</div>
<div>
	<table width="100%" cellpadding="2" cellspacing="1" border="0" align="center">
		...
		<tr class="tdbg" onmouseover="this.className='tdbgmouseover'" onmouseout="this.className='tdbg'">
			...
			<td>
				...
				<asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server" ErrorMessage="代码名称不能为空"
					ControlToValidate="Jsname"></asp:RequiredFieldValidator>
			</td>
		</tr>
		<tr class="tdbg" onmouseover="this.className='tdbgmouseover'" onmouseout="this.className='tdbg'">
			<td class="tdbgleft" style="width: 20%" align="right">
...
<center>
	...
	<asp:Button ID="Button2" runat="server" Text="返回" CssClass="C_input" 
