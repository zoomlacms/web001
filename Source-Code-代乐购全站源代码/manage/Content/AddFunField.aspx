<%@ page language="C#" autoeventwireup="true" inherits="manage_Content_AddFunField, App_Web_ptrmnxxy" enableEventValidation="false" viewStateEncryptionMode="Never" %>
<!DOCTYPE HTML>
<html>
<head >
<title>添加模型字段</title>
...
<body>
    ...
    <div class="r_navigation">
        ...
        <span>后台管理</span>&gt;&gt;<span>系统配置</a>&gt;&gt;<a  href="FunctionModel.aspx">功能模型</a> &gt;&gt; <a href="FunModelField.aspx?ModelId=<%=Request.QueryString["ModelID"] %>">
    ...
    <table class="border" cellspacing="1" cellpadding="0" width="99%" border="0" align="center">
        ...
        <tr class="tdbg">
            ...
            <td height="50">
                ...
                &nbsp;&nbsp;
                <input id="Button2" type="button" value=" 返回字段列表 "  onclick="javascript:window.location.href='FunModelField.aspx?ModelID=<%=Request.QueryString["ModelID"] %>'" class="C_input"/>
