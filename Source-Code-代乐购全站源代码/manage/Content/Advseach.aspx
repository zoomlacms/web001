<%@ page language="C#" autoeventwireup="true" inherits="ZoomLa.WebSite.Manage.Content.advseach, App_Web_ptrmnxxy" enableEventValidation="false" viewStateEncryptionMode="Never" %>
<!DOCTYPE HTML>
<html>
...
<body>
    ...
    <div>
        <table width="100%" cellpadding="
            ...
            <tr align="center">
                <td colspan="2" class="style15" align="center">
                    <b>高级检索</b>
                </td>
            </tr>
            <tr class="WebPart">
                <td class="style4" align="center">
                    <table class="tdbgleft">
                        <tr>
                        <td align="left" class="style6"><b>选择节点：</b></td>
                        </tr>
                        <tr>
                        <td class="tdbgleft" align="center">
                                <asp:ListBox ID="ListBox1" runat="server" Height="282px" Width="203px"   
                ...
                <td class="style4">
                    <table class="tdbgleft">
                     <tr>
                        ...
                        <tr>
                            <td class="style10">                            
                                <asp:DropDownList ID="DbTableDownList" runat="server" Width="225px" 
                                    AutoPostBack="True" 
                                    OnSelectedIndexChanged="DBTableDownList_SelectedIndexChanged" 
                                    Height="28px" >          
                                </asp:DropDownList>
                            </td>
                            <td align="center" class="style2" runat="server" id="cc1">
                                </td>
                        </tr>
                         <tr>
                        ...
                        <tr class="clearbox" lang="bla" style="border: 4% groove #FFFFFF; padding: 26px; position: static; z-index: inherit; width: 8px; list-style-image: none; table-layout: inherit">
                            <td class="style11">      
                                <asp:ListBox ID="DbFieldDownList" runat="server" Height="217px" Width="227px"  SelectionMode="Multiple" AutoPostBack="True" />
                            </td>
                              <td class="style14"   20px" align="left" id ="searchValueList" colspan="-1"  >
                                 ...
                                 <table id="tb" cellpadding="-1" border="2" cellspacing="-1" class="border" 
                                      style="border-style: dotted; border-width: 2px" ></table>
            ...
            <tr class="WebPart">
                <td height="22" align="left" class="style8"><span style="color:Red;">* </span>
                 </td>
                <td height="22"  align="left" class="tdbgleft" style="width: 24%" >
            <input name="button" type="button" class="C_input"  style="width:130px;"  onclick='additem("tb")' value="增加查询字段 ==〉" class="style17"/>
          </td>
            </tr>
           <tr>
                <td height="22" align="center" colspan="2" class="tdbgleft" style="line-height: 25px;">
                     <asp:HiddenField ID="HiddenField2" runat="server"  />
                    &nbsp;&nbsp;
                        <input type="submit" name="submit" class="C_input"  style="width:130px;"  onclick="getsub()" value="开 始 查 询" class="style16"/>
                </td>
        </tr>
        </table>
    </div>
