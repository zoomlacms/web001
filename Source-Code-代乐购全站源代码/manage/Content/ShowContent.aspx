<%@ page language="C#" autoeventwireup="true" inherits="ZoomLa.WebSite.Manage.Content.ShowContent, App_Web_2go44ezt" enableEventValidation="false" viewStateEncryptionMode="Never" %>
<!DOCTYPE HTML>
<html>
	...
	<tr class="tdbg">
		<td valign="top" style="margin-top: 0px; margin-left: 0px;">
			...
			<center>
				...
				&nbsp;<asp:Button ID="delete3" class="C_input" runat="server" Text="设为推荐" OnClick="delete3_Click" /><asp:Button
					ID="Button6" class="C_input" runat="server" Text="取消推荐" OnClick="Button6_Click" />
			</center>
		</td>
	</tr>
</table>
								...
								<asp:Repeater ID="gvCard" runat="server">
									<ItemTemplate>
										<tr class="tdbg" onmouseover="this.className='tdbgmouseover'" onmouseout="this.className='tdbg'">
											...
											<td height="22" align="center">
												<a href="ShowContent.aspx?menu=shen&CommentID=<%#Eval("CommentID") %>&modeid=<%=HdnModelID.Value %>&GID=<%=HiddenGID.Value %>">
													修改</a> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<a href="ShowContent.aspx?menu=del&CommentID=<%#Eval("CommentID") %>&modeid=<%=HdnModelID.Value %>&GID=<%=HiddenGID.Value %>"
