<%@ page language="C#" autoeventwireup="true" inherits="manage_CallStat_StatVisitorReport, App_Web_nlgsezto" enableEventValidation="false" viewStateEncryptionMode="Never" %>
<!DOCTYPE HTML>
<html>
<head runat="server">
<title>访问统计</title>
...
<div class="r_navigation">
	...
	<span>后台管理</span> &gt;&gt; <span>扩展功能</span> &gt;&gt; <span>访问统计</span> &gt;&gt;   <span>访问记录</span>
</div>
<div class="clearbox"></div>
<div>
<table width="100%"><tr><td>
    <asp:GridView ID="GridView1" runat="server" Width="100%" AutoGenerateColumns="False" CssClass="title">
        <Columns>
    ...
    <tr class="tdbg">
                <td height="24" colspan="6" align="center" class="tdbgleft">
                    ...
                    <asp:Label ID="pagess" runat="server" Text="" />个/页 转到第<asp:DropDownList ID="DropDownList1" runat="server" AutoPostBack="True">
