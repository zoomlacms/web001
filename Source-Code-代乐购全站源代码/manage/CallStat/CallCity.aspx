<%@ page language="C#" autoeventwireup="true" inherits="manage_CallStat_CallCity, App_Web_nlgsezto" enableEventValidation="false" viewStateEncryptionMode="Never" %>
<!DOCTYPE HTML>
<html>
...
<div class="r_navigation">
    ...
    <span>后台管理</span> &gt;&gt; <span>扩展功能</span> &gt;&gt; <span>邮件订阅 </span>&gt;&gt;
    <span>订阅管理</span>
</div>
<div class="clearbox">
</div>
...
<table width="100%" border="0" cellpadding="2" cellspacing="1" class="border">
        ...
        <tr class="tdbg">
<td>
添加地区或城市：<asp:DropDownList ID="DropDownList2" runat="server"  >
                ...
                </asp:DropDownList><asp:TextBox ID="txtTepy" class="l_input" runat="server"></asp:TextBox><asp:Button ID="Button1" class="C_input" runat="server" Text="添  加" OnClick="Button1_Click" />
</td>
                    
</tr>
<tr class="tdbg">
<td>
    <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" Width="100%" OnRowCancelingEdit="GridView1_RowCancelingEdit" OnRowDeleting="GridView1_RowDeleting" OnRowEditing="GridView1_RowEditing" OnRowUpdating="GridView1_RowUpdating" DataKeyNames="C_Nid">
        <Columns>
            ...
            <asp:TemplateField HeaderText="代码类型">
                ...
                <HeaderStyle Width="15%" />
                <ItemTemplate>
                    <%#Gettype(DataBinder.Eval(Container.DataItem, "Ctype").ToString())%>       
            ...
            <asp:TemplateField HeaderText="调用代码">
                ...
                <ItemTemplate>
                <%#GetCode(DataBinder.Eval(Container.DataItem, "C_Nid").ToString(),DataBinder.Eval(Container.DataItem, "Ctype").ToString())%>                 
                </ItemTemplate>
            </asp:TemplateField>
