<%@ page language="C#" autoeventwireup="true" inherits="manage_CallStat_CodeReference, App_Web_nlgsezto" enableEventValidation="false" viewStateEncryptionMode="Never" %>
<!DOCTYPE HTML>
<html>
<head runat="server">
<title>统计代码</title>
...
<form id="form1" runat="server">
    ...
    <div>
        <table width="100%" cellpadding="0" cellspacing="0" border="0" class="border">
            ...
            <tr>
                <td align="left" style="width: 30%; white-space: normal;">
            ...
            <td align="center" style="height: 109px">
                <asp:TextBox ID="TextBox1" class="l_input" runat="server" Height="50px" Width="595px" TextMode="MultiLine"
                    Text="<script src='/CounterLink.aspx?style=simple'></script>"></asp:TextBox>
            </td>
            <tr class="tdbg">
                <td style="white-space: normal; width: 30%; height: 69px;" class="tdbgleft">
                    <strong>仅获取系统主域名(IP)访问来源统计代码：</strong><br />
                    本方法仅统计[系统配置]-[网站信息配置]－[网站地址]中绑定的系统主域名访问来源数据，请将此代码拷贝到您需要做统计的页面，此代码不仅用于向放置了此代码的页面输出统计数据，而且还对该页面计数，用户可根据需要自行调用。
                </td>
            </tr>
            <tr>
            </tr>
            <td align="center" style="height: 109px">
                <asp:TextBox ID="TextBox2" class="l_input" runat="server" Height="50px" Width="595px" TextMode="MultiLine"
                    Text="<script src='{$SiteURL/}/CounterLink.aspx?style=simple'></script>"></asp:TextBox></td>
            <%--<tr class="tdbg">
