<%@ page language="C#" autoeventwireup="true" inherits="ZoomLa.WebSite.Manage.index, App_Web_g5gl3ftj" enableEventValidation="false" viewStateEncryptionMode="Never" %>
<!DOCTYPE HTML>
<html>
<head runat="server">
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                <td  style="height:24px;font-size: 12px">
                                                    ...
                                                    <input id="c2" type="checkbox" checked="checked" />内容管理1
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                <td style="height:24px;font-size: 12px">
                                                    ...
                                                    <input id="ss3" name="Shop" type="checkbox" checked="checked" />购物订单
                                                    ...
                                                    <input id="ss14" name="Shop" type="checkbox" checked="checked" />返利管理
                                                </td>
                                            </tr>
                                        </tbody>
                                        <tbody>
  ...
  <tbody>
    <tr>
      <td colspan="3" valign="top" align="left"  >
               ...
               <div id="Announce">
               <img src="<%Call.Label("{$LogoAdmin/}");%>" alt="<%Call.Label("{$SiteName/}");%>_后台管理系统" class="logoAdmin" />
                <p>
                ...
                <%= SiteCon%>
                <a href="?ShowConfig=true" title="场景切换">场景切换</a>
                <a href="javascript:void(0)" onclick="OpenNewWin('http://help.zoomla.cn')" title="在线帮助">在线帮助</a>
                <a href="SignOut.aspx" target="_top" title="安全退出">安全退出</a>
                <a href="../user/" target="_blank" title='ALT+U进入会员中心'><img src="../App_Themes/AdminDefaultTheme/images/manage_user.jpg" alt="ALT+U进入会员中心"  style="vertical-align: middle;" /></a>
                <a href="javascript:void(0)" style="cursor: pointer;" title='Alt+Q锁定屏幕' onclick="showWindow(900,460);"><img alt="" src="../App_Themes/AdminDefaultTheme/images/lock_closed.jpg" style="vertical-align: middle;" /></a>
                </p>
               </div>        
          <div id="content">
          <ul id="ChannelMenuItems" >
                        ...
                        <%
                            ...
                            {    
                        %>
                        <li id="Main_1" class="Main_2" onclick="ShowHideLayer(1,0);"><a id="AChannelMenu_Menu0"><span id="SpanChannelMenu_Menu0">我的工作台</span></a></li>
                        <%
                            }
                            ...
                            {
                        %>
                        <li id="Main_2" class="Main_1" onclick="ShowHideLayer(2,0)"><a id="AChannelMenu_Menu1"><span id="SpanChannelMenu_Menu1">内容管理</span></a></li>
                        <%
                            }
                            ...
                            {
                        %>
                        <li id="Main_4" class="Main_1" onclick="ShowHideLayer(4,0)"><a id="AChannelMenu_Menu1"><span id="SpanChannelMenu_Menu1">商城管理</span></a></li>
                        <%
                            }
                            ...
                            {
                        %>
                        <li id="Main_6" class="Main_1" onclick="ShowHideLayer(6,0)"><a id="AChannelMenu_Menu1"><span id="SpanChannelMenu_Menu1">企业黄页</span></a></li>
                        <%   
                            }
                            ...
                            {
                        %>
                        <li id="Main_13" class="Main_1" onclick="ShowHideLayer(13,0)"><a id="AChannelMenu_Menu1"><span id="SpanChannelMenu_Menu1">教育模块</span></a></li>
                        <%}
                            if (ShowUser == 1)
                            {
                        %>
                        <li id="Main_3" class="Main_1" onclick="ShowHideLayer(3,0)"><a id="AChannelMenu_Menu1"><span id="SpanChannelMenu_Menu1">用户管理</span></a></li>
                        <%
                            }
                            ...
                            {
                        %>
                        <li id="Main_9" class="Main_1" onclick="ShowHideLayer(9,0)"><a id="AChannelMenu_Menu1"><span id="SpanChannelMenu_Menu1">扩展功能</span></a></li>
                        <%
                            }

                            if (Showsys == 1)    
                        %>
                        <li id="Main_8" class="Main_1" onclick="ShowHideLayer(8,0)"><a id="AChannelMenu_Menu1"><span id="SpanChannelMenu_Menu1">系统配置</span></a></li>
                        <%
                            if (showtype == "All")
                            {
                        %>
                        ...
                        <%
                            ...
                            {
                        %>
                        <li id="Main_5" class="Main_1" onclick="ShowHideLayer(5,0)"><a id="AChannelMenu_Menu1"><span id="SpanChannelMenu_Menu1"><%=UC_BIs%></span></a></li>
                        <%} %>
          </ul>
          </div> 
                    <div id="SubMenu" >
                        ...
                        <div id="Menu_1" style="width: 100%;">
                            <ul>
                                <li><a href="javascript:ShowMain('Profile/QuickLinks.aspx','Profile/Worktable.aspx')">工作台首页</a></li>
                                <li><a href="javascript:ShowMain('Search/SearchGuide2.aspx','Search/SearchFunc.aspx')">便捷导航</a></li>
                                <li><a href="javascript:ShowMain('','Profile/ModifyPassword.aspx')">修改密码</a></li>
                                <li><a href="SignOut.aspx"><span class="SignOut">安全退出</span></a></li>
                                <li style=" display:none;"><a href="javascript:ShowMain('','MessageBoard.aspx')">站长留言</a></li>
                                <li style="float: right; background-image: none">
                                 ...
                                 <div style="float: left">
                                    ...
                                    <div style="float: left;">
                                        <select style="margin-top: 1px" id="souchoption" name="souchoption"></select>
                                    </div>
                                    <div style="float: left;">
                                        <input type="text" id="keyword" name="keyword" title="功能搜索" /><input type="submit"  value="搜 索" class="sbtn" />
                                    </div>
                                    </form>
                                </li>
                            </ul>
                        ...
                        <div id="Menu_2" style="width: 100%; display: none;">
                            <ul>
                                <%if (showContentArr[0].ToString() == "1")
                                  { %>
                                <li><a href="javascript:ShowMain('Content/NodeTree.aspx','Content/ContentManage.aspx')">按栏目管理</a></li>
                                <%}
                                  if (showContentArr[1].ToString() == "1")
                                  {%>
                                <li><a href="javascript:ShowMain('Content/SpecTree.aspx','Content/SpecContent.aspx')">按专题管理</a></li>
                                <%
                                    }       
                                %>
                                <%=sitetype%>
                                <%if (showContentArr[2].ToString() == "1")
                                  { %>
                                <li><a href="javascript:ShowMain('Content/NodeTree.aspx?t=1','Content/CommentManage.aspx')">评论管理</a></li>
                                <%}
                                  if (showContentArr[4].ToString() == "1")
                                  { %> <li><a href="javascript:void(0);" onclick="ShowMain('Pub/PubGuide.aspx','Pub/pubmanage.aspx')" onmouseover="showmenu(event,'<div class=menuitems><a onclick=open_title(\'pub/pubinfo.aspx\',\'添加互动模块\') href=\'javascript:void(0)\' >添加互动模块</a></div><div class=menuitems><a onclick=open_title(\'pub/pubmanage.aspx\',\'互动模块管理\') href=\'javascript:void(0)\'>互动模块管理</a></div><div class=menuitems><a onclick=open_title(\'pub/pubmanage.aspx\',\'互动信息管理\') href=\'javascript:void(0)\'>互动信息管理</a></div><div class=menuitems><a onclick=open_title(\'pub/pubModel.aspx\',\'互动模型管理\') href=\'javascript:void(0)\'>互动<font color=red>模型</font>管理</a></div><div class=menuitems><a onclick=open_title(\'pub/PubRecycler.aspx\',\'存档管理\') href=\'javascript:void(0)\'>存档管理</a></div>')"> 互动模块</a> </li> <%
                                    }
                                  if (showContentArr[5].ToString() == "1")
                                  { %>
                                <li><a href="javascript:ShowMain('Content/CollectionGuide.aspx','Content/CollectionManage.aspx')"
                                    onmouseover="showmenu(event,'<div class=menuitems><a href=\'javascript:void(0)\' onclick=open_title(\'Content/CollectionManage.aspx\')>采集项目管理</a></div><div class=menuitems><a href=\'javascript:void(0)\' onclick=open_title(\'Content/CollectionStep1.aspx\')>添加采集项目</a></div><div class=menuitems><a href=\'javascript:void(0)\' onclick=open_title(\'Content/CollectionStart.aspx\')>开始采集</a></div><div class=menuitems><a href=\'javascript:void(0)\'>采集进度</a></div><div class=menuitems><a href=\'javascript:void(0)\' onclick=open_title(\'Content/CollectionList.aspx\')>采集历史记录</a></div>')">
                                    信息采集</a> </li>
                                <%
                                    }
                                  if (showContentArr[6].ToString() == "1")
                                  { %>
                                <li><a href="javascript:ShowMain('Content/Print_Server.aspx','Content/Print_Type.aspx')">打印输出</a></li>
                                <%
                                    }
                                  if (showContentArr[7].ToString() == "1")
                                  { %>
                                  <li><a href="javascript:ShowMain('Content/CreateLink.aspx','Content/CreateHtmlContent.aspx')">生成发布</a></li>
                                <%}
                                  if (showContentArr[3].ToString() == "1")
                                  {  
                                %>
								<li><a href="javascript:ShowMain('Content/NodeTree.aspx?t=2','Content/ContentRecycle.aspx')">回收站</a></li>
                                <%}
                                  if (showContentArr[8].ToString() == "1")
                                  { %>
                                <li><a href="javascript:ShowMain('AddOn/OthersGuide.aspx','AddOn/SourceManage.aspx')">内容参数</a></li>
                                <%}
                                  if (showContentArr[8].ToString() == "1")
                                  { %>
                                <li><a href="javascript:ShowMain('Content/HitsGuide.aspx','Content/HitsList.aspx')">访问评价</a></li>
                                <%}
                                  if (ShowPlubArr[4].ToString() == "1")
                                  { %>
                                <li><a href="javascript:ShowMain('GuestBook/BbsGuide.aspx','GuestBook/GuestCateMana.aspx')">留言管理</a></li>
                                <%}
                                  if (showContentArr[9].ToString() == "1")
                                  {%>
                                <li><a href="javascript:void(0);" onclick="ShowHideLayer(12,0)" style="font-weight: bold">WAP管理</a></li>
                                <%}
                        ...
                        <div id="Menu_12" style="width: 100%; display: none;">
                            <ul>
                                <li><a href="javascript:ShowMain('WAP/WapTree.aspx?t=0','WAP/manageOrder.aspx?nodeid=0')">WAP栏目排版设置</a></li>
                                <li><a href="javascript:ShowMain('WAP/WapTree.aspx?t=1','WAP/WapArticleManage.aspx?nodeid=0')">WAP信息添加</a></li>
                                <li><a href="javascript:ShowMain('WAP/WapConfig.aspx','WAP/WapNodeManage.aspx')">WAP添加栏目</a></li>
                                <li><a href="javascript:ShowMain('WAP/Other/WapForumGuide.aspx','WAP/Other/WapForum_Class.aspx')">其他信息</a></li>
                                <li><a href="javascript:void(0);" onclick="ShowHideLayer(2,0)" style="font-weight: bold">返回菜单</a> </li>
                            </ul>
                        </div>
                        <!-- 用户社区 -->
                        <div id="Menu_3" style=" display: none;">
                            <ul>
                                <%
                                    ...
                                    { %>
                                <li><a href="javascript:ShowMain('User/UserGuide.aspx','User/UserManage.aspx')">会员管理</a></li>
                                <%
                                    }
                                    if (ShowUserArr[1].ToString() == "1")
                                    { 
                                %>
                                <li><a href="javascript:ShowMain('User/AdminLink.aspx','User/AdminManage.aspx')">管理员管理</a></li>
                                <%}
                                    if (ShowUserArr[2].ToString() == "1")
                                    { %>
                              <li><a href="javascript:ShowMain('User/PermissionGuide.aspx','User/PermissionInfo.aspx') "> 用户角色</a></li>
                                <% 
                                    } if (ShowUserArr[3].ToString() == "1")
                                    {%>
                                <li><a href="javascript:ShowMain('User/MessageLink.aspx','User/Message.aspx')">信息发送</a> </li>
                                <%}
                                    if (ShowUserArr[4].ToString() == "1")
                                    { %><li><a href="javascript:void(0);" onclick="ShowMain('User/MailGuide.aspx','User/RegValidateMail.aspx')" onmouseover="showmenu(event,'<div class=menuitems><a href=\'javascript:void(0)\' onclick=open_title(\'User/EidtMailModel.aspx  \')>邮件模板编辑</a></div><div class=menuitems><a href=\'javascript:void(0)\' onclick=open_title(\'User/RegValidateMail.aspx\')>邮件内容管理</a></div><div class=menuitems><a href=\'javascript:void(0)\' onclick=open_title(\'User/SendMailList.aspx\')>发送邮件管理</a></div><div class=menuitems><a href=\'javascript:void(0)\' onclick=open_title(\'User/MailListManage.aspx\')>邮件列表管理</a></div><div class=menuitems><a href=\'javascript:void(0)\' onclick=open_title(\'User/SubscribeTypeList.aspx\')>订阅管理</a></div><div class=menuitems><a href=\'javascript:void(0)\' onclick=open_title(\'User/AddMail.aspx\')>邮件发送</a></div><div class=menuitems><a href=\'javascript:ShowMain(\'User/MailIdiographList.aspx\')>签名管理</a></div>')">订阅中心</a></li><%}
                                    if (ShowUserArr[5].ToString() == "1")
                                    {  %>
                                <li><a href="javascript:ShowMain('User/JobsGuide.aspx','User/UserModelManage.aspx')">人才招聘</a> </li>
                                <%}
                                    if (ShowUserArr[6].ToString() == "1")
                                    {  %>
                                <li><a href="javascript:ShowMain('zone/ModelGuide.aspx','zone/zoneManage.aspx')">社区(SNS)模块</a> </li>
                                <%}
                                if (ShowUserArr[7].ToString() == "1")
                                {  %>
                                <li><a href="javascript:ShowMain('Microblog/MircGuide.aspx','Microblog/MbUser.aspx')">微博管理</a> </li>
                                <%}
                                if (ShowUserArr[8].ToString() == "1")
                                {  %>
                                <li><a href="javascript:ShowMain('3Dmanage/InfoGuid.aspx','3Dmanage/Infomanage.aspx')">3D地带</a> </li>
                                <%}
                                if (ShowUserArr[9].ToString() == "1")
                                {  %>
                                <li><a href="javascript:ShowMain('../CN/nite/Content/NiteGuide.aspx','../CN/nite/Content/NiteHouse.aspx')">Nite视频面试管理</a></li>
                                <%}
                                if (ShowUserArr[10].ToString() == "1")
                                {  %>
                                <li><a href="javascript:ShowMain('User/PersonsVideoGuide.aspx','User/VideoRoom.aspx')">多人视频管理</a></li>
                                <%}
                                %>
                        ...
                        <div id="Menu_4" style="width: 100%; display: none;">
                            <ul>
                                <%
                                    ...
                                    { %>
                                <li><a href="javascript:ShowMain('Shop/ShopNodeTree.aspx','Shop/ProductManage.aspx')">商品管理</a></li>
                                <%}
                                    if (ShowShopArr[1].ToString() == "1")
                                    {%>
                                <li><a href="javascript:ShowMain('Shop/StockGuid.aspx','Shop/StockManage.aspx')">库存管理</a></li>
                                <%}
                                    if (ShowShopArr[3].ToString() == "1")
                                    { %>
                                <li><a href="javascript:ShowMain('Shop/OrderLink.aspx','Shop/OrderList.aspx')">购物订单</a> </li>
                                <%}
                                    if (ShowShopArr[4].ToString() == "1")
                                    { %>
                                <li><a href="javascript:ShowMain('Shop/ListGuide.aspx','Shop/BankRollList.aspx')">明细记录</a> </li>
                                <%}
                                    if (ShowShopArr[5].ToString() == "1")
                                    { %>
                                <li><a href="javascript:ShowMain('Shop/StatisticLink.aspx','Shop/TotalSale.aspx')">销售统计</a> </li>
                                <%}
                                if (ShowShopArr[6].ToString() == "1")
                                { %>
                                <li><a href="javascript:ShowMain('Shop/PromotionGuide.aspx','Shop/PresentProject.aspx')">促销优惠</a> </li>
                                <%}
                                if (ShowShopArr[8].ToString() == "1")
                                { %>
                                <li><a href="javascript:ShowMain('Shop/ConfigGuide.aspx','Shop/DeliverType.aspx')">商城配置</a> </li>
                                <%}
                                if (ShowShopArr[9].ToString() == "1")
                                 { %>
                                <li><a href="javascript:ShowMain('Shop/ConfigGuide.aspx','boss/Bosstree.aspx')">加盟商管理</a> </li>
                                <%}
								if (ShowShopArr[10].ToString() == "1")
								{ %>
                                <li><a href="javascript:ShowMain('Shop/RecyclerNodeTree.aspx','Shop/ShopRecycler.aspx')">商品回收站</a> </li>
                                <%}
								if (ShowShopArr[12].ToString() == "1")
								{ %>
                                <li><a href="javascript:ShowMain('Flex/FlexGuide.aspx','Flex/ClassManage.aspx')">礼品管理</a></li>
                                <%}
								if (ShowShopArr[13].ToString() == "1")
								{ %>
                                <li><a href="javascript:ShowMain('Shop/BidManage/CompleteGuid.aspx','Shop/BidManage/BidComplete_Manage.aspx')">竞拍管理</a></li>
                                <%}
								if (ShowShopArr[14].ToString() == "1")
								{ %>
                                <li><a href="javascript:ShowMain('Shop/profile/ProfileGuide.aspx','Shop/profile/ProfileManage.aspx')">返利管理</a></li>
                                 <%}
								if (ShowShopArr[11].ToString() == "1")
								{ %>
                                <li><a href="javascript:void(0);" onclick="ShowHideLayer(11,4)" onmouseover="showmenu(event,'<div class=menuitems><a href=javascript:void(0) onclick=open_title(\'UserShopManage/ApplyStyle.aspx\')>店铺申请设置</a></div><div class=menuitems><a href=javascript:void(0) onclick=open_title(\'UserShopManage/StoreManage.aspx\')>商家店铺管理</a></div><div class=menuitems><a href=javascript:void(0) onclick=open_title(\'UserShopManage/StoreStyleManage.aspx\')>商家店铺模板管理</a></div><div class=menuitems><a href=javascript:void(0) onclick=open_title(\'UserShopManage/ProductManage.aspx\')>商家商品管理</a></div><div class=menuitems><a href=javascript:void(0) onclick=open_title(\'UserShopManage/ManageModel.aspx\')>店铺模型管理</a></div><div class=menuitems><a href=javascript:void(0) onclick=open_title(\'UserShopManage/ShopinfoManage.aspx\')>店铺配置</a></div>')"
                        ...
                        <div id="Menu_7" style="width: 100%; display: none;">
                            <ul>
                                <li><a href="javascript:ShowMain('3Dmanage/InfoGuid.aspx','3Dmanage/Infomanage.aspx')">参数配置</a></li>
                                <li><a href="javascript:ShowMain('3Dmanage/AfficheGuid.aspx','3Dmanage/Affiche.aspx')">公告管理</a> </li>
                                <li><a href="javascript:ShowMain('3Dmanage/UserGuid.aspx','3Dmanage/UserManage.aspx')">用户社区</a></li>
                                <li><a href="javascript:ShowMain('3Dmanage/boothGuide.aspx','3Dmanage/boothManage.aspx')">摊位管理</a></li>
                                <li><a href="javascript:ShowMain('3Dmanage/SceneGuide.aspx','3Dmanage/SceneManage.aspx')">场景管理</a> </li>
                                <li><a href="javascript:ShowMain('3Dmanage/WareGuide.aspx','3Dmanage/Waremanage.aspx')">商品管理</a></li>
                                <li><a href="javascript:void(0);" onclick="ShowHideLayer(3,0);ShowMainsgourl('User/AdminLink.aspx','User/AdminManage.aspx')">返回菜单</a></li>
                            </ul>
                        </div>
                        <!-- SiteServer -->
                        <div id="Menu_10" style="width: 100%; display: none;">
                            <ul>
                                <li><a href="javascript:ShowMain('SiteServer/ServerGuid.aspx','SiteServer/APIConfig.aspx')">主站配置管理</a> </li>
                                <li><a href="javascript:ShowMain('SiteServer/ClinetGuid.aspx','SiteServer/SitesManage.aspx')">子站管理</a></li>
                                <li><a href="javascript:ShowMain('SiteServer/FGuide.aspx','SiteServer/FManage.aspx')">共享池管理</a> </li>
                                <li><a href="javascript:ShowMain('SiteServer/FinanceGuide.aspx','SiteServer/Todaydetail.aspx')">财务管理</a></li>
                                <li><a href="javascript:ShowMain('SiteServer/LogGuid.aspx','SiteServer/LogManage.aspx')">日志管理</a> </li>
                            </ul>
                        </div>
                        <!-- 项目管理 -->
                        <div id="Menu_5" style="width: 100%; display: none;">
                            <ul>
                                <%if (ShowBIArr[0].ToString() == "1")
                                  { %>
                                <li><a href="javascript:ShowMain('AddOn/ProjectGuide.aspx','AddOn/ManageProjects.aspx')">项目管理</a></li>
                                <%}
                                  if (ShowBIArr[1].ToString() == "1")
                                  { %>
                                <li><a href="javascript:ShowMain('AddCRM/Customer.aspx','AddCRM/CustomerList.aspx?usertype=0')">CRM管理</a></li>
                                <%}
                                  if (ShowBIArr[2].ToString() == "1")
                                  { %>
                                <li><a href="javascript:ShowMain('iServer/ServerSite.aspx','iServer/BiServer.aspx?num=-3&strTitle=')">有问必答</a></li>
                                <%}
                                  if (ShowBIArr[3].ToString() == "1")
                                  { %>
                                <li><a href="javascript:ShowMain('SelectNum/Sconfig.aspx','SelectNum/NumManage.aspx')">选号系统</a></li>
                                <%}

                                  if (ShowBIArr[4].ToString() == "1")
                                  { %>
                                <li><a href="javascript:ShowMain('User/CustomerGuide.aspx','User/ServiceSeat.aspx')"
                                    onmouseover="showmenu(event,'<div class=menuitems><a href=\'javascript:void(0);\' onclick=ShowMain(\'User/CustomerGuide.aspx\',\'User/ServiceSeat.aspx\')>客服管理</a></div><div class=menuitems><a href=\'javascript:void(0)\' onclick=\'open_title();\'>开启客服</a></div>')">
                                    客服通</a></li>
                                <%} %>
                            </ul>
                        </div>
                        ...
                        <div id="Menu_6" style="width: 100%; display: none;">
                            <ul>
                                <%
                                    ...
                                    { %>
                                <li><a href="javascript:ShowMain('page/PageregGuide.aspx','page/UserModelManage.aspx')">黄页申请设置</a></li>
                                <%}
                                    if (ShowPageArr[1].ToString() == "1")
                                    {  %>
                                <li><a href="javascript:ShowMain('page/PageGuide.aspx','page/PageManage.aspx')">黄页审核与管理</a></li>
                                <%}
                                    if (ShowPageArr[2].ToString() == "1")
                                    {  %>
                                <li><a href="javascript:ShowMain('page/CorporationGuide.aspx','page/PageAudit.aspx')">黄页用户栏目管理</a></li>
                                <%}
                                    if (ShowPageArr[3].ToString() == "1")
                                    {  %>
                                <li><a href="javascript:ShowMain('page/NodeTree.aspx','page/PageContent.aspx')">黄页内容管理</a></li>
                                <%} if (ShowPageArr[4].ToString() == "1")
                                    {  %>
                                <li><a href="javascript:ShowMain('page/ModelGuide.aspx','page/PageModelManage.aspx')">黄页模型管理</a></li>
                                <%}
                                    if (ShowPageArr[5].ToString() == "1")
                                    {  %>
                                <li><a href="javascript:ShowMain('page/PageStyleGuide.aspx','page/PageStyle.aspx')">黄页样式管理</a></li>
                                <%}
                                    if (ShowPageArr[6].ToString() == "1")
                                    {  %>
                                <li><a href="javascript:ShowMain('page/StyleGuide.aspx','page/StyleManage.aspx')">黄页风格管理</a></li>
                                <%}
                                    if (ShowPageArr[6].ToString() == "1")
                                    {  %>
                                <li><a href="javascript:ShowMain('page/SheetStyleGuide.aspx','page/SheetStyleManage.aspx')">黄页标签管理</a></li>
                                <%} %>
                        ...
                        <div id="Menu_13" style="width: 100%; display: none;">
                            <ul>
                                <%if (ShowForumArr[1].ToString() == "1")
                                  { %>
                                <li><a href="javascript:ShowMain('Exam/QuestionGuide.aspx','Exam/QuestionManage.aspx')">考试管理</a></li>
                                <%}
                                    
                                  if (ShowForumArr[6].ToString() == "1")
                                  {  %>
                                <li><a href="javascript:ShowMain('Exam/AttendanceGuide.aspx','Exam/ToScore.aspx')">阅卷中心</a></li>
                                <%}
                                    
                                  if (ShowForumArr[2].ToString() == "1")
                                  {  %>
                                <li><a href="javascript:ShowMain('Exam/ClassGuide.aspx','Exam/ClassManage.aspx')">班级管理</a></li>
                                <%}
                                  if (ShowForumArr[3].ToString() == "1")
                                  {  %>
                                <li><a href="javascript:ShowMain('Exam/TrainGuide.aspx','Exam/Audit.aspx')">学员管理</a></li>
                                <%}
                                  if (ShowForumArr[4].ToString() == "1")
                                  {  %>
                                <li><a href="javascript:ShowMain('Exam/ResourceLibaryGuide.aspx','Exam/ExTeacherManage.aspx')">培训资源库</a></li>
                                <%}
                                  if (ShowForumArr[5].ToString() == "1")
                                  {  %>
                                <li><a href="javascript:ShowMain('Exam/FinanceGuide.aspx','Exam/FinanceManage.aspx')">财务管理</a></li>
                                <%}

                                  if (ShowForumArr[0].ToString() == "1")
                                  { %>
                                <li><a href="javascript:ShowMain('Question/QuestionGuide.aspx','Question/QuestionManage.aspx')">组卷管理</a></li>
                                <%}%>
                            </ul>
                        </div>
                        <!-- 店铺管理 -->
                        <div id="Menu_11" style="width: 100%; display: none;">
                            <ul>
                                <li><a href="javascript:ShowMain('UserShopManage/ApplySetTree.aspx','UserShopManage/ApplyStyle.aspx')">店铺申请设置</a> </li>
                                <li><a href="javascript:ShowMain('UserShopManage/StoreTree.aspx','UserShopManage/StoreManage.aspx')">商家店铺管理</a> </li>
                                <li><a href="javascript:ShowMain('UserShopManage/StoreStyleTree.aspx','UserShopManage/StoreStyleManage.aspx')">商家店铺模板管理</a> </li>
                                <li><a href="javascript:ShowMain('UserShopManage/ShopNodeTree.aspx','UserShopManage/ProductManage.aspx')">商家商品管理</a> </li>
                                <li><a href="javascript:ShowMain('UserShopManage/TreeModel.aspx','UserShopManage/ManageModel.aspx')">店铺模型管理</a> </li>
                                <li><a href="javascript:ShowMain('UserShopManage/UspManageGuide.aspx','UserShopManage/ShopinfoManage.aspx')">店铺配置</a> </li>
                                <li><a href="javascript:void(0);" onclick="ShowHideLayer(4,0)" style="font-weight: bold">返回菜单</a> </li>
                            </ul>
                        </div>
                        <!-- 系统配置 -->
                        <div id="Menu_8" style="width: 100%; display: none;">
                            <ul>
                                ...
                                <%}
                                    ...
                                    {  %>
                                <li><a href="javascript:ShowMain('Content/ModelGuide.aspx','Content/ModelManage.aspx')">
                                    模型管理</a></li>
                                <%}
                                    if (ShowsysArr[2].ToString() == "1")
                                    {  %>
                                <li><a href="javascript:void(0);" onclick="ShowMain('Content/SetNodeTree.aspx','Content/NodeManage.aspx')">
                                    节点管理</a></li>
                                <%}
                                    if (ShowsysArr[3].ToString() == "1")
                                    {  %>
                                <li><a href="javascript:void(0);" onclick="ShowMain('Content/AuditingLink.aspx','Content/AuditingState.aspx')">
                                    工作流配置</a></li>
                                <%}
                                    if (ShowsysArr[4].ToString() == "1")
                                    {  %>
                                <li><a href="javascript:void(0);" onclick="ShowMain('Content/FlowLink.aspx?type=1','Content/FlowManager.aspx')">
                                    流程管理</a></li>
                                <%}
                                    if (ShowsysArr[5].ToString() == "1")
                                    {  %>
                                <li><a href="javascript:void(0);" onclick="ShowMain('Content/SpecLink.aspx','Content/SpecialManage.aspx')">
                                    专题管理</a></li>
                                <%}
                                if (ShowsysArr[6].ToString() == "1")
                                {  %>
                                <li><a href="javascript:void(0);" onclick="ShowMain('Template/TemplateLink.aspx','Template/TemplateSet.aspx')">模板风格</a></li>
                                <%}
                                 if (ShowsysArr[7].ToString() == "1")
                                        {  %>
                                <li><a href="javascript:void(0);" onclick="ShowMain('Template/TemplateLink.aspx','Template/LabelManage.aspx')">标签管理</a></li>
                                <%}
                                  if (ShowsysArr[8].ToString() == "1")
                                        {  %>
                                <li><a href="javascript:void(0);" onclick="ShowMain('AddOn/PayPlatLink.aspx','AddOn/PayPlatManage.aspx')">在线支付平台</a></li>
                                <%} %>
                            </ul>
                        </div>
                        <!-- 附件管理 -->
                        <div id="Menu_9" style="width: 100%; display: none;">
                            <ul>
                                <%if (ShowPlubArr[0].ToString() == "1")
                                  {  %>
                                <li><a href="javascript:void(0);" onclick="ShowMain('Plus/ADGuide.aspx','Plus/ADZoneManage.aspx')">广告管理</a></li>
                                <%}
                                  if (ShowPlubArr[1].ToString() == "1")
                                  { %>
                                <li><a href="javascript:void(0);" onclick="ShowMain('Counter/PageLeft.aspx','Counter/Counter.aspx')">访问统计</a></li>
                                <%}
                                  if (ShowPlubArr[2].ToString() == "1")
                                  { %>
                                <li><a href="javascript:void(0);" onclick="ShowMain('Plus/LogGuide.aspx','Plus/LogManage.aspx')">日志管理</a></li>
                                <%}
                                  if (ShowPlubArr[3].ToString() == "1")
                                  { %>
                                <li><a href="javascript:void(0);" onclick="ShowMain('Plus/SurveyGuide.aspx','Plus/SurveyManage.aspx')">问卷调查和投票</a></li>
                                <%}
                                  if (ShowPlubArr[5].ToString() == "1")
                                  { %>
                                <li><a href="javascript:void(0);" onclick="ShowMain('File/FileGuide.aspx','File/UploadFile.aspx')">文件管理</a></li>
                                <%}
                                  if (ShowPlubArr[6].ToString() == "1")
                                  { %>
                                <li><a href="javascript:void(0);" onclick="ShowMain('AddOn/DictionaryGuide.aspx','AddOn/DictionaryManage.aspx')">数据字典</a></li>
                                <%}
                                  if (ShowPlubArr[7].ToString() == "1")
                                  { %>
                                <li><a href="javascript:void(0);" onclick="ShowMain('File/Addlinkname.aspx','File/Addlinkhttp.aspx')">站内链接</a></li>
                                <%}
                                  if (ShowPlubArr[7].ToString() == "1")
                                  { %>
                                <li><a href="javascript:void(0);" onclick="ShowMain('AddOn/DataGuide.aspx','Config/RunSql.aspx')">数据维护</a></li>
                                <%}
                                  if (ShowPlubArr[8].ToString() == "1")
                                  { %>
                                <li><a href="javascript:void(0);" onclick="ShowMain('Pub/PubGuide.aspx','Pub/pubmanage.aspx')"
                                    onmouseover="showmenu(event,'<div class=menuitems><a href=\'javascript:void(0);\' onclick=ShowMain(\'Iplook/IplookGuide.aspx\',\'Iplook/IPManage.aspx\') >IP识别系统</a></div><div class=menuitems><a href=\'javascript:void(0);\' onclick=ShowMain(\'Search/SearchGuide.aspx\',\'Search/DirectoryManage.aspx\')>全文检索</a></div><div class=menuitems><a href=\'javascript:void(0);\' onclick=ShowMain(\'AddOn/FileseeGuide.aspx\',\'AddOn/FileseeManage.aspx\')>文件比较</a></div>')">
                                    其它功能</a> </li>
                                <%} %>
    ...
    <tr style="vertical-align: top">
      <td id="frmTitle" align="left"   style="width:195px; background:#CFE8FE;"><iframe id="left" style="z-index: 2; visibility: inherit; width: 195px;height:800px; " name="left" src="Profile/QuickLinks.aspx" frameborder="0" tabid="1"></iframe>
     </td>
      <td class="but" onclick="switchSysBar();" style="width:12px" align="left"><img id="switchPoint" style="border-right: 0px; border-top: 0px; border-left: 0px;width: 12px; border-bottom: 0px" alt="关闭左栏" src="/images/butClose.gif" /></td>
      ...
      <div id="FrameTabs" style="overflow: hidden; width:100%;">
          ...
          <div class="tab-strip-wrap" >
            <ul class="tab-strip" style="float: left">
              <li class="current" id="iFrameTab1"><a href="javascript:"><span id="frameTabTitle">我的工作台</span></a><a class="closeTab"><img alt="" src="/images/tab-close.gif" style="border:0;"/></a> </li>
        ...
        <div id="main_right_frame">
          <iframe id="main_right" style="z-index: 2; visibility: inherit; overflow-x: hidden; width:100%;"  height="100%" name="main_right" src="Profile/Worktable.aspx" frameborder="0" scrolling="yes" onload="SetTabTitle(this)" tabid="1"></iframe>
...
<div id="iframeGuideTemplate" style="display: none">
  <iframe style="z-index: 2; visibility: inherit; width: 195px; height:800px;  " src="about:blank"  frameborder="0" tabid="0"></iframe>
</div>
<div id="iframeMainTemplate" style="display: none">
  <iframe style="z-index: 2; visibility: inherit; overflow-x: hidden; width: 100%;height:800px;" src="about:blank" frameborder="0" scrolling="yes" onload="SetTabTitle(this)" tabid="0"></iframe>
</div>
...
<!--这里是实际输出层 -->
<div style="position: absolute; left: 0px; top: 0px; z-index: 1; text-align:center;" id="infoDiv"></div>
<div style="position: absolute; display: none; left: 0px; top: 0px; z-index: 0" id="tranDiv" class="insbox">
