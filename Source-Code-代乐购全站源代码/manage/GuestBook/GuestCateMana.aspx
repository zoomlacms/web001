<%@ page language="C#" autoeventwireup="true" inherits="ZoomLa.WebSite.Manage.Plus.GuestCateMana, App_Web_v0xs0ycl" enableEventValidation="false" viewStateEncryptionMode="Never" %>

<!DOCTYPE HTML>
<html>
<head runat="server">
    <title>论坛留言分类管理</title>
...
<body>
    ...
    <div class="r_navigation">
        ...
        <span>后台管理</span>&gt;&gt;<span>留言管理</span> &gt;&gt;<span>留言分类管理</span>
        <div style="float: right; padding-right: 10px;">
            分类名：<asp:TextBox ID="txtCateName" class="l_input" runat="server" Width="150px"></asp:TextBox><asp:RequiredFieldValidator
                ID="RequiredFieldValidator1" runat="server" ErrorMessage="必填项" ControlToValidate="txtCateName"></asp:RequiredFieldValidator>
            是否开放匿名留言：<asp:DropDownList ID="NeedLog" runat="server">
                <asp:ListItem Value="0">是</asp:ListItem>
                <asp:ListItem Value="1">否</asp:ListItem>
            </asp:DropDownList>
            &nbsp;<asp:Button ID="addCate" class="C_input" runat="server" Text="添加分类" OnClick="addCate_Click" /></div>
    </div>
    <div class="clearbox">
    </div>
