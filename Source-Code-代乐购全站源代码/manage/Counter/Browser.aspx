<%@ page language="C#" autoeventwireup="true" inherits="manage_Counter_Browser, App_Web_xlmayt0p" enableEventValidation="false" viewStateEncryptionMode="Never" %>
<!DOCTYPE html>
<html>
<head runat="server">
<title>浏览器统计报表</title>
...
<div class="r_navigation" >后台管理 &gt;&gt;扩展功能 &gt;&gt; <a href="Counter.aspx">访问统计</a> &gt;&gt; 浏览器统计报表</div>
        <table class="tables" cellspacing="0" cellpadding="2"   bgcolor="#ffffff" border="1">
            <tr class="title_link">
                <td class="title" style="height: 22px" colspan="2">
                    <a style="float:right;" href="counter.aspx">[返回]</a>
                    <font color="#333333">浏览器累计： </font>
                    <%=SumCount%>
                </td>
            </tr>
            <tr>
