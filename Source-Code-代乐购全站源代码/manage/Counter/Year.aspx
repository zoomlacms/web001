<%@ page language="C#" autoeventwireup="true" inherits="manage_Counter_Year, App_Web_xlmayt0p" enableEventValidation="false" viewStateEncryptionMode="Never" %>
<!DOCTYPE html>
<html>
<head runat="server">
<title>月统计报表</title>
            ...
            <tr class="title_link">
                <td class="title" style="height: 22px" colspan="2">
                 <a style="float:right;" href="counter.aspx">[返回]</a>
                    <font color="#333333">统计年份：<%=Cyear%>
                        本年累计：<%=SumCount%>
                    </font>[<a href="year.aspx">当前年</a>] [<a href="year.aspx?step=1">前一年</a>] [<a href="year.aspx?step=2">前两年</a>]
