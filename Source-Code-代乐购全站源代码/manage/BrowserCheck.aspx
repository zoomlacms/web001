<%@ page language="C#" autoeventwireup="true" inherits="manage_SystemCheck_, App_Web_g5gl3ftj" enableEventValidation="false" viewStateEncryptionMode="Never" %>
<!DOCTYPE HTML>
<html>
<head runat="server">
<title>浏览器检测</title>
...
<table style="width:100%"> 
    ...
    <tr class="tdbgleft"><td style="width:100px">本机Mac</td><td id="tdMac" runat="server"></td></tr>
</table>
<div><a href="http://www.zoomla.cn/help/web/1414.shtml" title="帮助提示" style="color:#1370b5;text-decoration:none;" target="_blank" >《如何设置cookie》</a>&nbsp;&nbsp;&nbsp;
<a href="http://www.zoomla.cn/help/web/1413.shtml" title="帮助提示" style="color:#1370b5;text-decoration:none;" target="_blank">《如何设置网页脚本》</a></div>
</div>
