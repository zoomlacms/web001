<%@ page language="C#" autoeventwireup="true" inherits="manage_Microblog_AddClass, App_Web_er5ey2ru" enableEventValidation="false" viewStateEncryptionMode="Never" %>
<!DOCTYPE HTML>
<html>
<head runat="server">
<title>添加分类</title>
...
<table width="100%" border="0" cellpadding="5" cellspacing="1" class="border">
    ...
    <tr class="tdbg" onmouseover="this.className='tdbgmouseover'" onmouseout="this.className='tdbg'">
        <td align="center" width="30%" class="tdbgleft"><strong>分类名：</strong></td>
