<%@ page language="C#" autoeventwireup="true" inherits="manage_Config_CitizenXmlConfig, App_Web_24osmk5a" enableEventValidation="false" viewStateEncryptionMode="Never" %>
<!DOCTYPE HTML>
<html>
<head runat="server">
...
<div class="r_navigation">	
	<span>后台管理</span>&gt;&gt;<span>附件管理</span> &gt;&gt;<a href="GradeCateManage.aspx">多级数据字典分类:</a><span
		style="color: Red"><asp:Label ID="lblCateName" runat="server" Text=""></asp:Label></span>&gt;&gt;<span><asp:Label ID="LblGradeLevel" runat="server" Text=""></asp:Label>选项列表</span>
</div>
...
<table class="border" cellspacing="1" cellpadding="0" width="100%" border="0" align="center">
	<tr class="tdbg" onmouseover="this.className='tdbgmouseover'" onmouseout="this.className='tdbg'">
		...
		<td>
			<asp:Label ID="LblCate" runat="server" Text="国省市三级联动"></asp:Label>
		</td>
	</tr>
	<tr class="tdbg" onmouseover="this.className='tdbgmouseover'" onmouseout="this.className='tdbg'">
		<td class="tdbgleft" style="width: 20%; height: 21px; text-align: right">
	...
	<tr class="tdbg" onmouseover="this.className='tdbgmouseover'" onmouseout="this.className='tdbg'">
		...
		<td>
			<asp:Label ID="LblPreGrade" runat="server" Text=""></asp:Label>
		</td>
	</tr>
	<tr class="tdbg" onmouseover="this.className='tdbgmouseover'" onmouseout="this.className='tdbg'">
		<td class="tdbgleft" style="width: 20%; height: 21px; text-align: right">
