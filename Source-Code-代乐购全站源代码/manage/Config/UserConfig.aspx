<%@ page language="C#" autoeventwireup="true" enableeventvalidation="false" inherits="ZoomLa.WebSite.Manage.Config.UserConfig, App_Web_24osmk5a" validaterequest="false" viewStateEncryptionMode="Never" %>
<!DOCTYPE HTML>
<html>
...
<div class="r_navigation">
	<span>后台管理</span>&gt;&gt;<span>系统配置</span> &gt;&gt;<span>会员参数配置</span>
</div>
...
<table width="99%" cellspacing="1" cellpadding="0" class="border">
	<tbody id="Tabs0">
		...
		<tr class="tdbg" onmouseover="this.className='tdbgmouseover'" onmouseout="this.className='tdbg'">
			<td class="tdbgleft" style="width: 300px">
				<strong>是否开启支付宝登陆：</strong></td>
			<td style="width: 500px">
				<asp:RadioButtonList ID="rdoAlipayCheck" runat="server" 
		...
		<tr class="tdbg" onmouseover="this.className='tdbgmouseover'" onmouseout="this.className='tdbg'">
			<td class="tdbgleft" style="width: 300px">
				<strong>是否允许一个Email注册多个会员：</strong>
			</td>
			<td style="width: 500px">
		...
		<tr class="tdbg" onmouseover="this.className='tdbgmouseover'" onmouseout="this.className='tdbg'">
			<td class="tdbgleft" style="width: 300px">
				...
				</strong>启用验证码功能可以在一定程度上防止暴力营销软件或注册机自动注册。
			</td>
		...
		<tr class="tdbg" onmouseover="this.className='tdbgmouseover'" onmouseout="this.className='tdbg'">
			<td class="tdbgleft" style="width: 300px">
				...
				</strong>启用验证码功能可以在一定程度上防止会员密码被暴力破解
			</td>
			<td style="width: 500px">
		...
		<tr class="tdbg" onmouseover="this.className='tdbgmouseover'" onmouseout="this.className='tdbg'">
			<td class="tdbgleft" style="width: 300px">
				<strong>是否允许多人同时使用同一会员帐号登陆：</strong>
			</td>
			<td style="width: 500px">
		...
		<tr class="tdbg" onmouseover="this.className='tdbgmouseover'" onmouseout="this.className='tdbg'">
			...
			<td style="width: 500px">
				<asp:TextBox ID="TextBox6" runat="server" class="l_input"></asp:TextBox>个字符
		...
		<tr class="tdbg" onmouseover="this.className='tdbgmouseover'" onmouseout="this.className='tdbg'">
			...
			<td style="width: 500px">
				<asp:TextBox ID="TextBox7" runat="server" class="l_input"></asp:TextBox>个字符
		...
		<tr class="tdbg" onmouseover="this.className='tdbgmouseover'" onmouseout="this.className='tdbg'">
			<td class="tdbgleft" style="width: 300px">
				<strong>禁止注册的用户名：<br />
				</strong>在右边指定的用户名将被禁止注册，每个用户名请用“|”符号分隔
			</td>
			<td style="width: 500px">
				<asp:TextBox ID="TextBox8" runat="server" Rows="6" TextMode="MultiLine" Width="300px"
					...
					<tr>
						...
						<td>
							<table>
								...
								<tr>
									<td>
										<input id="Button3" value=" >> " onclick="AddFields_SelectFill()" title="添加所选项" type="button" /><br />
									...
									<td>
										...
										<asp:ListBox ID="LitRegFields_SelectFill" SelectionMode="Multiple" Width="130" Height="130"
											class="x_input" runat="server" />
									</td>
									<td>
										<input id="Button8" value=" ︽ " onclick="UpFields_SelectFill()" title="上移" type="button" /><br />
		...
		<tr class="tdbg" onmouseover="this.className='tdbgmouseover'" onmouseout="this.className='tdbg'">
			<td class="tdbgleft" style="width: 300px">
				<strong>注册成功时发送的提醒邮件内容：<br />
				</strong>邮件内容支持HTML，邮件内容中可用标签说明如下：<br />
				<span>{$UserName}</span>：用户名<br />
				<span>{$UserPwd}</span>：密码
			</td>
			<td style="width: 500px">
		...
		<tr class="tdbg" onmouseover="this.className='tdbgmouseover'" onmouseout="this.className='tdbg'">
			<td class="tdbgleft" style="width: 300px">
				<strong>使用邮箱找回密码邮件内容：<br />
				</strong>邮件内容支持HTML，邮件内容中可用标签说明如下：<br />
				<span>{$UserName}</span>：会员名称<br />
				<span>{$SiteName}</span>：网站名称<br />
				<span>{$SiteUrl}</span>：网站地址<br />
				<span>{$Password}</span>：会员密码
			</td>
			<td style="width: 500px">
	...
	<tbody id="Tabs1" style="display: none">
		<tr class="tdbg" onmouseover="this.className='tdbgmouseover'" onmouseout="this.className='tdbg'"
			...
			<td>
				<asp:TextBox ID="TxtPresentExpPerLogin" Text="0" runat="server" Columns="5" class="l_input" />分积分
			</td>
		</tr>
		<tr class="tdbg" onmouseover="this.className='tdbgmouseover'" onmouseout="this.className='tdbg'"
			runat="server" id="Tr1">
			<td class="tdbgleft">
				<strong>发布一条新内容奖励积分：</strong>
			</td>
			<td>
				<asp:TextBox runat="server" ID="tb_InformationRule" class="l_input"></asp:TextBox>分积分
				<asp:RegularExpressionValidator runat="server" ID="rev_2" ValidationExpression="^[1-9]\d*|0$"
					ControlToValidate="tb_InformationRule" ErrorMessage="只能输入非0整数"></asp:RegularExpressionValidator>
			</td>
		</tr>
		<tr class="tdbg" onmouseover="this.className='tdbgmouseover'" onmouseout="this.className='tdbg'"
			runat="server" id="Tr2">
			<td class="tdbgleft">
				<strong>发布一条评论奖励积分：</strong>
			</td>
			<td>
				<asp:TextBox runat="server" ID="tb_CommentRule" class="l_input"></asp:TextBox>分积分
				<asp:RegularExpressionValidator runat="server" ID="Rev_1" ValidationExpression="^[1-9]\d*|0$"
					ControlToValidate="tb_CommentRule" ErrorMessage="只能输入非0整数"></asp:RegularExpressionValidator>
			</td>
		</tr>
		<tr class="tdbg" onmouseover="this.className='tdbgmouseover'" onmouseout="this.className='tdbg'"
			runat="server" id="Tr3">
			<td class="tdbgleft">
				<strong>发布的内容被推荐奖励积分：</strong>
			</td>
			<td>
				<asp:TextBox runat="server" ID="tb_RecommandRule" class="l_input"></asp:TextBox>分积分
				<asp:RegularExpressionValidator runat="server" ID="rev_3" ValidationExpression="^[1-9]\d*|0$"
					ControlToValidate="tb_RecommandRule" ErrorMessage="只能输入非0整数"></asp:RegularExpressionValidator>
			</td>
		</tr>
		<tr class="tdbg" onmouseover="this.className='tdbgmouseover'" onmouseout="this.className='tdbg'"
		...
		<tr class="tdbg" onmouseover="this.className='tdbgmouseover'" onmouseout="this.className='tdbg'"
			...
			<td>
				<asp:TextBox ID="TxtPresentValidNum" Text="0" runat="server" Columns="5" class="l_input" /><asp:DropDownList
		...
		<tr class="tdbg" onmouseover="this.className='tdbgmouseover'" onmouseout="this.className='tdbg'">
			<td class="tdbgleft">
				<strong>创建群组所需要的积分：</strong>
			</td>
			<td>
				<asp:TextBox ID="Txtintegral" Text="0" runat="server" Columns="5" class="l_input" />
	...
	<tbody id="Tabs2" style="display: none">
			...
			<td>
				...
				元钱可兑换 <strong>
					<asp:TextBox ID="txtCMoneyExchangeDummyPurse" Text="1" runat="server" Columns="7"
						MaxLength="7" class="l_input" /></strong> 元虚拟金币
			...
			<td>
				...
				分积分可兑换 <strong>
					<asp:TextBox ID="TxtCUserExpExchangeValidDay" Text="1" runat="server" Columns="7"
						MaxLength="7" class="l_input" /></strong> 天有效期
		...
		<tr class="tdbg" onmouseover="this.className='tdbgmouseover'" style="display: none"
			...
			<td class="tdbgleft">
				<strong>打卡奖励数值：</strong>
			</td>
			<td>
				<asp:TextBox ID="txtPunch" Text="" runat="server" Columns="5" MaxLength="5" class="l_input" />
			</td>
		</tr>
		<tr class="tdbg" onmouseover="this.className='tdbgmouseover'" onmouseout="this.className='tdbg'">
			<td class="tdbgleft">
				<strong>推广奖励类型：</strong>
			</td>
			<td>
		...
		<tr class="tdbg" onmouseover="this.className='tdbgmouseover'" visible="false" onmouseout="this.className='tdbg'"
			runat="server" id="Tr6">
			<td class="tdbgleft">
				<strong>推广奖励数值：</strong>
			</td>
			<td>
				<asp:TextBox ID="txtPromotion" Text="" runat="server" Columns="5" MaxLength="5" class="l_input" />
			</td>
		</tr>
	</tbody>
	<tbody id="Tabs3" style="display: none">
		...
		<tr class="tdbg" onmouseover="this.className='tdbgmouseover'" onmouseout="this.className='tdbg'">
			...
			<td style="width: 500px">
				<asp:TextBox ID="txtzi" runat="server" Columns="7" MaxLength="7" class="l_input"></asp:TextBox>
	...
	<tbody id="Tabs4" style="display: none">
		<tr class="tdbg" onmouseover="this.className='tdbgmouseover'" onmouseout="this.className='tdbg'">
			<td class="tdbgleft" align="right" style="height: 23px" valign="middle">
				<strong>是否对同一IP注册进行时间间隔限制：</strong>
			</td>
			<td>
		...
		<tr class="tdbg" onmouseover="this.className='tdbgmouseover'" onmouseout="this.className='tdbg'">
			<td class="tdbgleft" align="right" style="height: 23px" valign="middle">
				<strong>注册间隔限制时间：</strong>
			</td>
			<td>
				<asp:TextBox ID="txtLimitTime" class="l_input" runat="server" onkeyup="if(this.value.length==1){this.value=this.value.replace(/[^1-9]/g,'')}else{this.value=this.value.replace(/\D/g,'')}"
					onafterpaste="if(this.value.length==1){this.value=this.value.replace(/[^1-9]/g,'')}else{this.value=this.value.replace(/\D/g,'')}"
					Width="150px"></asp:TextBox><strong style="color: red">&nbsp;间隔时间单位为小时 </strong>
			</td>
		</tr>
		<tr class="tdbg" onmouseover="this.className='tdbgmouseover'" onmouseout="this.className='tdbg'">
			<td class="tdbgleft" align="right" style="height: 23px" valign="middle">
				<strong>是否设置限制的IP段：</strong>
			</td>
			<td>
		...
		<div id="IPpart" runat="server">
			<tr class="tdbg" onmouseover="this.className='tdbgmouseover'" onmouseout="this.className='tdbg'">
				<td class="tdbgleft" align="right" style="height: 23px" valign="middle">
					<strong>设置限制的IP段：</strong>
				</td>
				<td>
					<asp:TextBox ID="txtBeginIP" class="l_input" runat="server" Width="150px"></asp:TextBox>
					&nbsp; —— &nbsp;<asp:TextBox ID="txtEndIP" class="l_input" runat="server" Width="150px"></asp:TextBox>
					<strong style="color: red">&nbsp; 不填为所有IP限制</strong>
				</td>
			</tr>
		</div>
	</tbody>
...
<br />
<asp:Button ID="Button1" runat="server" Text="保存设置" OnClick="Button1_Click" class="C_input" /><br />
