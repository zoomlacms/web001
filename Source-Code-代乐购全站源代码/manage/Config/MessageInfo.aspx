<%@ page language="C#" autoeventwireup="true" inherits="manage_Config_MessageInfo, App_Web_24osmk5a" enableEventValidation="false" viewStateEncryptionMode="Never" %>
...
<body>
    ...
    <input id="txtType" type="hidden" value="" runat="server"/><!--短信类型-->
        <table align="center" class="style1">
            
            <tr>
                <td class="style2">手机号</td>
                <td>
                    <asp:TextBox ID="t_sendNo" runat="server"></asp:TextBox>
                </td>
            </tr>
            <tr>
                <td class="style2">
                    短信内容</td>
                <td>
                    <asp:TextBox ID="s_memo" runat="server" TextMode="MultiLine"></asp:TextBox>
                </td>
            </tr>
            <tr>
                <td class="style2">
                    <asp:Button ID="Button1" class="C_input" runat="server" Text="发送" 
                        OnClientClick="return sendsms();" onclick="Button1_Click"/>
                </td>
                <td>&nbsp;</td>
            </tr>
        </table>
