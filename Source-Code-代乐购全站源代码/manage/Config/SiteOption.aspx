<%@ page language="C#" autoeventwireup="true" inherits="ZoomLa.WebSite.Manage.SiteConfig.SiteOption, App_Web_24osmk5a" enableEventValidation="false" viewStateEncryptionMode="Never" %>
<!DOCTYPE HTML>
<html>
...
<body>
    ...
    <div class="r_navigation">后台管理&gt;&gt;系统配置 &gt;&gt;网站参数配置 
    </div>
    ...
    <table width="99%" cellspacing="1" cellpadding="0" class="border">
        <tbody id="Tabs0">
            ...
            <tbody id="ClientApiOpton" runat="server">
                <tr class="tdbg" onmouseover="this.className='tdbgmouseover'" onmouseout="this.className='tdbg'">
                    ...
                    <td>
                        <asp:TextBox ID="ServerApiUrl" runat="server" Width="360px" AutoPostBack="True" OnTextChanged="ServerApiUrl_TextChanged"></asp:TextBox>
            ...
            <tr class="tdbg" onmouseover="this.className='tdbgmouseover'" onmouseout="this.className='tdbg'">
                <td style="width: 200px" class="tdbgleft">
        ...
        <tbody id="Tabs1" style="display: none">
            <tr class="tdbg" onmouseover="this.className='tdbgmouseover'" onmouseout="this.className='tdbg'">
                ...
                <td>
                    <asp:TextBox ID="txtProjectServer" Width="180" runat="server" class="l_input"></asp:TextBox>
                    <font color="green">支持从远程云端下载功能与模板界面，官方服务器地址：http://updata.zoomla.cn</font>
                </td>
            </tr>
            <tr class="tdbg" onmouseover="this.className='tdbgmouseover'" onmouseout="this.className='tdbg'">
                <td class="tdbgleft" style="width: 200px; height: 23px;">
...
('../Template/TemplateList.aspx?OpenerText='+escape('txtShopTemplate')+'&FilesDir=',650,480)" class="C_input" />
            ...
            <tr class="tdbg" onmouseover="this.className='tdbgmouseover'" onmouseout="this.className='tdbg'">
                ...
                <td>
                    <div id="DivtemplateDir">
                        ...
                        <asp:TextBox ID="txtTemplateDir" runat="server" class="l_input" onkeyup="cc()"></asp:TextBox><asp:Button ID="Button2" OnClick="Button2_Click" OnClientClick="document.getElementById('lblKai').innerText='开销中...';" runat="server" Text="一键开销" class="C_input" />
            ...
            <tr class="tdbg" onmouseover="this.className='tdbgmouseover'" onmouseout="this.className='tdbg'">
                ...
                <td>
                    <div id="DivCssDir">
                        <asp:TextBox ID="txtCssDir" runat="server" class="l_input"></asp:TextBox><span style="color: Red">*提示：为保证风格能够与云台结合使用，请继承上一项的模板目录</span>
                    </div>
                </td>
            </tr>
            <tr class="tdbg" onmouseover="this.className='tdbgmouseover'" onmouseout="this.className='tdbg'">
        ...
        <tbody id="Tabs2" style="display: none">
            <tr class="tdbg" onmouseover="this.className='tdbgmouseover'" onmouseout="this.className='tdbg'">
                ...
                <td>
                    <asp:TextBox ID="txtManageDir" runat="server" class="l_input"></asp:TextBox><span
                        style="color: #1e860b;">&nbsp;默认目录为manage，改名后将屏蔽原路径访问，并启用新路径进入后台管理。</span>
                </td>
            </tr>
            <tr class="tdbg" onmouseover="this.className='tdbgmouseover'" onmouseout="this.className='tdbg'">
                <td class="tdbgleft" style="width: 200px;">
            ...
            <tr class="tdbg" onmouseover="this.className='tdbgmouseover'" onmouseout="this.className='tdbg'">
                ...
                <td>
                    ...
                    <asp:RadioButton ID="rdoEskFalse" runat="server" GroupName="EnableSoftKey" TabIndex="2"
                        ...
                        <tr class="tdbg" onmouseover="this.className='tdbgmouseover'" onmouseout="this.className='tdbg'">
                <td class="tdbgleft">
                    <strong>是否启用发送短信：</strong>
                </td>
                <td class="style2">
                    <asp:RadioButton ID="rdoSendMessageTrue" runat="server" GroupName="OpenSendMessage"
                        TabIndex="1" Text="是" />
            ...
            <tr class="tdbg" onmouseover="this.className='tdbgmouseover'" onmouseout="this.className='tdbg'">
                <td class="tdbgleft" style="width: 200px">
                    <strong>Google地图安全密钥：</strong>
                </td>
                <td>
                    <asp:TextBox ID="txtgoogle" Width="360px" runat="server" class="l_input"></asp:TextBox>
                    <span style="color: #1e860b;">&nbsp;没有密钥？<a href="http://code.google.com/intl/zh-CN/apis/maps/signup.html" target="_parent" title="申请Google maps 地图API密钥">点此申请</a></span>
                </td>
            </tr>
            <tr class="tdbg" onmouseover="this.className='tdbgmouseover'" onmouseout="this.className='tdbg'"
                style="display: none">
                ...
                <td>
                    <asp:TextBox ID="TxtSensitivity" runat="server" Rows="6" TextMode="MultiLine" Width="300px" class="x_input"></asp:TextBox>
                    &nbsp;提示：敏感词汇请用","分隔
                </td>
            </tr>
