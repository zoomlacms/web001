<%@ page language="C#" autoeventwireup="true" inherits="ZoomLa.WebSite.Manage.Config.ThumbConfig, App_Web_24osmk5a" enableEventValidation="false" viewStateEncryptionMode="Never" %>
<!DOCTYPE HTML>
<html>
...
<div class="r_navigation">	
	<span>后台管理</span>&gt;&gt;<span>系统配置</span> &gt;&gt;<span>缩略图配置</span>
</div>
<div class="clearbox"></div>
      <table width="99%" cellspacing="1" cellpadding="0" class="border">
              <tr class="tdbg" onmouseover="this.className='tdbgmouseover'" onmouseout="this.className='tdbg'">
        <td class="style1">
            <strong>上传图片默认宽度：</strong></td>
        <td  >
            <asp:TextBox ID="iwidth" runat="server" class="l_input"></asp:TextBox>像素&nbsp;&nbsp;设为0时，将以高度为准按比例缩小。 </td>
    </tr>
     <tr class="tdbg" onmouseover="this.className='tdbgmouseover'" onmouseout="this.className='tdbg'">
        <td class="style1">
            <strong>上传图片默认高度：</strong></td>
        <td >
            <asp:TextBox ID="iheight" runat="server" class="l_input"/></asp:TextBox>像素&nbsp;&nbsp;设为0时，将以宽度为准按比例缩小。都为0时，则为原图大小。</td>
    </tr>
             <tr class="tdbg" onmouseover="this.className='tdbgmouseover'" onmouseout="this.className='tdbg'">
        <td class="style1">
            <strong>是否开启水印：</strong></td>
        <td >
    ...
    <tr class="tdbg" onmouseover="this.className='tdbgmouseover'" onmouseout="this.className='tdbg'">
        <td class="style1">
            <strong>水印图路径(不支持标签读取): </strong></td>
        <td >
            <asp:TextBox ID="iLogo" runat="server" Width="400" class="l_input"/></asp:TextBox></td>
    </tr>
    <tr class="tdbg" onmouseover="this.className='tdbgmouseover'" onmouseout="this.className='tdbg'">
        <td class="style1">
            <strong>水印图片透明度：</strong></td>
        <td >
            <asp:TextBox ID="iAlp" runat="server" Width="50" class="l_input"></asp:TextBox>%，0为完全透明，100为完全不透明</td>
    </tr>
    </div>
    <div id="zi" runat="server">
     <tr class="tdbg" onmouseover="this.className='tdbgmouseover'" onmouseout="this.className='tdbg'">
        ...
        <td >
            <asp:TextBox ID="waterWord" runat="server"></asp:TextBox>
        </td>
    </tr>
        <tr class="tdbg" onmouseover="this.className='tdbgmouseover'" onmouseout="this.className='tdbg'">
        <td class="style1">
...
<img onclick="SelectColor(this,'txt_dfg');"src="/images/Rect.gif" align="absmiddle" style="border-width: 0px; cursor: pointer" />
    ...
    <tr class="tdbg" onmouseover="this.className='tdbgmouseover'" onmouseout="this.className='tdbg'">
        <td class="style1">
            <strong>坐标起点位置：</strong></td>
        <td style=" height: 23px;">
            <asp:DropDownList ID="localP" runat="server" AutoPostBack="True" 
      ...
      <tr class="tdbg" onmouseover="this.className='tdbgmouseover'" onmouseout="this.className='tdbg'" runat="server" id="oox" >
        <td class="style1">
            <strong>坐标位置：坐标起点位置设置为手动设置时才有效。 </strong></td>
        <td style="height: 23px;">
          X：<asp:TextBox ID="PX" runat="server" Width="50"></asp:TextBox>
            像素 填写的数据必须是数字！设为手动才可启用改参数<br />
Y：<asp:TextBox ID="PY" runat="server" Width="50"></asp:TextBox>像素 填                
        </td>
    </tr>
    </table>
    <br />
