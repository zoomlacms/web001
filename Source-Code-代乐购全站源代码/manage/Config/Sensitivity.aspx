<%@ page language="C#" autoeventwireup="true" inherits="manage.Config.Sensitivity, App_Web_24osmk5a" enableEventValidation="false" viewStateEncryptionMode="Never" %>
<!DOCTYPE HTML>
<html>
...
<body>
    ...
    <div class="r_navigation">
        <span>后台管理</span> &gt;&gt; <span>网站配置</span> &gt;&gt;<span> 过滤敏感词汇</span>
    </div>
    ...
    <table width="99%" cellspacing="1" cellpadding="0" class="border">
        ...
        <tr class="tdbg">
            <td class="tdbgleft" style="width: 200px">
                <strong>选择库文件：(txt文件)</strong>
            </td>
            <td height="50px">
                &nbsp;
                <asp:FileUpload ID="InputTxt" CssClass="l_input" runat="server" Width="379px" />
            </td>
        </tr>
        <tr class="tdbg" onmouseover="this.className='tdbgmouseover'" onmouseout="this.className='tdbg'">
         <td  style="width: 200px"></td>
            <td class="tdbg">&nbsp;
                ...
                <asp:Button ID="Button6" runat="server" Text=" 导 出 全 部 " CssClass="C_input" 
    ...
    <table width="99%" cellspacing="1" cellpadding="0" class="border">
        <tr class="title">
           ...
           <input id="Checkall" type="checkbox" name="Checkall" onclick="javascript:CheckAll(this);" /> ID
            </td>
            <td align="center">
            词汇
            </td>
        ...
        <ItemTemplate>
        <tr class="tdbg" onmouseover="this.className='tdbgmouseover'" onmouseout="this.className='tdbg'">
            <td height="26px" width="10%" align="center">
            <input name="Item" type="checkbox" value='<%#Eval("id") %>' /> <%#Eval("id") %>
            </td>
            ...
            <td width="10%" align="center">
               <a href="AddSensitivity.aspx?menu=edit&id=<%#Eval("id") %>">修改</a> <a onclick="return confirm('你确定将该数据删除到回收站吗？')" href="?menu=delete&id=<%#Eval("id") %>">删除</a>
            </td>
        </tr>
        </ItemTemplate>
        </asp:Repeater>
        <tr class="tdbg" onmouseover="this.className='tdbgmouseover'" onmouseout="this.className='tdbg'">
            <td class="tdbg" colspan="4" align="center">
                ...
                Width="30px"></asp:TextBox>条信息/页  转到第<asp:DropDownList   ID="DropDownList1" runat="server" AutoPostBack="True"   onselectedindexchanged="DropDownList1_SelectedIndexChanged">
              </asp:DropDownList>页
            </td>
        </tr>
    </table>
