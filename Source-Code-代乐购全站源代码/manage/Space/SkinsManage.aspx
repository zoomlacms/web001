<%@ page language="C#" autoeventwireup="true" inherits="manage_Space_SkinsManage, App_Web_b23wmswg" enableEventValidation="false" viewStateEncryptionMode="Never" %>
...
<body>
    ...
    <div class="r_navigation">
        ...
        &gt;&gt; <span>风格管理</span> [<a href="AddSkins.aspx">添加风格</a>]
    </div>
    <div class="clearbox">
    </div>
            ...
            <tr class="tdbg">
                <td height="24" colspan="7" align="center" class="tdbgleft">
                    ...
                    页次：<asp:Label ID="Nowpage" runat="server" Text="" />/<asp:Label ID="PageSize" runat="server"
                        Text="" />页
                    <asp:Label ID="pagess" runat="server" Text="" />个风格/页 转到第<asp:DropDownList ID="DropDownList1"
