<%@ page language="C#" autoeventwireup="true" inherits="manage_Space_ObjectManage, App_Web_b23wmswg" enableEventValidation="false" viewStateEncryptionMode="Never" %>
...
<body>
    ...
    <div class="r_navigation">
        ...
        &gt;&gt; <span>装扮管理</span> [<a href="AddPlate.aspx">添加装扮</a>]
    </div>
    <div class="clearbox">
    </div>
        ...
        <tbody id="Tbody1">
            <tr class="tdbg">
                <td width="5%" align="center" class="title" colspan="2">
                    <span class="tdbgleft">装扮ID</span>
                </td>
                <td width="20%" align="center" class="title">
                    <span class="tdbgleft">装扮名称</span>
                </td>
                <td width="20%" align="center" class="title">
                    <span class="tdbgleft">装扮分类</span>
                </td>
                <td width="20%" align="center" class="title">
            ...
            <tr class="tdbg">
                <td height="24" colspan="7" align="center" class="tdbgleft">
                    ...
                    页次：<asp:Label ID="Nowpage" runat="server" Text="" />/<asp:Label ID="PageSize" runat="server"
                        Text="" />页
                    <asp:Label ID="pagess" runat="server" Text="" />个装扮/页 转到第<asp:DropDownList ID="DropDownList1"
