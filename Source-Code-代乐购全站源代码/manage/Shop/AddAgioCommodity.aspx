<%@ page language="C#" autoeventwireup="true" inherits="manage_Shop_AddAgioCommodity, App_Web_cssnzwht" enableEventValidation="false" viewStateEncryptionMode="Never" %>
    ...
    <table width="100%" border="0" cellpadding="2" cellspacing="0" class="border">
                ...
                <table width="100%" border="0" cellspacing="1" cellpadding="1">
                    ...
                    <td colspan="3"></td>
                        <td align="right">
                            <b>商品列表：</b></td>
                        <td align="right">
                            <asp:TextBox ID="TxtKeyWord" runat="server" class="l_input"></asp:TextBox>&nbsp;&nbsp;<asp:Button
                                ID="BtnSearch" runat="server" Text="查找" class="C_input"  OnClick="BtnSearch_Click" /></td>
                    </tr>
                    <tr class="tdbgleft">
        ...
        <tr class="tdbgleft" id="tr2" runat="server">
            <td>
                <asp:Repeater ID="Repeater1" runat="server">
                    <ItemTemplate><input type="hidden" id="Pronames<%#Eval("NodeID") %>" value="<%#DataBinder.Eval(Container.DataItem, "NodeName")%>" />
                        <%# GetIcon(DataBinder.Eval(Container, "DataItem.NodeName", "{0}"), DataBinder.Eval(Container, "DataItem.NodeID", "{0}"), DataBinder.Eval(Container, "DataItem.Depth", "{0}"), DataBinder.Eval(Container, "DataItem.NodeType", "{0}"), DataBinder.Eval(Container, "DataItem.ParentID", "{0}"))%>
                        <br />
                    </ItemTemplate>
                </asp:Repeater>
            </td>
        ...
        <tr>
            <td colspan="2" align="center">
                <asp:Button ID="Button1" class="C_input" runat="server" Text="添加商品" />
