<%@ page language="C#" autoeventwireup="true" inherits="manage_Shop_AddCard, App_Web_psxnd2zu" enableEventValidation="false" viewStateEncryptionMode="Never" %>
...
<body>
    ...
    <div class="r_navigation">
        ...
        <span><a href="CardManage.aspx">VIP卡管理</a></span> &gt;&gt; <span>生成VIP卡</span>
    </div>
    <div class="clearbox">
    </div>
    <div>
        <table width="100%" cellpadding="2" cellspacing="1" border="0" class="r_navigation">
            ...
            <tr class="WebPart" onmouseover="this.className='tdbgmouseover'" onmouseout="this.className='tdbg'">
                ...
                <td>
                    &nbsp;
                    <asp:TextBox ID="endtime" class="l_input" runat="server" Width="217px" onclick="calendar();"></asp:TextBox>
