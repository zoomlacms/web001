<%@ page language="C#" autoeventwireup="true" inherits="manage_Shop_AddbindPro, App_Web_psxnd2zu" enableEventValidation="false" viewStateEncryptionMode="Never" %>
<!DOCTYPE HTML>
<html>
        ...
        <tr class="title">
            ...
            <td align="right">
                <asp:TextBox ID="TxtKeyWord" class="l_input"  runat="server"></asp:TextBox>&nbsp;&nbsp;<asp:Button
                    ID="BtnSearch" runat="server" class="C_input"  Text="查找" OnClick="BtnSearch_Click" /></td>
        </tr>
        <tr>
