<%@ page language="C#" autoeventwireup="true" inherits="manage_Shop_ShopRecycler, App_Web_psxnd2zu" enableEventValidation="false" viewStateEncryptionMode="Never" %>
...
<body>
    ...
    <div>
        <div class="r_navigation">
            ...
            <span>后台管理</span> &gt;&gt; <span>商城管理</span> &gt;&gt; <a href="ProductManage.aspx">商品管理</a>
            &gt;&gt; <span><a href="ProductManage.aspx">商品列表</a></span>
            ...
            <tbody id="Tabss">
                <tr class="tdbg">
                    ...
                    <td width="7%" align="center" class="title">
                        <span class="tdbgleft">单位</span>
                    </td>
                    <td width="7%" align="center" class="title">
                        <span class="tdbgleft">库存</span>
                    </td>
                    <td width="6%" align="center" class="title">
                        <span class="tdbgleft">价格</span>
                    </td>
                    <td width="6%" align="center" class="title">
                        <span class="tdbgleft">类型</span>
                    </td>
                    <td width="5%" align="center" class="title">
                        <span class="tdbgleft">推荐</span>
                    </td>
                ...
                <asp:Repeater ID="Productlist" runat="server">
                    <ItemTemplate>
                        <tr class="tdbg" onmouseover="this.className='tdbgmouseover'" onmouseout="this.className='tdbg'">
                            ...
                            <td height="24" align="center">
                                <a href="ShopRecycler.aspx?menu=edit&ModelID=<%#Eval("ModelID") %>&NodeID=<%#Eval("Nodeid") %>&id=<%#Eval("id")%>">
                                    还原</a> <a href="ShopRecycler.aspx?menu=delete&NodeID=<%#Eval("Nodeid") %>&id=<%#Eval("id")%>"
            ...
            <tr>
                <td style="height: 21px">
                    &nbsp;<asp:Button ID="Button1" class="C_input" Style="width: 110px;" runat="server"
                        Text="批量还原" OnClick="Button1_Click" />
                    <asp:Button ID="Button2" class="C_input" Style="width: 110px;" runat="server" Text="批量删除"
