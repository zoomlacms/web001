<%@ page language="C#" autoeventwireup="true" enableeventvalidation="false" inherits="manage_Shop_AddAgioProject, App_Web_psxnd2zu" viewStateEncryptionMode="Never" %>
...
<div class="r_navigation">
	...
	<span>后台管理</span> &gt;&gt; <span>商城管理</span> &gt;&gt; 促销管理 &gt;&gt; <span><a href="AgioProject.aspx" >打折方案管理</a></span> &gt;&gt; <span><%=type %>打折方案</span>
</div>
...
<tr class="WebPart" onmouseover="this.className='tdbgmouseover'" onmouseout="this.className='tdbg'">
    ...
    <td width="76%" valign="middle"><asp:TextBox ID="txtName" class="l_input" runat="server" Width="253px" />
        <font color=red>*
            <asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server" ErrorMessage="方案名称不能为空!" ControlToValidate="txtName"></asp:RequiredFieldValidator></font></td>
  </tr>
   <tr class="WebPart" onmouseover="this.className='tdbgmouseover'" onmouseout="this.className='tdbg'">
    <td height="22" class="tdbgleft" align="right" style="width: 24%"><strong>有效期：</strong></td>
<td height="22" valign="middle"><asp:TextBox ID="txtStartTime" class="l_input" runat="server" Width="96px" onclick="calendar()" />&nbsp;<asp:Image
      ID="Image1" runat="server" ImageUrl="/App_Themes/AdminDefaultTheme/images/Calendar.gif" ToolTip="鼠标点击左边输入框出现时间选择框" />
&nbsp;止        <asp:TextBox ID="txtEndTime" runat="server"  class="l_input" Width="96px" onclick="calendar()" />
  <asp:Image ID="Image2" runat="server" ImageUrl="/App_Themes/AdminDefaultTheme/images/Calendar.gif"
      ToolTip="鼠标点击左边输入框出现时间选择框" />
  不填写为不限制有效期</td>
  </tr><tr class="WebPart" onmouseover="this.className='tdbgmouseover'" onmouseout="this.className='tdbg'">
        <td align="right" class="tdbgleft" height="22" style="width: 24%"><strong>方案类型：</strong>
        </td>
    ...
    <td height="22" valign="middle"><table width="100%" border="0" cellspacing="0" cellpadding="0">
      <tr>
        ...
        <asp:Button ID="Button2" runat="server" class="C_input" Text="添加打折商品" style="width:110px;"  OnClientClick="SelectProducer();return false;" />
            <asp:Button ID="Button3" runat="server" class="C_input" Text="删除" OnClientClick="Clearoption();return false;" /><br />
            <font color="red">非选中</font><font color="green">状态的商品添加或更新后将被</font><font color="red">删除<br /><font color="red"><b>选中状态</b></font><font color="green">的商品将被更新</font> 支持<b>Ctrl</b>或<b>Shift</b>键多选
        </font></td>
      </tr>  
    </table></td>
  </tr>
...
<tr class="tdbg">
    <td height="22" colspan="5" align="center" class="tdbgleft">
        ...
        <asp:Button ID="Button4" class="C_input" runat="server" Text="提  交" OnClick="Button4_Click" />&nbsp; &nbsp; &nbsp;<input id="Button5"  class="C_input" type="button"
            value="返  回" onclick="javascript:window.history.go(-1);" /></td>
  </tr>
</table>
</form>
</body>
