<%@ page language="C#" autoeventwireup="true" inherits="ZoomLa.WebSite.Manage.Shop.AddModelField, App_Web_cssnzwht" enableEventValidation="false" viewStateEncryptionMode="Never" %>
...
<div class="r_navigation">
	...
	<span>后台管理</span> &gt;&gt; <span>商城管理</span> &gt;&gt; <a href="ModelManage.aspx">模型管理</a>    &gt;&gt; <a href="ModelField.aspx?ModelId=<%=Request.QueryString["ModelID"] %>">字段列表</a>
&gt;&gt; 添加[<asp:Label ID="lblModel" runat="server" Text="Label"></asp:Label>模型]字段</div>
