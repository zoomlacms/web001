<%@ page language="C#" autoeventwireup="true" inherits="Zoomla.Website.manage.Shop.CartManage, App_Web_psxnd2zu" enableEventValidation="false" viewStateEncryptionMode="Never" %>
<!DOCTYPE HTML>
<html>
...
<table width="100%" cellpadding="2" cellspacing="1" class="border" style="background-color: white;">
    ...
    <tr class="tdbg">
        ...
        <td width="150" align="center" class="title"><span class="tdbgleft">时间</span></td>
    ...
    <tr class="tdbg" id="<%#Eval("ID")%>" ondblclick="getinfo(this.id)" onmouseover="this.className='tdbgmouseover'" onmouseout="this.className='tdbg'">
        <td height="24" align="center" colspan="2"><a href="cartinfo.aspx?id=<%#Eval("ID")%>"><%#Eval("Cartid")%></a></td>
    ...
    <tr class="tdbg">
        <td colspan="8" align="center">共<asp:Label ID="Allnum" runat="server" Text=""></asp:Label>条数据
            ...
            <asp:TextBox ID="txtPage" runat="server" AutoPostBack="true" class="l_input" Width="16px"
                Height="16px" OnTextChanged="txtPage_TextChanged" Text="1"></asp:TextBox> 条数据/页 转到第
