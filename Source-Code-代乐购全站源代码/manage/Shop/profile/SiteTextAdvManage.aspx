<%@ page language="C#" autoeventwireup="true" inherits="manage_Shop_profile_SiteTextAdvManage, App_Web_3dejae34" enableEventValidation="false" viewStateEncryptionMode="Never" %>
<!DOCTYPE HTML>
<html>
<head runat="server">
<title>文字广告管理</title>
...
<span>后台管理</span> &gt;&gt; <span>商城管理</span> &gt;&gt; <span>返利管理</span> &gt;&gt;<span><a href="sitepicManage.aspx">分站文字广告管理</a></span> 
[<a href="SiteTextAdv.aspx?menu=add">添加文字广告</a>]
</div>      
<div class="clearbox">
</div>
<asp:GridView ID="gvCard" runat="server" AutoGenerateColumns="False"  class="border"  Width="100%"  RowStyle-CssClass='tdbg'  onrowcommand="gvCard_RowCommand">
    <Columns>
        ...
        <asp:TemplateField HeaderText="添加时间" ItemStyle-HorizontalAlign="Center" ItemStyle-VerticalAlign="Middle">
            <ItemTemplate>
                <asp:Label ID="lblType" runat="server" Text='<%#DataBinder.Eval(Container.DataItem,"AddTime","{0:yyyy-MM-dd}") %>'></asp:Label>
            </ItemTemplate>
        </asp:TemplateField>
