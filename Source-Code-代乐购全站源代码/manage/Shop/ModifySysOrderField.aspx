<%@ page language="C#" autoeventwireup="true" inherits="manage_Shop_ModifySysOrderField, App_Web_psxnd2zu" enableEventValidation="false" viewStateEncryptionMode="Never" %>
<!DOCTYPE HTML>
<html>
<head runat="server">
       ...
       <!--  文件类型    -->
        ...
        <tr class="tdbg">
            ...
            <td height="50">
                ...
                &nbsp;&nbsp;
                <input id="Button2" type="button" runat="server" value=" 返回字段列表 "  onclick="javascript:window.location.href='SystemUserModel.aspx'" class="C_input"/>
