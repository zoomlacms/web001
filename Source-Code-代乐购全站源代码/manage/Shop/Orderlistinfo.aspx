<%@ page language="C#" autoeventwireup="true" inherits="manage_Shop_Orderlistinfo, App_Web_psxnd2zu" enableEventValidation="false" viewStateEncryptionMode="Never" %>
<!DOCTYPE HTML>
<html>
...
<tbody id="Tbody2">
    <tr>
        ...
        <td width="14%" align="center" class="title">商品属性</td>
        <td width="6%" align="center" class="title">市场价</td>
        <td width="10%" align="center" class="title">实价(本店价)</td>
        <td width="3%" align="center" class="title">数量</td>
    ...
    <asp:Repeater ID="procart" runat="server" OnItemDataBound="cartinfo_ItemDataBound">
        <ItemTemplate>
            <tr class="tdbg" onmouseover="this.className='tdbgmouseover'" onmouseout="this.className='tdbg'"
                ...
                <td width="6%" align="center"><%#Eval("ProCode")%></td>

                <td align="center"><a href='ShowProduct.aspx?menu=edit&ModelID=<%#(Eval("ModelID"))%>&NodeID=<%#(Eval("NodeID"))%>&id=<%#(Eval("ItemID"))%>' target='_blank'><%#Eval("proname")%></a></td>

                <td align="center"><%#Eval("Attribute")%></td><!--商品属性 -->

                <td align="center"><%#getjiage(Eval("proclass","{0}"),"1", DataBinder.Eval(Container, "DataItem.ProID", "{0}"))%></td>

                <td align="center"> <%#shijia(Eval("proclass", "{0}"), Eval("ProID", "{0}"), DataBinder.Eval(Container, "DataItem.Shijia", "{0}"))%></td>

                <td align="center"><%#Eval("pronum") %></td>

                <td align="center"><%#Eval("Danwei") %></td>

                <td align="center"><%#getprojia(Eval("ProID", "{0}"), DataBinder.Eval(Container, "DataItem.ID", "{0}"))%></td>

                <td align="center"><%#qixian(DataBinder.Eval(Container, "DataItem.ProID", "{0}"))%></td>
    ...
    <tr class="tdbg"onmouseover="this.className='tdbgmouseover'" onmouseout="this.className='tdbg'">
        ...
        <td height="24" align="left" colspan="4">
            合计：
            &nbsp;<asp:TextBox ID="Label2"
                runat="server" CssClass="l_input" Width="116px" Height="17px"></asp:TextBox>&nbsp;
        <asp:Button ID="Button8" runat="server" Text="修改" CssClass="C_input" 
...
<tr onmouseover="this.className='tdbgmouseover'" onmouseout="this.className='tdbg'"><td>
    ...
    <asp:Button ID="Button1" class="C_input"  style="width:100px;"  runat="server" Text="成功付款" Enabled="false" OnClientClick="return confirm('确定要修改付款状态吗？');" onclick="Button1_Click" />
        <asp:Button ID="buttonorder" class="C_input"  style="width:100px;"  runat="server" Text="打印签收单"  OnClientClick="order(); return false;" />
        <script>
            function order()
{
...
<table width="100%" cellpadding="2" cellspacing="1" class="border" style="background-color: white;" id="TABLE1">
    ...
    <tr class="tdbg">
        <td width="25%"><asp:Button ID="Button4" class="C_input"  style="width:100px;" runat="server" Text="确认订单" Width="100px" OnClick="Button4_Click"  />
            </td>
        <td width="25%"><asp:Button ID="Button2" class="C_input"  style="width:100px;" runat="server" Text="已经支付" Width="100px" OnClick="Button2_Click"  />
            </td>
        <td width="25%"><asp:Button ID="Button13" class="C_input"  style="width:100px;" runat="server" Text="暂停处理" Width="100px" OnClick="Button13_Click"  />
            </td>
        <td width="25%"><asp:Button ID="Button9" class="C_input"  style="width:100px;" runat="server" Text="结清订单" Width="100px" OnClick="Button9_Click"  />
            </td>
    </tr>
    <tr  class="tdbg">
    <td><asp:Button ID="Button5" class="C_input"  style="width:100px;" runat="server" Text="取消确认" Width="100px" OnClick="Button5_Click"  /></td>
    <td><asp:Button ID="Button7" class="C_input"  style="width:100px;" runat="server" Text="客户已签收" Width="100px" OnClick="Button7_Click"  /></td>
    <td><asp:Button ID="Button14" class="C_input"  style="width:100px;" runat="server" Text="恢复正常" Width="100px" OnClick="Button14_Click"  /></td>
    <td><asp:Button ID="Button11" class="C_input"  style="width:100px;" runat="server" Text="开发票" Width="100px" OnClick="Button11_Click" /></td>
    </tr>
    <tr class="tdbg">
        <td><asp:Button ID="Button3" class="C_input"  style="width:100px;" runat="server" Width="100px" Text="发货" OnClientClick="show();return false;"  /></td>
        <td><asp:Button ID="Button6" class="C_input"  style="width:100px;" runat="server" Text="订单作废" Width="100px" OnClick="Button6_Click" /></td>
        <td><asp:Button ID="Button12" class="C_input"  style="width:100px;" runat="server" Text="删除订单" Width="100px" OnClick="Button12_Click"  /></td>
        <td><asp:Button ID="Button15" class="C_input"  style="width:100px;" runat="server" Text="打印订单" Width="100px" OnClientClick="preview();return false;"  />
        </td>
    </tr>
    ...
    <td colspan="4">
        <table id="isAlipay">
            <tr><td align="right">淘宝交易号：</td><td><asp:TextBox ID="trade_no" runat="server" class="l_input"></asp:TextBox></td></tr>
            <tr><td align="right">发货类型：</td><td>
            ...
            <tr><td align="right">物流公司名称：</td><td><asp:TextBox ID="logistics_name" runat="server" class="l_input"></asp:TextBox></td></tr>
            <tr><td align="right">物流发货单号：</td><td><asp:TextBox ID="txtMS" runat="server" class="l_input"></asp:TextBox></td></tr>
        </table>
        <table id="noAlipay">
        <tr>
            <td>快递单号：<asp:TextBox ID="txtMSnoAlipay" runat="server" class="l_input"></asp:TextBox></td>
        </tr>
        </table>
	<asp:Button ID="btnfahuo" runat="server" OnClick="Button3_Click" Text="发货" class="C_input"></asp:Button>
    </td>
    </tr>
    </tbody>
