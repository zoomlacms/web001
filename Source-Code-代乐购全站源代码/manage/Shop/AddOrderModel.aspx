<%@ page language="C#" autoeventwireup="true" inherits="manage_Shop_AddOrderModel, App_Web_cssnzwht" enableEventValidation="false" viewStateEncryptionMode="Never" %>
<!DOCTYPE HTML>
<html>
<head runat="server">
<title>添加订单模型</title>
...
<body>
 <form id="form1" runat="server">
    <div class="r_navigation">
        ...
        <span>后台管理</span>&gt;&gt;<span><a href="ProductManage.aspx">商城管理</a></span> &gt;&gt;订单模型管理
        &gt;&gt; <span id="spLink" runat="server"></span> &gt;&gt; 添加系统订单字段
    </div>
    <div class="clearbox">
    </div>
