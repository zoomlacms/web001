<%@ page language="C#" autoeventwireup="true" inherits="manage_Shop_AddInvoType, App_Web_cssnzwht" enableEventValidation="false" viewStateEncryptionMode="Never" %>
<!DOCTYPE HTML>
<html>
<head runat="server">
<title>添加发票类型</title>
...
<div class="r_navigation">
	...
	<span>后台管理</span> &gt;&gt; <span>商城管理</span> &gt;&gt; 商城设置 &gt;&gt; <a href="InvtoManage.aspx">发票类型管理</a> &gt;&gt;
    <span><a href="AddInvoType.aspx" target="_self">添加发票类型</a></span></div>
...
<table width="100%" cellpadding="2" cellspacing="1" class="border" style="background-color: white;">
    ...
    <tr class="tdbg" onmouseover="this.className='tdbgmouseover'" onmouseout="this.className='tdbg'" >
      ...
      <td height="24" ><asp:TextBox ID="deliinfo" class="l_input" runat="server" 
              Height="177px" TextMode="MultiLine" Width="428px" /></td>
    </tr>
      ...
      <asp:RegularExpressionValidator ID="RegularExpressionValidator13"
            runat="server" ControlToValidate="shuilv" ErrorMessage="税率格式不对!" ValidationExpression="\d+[.]?\d*"
