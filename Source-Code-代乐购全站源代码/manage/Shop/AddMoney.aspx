<%@ page language="C#" autoeventwireup="true" inherits="Zoomla.Website.manage.Shop.AddMoney, App_Web_psxnd2zu" enableEventValidation="false" viewStateEncryptionMode="Never" %>
...
<body>
    ...
    <div class="r_navigation">
        ...
        <span>后台管理</span> &gt;&gt; <span>商城管理</span> &gt;&gt; 商城设置 &gt;&gt; <span><a href="MoneyManage.aspx"
            target="_self">货币管理</a></span> [<span><a href="AddMoney.aspx"></a><asp:Label ID="titles"
                runat="server" Text="添加货币"></asp:Label>
            </span>]
    </div>
    <div class="clearbox">
    </div>
    ...
    <asp:Button ID="Button1" class="C_input" Style="width: 110px;" runat="server" Text="保存设置"
        Width="87px" OnClick="Button1_Click" /><br />
    </form>
</body>
</html>
