<%@ page language="C#" autoeventwireup="true" inherits="ZoomLa.WebSite.Manage.Page.AddPageModel, App_Web_4ivp2eav" enableEventValidation="false" viewStateEncryptionMode="Never" %>
    ...
    <table class="border" width="100%" cellpadding="2" cellspacing="1">
        ...
        <tr class="tdbgbottom">
            <td colspan="2">
                ...
                &nbsp;&nbsp;
                <input name="Cancel" type="button" class="C_input"  id="Cancel" value="取消" onclick="window.location.href='PageModelManage.aspx';" />
            </td>
        </tr>
    </table>
