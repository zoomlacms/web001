<%@ page language="C#" autoeventwireup="true" inherits="ZoomLa.WebSite.Manage.Page.AddPageField, App_Web_ffkldptm" enableEventValidation="false" viewStateEncryptionMode="Never" %>
...
<style type="text/css">
    .style1 {background: #e0f7e5;line-height: 120%;}
</style>
<!----颜色代码---->
...
<table class="border" cellspacing="1" cellpadding="0" width="99%" border="0" align="center">
    <tr class="tdbg"  onmouseover="this.className='tdbgmouseover'" onmouseout="this.className='tdbg'">
        ...
        <td>
            <asp:TextBox ID="Alias" class="l_input" runat="server" MaxLength="20"></asp:TextBox><font color="#ff0066">*</font><span class="tips" style="color: #808000"> 如：文章标题</span>
        </td>
    </tr>
    <tr class="tdbg" onmouseover="this.className='tdbgmouseover'" onmouseout="this.className='tdbg'" >
        <td class="tdbgleft">字段名称：</td>
        <td>
            <asp:TextBox ID="Name" class="l_input" MaxLength="50" runat="server"></asp:TextBox><font color="#ff0066">*</font><span class="tips" style="color: #808000">字段名由字母、数字、下划线组成，不接受空格</span>
        </td>
    </tr>
    <tr class="tdbg"  onmouseover="this.className='tdbgmouseover'" onmouseout="this.className='tdbg'">
    ...
    <tr class="tdbg" >
        ...
        <td>
            <asp:TextBox ID="Description" class="l_input" runat="server" Columns="40" Rows="6" TextMode="MultiLine" Height="60px"></asp:TextBox>
        </td>
    </tr>
    <tr class="tdbg" onmouseover="this.className='tdbgmouseover'" onmouseout="this.className='tdbg'" >
        ...
        <tr class="tdbg" onmouseover="this.className='tdbgmouseover'" onmouseout="this.className='tdbg'" >
            ...
            <td>
                <input id="Button4" type="button" value="从数据字典中选择选项" class="C_input"onclick="SelectDictionary('ListBoxType_Content')" /><input
                    id="Button6" type="button" value="添加数据字段" class="C_input" onclick='SubPage("ListBoxType_Content")' /><br />
                    ...
                    <tr class="tdbg" onmouseover="this.className='tdbgmouseover'" onmouseout="this.className='tdbg'" >
                        <td>
                            <asp:TextBox ID="DateSearchRang" class="l_input" runat="server" 
                                TextMode="MultiLine" Columns="40"
                                Rows="6" Height="59px"></asp:TextBox><br />
    ...
    <tbody id="DivColorType" style="display: none" runat="server">
        <tr class="tdbg"  onmouseover="this.className='tdbgmouseover'" onmouseout="this.className='tdbg'">
            ...
            <td>
                <asp:TextBox ID="ColorDefault" runat="server" class="l_input"  MaxLength="7" Columns="10" Style="font-size: 9pt;
