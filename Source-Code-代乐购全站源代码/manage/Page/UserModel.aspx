<%@ page language="C#" autoeventwireup="true" inherits="ZoomLa.WebSite.Manage.Page.UserModel, App_Web_ffkldptm" enableEventValidation="false" viewStateEncryptionMode="Never" %>
...
<div class="r_navigation">
	...
	<span>后台管理</span> &gt;&gt; 企业黄页 &gt;&gt; 黄页申请设置 &gt;&gt;<span><asp:Literal ID="LNav" runat="server" Text="添加申请模型"></asp:Literal></span></div>
...
<table class="border" width="100%" cellpadding="2" cellspacing="1">
    ...
    <tr class="tdbg" onmouseover="this.className='tdbgmouseover'" onmouseout="this.className='tdbg'">
        ...
        <td>
            <asp:TextBox ID="TxtModelName" class="l_input" runat="server" Width="168px" 
                MaxLength="200" /><font color="red">*</font>
