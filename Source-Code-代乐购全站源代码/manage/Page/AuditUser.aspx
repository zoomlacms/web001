<%@ page language="C#" autoeventwireup="true" validaterequest="false" enableeventvalidation="false" inherits="manage_Page_AuditUser, App_Web_4ivp2eav" viewStateEncryptionMode="Never" %>
        ...
        <tbody id="Tbody1">
            ...
            <asp:Label ID="RegFileds" runat="server" Text=""></asp:Label><tr class="tdbg">
                <td align="center" colspan="2" class="tdbgright" style="height: 24px; width: 100%">
                    ...
                    <asp:Button ID="Button1" runat="server" Text="确认审核" class="C_input" OnClick="Button1_Click" />
                    <asp:Button ID="Button2" runat="server" Text="取消审核" class="C_input" OnClick="Button2_Click"
                        OnClientClick="return confirm('您确定要取消该用户的企业黄页吗？');" />
                    <asp:Button ID="Button3" runat="server" Text="返回" class="C_input" OnClick="Button3_Click" />
                    <asp:Button ID="Button5" class="C_input" runat="server" Text="修改" OnClick="Button5_Click" />
                    <asp:Button ID="Button4" class="C_input" runat="server" OnClick="Button4_Click" Text="返回" />
                </td>
            </tr>
        </tbody>
    </table>
