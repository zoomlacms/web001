<%@ page language="C#" autoeventwireup="true" inherits="manage_Question_TrainGuide, App_Web_tigbetrx" enableEventValidation="false" viewStateEncryptionMode="Never" %>
...
<body id="Guidebody" style="margin-left: 0px; margin-right: 0px; margin-top: 1px;
    ...
    <div id="Div1">
        <ul>
            <li id="Guide_top">
                <div id="Guide_toptext">学员管理</div>
            </li>
            <li id="Guide_main">
                <div id="Guide_box">
                    <div class="guideexpand" onclick="Switch(this)"> 学员管理</div>
                    <div class="guide">
                        <ul>
                            <li class="guideli" onmouseover="this.className='guidelihover'" onmouseout="this.className='guideli'">
                                <a href="../Exam/Audit.aspx" target="main_right">学员申请审批</a></li>
                            <li class="guideli" onmouseover="this.className='guidelihover'" onmouseout="this.className='guideli'">
