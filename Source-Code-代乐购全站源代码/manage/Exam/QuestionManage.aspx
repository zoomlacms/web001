<%@ page language="C#" autoeventwireup="true" inherits="manage_Question_QuestionManage, App_Web_tigbetrx" enableEventValidation="false" viewStateEncryptionMode="Never" %>
...
<body>
    ...
    <div class="r_navigation">
        <span>后台管理</span> &gt;&gt; <span>教育模块</span> &gt;&gt;<span>考试管理</span>&gt;&gt;<a href="QuestionManage.aspx">试题管理</a><font color="red">[<a href="AddQuestionForType.aspx" style="color: Red">添加试题</a>]</font></div>
    <div class="clearbox">
    </div>
    <div class="clearbox">
    </div>
