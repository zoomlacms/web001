<%@ page language="C#" autoeventwireup="true" inherits="manage_Question_Papers_User_Manage, App_Web_tigbetrx" enableEventValidation="false" viewStateEncryptionMode="Never" %>
...
<body>
    ...
    <div class="r_navigation">
        ...
        <span>后台管理</span> &gt;&gt;<span>教育模块</span> &gt;&gt;<a href="QuestionManage.aspx">在线考试系统</a>&gt;&gt; <span><a href="Papers_User_Manage.aspx">
            用户试卷管理</a></span>
    </div>
    <div class="clearbox">
    </div>
