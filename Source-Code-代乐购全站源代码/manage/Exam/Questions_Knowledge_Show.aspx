<%@ page language="C#" autoeventwireup="true" inherits="manage_Question_Questions_Knowledge_Show, App_Web_tigbetrx" enableEventValidation="false" viewStateEncryptionMode="Never" %>
<!DOCTYPE HTML>
<html>
<head runat="server">
    <title>知识点管理</title>
...
<body>
    ...
    <div class="r_navigation">
        ...
        <span>后台管理</span> &gt;&gt; <span>教育模块</span> &gt;&gt;<a href="QuestionManage.aspx">在线考试系统</a> &gt;&gt; <span>知识点管理</span>
        <asp:HyperLink ID="hlAdd" runat="server">[添加知识点]</asp:HyperLink>
    </div>
    <div class="clearbox">
    </div>
