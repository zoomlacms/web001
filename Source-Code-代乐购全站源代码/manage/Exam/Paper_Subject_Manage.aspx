<%@ page language="C#" autoeventwireup="true" inherits="manage_Question_Paper_Subject_Manage, App_Web_tigbetrx" enableEventValidation="false" viewStateEncryptionMode="Never" %>
<!DOCTYPE HTML>
<html>
<head runat="server">
<title>试卷试题管理</title>
...
<form id="form1" runat="server">
    <div class="r_navigation">
        <span>后台管理</span> &gt;&gt;<span>教育模块</span> &gt;&gt;<a href="QuestionManage.aspx">在线考试系统</a> &gt;&gt; <span><a href="Papers_System_Manage.aspx">
            试卷试题管理</a></span><asp:Literal ID="liQuestion" runat="server"></asp:Literal> 
    </div>
