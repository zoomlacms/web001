<%@ page language="C#" autoeventwireup="true" inherits="manage_Question_Papers_System_Manage, App_Web_tigbetrx" enableEventValidation="false" viewStateEncryptionMode="Never" %>
...
<body>
    ...
    <div class="r_navigation">
        ...
        <span>后台管理</span> &gt;&gt;<span>教育模块</span> &gt;&gt;<a href="QuestionManage.aspx">在线考试系统</a> &gt;&gt; <span><a href="Papers_System_Manage.aspx">
            系统试卷管理</a></span><font color="red">[<a href="Add_Papers_System.aspx?menu=Add" style="color: Red">添加系统试卷</a>]</font>
    </div>
    <div class="clearbox">
    </div>
