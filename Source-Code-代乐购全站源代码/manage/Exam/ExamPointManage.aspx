<%@ page language="C#" autoeventwireup="true" inherits="manage_Question_ExamPointManage, App_Web_tigbetrx" enableEventValidation="false" viewStateEncryptionMode="Never" %>
<!DOCTYPE html>
<html>
...
<div class="r_navigation">
    <span>后台管理</span> &gt;&gt;<span>教育模块</span> &gt;&gt;<a href="QuestionManage.aspx">在线考试系统</a>&gt;&gt; <span>考点管理</span>&gt;&gt;<font color="red">[<a href="Add_ExamPoint.aspx?AdminId=<%=AdminID%>" style="color: Red">添加考点</a>]</font>
</div>
<div class="clearbox">
</div>
