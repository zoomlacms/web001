<%@ page language="C#" autoeventwireup="true" inherits="manage_User_Agent, App_Web_pwasdykj" enableEventValidation="false" viewStateEncryptionMode="Never" %>
<!DOCTYPE HTML>
<html>
...
<body>
    ...
    <div class="r_navigation">
        <span style="float: right; background: url(../../../Images/ModelIcon/edit.gif) no-repeat left;
            padding-left: 20px;"></span><span>后台管理</span> &gt;&gt; <span>用户社区</span> &gt;&gt;
        多人视频管理&gt;&gt; <span>代理商管理</span><%--<a href="AddAgent.aspx">【添加代理房间】</a>--%>
    </div>
   <div>
