<%@ page language="C#" autoeventwireup="true" inherits="manage_User_ServiceInfo, App_Web_d0ltifsq" enableEventValidation="false" viewStateEncryptionMode="Never" %>
...
<body>
    ...
    <div class="r_navigation">
        ...
        <span>后台管理 </span>&gt;&gt;<span> 附件管理</span> &gt;&gt;<span> 客服管理</span> &gt;&gt;<span>
            <a href='CustomerService.aspx'>客服信息</a> </span>&gt;&gt;<span> 查询客服记录</span>
    </div>
    <div class="clearbox">
    </div>
