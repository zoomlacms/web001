<%@ page language="C#" autoeventwireup="true" inherits="manage_User_addUrlReWr, App_Web_d0ltifsq" enableEventValidation="false" viewStateEncryptionMode="Never" %>
            ...
            <tr class="WebPart" onmouseover="this.className='tdbgmouseover'" onmouseout="this.className='tdbg'">
              ...
              <tr class="WebPart" onmouseover="this.className='tdbgmouseover'" onmouseout="this.className='tdbg'">
                <td height="22" class="style4" align="right">
                    请求来源地址：</td>
                <td>
                 <asp:TextBox ID="UrlLook" class="l_input" runat="server" Width="311px"></asp:TextBox>
                    <br />
