<%@ page language="C#" autoeventwireup="true" inherits="manage_User_UserMobile, App_Web_pwasdykj" enableEventValidation="false" viewStateEncryptionMode="Never" %>
    ...
    <div>
            <table width="100%" border="0" cellpadding="2" cellspacing="0" class="border">
                ...
                <tr class="tdbg" onmouseover="this.className='tdbgmouseover'" onmouseout="this.className='tdbg'">
                    ...
                    <td align="center">
                        <input type="button"  name="del1" onclick="del(1)" value="删除最后" class="C_input" />
                ...
                <tr>
                    <td valign="top" colspan="2">
                        ...
                        <asp:Repeater ID="RepUser" runat="server" OnItemDataBound="RepUser_ItemDataBound">
                            ...
                            <ItemTemplate>
                                <td align="center">
                                    <a href="#" onclick="add('<%# Eval("Mobile") %>')">
                                        <%# Eval("UserName") %>
                                    </a>
                                </td>
                                <% 
