<%@ page language="C#" title="角色管理" autoeventwireup="true" inherits="User.RoleManage, App_Web_pwasdykj" enableeventvalidation="false" viewStateEncryptionMode="Never" %>
<!DOCTYPE HTML>
<html>
...
<div class="r_navigation">        
    <span>后台管理</span>&gt;&gt;<span><a href="AdminManage.aspx">管理员管理</a></span> &gt;&gt;角色管理&nbsp;&nbsp;<a href="AddRole.aspx">[添加角色]</a>
</div>
...
<table width="100%" border="0" cellpadding="0" cellspacing="1" class="border" align="center">
    <tr class="tdbg">
        <td class="tdbgleft">
            <img src="../../Images/notice.gif" align="absmiddle">&nbsp;<b>说明：超级管理员拥有最高的权限，不能修改其权限，删除该组！</b>
        </td>
    </tr>
</table>
</form>
