<%@ page language="C#" autoeventwireup="true" inherits="manage_User_AdminDetail, App_Web_d0ltifsq" enableEventValidation="false" viewStateEncryptionMode="Never" %>
<!DOCTYPE HTML>
<html>
<head runat="server">
<title>管理员预览</title>
...
<span>后台管理</span>&gt;&gt;<span><a href="AdminManage.aspx">管理员管理</a></span> &gt;&gt;管理员预览
</div>
      ...
      <table width="100%" border="0" cellpadding="0" cellspacing="1" class="border" align="center">
       <tr>
            <td class="spacingtitle" align="center" colspan="2" dir="ltr" valign="middle"　style="height: 23px">
                <asp:Label ID="lbTitle" runat="server" Text="管理员预览"></asp:Label>&nbsp;</td>
        </tr>
      ...
      <tr><td>
       <tbody id="Tabs0">
        ...
        <tr class="tdbg" onmouseover="this.className='tdbgmouseover'" onmouseout="this.className='tdbg'">
            <td class="tdbgleft" style="width: 25%; height: 23px;" valign="middle">
                <strong>管理员名：</strong></td>
            <td style="height: 23px">
                <asp:Label ID="tbdName" runat="server" Text="Label"></asp:Label>
                </td>
        </tr>    
           ...
           <tr class="tdbg" onmouseover="this.className='tdbgmouseover'" onmouseout="this.className='tdbg'">
            ...
            <td style="height: 23px">
                <asp:Label ID="txtAdminTrueName" runat="server" Text="Label"></asp:Label>
                </td>
        </tr>
         <tr class="tdbg" onmouseover="this.className='tdbgmouseover'" onmouseout="this.className='tdbg'">
            ...
            <td>
                <asp:Label ID="cb1" runat="server" Text="Label"></asp:Label>
        ...
        <tr class="tdbg" onmouseover="this.className='tdbgmouseover'" onmouseout="this.className='tdbg'">
            <td class="tdbgleft" style="width:25%;">
                <strong>&nbsp;管理员角色：</strong></td>
            <td align="left" valign="top">
                    <asp:Label ID="cblRoleList1" runat="server" Text="Label"></asp:Label>
            </td>
        </tr>
          ...
          <tr class="tdbg" onmouseover="this.className='tdbgmouseover'" onmouseout="this.className='tdbg'">
            ...
            <td align="left" valign="top">
               <asp:Label ID="DropDownList11" runat="server" Text="Label"></asp:Label>
            </td>
        </tr>
        </tbody>
        ...
        <tbody id="Tabs2" style=" display:none">
          <tr class="tdbg" onmouseover="this.className='tdbgmouseover'" onmouseout="this.className='tdbg'">
            ...
            <td align="left" valign="top">
                 <asp:Label ID="CheckBox1" runat="server" Text="Label"></asp:Label>
            </td>
        </tr>
        ...
        <tr class="tdbg" onmouseover="this.className='tdbgmouseover'" onmouseout="this.className='tdbg'">
            ...
            <td align="left" valign="top">
                 <asp:Label ID="DefaultStart1" runat="server" Text="Label"></asp:Label>
            </td>
        </tr>
        </tbody>
        <tr class="tdbg">
            <td class="tdbgleft" colspan="2" style="height: 23px" align="center">
                <asp:Button ID="btnSubmit" class="C_input" runat="server" 
                    OnClick="btnSubmit_Click" Text="重新修改" />
                <asp:Button ID="btnAdd" runat="server" class="C_input" Text="添加管理员" 
                    onclick="btnAdd_Click" />
                &nbsp;
                <asp:Button ID="btnList" class="C_input" runat="server" Text="返回列表" 
                    OnClientClick="location.href='AdminManage.aspx';return false;" />&nbsp;</td>
        </tr>
