<%@ page language="C#" autoeventwireup="true" inherits="manage_User_SubscriptListManage, App_Web_pwasdykj" enableEventValidation="false" viewStateEncryptionMode="Never" %>
...
<body>
    <form id="form1" runat="server">
        <div class="r_navigation">
            ...
            <span><asp:HyperLink ID="hyname" runat="server"></asp:HyperLink><a href="AddSubscriptionCount.aspx?menu=add">【新增订阅】</a></span>
        </div>
        <div class="clearbox">
        </div>
        <div>
