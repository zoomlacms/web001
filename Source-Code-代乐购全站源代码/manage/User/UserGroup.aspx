<%@ page language="C#" autoeventwireup="true" inherits="manage_User_RoomManage, App_Web_pwasdykj" enableEventValidation="false" viewStateEncryptionMode="Never" %>
<!DOCTYPE HTML>
<html>
<head runat="server">
<title>用户组管理</title>
...
<div class="r_navigation">后台管理 &gt;&gt;企业办公 &gt;&gt;网页聊天系统&gt;&gt;<a href="UserGroup.aspx">添加用户组</a></div>
<div>
        ...
        <tbody id="Tabs0">
            <tr class="tdbg" onmouseover="this.className='tdbgmouseover'" onmouseout="this.className='tdbg'">
                <td class="tdbgleft" style="width: 20%" align="right">
                    <asp:Label ID="ssjd_txt" runat="server" Text="用户组名称："></asp:Label>
                    &nbsp;
                </td>
                <td class="bqright">
