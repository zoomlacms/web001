<%@ page language="C#" autoeventwireup="true" inherits="manage_User_RuleList, App_Web_pwasdykj" enableEventValidation="false" viewStateEncryptionMode="Never" %>
                ...
                <tr class="title">
                    ...
                    <td align="right">
                        <asp:TextBox ID="TxtKeyWord" runat="server" class="l_input"></asp:TextBox>&nbsp;&nbsp;<asp:Button
                            ID="BtnSearch" runat="server" Text="查找" OnClick="BtnSearch_Click" class="C_input" /></td>
                </tr>
                <tr>
