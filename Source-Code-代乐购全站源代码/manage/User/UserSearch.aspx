<%@ page language="C#" autoeventwireup="true" inherits="manage_User_UserSearch, App_Web_pwasdykj" enableEventValidation="false" viewStateEncryptionMode="Never" %>
...
<body>
    ...
    <div class="r_navigation">
        ...
        <span><a href="UserManage.aspx">会员管理</a></span> &gt;&gt;会员搜索
    </div>
    <div class="clearbox">
    </div>
    <table cellpadding="2" cellspacing="1" class="border" style="background-color: white;"
       ...
       <tr class="tdbgleft" onmouseover="this.className='tdbgmouseover'" onmouseout="this.className='tdbg'">
        ...
        <tr class="tdbgleft" onmouseover="this.className='tdbgmouseover'" onmouseout="this.className='tdbg'">
           ...
           <td><strong id="strgroup" runat="server" visible="true">
                    <asp:DropDownList ID="ddlGroup" runat="server" CssClass="x_input">
                    </asp:DropDownList>
                </strong></td>
           </tr>
       <tbody id="Search" runat="server" >
        <tr  class="tdbgleft" onmouseover="this.className='tdbgmouseover'" onmouseout="this.className='tdbg'">
           <td>登陆日期查找</td>
            <td><strong id="strtime" runat="server">
                <asp:TextBox ID="txtSteatTime" runat="server" Height="22px" Width="160px" onclick="calendar()"
                    class="l_input"></asp:TextBox>到
                <asp:TextBox ID="txtEndTime" runat="server"  Height="22px" Width="160px" onclick="calendar()" class="l_input"></asp:TextBox></strong>
            </td>
            </tr>
        <tr class="tdbgleft" onmouseover="this.className='tdbgmouseover'" onmouseout="this.className='tdbg'">
              <td> Email:</td>
        ...
        <tr class="tdbgleft" onmouseover="this.className='tdbgmouseover'" onmouseout="this.className='tdbg'">
            ...
            <td><strong id="strgroup0" runat="server" visible="true">
                    <asp:DropDownList ID="ddlApprove" runat="server" DataTextField="GroupName" 
                    DataValueField="GroupID" CssClass="x_input">
      ...
      <tr class="tdbgleft" onmouseover="this.className='tdbgmouseover'" onmouseout="this.className='tdbg'">
       <td colspan="2" align="center"><asp:Button ID="btnSearch" runat="server" 
               Text="搜  索" class="C_input" Style="height: 25px" Width="100px" 
               onclick="btnSearch_Click" />
            <asp:Button ID="btnlist" runat="server" Text="返回列表" OnClientClick="location.href='UserManage.aspx';return false;"  class="C_input" Style="height: 25px" Width="100px" />
            </td>
       </tr>
    </table>
    <div class="clearbox">
