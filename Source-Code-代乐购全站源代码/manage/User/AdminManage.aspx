<%@ page language="C#" autoeventwireup="true" inherits="ZoomLaManage.WebSite.Manage.User.AdminManage, App_Web_d0ltifsq" title="管理员管理" tracemode="SortByCategory" enableEventValidation="false" viewStateEncryptionMode="Never" %>
...
<body>
    ...
    <span>后台管理</span> &gt;&gt; <span>用户管理</span> &gt;&gt; <a href="AdminManage.aspx">管理员管理</a> <asp:Label ID="Label1" runat="server" Text=""></asp:Label>&nbsp;<a href="AddManage.aspx<%=Getroleid() %>">[添加管理员]</a>
    </div>
    <div class="clearbox"></div>
    <asp:GridView ID="Egv" runat="server" AllowPaging="True" 
        AutoGenerateColumns="False" CssClass="border" DataKeyNames="AdminID" 
        OnRowEditing="Egv_RowEditing" OnPageIndexChanging="Egv_PageIndexChanging" 
    ...
    <asp:Button ID="Button2" class="C_input" runat="server" Font-Size="9pt" Text="批量删除" OnClick="Button2_Click" 
