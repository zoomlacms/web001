<%@ page language="C#" autoeventwireup="true" inherits="ZoomLa.WebSite.Manage.User.MailList, App_Web_pwasdykj" enableEventValidation="false" viewStateEncryptionMode="Never" %>
...
<body>
    ...
    <table width="100%" border="0" cellpadding="2" cellspacing="1" class="border">
            ...
            <td style="text-align: left">
                <table>
                    ...
                    <tr>
                        ...
                        <td>
                            <asp:TextBox class="l_input" ID="TxtUserName" runat="server" Width="260px"></asp:TextBox>
                            <span style="color: blue"><=【</span><a href="javascript:void(0)" onclick="SelectUser();"><span style="color: green">会员列表</span></a><span
                    ...
                    <tr>
                        ...
                        <td>
                            <asp:TextBox class="l_input" ID="TxtEmails" runat="server" Width="260px"></asp:TextBox>
        ...
        <tr class="tdbg" onmouseover="this.className='tdbgmouseover'" onmouseout="this.className='tdbg'">
            ...
            <td>
                <asp:TextBox class="l_input" ID="TxtSubject" runat="server" Width="390px"></asp:TextBox>
        ...
        <tr class="tdbg" onmouseover="this.className='tdbgmouseover'" onmouseout="this.className='tdbg'">
            ...
            <td>
                <asp:TextBox class="x_input" ID="TxtContent" runat="server" Height="158px" TextMode="MultiLine" Width="476px"></asp:TextBox></td>
        </tr>
        <tr class="tdbg" onmouseover="this.className='tdbgmouseover'" onmouseout="this.className='tdbg'">
            <td align="right" class="tdbgleft">
                <strong>发件人：</strong></td>
            <td>
                <asp:TextBox class="l_input" ID="TxtSenderName" runat="server" Width="350px"></asp:TextBox>
            </td>
        </tr>
        <tr class="tdbg" onmouseover="this.className='tdbgmouseover'" onmouseout="this.className='tdbg'">
            <td align="right" class="tdbgleft">
            ...
            <td>
                <asp:TextBox class="l_input" ID="TxtSenderEmail" runat="server" Width="350px"></asp:TextBox>
