<%@ page language="C#" autoeventwireup="true" inherits="manage_User_AddVideohall, App_Web_pwasdykj" enableEventValidation="false" viewStateEncryptionMode="Never" %>
...
<body>
    ...
    <div class="r_navigation">
        <span>后台管理</span> &gt;&gt; <span>用户管理</span> &gt;&gt; 多人视频管理 &gt;&gt; 房间管理 &gt;&gt; 
    ...
    <table width="99%" cellspacing="1" cellpadding="0" class="border" align="center">
        <tr>
            <td align="center" class="spacingtitle" colspan="2" style="height: 22px">
                <asp:Literal ID="LblTitle" Text="添加大厅" runat="Server"></asp:Literal>
            </td>
        </tr>
        ...
        <tr class="tdbg" onmouseover="this.className='tdbgmouseover'" onmouseout="this.className='tdbg'">
            ...
            <td style="width: 100px">
                <asp:TextBox ID="txt_MaxPerson" runat="server" class="l_input" Text="0" Width="76px"></asp:TextBox> &nbsp;</td>
        </tr>
        <tr class="tdbg" onmouseover="this.className='tdbgmouseover'" onmouseout="this.className='tdbg'">
            <td class="leftwidth" align="right">
                排序：
       ...
       <%-- <tr class="tdbg" onmouseover="this.className='tdbgmouseover'" onmouseout="this.className='tdbg'">
        ...
        <tr class="tdbg">
            <td align="center" class="tdbgleft" colspan="2">
                <asp:Button ID="btnSave" runat="server" Text="添加大厅" Width="95px" OnClick="Button2_Click"
                    class="C_input" />
                <asp:Button ID="btnBack" class="C_input" runat="server" Text="返回大厅列表" Width="100px"
