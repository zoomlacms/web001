<%@ page language="C#" autoeventwireup="true" inherits="manage_User_SelectFrient, App_Web_d0ltifsq" enableeventvalidation="false" viewStateEncryptionMode="Never" %>
<!DOCTYPE HTML>
<html>
<head runat="server">
    <title>查找好友</title>
  ...
  <form id="form1" runat="server">
    <div id="TopDiv" runat="server">    
	    <div class="friends">
           ...
           <li> <asp:Button Text="查找好友" CssClass="C_input" id="button1" runat="server"  onclick="button1_Click" />&nbsp;&nbsp;
             ...
             <asp:Button ID="Button4" Text="添加好友" runat="server" CssClass="C_input" onclick="Button4_Click" CausesValidation="false" />                 
               共<asp:Label ID="Allnum" runat="server" Text=""></asp:Label>条数据
                ...
                AutoPostBack="True" onselectedindexchanged="DropDownList1_SelectedIndexChanged">
                        ...
                        <asp:LinkButton runat="server" Text="返回上页面" onclick="Unnamed1_Click"></asp:LinkButton>
            </td>
        </tr>
    </table>    
    </div>
