<%@ page language="C#" autoeventwireup="true" inherits="ZoomLa.WebSite.Manage.User.GroupPermissions, App_Web_pwasdykj" enableEventValidation="false" viewStateEncryptionMode="Never" %>
...
<body>
    ...
    <div class="r_navigation">
        ...
        <span>后台管理</span>&gt;&gt;<span>用户管理</span> &gt;&gt;<a href="GroupManage.aspx">会员组管理</a>&gt;&gt;<span>会员组权限设置</span>
    </div>
    <div class="clearbox">
    </div>
    <table width="99%" cellspacing="1" cellpadding="0" class="border" align="center">
        ...
        <tr class="tdbg" onmouseover="this.className='tdbgmouseover'" onmouseout="this.className='tdbg'">
            ...
            <td>
                每天最多发布<asp:TextBox ID="TxtCCountPerDay" Columns="5" runat="server" class="l_input">0</asp:TextBox>条信息（不想限制请设置为0）。
            </td>
        </tr>
        <tr class="tdbg" onmouseover="this.className='tdbgmouseover'" onmouseout="this.className='tdbg'">
            <td class="tdbgleft" align="right" style="width: 100px;">
            ...
            <td>
                会员收藏夹内最多可收录<asp:TextBox ID="TxtFavCount" Columns="5" runat="server" class="l_input">0</asp:TextBox>条信息（如果为0，则没有收藏权限）
            </td>
        </tr>
        <tr class="tdbg" onmouseover="this.className='tdbgmouseover'" onmouseout="this.className='tdbg'">
            <td class="tdbgleft" align="right" style="width: 100px;">
        ...
        <tr class="tdbg" onmouseover="this.className='tdbgmouseover'" onmouseout="this.className='tdbg'">
            <td class="tdbgleft" align="right" style="width: 100px;">
                <strong>节点权限设置：</strong>
            </td>
            <td>
                &nbsp;<asp:ListBox ID="UserPromotions" runat="server" Height="213px" 
                    Width="488px" SelectionMode="Multiple"></asp:ListBox>
                <br />
                ...
                <asp:Button ID="Button2" runat="server" Text="删除" CssClass="C_input" 
                    onclick="Button2_Click" OnClientClick="return confirm('确实要删除该权限吗？')" />
            </td>
        </tr>
        <tr class="tdbg">
            <td align="center" class="tdbgleft" colspan="2" style="height: 79px">
                &nbsp;<asp:Button ID="btnSave" runat="server" OnClick="btnSave_Click" Text="保存权限设置"
                    class="C_input" />
                &nbsp; &nbsp;&nbsp;<input id="Button1" type="button" value="返回" onclick="javascript:window.location.href='GroupManage.aspx'"
                    class="C_input" /><asp:HiddenField ID="HdnGroupID" runat="server" />
            </td>
        </tr>
    </table>
    </form>
