<%@ page language="C#" autoeventwireup="true" inherits="manage_Config_PermissionInfo, App_Web_d0ltifsq" enableviewstate="false" enableEventValidation="false" viewStateEncryptionMode="Never" %>
<!DOCTYPE HTML>
<html>
...
<div class="r_navigation">		
	<span>后台管理</span> &gt;&gt; <span>角色管理</span> &gt;&gt; <span><a href="PermissionInfo.aspx">角色管理</a></span>&nbsp;&nbsp;<a href="Permissionadd.aspx">[添加角色]</a>
</div>
...
<table class="border" cellspacing="1" cellpadding="0" width="100%" border="0" align="center">
    ...
    <tr class="tdbg" onmouseover="this.className='tdbgmouseover'" onmouseout="this.className='tdbg'">
            ...
            OnTextChanged="txtPage_TextChanged" Width="30px"></asp:TextBox>条信息/页  转到第<asp:DropDownList ID="DropDownList1" runat="server" AutoPostBack="True">
            </asp:DropDownList>页
            </td>
        </tr>
