<%@ page language="C#" title="发送信息" autoeventwireup="true" inherits="User.MessageSend, App_Web_d0ltifsq" enableEventValidation="false" viewStateEncryptionMode="Never" %>
<!DOCTYPE HTML>
 ...
 <table width="100%" border="0" cellpadding="2" cellspacing="1" class="border">
        ...
        <tr class="tdbg" onmouseover="this.className='tdbgmouseover'" onmouseout="this.className='tdbg'">
            ...
            <td>
                <table id="TblAddMessage" width="100%" visible="true" runat="server">
                    ...
                    <tr>
                        <td>
                            <asp:RadioButton ID="RadIncept3" runat="server" Text="指定用户名" GroupName="InceptGroup" /><asp:TextBox class="l_input" ID="TxtInceptUser" runat="server" Width="326px"></asp:TextBox>
                        </td>
                        <td>
        ...
        <tr class="tdbg" onmouseover="this.className='tdbgmouseover'" onmouseout="this.className='tdbg'">
            <td align="right" style="height: 28px; width: 15%;">
                短消息主题：</td>
            <td>
                <asp:TextBox class="l_input" ID="TxtTitle" runat="server" Width="300px"> </asp:TextBox><font color=red>*</font>
        ...
        <tr class="tdbg" onmouseover="this.className='tdbgmouseover'" onmouseout="this.className='tdbg'">
            <td align="right" style="height: 23px; width: 15%;">
                短消息内容：</td>
            <td>
                <asp:TextBox class="x_input" ID="EditorContent" runat="server" Rows="10" TextMode="MultiLine" Width="99%"></asp:TextBox> <font color=red>*</font>               
