<%@ page language="C#" title="发送短信息" autoeventwireup="true" inherits="User.Message, App_Web_d0ltifsq" enableEventValidation="false" viewStateEncryptionMode="Never" %>
...
<body>
    ...
    <div>
        <table width="100%" border="0" cellpadding="0" cellspacing="1" class="border" align="center">
            ...
            <tr class="tdbg" onmouseover="this.className='tdbgmouseover'" onmouseout="this.className='tdbg'">
                <td align="right" style="height: 28px; width: 45%;">
                    ...
                    </strong>可以用英文状态下的逗号将用户名隔开实现多会员同时删除
                </td>
                <td style="height: 28px; width: 511px;">
                    ...
                    <asp:Button ID="BtnDelSender" runat="server" Text="删除" OnClientClick="return confirm('确定要删除吗？');"
                        OnClick="BtnDelSender_Click" class="C_input" />
                </td>
            </tr>
            <tr class="tdbg" onmouseover="this.className='tdbgmouseover'" onmouseout="this.className='tdbg'">
                <td align="right" style="height: 28px; width: 45%;">
                ...
                <td style="height: 28px; width: 511px;">
                    ...
                    <asp:Button ID="BtnDelDate" runat="server" Text="删除" OnClientClick="return confirm('确定要删除吗？');"
                        OnClick="BtnDelDate_Click" class="C_input" />
                </td>
            </tr>
        </table>
        <div class="clearbox">
        ...
        <div class="divbox" id="nocontent" runat="server">
            <div style="width: 100%; height: 19px; text-align: center;" class="title">
                消&nbsp;息&nbsp;管&nbsp;理</div>
            暂无短消息</div>
        <div class="clearbox">
        </div>
        <asp:GridView ID="GridView1" runat="server" Width="100%" AutoGenerateColumns="False"
            ...
            OnRowCommand="Row_Command" CssClass="border">
            <Columns>
                ...
                <asp:TemplateField HeaderText="短消息主题">
                    <ItemTemplate>
                        <a href="MessageRead.aspx?id=<%#Eval("MsgID")%>" title='<%# Eval("Title")%>'>
                            <%# Eval("Title")%></a>
                    </ItemTemplate>
                ...
                <asp:TemplateField HeaderText="收件人状态">
                    ...
                    <ItemTemplate>
                        <%#GetInceptStatus(Convert.ToInt32(Eval("MsgID")))%>
                    </ItemTemplate>
                    <ItemStyle CssClass="tdbg" HorizontalAlign="Center" />
                </asp:TemplateField>
                ...
                <asp:TemplateField HeaderText="发件人状态">
                    <ItemTemplate>
                        <%#GetSenderStatus(Convert.ToInt32(Eval("MsgID")))%>
                    </ItemTemplate>
