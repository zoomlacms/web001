<%@ page language="C#" autoeventwireup="true" inherits="manage_User_EidtMailModel, App_Web_d0ltifsq" enableEventValidation="false" viewStateEncryptionMode="Never" %>
            ...
            <tr class="tdbg">
                ...
                <tr style="width: 100%" class="tdbg">
                    <td colspan="2" align="center">
                        <asp:Button ID="Button1" runat="server" Text="提  交"  class="C_input"/>
                    </td>
                </tr>
            </table>
        </div>
