<%@ page language="C#" autoeventwireup="true" inherits="manage_User_AddSubscriptionCount, App_Web_pwasdykj" enableEventValidation="false" viewStateEncryptionMode="Never" %>
<!DOCTYPE HTML>
<html>
...
<form id="form1" runat="server">
    <div class="r_navigation">
        ...
        <span>后台管理</span> &gt;&gt; <span>附件管理</span> &gt;&gt; <span><a href="SubscriptListManage.aspx?menu=all">订阅管理</a></span>&gt;&gt;
