<%@ page language="C#" autoeventwireup="true" inherits="ZoomLaManage.WebSite.Manage.User.AddManage, App_Web_d0ltifsq" title="编辑管理员" enableEventValidation="false" viewStateEncryptionMode="Never" %>
<!DOCTYPE HTML>
<html>
...
<span>后台管理</span>&gt;&gt;<span><a href="AdminManage.aspx">管理员管理</a></span> &gt;&gt;编辑管理员
</div>
...
<table border="0" cellpadding="0" cellspacing="0">
      ...
      <tbody id="Tabs0">
        ...
        <tr class="tdbg" onmouseover="this.className='tdbgmouseover'" onmouseout="this.className='tdbg'">
            <td class="tdbgleft" style="width: 25%; height: 23px;">
                <strong>管理员名：</strong></td>
            <td style="height: 23px">
                <asp:TextBox ID="tbdName" runat="server" class="l_input"></asp:TextBox> 管理员名必须大于等于2个字符并且不能超过20个字符
          ...
          <tr class="tdbg" onmouseover="this.className='tdbgmouseover'" onmouseout="this.className='tdbg'">
            ...
            <td style="height: 23px">
                <asp:TextBox ID="txtAdminTrueName" runat="server" class="l_input"></asp:TextBox> 管理员真实姓名必须大于等于2个字符并且不能超过20个字符
        ...
        <tr class="tdbg" onmouseover="this.className='tdbgmouseover'" onmouseout="this.className='tdbg'">
            ...
            <td>
                <asp:TextBox ID="tbPwd" runat="server" TextMode="Password" Width="150px" class="l_input"></asp:TextBox> 管理员密码字符数要在3-18之间<strong>&nbsp;
        ...
        <tr class="tdbg" onmouseover="this.className='tdbgmouseover'" onmouseout="this.className='tdbg'">
            <td class="tdbgleft" style="width: 25%; height: 41px;">
                <strong>确认密码：</strong></td>
            <td>
                <asp:TextBox ID="tbPwd1" runat="server" TextMode="Password" Width="149px" class="l_input"></asp:TextBox> 确认密码必须与密码保持一致 <asp:HiddenField ID="HdnPwd" runat="server" />
        ...
        <tr class="tdbg" onmouseover="this.className='tdbgmouseover'" onmouseout="this.className='tdbg'">
            <td class="tdbgleft"style="width: 25%;" valign="middle">
        ...
        <tr id="showmenu" runat="server">
            <td class="title" align="left" colspan="2"　style="height: 23px">
         ...
         <tr class="tdbg" onmouseover="this.className='tdbgmouseover'" id="Tr1" runat="server" visible="true" onmouseout="this.className='tdbg'">
            <td class="tdbgleft" align="right">
                ...
                <td align="left" class="style2"  colspan="3">
                    <asp:TextBox ID="tbQuestion" runat="server" Width="220px" class="l_input"></asp:TextBox><span style="color: red">*</span>
         ...
         <tr class="tdbg" onmouseover="this.className='tdbgmouseover'" id="Tr2" runat="server" visible="true" onmouseout="this.className='tdbg'">
            <td class="tdbgleft" align="right">
                ...
                <td align="left" class="style2"  colspan="3">
                    <asp:TextBox ID="tbAnswer" runat="server" Width="220px" class="l_input"></asp:TextBox><span style="color: red">*</span>
                    <asp:RequiredFieldValidator ID="RequiredFieldValidator3" runat="server" ControlToValidate="tbAnswer" ErrorMessage="提示答案不能为空" Display="Dynamic"></asp:RequiredFieldValidator>
                </td>
        </tr>
        <tr class="tdbg" onmouseover="this.className='tdbgmouseover'" id="viewmail" runat="server" visible="true" onmouseout="this.className='tdbg'">
            <td class="tdbgleft" align="right">
                ...
                <td align="left" class="style2"  colspan="3">
                    <asp:TextBox ID="tbEmail" runat="server" Width="220px" class="l_input"></asp:TextBox ><span style="color: red">*</span>
        ...
        <tr class="tdbg" onmouseover="this.className='tdbgmouseover'" onmouseout="this.className='tdbg'">
            <td class="tdbgleft" style="width:25%">
                <strong>管理员角色设置：</strong></td>
            <td align="left" valign="top">
                <asp:CheckBoxList ID="cblRoleList" runat="server" BorderStyle="Solid" DataTextField="RoleName" DataValueField="RoleID"/>
            </td>
        </tr>    
          <tr class="tdbg" onmouseover="this.className='tdbgmouseover'" onmouseout="this.className='tdbg'">
            <td class="tdbgleft" style="width:25%">
                <strong>默认节点控制权限：</strong></td>
            <td align="left" valign="top">         
        ...
        <tbody id="Tabs2" style=" display:none">
          <tr class="tdbg" onmouseover="this.className='tdbgmouseover'" onmouseout="this.className='tdbg'">
            <td class="tdbgleft" style="width:25%">
                <strong>是否前台审核互动：</strong></td>
            <td  valign="top">
                <asp:CheckBox ID="CheckBox1" Checked runat="server" />
            </td>
        </tr>       
        <tr class="tdbg" onmouseover="this.className='tdbgmouseover'" onmouseout="this.className='tdbg'">
            <td class="tdbgleft" style="width:25%">
                <strong>发布内容默认状态：</strong></td>
            <td  valign="top">       
        ...
        <tr class="tdbg">
            <td class="tdbgleft" colspan="2" style="height: 23px" align="center">
                <asp:Button ID="btnSubmit" class="C_input" runat="server" OnClick="btnSubmit_Click" Text="保　存" />
                &nbsp;
                <asp:Button ID="btnCancel" class="C_input" runat="server" Text="取 消" OnClientClick="location.href='AdminManage.aspx';return false;" />&nbsp;</td>
        </tr>
        </table>    
