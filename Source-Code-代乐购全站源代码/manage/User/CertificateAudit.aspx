<%@ page language="C#" autoeventwireup="true" inherits="manage_User_CertificateAudit, App_Web_pwasdykj" enableEventValidation="false" viewStateEncryptionMode="Never" %>
...
<body style="background: none">
    ...
    <div class="r_navigation">
        ...
        <span><a href="CertificateAudit.aspx">证书审核</a></span>
    </div>
    <div class="clearbox">
    </div>
    <table cellpadding="2" cellspacing="1" class="border" style="background-color: white;"
        width="100%">
        <tr>
            <td class="spacingtitle" align="center" colspan="3">
                证书审核
            </td>
        </tr>
        <tr class="tdbgleft" onmouseover="this.className='tdbgmouseover'" onmouseout="this.className='tdbg'">
            <td>
                关键字：<asp:TextBox ID="TextBox1" runat="server" Width="102px" CssClass="l_input"></asp:TextBox>
                认证状态：
                ...
                指定用户：<asp:TextBox ID="TextBox2" runat="server" Width="102px" CssClass="l_input"></asp:TextBox>
                <asp:Button ID="Button2" runat="server" Text="搜  索" class="C_input" Style="height: 20px"
    ...
    <asp:GridView ID="Egv" runat="server" AutoGenerateColumns="False" CssClass="border"
        Width="100%" OnRowCommand="Lnk_Click">
        <Columns>
            ...
            <asp:TemplateField HeaderText="操作">
                <ItemTemplate>
                    ...
                    | <a href='CertificateAuditInfo.aspx?UserID=<%# Eval("UserID")%>'>进行认证</a>
                </ItemTemplate>
                <HeaderStyle Width="10%" />
                <ItemStyle HorizontalAlign="Center" />
            </asp:TemplateField>
