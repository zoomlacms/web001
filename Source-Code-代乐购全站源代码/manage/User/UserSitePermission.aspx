<%@ page language="C#" autoeventwireup="true" inherits="manage_User_UserSitePermission, App_Web_pwasdykj" enableEventValidation="false" viewStateEncryptionMode="Never" %>
<!DOCTYPE HTML>
<html>
...
<span>后台管理</span> &gt;&gt; <span>用户管理</span> &gt;&gt; <span>会员管理</span> &gt;&gt; <span><a href="UserManage.aspx">会员列表</a></span> &gt;&gt; <span>设置<%=Username %>会员权限</span>
</div>
<div class="clearbox">
</div>
...
<tr class="gridtitle" align="center" style="height: 25px;">
    <td height="26" colspan="2">
        <strong>设置<%=Username %>会员权限</strong>
    </td>
</tr>
...
<asp:UpdatePanel ID="UpdatePanel1" runat="server">
    <ContentTemplate>
        ...
        <tbody id="tdPermission" runat="server">
            ...
            <tr class="tdbg">
                <td height="24" class="tdbgleft" style="width: 137px">
            ...
            <tr class="tdbg">
                <td class="tdbgleft" style="height: 24px; width: 20%;">
...
<tr class="tdbg">
    <td height="26" colspan="2" class="tdbgleft" align="center">
        ...
        <asp:Button ID="Button2" runat="server" Text="返回列表" OnClientClick="location.href='UserManage.aspx';return false;" class="C_input"/>
    </td>
</tr>
</table>
</form>
