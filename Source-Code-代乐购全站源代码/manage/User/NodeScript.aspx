<%@ page language="C#" autoeventwireup="true" inherits="manage_User_NodeScript, App_Web_pwasdykj" enableEventValidation="false" viewStateEncryptionMode="Never" %>
    ...
    <table width="99%" cellspacing="1" cellpadding="0" class="border" align="center">
        ...
        <tr class="tdbg">
            <td class="tdbgleft" align="right" style="width: 100px;">
                <asp:ListBox ID="NodeList" runat="server" Height="282px" Width="258px" 
                    SelectionMode="Multiple"></asp:ListBox>
            </td>
            <td valign="top" style="padding:10px;" >
                <asp:CheckBoxList ID="CheckBoxList1" runat="server" CellSpacing="10">
                ...
                <asp:Button ID="Button2" runat="server" Text="取消" CssClass="C_input" OnClientClick="parent.Dialog.close();return false;" />
            </td>
        </tr>
    </table>
    </form>
