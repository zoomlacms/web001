<%@ page language="C#" autoeventwireup="true" inherits="manage_User_AddUserModel, App_Web_d0ltifsq" enableEventValidation="false" viewStateEncryptionMode="Never" %>
...
<body>
    ...
    <div class="r_navigation">
        ...
        <span>后台管理</span>&gt;&gt;<span><a href="UserManage.aspx">会员管理</a></span> &gt;&gt;会员模型管理
        &gt;&gt; <a href="SystemUserModel.aspx">系统会员模型字段列表</a> &gt;&gt; 添加系统会员字段
    </div>
    <div class="clearbox">
    </div>
