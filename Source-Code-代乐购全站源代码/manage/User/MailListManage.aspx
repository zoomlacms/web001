<%@ page language="C#" autoeventwireup="true" inherits="manage_User_MailListManage, App_Web_pwasdykj" enableEventValidation="false" viewStateEncryptionMode="Never" %>
    ...
    <form id="form1" runat="server">
        ...
        <div>
            <table width="100%" border="0" cellpadding="2" cellspacing="1" class="border">
                ...
                <tr class="tdbg">
                    <td >
                        ...
                        <asp:DropDownList ID="DropDownList2" runat="server" AutoPostBack="True" OnSelectedIndexChanged="DropDownList2_SelectedIndexChanged">
                                ...
                                <td>
                                    <asp:TextBox class="l_input" ID="txtType" runat="server"></asp:TextBox></td>
                                <td>
                                    <asp:Panel ID="Panel1" Visible="false" runat="server" Width="300px" Height="20px">
                                        ...
                                        ~
                                        <asp:TextBox class="l_input" ID="txtEndTime" onfocus="setday(this)" runat="server"></asp:TextBox>&nbsp;<br />
                                        &nbsp;
                                ...
                                <td>
                                    <asp:Button ID="Button1" runat="server" OnClick="Button1_Click" Text="查 询" class="C_input"/>
                                </td>
                            </tr>
                ...
                <tr class="tdbg">
                <td>添加邮箱地址：<asp:TextBox class="l_input" ID="txtMail" runat="server" Width="200px"></asp:TextBox>  <asp:Button ID="Button2"
                    runat="server" Text="添  加" OnClick="Button2_Click" class="C_input"/>
