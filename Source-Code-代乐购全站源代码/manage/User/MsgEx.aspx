<%@ page language="C#" autoeventwireup="true" inherits="manage_User_MsgEx, App_Web_pwasdykj" enableEventValidation="false" viewStateEncryptionMode="Never" %>
<!DOCTYPE HTML>
<html>
<head runat="server">
    <title>聊天记录</title>
...
<body>
    ...
    <div>
        <div class="r_navigation"><span>后台管理</span>&gt;&gt;<span>企业办公</span>&gt;&gt;<span>聊天记录</span></div>
            ...
            <ItemTemplate>
                <tr class="tdbg" onmouseover="this.className='tdbgmouseover'" onmouseout="this.className='tdbg'" id="<%#Eval("ID") %>" ondblclick="ShowTabs(this.id)">
                    ...
                    <td height="22" align="center">
                     <a href="ShowMinute.aspx?cid=<%#Eval("ID")%>">详细</a> <a href="?menu=delete&cid=<%#Eval("ID")%>" onclick="return confirm('确实要删除此学员吗？');">删除</a>
                    </td>
                </tr>
            </ItemTemplate>
        </asp:Repeater>
