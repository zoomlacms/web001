<%@ page language="C#" autoeventwireup="true" inherits="manage_User_SelectUserName, App_Web_pwasdykj" enableEventValidation="false" viewStateEncryptionMode="Never" %>
...
<body>
    ...
    <table width="100%" cellspacing="1" cellpadding="0" class="border">
        ...
        <asp:Repeater ID="Repeater1" runat="server">
            <ItemTemplate>
                <tr class="tdbg" onmouseover="this.className='tdbgmouseover'" onmouseout="this.className='tdbg'">
                   ...
                   <asp:HiddenField ID="hfId" runat="server" Value='<%# Eval("UserID") %>' /> <asp:CheckBox ID="chkSel" runat="server" /></td>
                    <td align="center" style="height: 24px;">
                        <%#Eval("UserID")%>
                    </td>
                    <td align="center" style="height: 24px;">
        ...
        <tr class="tdbg">
         <td class="tdbg" style="height: 24px;" colspan="5"> 
         <asp:CheckBox ID="CheckSelectAll" runat="server" AutoPostBack="True" OnCheckedChanged="CheckSelectAll_CheckedChanged" Text="全选" />
         <asp:Button ID="btnSelect" runat="server" class="C_input" OnClick="btnSelect_Click"
                            OnClientClick="if(!IsSelectedId()){alert('请选择用户');return false;}else{return true;}"
                            Text="批量投递用户" Width="134px" /></td>
        </tr>
        <tr class="tdbg">
