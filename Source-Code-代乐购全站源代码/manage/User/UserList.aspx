<%@ page language="C#" autoeventwireup="true" inherits="manage_User_UserList, App_Web_pwasdykj" enableEventValidation="false" viewStateEncryptionMode="Never" %>
...
<body>
    ...
    <div>
            <table width="100%" border="0" cellpadding="2" cellspacing="0" class="border">
                ...
                <tr class="tdbg">
                    <td align="left">
                        <input type="text" class="l_input" id="UserNameList" size="60" maxlength="200" readonly="readonly"
                            />
                        <input type="hidden" name="HdnUserName" id="HdnUserName" value="" /></td>
                    <td align="center">
                        <input type="button" class="C_input"  name="del1" onclick="del(1)" value="删除最后" />
            ...
            <table width="100%" border="0" cellpadding="2" cellspacing="0" class="border">
                <tr class="title">
                    <td align="left">
                        <b>会员列表：</b></td>
                    <td align="right">
                        <asp:TextBox ID="TxtKeyWord" class="l_input" runat="server"></asp:TextBox>&nbsp;&nbsp;<asp:Button class="C_input" 
