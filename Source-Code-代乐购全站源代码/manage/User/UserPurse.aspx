<%@ page language="C#" autoeventwireup="true" inherits="manage_User_UserPurse, App_Web_pwasdykj" enableEventValidation="false" viewStateEncryptionMode="Never" %>
...
<div class="r_navigation">
	...
	<span>后台管理</span> &gt;&gt; <span>用户管理</span> &gt;&gt; <span>会员管理</span> &gt;&gt; <span><a href='UserManage.aspx'>会员列表</a></span> &gt;&gt; <span>会员资金操作</span>
</div>
    ...
    <tr class="tdbg">
     ...
     <tr class="tdbg">
        <td class="tdbgleft" style="width: 20%" align="right">                    
            资金：</td>
        <td class="bqright">
            <asp:TextBox ID="TxtScore" runat="server" CssClass="l_input"></asp:TextBox>
     ...
     <tr class="tdbgbottom">
        <td colspan="2">
            ...
            <asp:Button ID="Button1" Text="取 消" runat="server" class="C_input" CausesValidation="false"
...
<table  width="100%" border="0" cellpadding="5" cellspacing="1" class="border">
    ...
    <tr>
        <td colspan="4"><asp:Label ID="Allnum" runat="server" Text=""></asp:Label>条数据
