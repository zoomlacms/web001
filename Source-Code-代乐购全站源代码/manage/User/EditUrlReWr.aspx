<%@ page language="C#" autoeventwireup="true" inherits="manage_User_EditUrlReWr, App_Web_d0ltifsq" enableEventValidation="false" viewStateEncryptionMode="Never" %>
...
<body>
    ...
    <div class="r_navigation">
        ...
        <span>后台管理</span> &gt;&gt; <span>系统配置</span> &gt;&gt; <a href="UrlReWr.aspx">栏目变子站管理</a>
    </div>
    <div class="clearbox">
    </div>
    <div>
        <table width="100%" cellpadding="2" cellspacing="1" border="0" class="r_navigation">
            ...
            <tr class="WebPart">
                <td class="style4" align="right">
                  转换记录标题名称：</td>
                <td>
                <asp:TextBox ID="KeyName" runat="server" Width="240px"></asp:TextBox>
               ...
               <tr class="WebPart">
                ...
                <td>
                    <asp:RadioButtonList runat="server" AutoPostBack="True" 
                        RepeatDirection="Horizontal" ID="xuan" 
                        onselectedindexchanged="Unnamed1_SelectedIndexChanged" Height="16px">
              ...
              <tr class="WebPart" id="two" runat="server">
                ...
                <td>
               <asp:RadioButtonList runat="server" AutoPostBack="True" 
                        RepeatDirection="Horizontal" ID="RadioButtonList1" onselectedindexchanged="RadioButtonList1_SelectedIndexChanged" 
                      >
              ...
              <tr class="WebPart">
                <td height="22" class="style4" align="right">
                   请求来源地址：</td>
                <td>
                <asp:TextBox ID="UrlLook" runat="server" Width="311px"></asp:TextBox>
                    <br />
               ...
               <tr class="WebPart">
                ...
                <td>
                <asp:TextBox ID="UrlSend" runat="server" Width="311px"></asp:TextBox> 
                    <br />
             ...
             <tr class="WebPart">
                ...
                <td>
                    ...
                    <asp:HiddenField ID="HdnKeyName" runat="server" />            
                      <asp:HiddenField ID="HiddenUSend" runat="server" />
                </td>
            </tr>
        </table>
