<%@ page language="C#" autoeventwireup="true" inherits="manage_User_JobsRecycler, App_Web_pwasdykj" enableEventValidation="false" viewStateEncryptionMode="Never" %>
...
<body>
    ...
    <div class="r_navigation">
		...
		<span>后台管理</span>&gt;&gt;<span>人才系统管理回收站&gt;&gt;</span> 
        <asp:Label ID="Label1" runat="server" Text="Label"></asp:Label></div>
        <div class="r_navigation">
		
		&nbsp;&nbsp;&nbsp;&nbsp;<span><a href="JobsRecycler.aspx?modeid=qiye">招聘企业</a></span>
		&nbsp;&nbsp;&nbsp;&nbsp;<span><a href="JobsRecycler.aspx?modeid=zhappin">职位信息</a></span>
		&nbsp;&nbsp;&nbsp;&nbsp;<span><a href="JobsRecycler.aspx?modeid=geren">用户简历</a></span>
        </div>
    ...
    <div class="us_seta"  id="manageinfo" runat ="server">
       ...
       <asp:Button ID="btn_ResumeRecords" runat="server" OnClientClick="return judgeSelect();" Text="还原选中记录" OnClick="btn_ResumeRecords_Click" class="C_input"/>
         <asp:Button ID="Button1" runat="server" 
                Text="还原所有" onclick="Button1_Click" class="C_input"/>
           <asp:Button ID="Button2" runat="server" OnClientClick="return judgeSelect();" 
                Text="删除所有" onclick="Button2_Click"  class="C_input"/>
            </div>       
    </div>
    </form>
</body>
