<%@ page language="C#" autoeventwireup="true" inherits="User.UserManage, App_Web_pwasdykj" title="会员管理" enableEventValidation="false" viewStateEncryptionMode="Never" %>
<!DOCTYPE HTML>
<html>
...
<body>
    ...
    <div class="r_navigation">
        后台管理 &gt;&gt; <a href="AdminManage.aspx">用2户管理</a> &gt;&gt;<a href="UserManage.aspx">会员管理</a><asp:Label ID="LblGroup" runat="server" Text="Label"></asp:Label>
        <span class="red">[<asp:Label ID="lblAddUser" runat="server" Text=""></asp:Label>]</span>        
    </div>
    <div class="border">
    <ul>
    <li class="tdbg">
    ...
    <asp:GridView ID="Egv" runat="server" AutoGenerateColumns="False" CssClass="border"
        ...
        <Columns>
            ...
            <asp:TemplateField HeaderText="会员名">
                <ItemTemplate>
                    <a href="UserInfo.aspx?id=<%# Eval("UserID") %>"><asp:Label ID="Label1" runat="server" Text='<%# Bind("UserName") %>'></asp:Label></a>
                </ItemTemplate>
                <HeaderStyle Width="8%" />
                <ItemStyle HorizontalAlign="Center" />
            </asp:TemplateField>
