<%@ page language="C#" autoeventwireup="true" inherits="ZoomLa.WebSite.Manage.User.UserPassModify, App_Web_pwasdykj" enableEventValidation="false" viewStateEncryptionMode="Never" %>
<!DOCTYPE HTML>
<html>
<head runat="server">
<title>修改用户信息</title>
...
<span>后台管理</span> &gt;&gt; <span>用户管理</span> &gt;&gt; <span>会员管理</span> &gt;&gt;
<span><a href="UserManage.aspx">会员列表</a></span> &gt;&gt; 修改会员信息
</div>
<div class="clearbox"></div>
<table width="100%" border="0" cellpadding="0" cellspacing="1" class="border">
    <tr align="center">
        <td colspan="4" class="spacingtitle">
            <strong>修改<asp:Label ID="LblUserName" runat="server" Text="Label"></asp:Label>的信息</strong>
        </td>
    </tr>
    <tr><td colspan="4">
    <table>
    ...
    <tr class="tdbg" onmouseover="this.className='tdbgmouseover'" onmouseout="this.className='tdbg'">
        <td class="tdbgleft" style="width: 15%; height: 25px;" align="right">
            用户名：
        </td>
        ...
        <td style="width: 85%; height: 25px;" colspan="3" align="left">
           <asp:TextBox ID="txtHoneyName" runat="server" class="l_input"></asp:TextBox>
        </td>
    </tr>
    <tr class="tdbg" onmouseover="this.className='tdbgmouseover'" onmouseout="this.className='tdbg'">
        <td class="tdbgleft" style="width: 15%; height: 25px;" align="right">
    ...
    <tr class="tdbg" onmouseover="this.className='tdbgmouseover'" onmouseout="this.className='tdbg'">
        ...
        <td align="left">
            ...
            <asp:CompareValidator ID="CompareValidator1" runat="server" ErrorMessage="新密码和确认密码必须一样"
                ControlToValidate="tbConPwd" ControlToCompare="tbNewPwd"></asp:CompareValidator>
        </td>
    ...
    <tr class="tdbg" onmouseover="this.className='tdbgmouseover'" onmouseout="this.className='tdbg'">
        ...
        <td align="left">
            <asp:TextBox ID="tbQuestion" runat="server" class="l_input"></asp:TextBox>
        </td>
        <td class="tdbgleft" style="width: 15%; height: 22px" align="right">
            提示问题答案：
        </td>
        <td style="width: 35%; height: 22px" align="left">
            ...
            <asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server" ControlToValidate="tbAnswer"
                ErrorMessage="提示答案不能为空"></asp:RequiredFieldValidator>
        </td>
    </tr>
    </tbody>
        ...
        <td colspan="4">
           ...
           <tbody id="Tabs2" style="display:none">
                <tr class="tdbg">
                    ...
                    <td style="width: 35%; height: 22px" align="left">
                        <asp:TextBox ID="txtMoney" runat="server" class="l_input"></asp:TextBox>
                    </td>
                ...
                <tr class="tdbg" onmouseover="this.className='tdbgmouseover'" onmouseout="this.className='tdbg'">
                    ...
                    <td style="width: 35%; height: 22px" align="left">
                        <asp:TextBox ID="txtUserPoint" runat="server" class="l_input"></asp:TextBox>
                    </td>
                    <td class="tdbgleft" style="width: 15%; height: 22px" align="right">
                        用户积分：
                    </td>
                    <td style="width: 35%; height: 22px" align="left">
                        <asp:TextBox ID="txtPoint" runat="server" class="l_input"></asp:TextBox>
                    </td>
                </tr>
                   <tr class="tdbg" onmouseover="this.className='tdbgmouseover'" onmouseout="this.className='tdbg'">
                    <td class="tdbgleft" style="width: 15%; height: 22px" align="right">
                    ...
                    <td style="width: 35%; height: 22px" align="left">
                        <asp:TextBox ID="txtPurm" runat="server" class="l_input"></asp:TextBox>
                    </td>
                    <td class="tdbgleft" style="width: 15%; height: 22px" align="right">
                ...
                <tr>
                    ...
                    <td style="width: 35%; height: 22px" align="left">
                        <asp:TextBox ID="txtCerificateDeadLine" runat="server" class="l_input"></asp:TextBox>
                    </td>
                    <td class="tdbgleft" style="width: 15%; height: 22px" align="right">
                        有效期截止时间：
                    </td>
                    <td style="width: 35%; height: 22px" align="left">
                        <asp:TextBox ID="txtDeadLine" runat="server" class="l_input"></asp:TextBox>
                    </td>
                </tr>
                 <tr>
                <tr class="tdbg" onmouseover="this.className='tdbgmouseover'" onmouseout="this.className='tdbg'">
                    ...
                    <td style="width: 35%; height: 22px" align="left">
                        <asp:TextBox ID="txtboffExp" runat="server" class="l_input"></asp:TextBox>
                    </td>
                    <td class="tdbgleft" style="width: 15%; height: 22px" align="right">
                        消费积分：
                    </td>
                    <td style="width: 35%; height: 22px" align="left">
                        <asp:TextBox ID="txtConsumeExp" runat="server" class="l_input"></asp:TextBox>
                    </td>
                </tr>
                 <tr>
                <td>
             ...
             <tr class="tdbg" onmouseover="this.className='tdbgmouseover'" onmouseout="this.className='tdbg'">
                ...
                <tr class="tdbg" onmouseover="this.className='tdbgmouseover'" onmouseout="this.className='tdbg'">
                    ...
                    <td style="width: 35%; height: 22px" align="left">
                        <asp:TextBox ID="tbBirthday" runat="server" onblur="setday(this);" onclick="setday(this);"
    ...
    <tr class="tdbgbottom">
        <td colspan="4">
            ...
            &nbsp;&nbsp;<asp:Button ID="Button1" runat="server" Text="取消" class="C_input" 
                OnClick="Button1_Click" CausesValidation="False" />
            <asp:ValidationSummary ID="ValidationSummary1" runat="server" ShowMessageBox="True"
                ShowSummary="False" class="C_input" />
        </td>
    </tr>
</table>
</form>
