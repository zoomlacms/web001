<%@ page language="C#" autoeventwireup="true" inherits="ZoomLa.WebSite.Manage.User.AddRole, App_Web_pwasdykj" title="添加角色" enableeventvalidation="false" viewStateEncryptionMode="Never" %>
<!DOCTYPE HTML>
<html>
...
<table width="100%" cellspacing="1" cellpadding="0" class="border" align="center">        
        ...
        <tr class="tdbg" onmouseover="this.className='tdbgmouseover'" onmouseout="this.className='tdbg'">
            ...
            <td style="width: 100px">
                <asp:TextBox ID="txbRoleName" runat="server" class="l_input"></asp:TextBox>
        ...
        <tr class="tdbg" onmouseover="this.className='tdbgmouseover'" onmouseout="this.className='tdbg'">
            ...
            <asp:TextBox ID="tbRoleInfo" class="x_input" runat="server" Height="72px" TextMode="MultiLine" Width="228px"></asp:TextBox></td>
        </tr>
    </table>
    &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;&nbsp;
