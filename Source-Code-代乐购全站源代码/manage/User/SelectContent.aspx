<%@ page language="C#" autoeventwireup="true" inherits="manage_User_SelectContent, App_Web_pwasdykj" enableEventValidation="false" viewStateEncryptionMode="Never" %>
...
<body>
    ...
    <div class="r_navigation">
            ...
            &nbsp;<span>后台管理</span> &gt;&gt; <span>内容管理</span> &gt;&gt; <span>选择内容</span>
    ...
    <div>
        ...
        <div style="float:right;text-align:center;width:70%">
         <div class="divbox" id="nocontent"  runat="server" style="float:right;text-align:center;width:100%">
        暂无内容信息</div>
         <asp:GridView ID="Egv" runat="server" AutoGenerateColumns="False" DataKeyNames="GeneralID"  Width="100%">
            <Columns>
                ...
                <asp:TemplateField HeaderText="操作">
                    <ItemTemplate>
                    <a href='?menu=select&id=<%#Eval("GeneralID") %>'>选择</a>
                      </ItemTemplate>
                    <ItemStyle HorizontalAlign="Center" />
                </asp:TemplateField>
                </Columns>
    ...
    <div id="Egvdiv" runat="server" style="text-align: center" class="tdbg">
