<%@ page language="C#" autoeventwireup="true" inherits="manage_User_Userinfo, App_Web_pwasdykj" enableEventValidation="false" viewStateEncryptionMode="Never" %>
<!DOCTYPE HTML>
<html>
                        ...
                        <ItemTemplate>
                            <tr class="tdbg">
                                ...
                                <td style="width: 35%; height: 25px;" align="left">
                                    <%#Eval("UserName") %> &nbsp;<asp:LinkButton ID="btnlogin" runat="server" Text=">>作为此会员登录" CommandName="useLogin" CommandArgument='<%#Eval("UserId") %>' />
                                   (在新窗口中打开)
                                </td> 
                    ...
                    <asp:Repeater ID="Repeater2" runat="server">
                        <ItemTemplate>
                            ...
                            <tr class="tdbg">
                                ...
                                <td style="width: 35%; height: 22px" align="left">
                                    <%#Getbir(DataBinder.Eval(Container.DataItem,"BirthDay").ToString())%>
                                </td>
                                <td class="tdbgleft" style="width: 15%; height: 22px" align="right">
                                    办公电话：
                                </td>
...
<asp:Button ID="Button3" runat="server" Text="升级为客户" class="C_input" onclick="Button3_Click" />&nbsp
