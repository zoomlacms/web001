<%@ page language="C#" autoeventwireup="true" inherits="manage_User_UserCart, App_Web_pwasdykj" enableEventValidation="false" viewStateEncryptionMode="Never" %>
<!DOCTYPE HTML>
<html>
<head runat="server">
<title>用户信誉值管理</title>
...
<table width="100%" border="0" cellpadding="5" cellspacing="1" class="border"> 
    ...
    <tr class="tdbg">
        ...
        <td class="bqright"><asp:Label ID="lblUserName" runat="server" Text=""></asp:Label>
          <asp:LinkButton ID="lbUserName" runat="server" PostBackUrl='~/manage/User/Userinfo.aspx?id=<%=Request.QueryString("UserID") %>'></asp:LinkButton></td></td>
     </tr>
     <tr class="tdbg">
