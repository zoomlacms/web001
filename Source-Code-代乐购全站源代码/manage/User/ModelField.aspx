<%@ page language="C#" autoeventwireup="true" inherits="ZoomLa.WebSite.Manage.User.ModelField, App_Web_pwasdykj" enableEventValidation="false" viewStateEncryptionMode="Never" %>
...
<body>
    ...
    <div class="r_navigation">
        ...
        <span>后台管理</span>&gt;&gt;<span><a href="UserManage.aspx">会员管理</a></span> &gt;&gt;<a
            href="UserModelManage.aspx">会员模型管理</a> &gt;&gt; <a href="UserModelField.aspx?ModelId=<%=Request.QueryString["ModelID"] %>">
                字段列表</a> &gt;&gt; 添加[<asp:Label ID="lblModel" runat="server" Text="Label"></asp:Label>模型]字段
    </div>
    <div class="clearbox">
    </div>
    <table class="border" cellspacing="1" cellpadding="0" width="99%" border="0" align="center">
        <tr class="tdbg" onmouseover="this.className='tdbgmouseover'" onmouseout="this.className='tdbg'">
            ...
            <td>
                <asp:TextBox class="l_input" ID="Alias" runat="server" MaxLength="20"></asp:TextBox><font color="#ff0066">*</font><span
        ...
        <tr class="tdbg" onmouseover="this.className='tdbgmouseover'" onmouseout="this.className='tdbg'">
            ...
            <td>
                <asp:TextBox class="l_input" ID="Name" MaxLength="50" runat="server"></asp:TextBox><font color="#ff0066">*</font><span
        ...
        <tr class="tdbg" onmouseover="this.className='tdbgmouseover'" onmouseout="this.className='tdbg'">
            ...
            <td>
                <asp:TextBox class="x_input" ID="Description" runat="server" Columns="40" Rows="6" TextMode="MultiLine"></asp:TextBox>
            </td>
        </tr>
        <tr class="tdbg" onmouseover="this.className='tdbgmouseover'" onmouseout="this.className='tdbg'">
            <td class="tdbgleft">
        ...
        <tr class="tdbg" onmouseover="this.className='tdbgmouseover'" onmouseout="this.className='tdbg'">
            <td class="tdbgleft" style="height: 11px">
                是否在前台录入显示 ：
            </td>
            <td style="height: 11px">
                ...
                <span style="color: Red;" class="tips">选择“否”可作为相关隐藏识别符而不能输出在前台(仅能后台录入)。</span>
            </td>
        </tr>
        <tr class="tdbg" onmouseover="this.className='tdbgmouseover'" onmouseout="this.className='tdbg'">
            <td class="tdbgleft">
        ...
        <tbody id="DivMultipleTextType" style="display: none">
            <tr class="tdbg" onmouseover="this.className='tdbgmouseover'" onmouseout="this.className='tdbg'">
                ...
                <td>
                    <asp:TextBox class="l_input" ID="MultipleTextType_Width" runat="server" Columns="10" MaxLength="4">500</asp:TextBox>px
                </td>
            </tr>
            <tr class="tdbg" onmouseover="this.className='tdbgmouseover'" onmouseout="this.className='tdbg'">
                <td class="tdbgleft">
                ...
                <td>
                    <asp:TextBox class="l_input" ID="MultipleTextType_Height" runat="server" Columns="10" MaxLength="4">200</asp:TextBox>px
                </td>
            </tr>
        </tbody>
        <!--  多行文本(支持Html)    -->
        <tbody id="DivMultipleHtmlType" style="display: none">
            ...
            <tr class="tdbg" onmouseover="this.className='tdbgmouseover'" onmouseout="this.className='tdbg'">
                ...
                <td>
                    <asp:TextBox class="l_input" ID="MultipleHtmlType_Width" runat="server" Columns="10" MaxLength="4">715</asp:TextBox>px
                </td>
            </tr>
            <tr class="tdbg" onmouseover="this.className='tdbgmouseover'" onmouseout="this.className='tdbg'">
                <td class="tdbgleft">
                ...
                <td>
                    <asp:TextBox class="l_input" ID="MultipleHtmlType_Height" runat="server" Columns="10" MaxLength="4">400</asp:TextBox>px
                </td>
            </tr>
        </tbody>
        <!--  单选项    -->
        <tbody id="DivOptionType" style="display: none">
            <tr class="tdbg" onmouseover="this.className='tdbgmouseover'" onmouseout="this.className='tdbg'">
                ...
                <td>
                    <input id="Button3" type="button" value="从数据字典中选择选项"  onclick="SelectDictionary('RadioType_Content')" class="C_input"/><input
                        id="Button5" type="button" value="添加数据字段" onclick='SubPage("RadioType_Content")' class="C_input"/><br />
                    <asp:TextBox class="x_input" ID="RadioType_Content" runat="server" TextMode="MultiLine" Columns="40"
                        Rows="6"></asp:TextBox>
        ...
        <tbody id="DivListBoxType" style="display: none">
            <tr class="tdbg" onmouseover="this.className='tdbgmouseover'" onmouseout="this.className='tdbg'">
                ...
                <td>
                    <input id="Button4" type="button" value="从数据字典中选择选项"  onclick="SelectDictionary('ListBoxType_Content')" class="C_input"/><input
                        id="Button6" type="button" value="添加数据字段" onclick='SubPage("ListBoxType_Content")' class="C_input"/><br />
                    <asp:TextBox class="x_input" ID="ListBoxType_Content" runat="server" TextMode="MultiLine" Columns="40"
                        Rows="6"></asp:TextBox>
                    <span style="color: red">*</span>
                </td>
            </tr>
            ...
            <tr class="tdbg" onmouseover="this.className='tdbgmouseover'" onmouseout="this.className='tdbg'">
                ...
                <td>
                    <table cellspacing="0" cellpadding="0" width="100%" border="0" align="center">
                        ...
                        <tr class="tdbg" onmouseover="this.className='tdbgmouseover'" onmouseout="this.className='tdbg'">
                            <td>
                                <asp:TextBox class="x_input" ID="DateSearchRang" runat="server" TextMode="MultiLine" Columns="40"
        ...
        <tbody id="DivPicType" style="display: none">
            ...
            <tr class="tdbg" onmouseover="this.className='tdbgmouseover'" onmouseout="this.className='tdbg'">
                ...
                <td>
                    <asp:TextBox class="l_input" ID="TxtSPicSize" runat="server" Columns="5">1024</asp:TextBox>KB <span
        ...
        <tbody id="DivMultiPicType" style="display: none">
            <tr class="tdbg" onmouseover="this.className='tdbgmouseover'" onmouseout="this.className='tdbg'">
                ...
                <td>
                    ...
                    <asp:TextBox class="l_input" ID="TxtThumb" runat="server" Columns="20"></asp:TextBox><span style="color: Red;
            ...
            <tr class="tdbg" onmouseover="this.className='tdbgmouseover'" onmouseout="this.className='tdbg'">
                ...
                <td>
                    <asp:TextBox class="l_input" ID="TxtPicSize" runat="server" Columns="5">1024</asp:TextBox>KB <span
                        style="color: blue">提示：1 KB = 1024 Byte，1 MB = 1024 KB</span> <span style="color: red">
                            *</span>
                </td>
            </tr>
        ...
        <tbody id="DivOperatingType" style="display: none">
            <tr class="tdbg" onmouseover="this.className='tdbgmouseover'" onmouseout="this.className='tdbg'">
                ...
                <td>
                    <asp:TextBox class="x_input" ID="TxtOperatingOption" runat="server" TextMode="MultiLine" Columns="40"
                        Rows="6"></asp:TextBox>
            ...
            <tr class="tdbg" onmouseover="this.className='tdbgmouseover'" onmouseout="this.className='tdbg'">
                ...
                <td>
                    <asp:TextBox class="l_input" ID="OperatingType_TitleSize" runat="server" Columns="10" MaxLength="4">35</asp:TextBox><span
        ...
        <tbody id="DivSuperLinkType" style="display: none">
            <tr class="tdbg" onmouseover="this.className='tdbgmouseover'" onmouseout="this.className='tdbg'">
                ...
                <td>
                    <asp:TextBox class="l_input" ID="SuperLinkType_TitleSize" runat="server" Columns="10" MaxLength="4">50</asp:TextBox>
                </td>
            </tr>
            <tr class="tdbg" onmouseover="this.className='tdbgmouseover'" onmouseout="this.className='tdbg'">
                <td class="tdbgleft">
        ...
        <tbody id="DivNumType" style="display: none">
            <tr class="tdbg" onmouseover="this.className='tdbgmouseover'" onmouseout="this.className='tdbg'">
                ...
                <td>
                    <asp:TextBox class="l_input" ID="NumberType_TitleSize" runat="server" Columns="10" MaxLength="4">35</asp:TextBox>
                </td>
            </tr>
            <tr class="tdbg" onmouseover="this.className='tdbgmouseover'" onmouseout="this.className='tdbg'">
                <td class="tdbgleft">
            ...
            <tr class="tdbg" onmouseover="this.className='tdbgmouseover'" onmouseout="this.className='tdbg'">
                ...
                <td>
                    <table cellspacing="0" cellpadding="0" width="100%" border="0" align="center">
                        ...
                        <tr class="tdbg" onmouseover="this.className='tdbgmouseover'" onmouseout="this.className='tdbg'">
                            <td>
                                <asp:TextBox class="x_input" ID="NumSearchRange" runat="server" TextMode="MultiLine" Columns="40"
                                    Rows="6"></asp:TextBox><br />
                            </td>
                            <td>
                                <font color="red">选择了自定范围时请输入此项内容,格式：范围名|范围<br />
        ...
        <tbody id="DivColorType" style="display: none" runat="server">
            <tr class="tdbg" onmouseover="this.className='tdbgmouseover'" onmouseout="this.className='tdbg'">
                ...
                <td>
                    <asp:TextBox class="l_input" ID="ColorDefault" runat="server" MaxLength="7" Columns="7" Style="font-size: 9pt;
        ...
        <tr class="tdbg">
            ...
            <td height="50">
                <asp:Button ID="Button1" runat="server" Text=" 添加字段 "  OnClientClick="return isok()"
                    OnClick="Button1_Click" class="C_input"/>
                &nbsp;&nbsp;
                <input id="Button2" type="button" value=" 返回字段列表 "  onclick="javascript:window.location.href='UserModelField.aspx?ModelID=<%=Request.QueryString["ModelID"] %>'" class="C_input"/>
