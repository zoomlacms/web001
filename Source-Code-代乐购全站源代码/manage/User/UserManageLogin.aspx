<%@ page language="C#" autoeventwireup="true" inherits="User.UserManageLogin, App_Web_pwasdykj" title="会员管理" enableEventValidation="false" viewStateEncryptionMode="Never" %>
<!DOCTYPE HTML>
<html>
...
<span>后台管理</span> &gt;&gt; <span><a href="AdminManage.aspx">用户管理</a></span> &gt;&gt; <span>会员管理</span> <asp:Label ID="LblGroup" runat="server" Text="Label"></asp:Label>
    </div>
        ...
        <tr class="tdbgleft">
            <td>
                ...
                <strong id="strtime" runat="server" visible="false">
                    ...
                    到
                    <asp:TextBox ID="txtEndTime" runat="server"  Width="102px" onclick="calendar()"></asp:TextBox></strong> <strong id="strgroup" runat="server" visible="true">
                        <asp:DropDownList ID="ddlGroup" runat="server" DataTextField="GroupName" DataValueField="GroupID">
                        </asp:DropDownList>
                    </strong>
                <asp:Button ID="Button1" runat="server" Text="查  找" OnClick="Button1_Click1" 
                    style="height: 20px" Width="62px" class="C_input"/>&nbsp; 
                ...
                <asp:TextBox ID="IDName" runat="server" Width="70px" EnableTheming="true" 
                   ></asp:TextBox></strong>
