<%@ page language="C#" autoeventwireup="true" inherits="manage_User_ALLOnlineInfo, App_Web_d0ltifsq" enableEventValidation="false" viewStateEncryptionMode="Never" %>
...
<body>
    ...
    <div style="font-size: 12px">
        &nbsp;<b><asp:DropDownList ID="txtbyfilde" CssClass="x_input" runat="server">
            <asp:ListItem Value="1">按客服人员</asp:ListItem>
            <asp:ListItem Value="2">按时间</asp:ListItem>
            <asp:ListItem Value="3">按关键字</asp:ListItem>
        </asp:DropDownList>
        </b>&nbsp;查找：<asp:TextBox ID="txtdate" onclick="calendar('txtdate')" runat="server"
            Width="123px" class="l_input" Height="18px"></asp:TextBox>
            ...
            <ItemTemplate>
                <tr class="tdbg" onmouseover="this.className='tdbgmouseover'" onmouseout="this.className='tdbg'">
                    <td height="22" align="center">
                        <input name="Item" type="checkbox" value='<%# Eval("CS_ID")%>' />
                    </td>
                    <td height="22" align="center">
                        <%# Eval("CS_SendName")%>
                    </td>
                    ...
                    <td height="22" align="center">
                        <%#DataBinder.Eval(Container.DataItem, "CS_AddTime", "{0:yyyy-MM-dd}")%>
                    </td>
                    <td height="22" align="center">
                        <a href="?menu=del&id=<%#Eval("CS_ID") %>&CSOID=<%#Eval("CS_OID")%>" onclick="return confirm('不可恢复性删除数据,你确定将该数据删除吗？');">
                            删除</a>
                    </td>
                </tr>
            </ItemTemplate>
