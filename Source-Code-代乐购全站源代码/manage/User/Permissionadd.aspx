<%@ page language="C#" autoeventwireup="true" inherits="manage_Config_Permissionadd, App_Web_d0ltifsq" enableviewstate="False" enableEventValidation="false" viewStateEncryptionMode="Never" %>
<!DOCTYPE HTML>
<html>
...
<div class="r_navigation">        
    <span>后台管理</span> &gt;&gt; <span>用户管理</span> &gt;&gt; <span><a href="PermissionInfo.aspx">角色管理</a></span> &gt;&gt; <span><%=type %></span>
</div>
<div class="clearbox">
</div>
<table class="border" cellspacing="1" cellpadding="0" width="100%" border="0" align="center">
    ...
    <tr class="tdbg" onmouseover="this.className='tdbgmouseover'" onmouseout="this.className='tdbg'">
        <td height="24" class="tdbgleft" style="width: 237px">
            <strong>角色名称：</strong>
        </td>
        <td width="75%" height="24">
            <asp:TextBox class="l_input" ID="txtRoleName" runat="server" />
            <asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server" ControlToValidate="txtRoleName" ErrorMessage="角色名不能为空!"></asp:RequiredFieldValidator>
        </td>
    </tr>
    <tr class="tdbg" onmouseover="this.className='tdbgmouseover'" onmouseout="this.className='tdbg'">
        <td class="tdbgleft" style="height: 24px; width: 237px;">
            <strong>角色说明：</strong>
        </td>
        <td style="height: 24px">
            <asp:TextBox class="l_input" ID="txtInfo" runat="server" Width="432px" />
        </td>
    </tr>
    <tr class="tdbg" onmouseover="this.className='tdbgmouseover'" onmouseout="this.className='tdbg'">
        <td class="tdbgleft">
        ...
        <td>
            <asp:TextBox class="l_input" ID="txtPrecedence" runat="server" Width="84px">0</asp:TextBox>
            <asp:RegularExpressionValidator ID="RegularExpressionValidator1" runat="server" ControlToValidate="txtPrecedence" Display="Dynamic" ErrorMessage="格式不正确!" ValidationExpression="^-?\d+$"></asp:RegularExpressionValidator><asp:RequiredFieldValidator ID="RequiredFieldValidator2" runat="server" ControlToValidate="txtPrecedence" Display="Dynamic" ErrorMessage="不能为空!"></asp:RequiredFieldValidator>
        </td>
    </tr>
    <tr class="tdbg" onmouseover="this.className='tdbgmouseover'" onmouseout="this.className='tdbg'">
        <td height="24" class="tdbgleft" style="width: 237px">
    ...
    <tr class="gridtitle">
        <td height="26" colspan="2" align="center">
            <strong>权限设置</strong><strong></strong>
        </td>
    </tr>
    <tr class="tdbgleft">
        <td colspan="2" >
            <table width="100%"   cellpadding="0" cellspacing="0" border="0">
                <tr>
                    <td align="center" class="tdbgleft"  style="height: 24px" id="tdtext" runat="server">
                        <strong>选择子站</strong>
                    </td>
                    <td align="center"  class="tdbgleft" style="height: 24px">
                        <strong>选择节点</strong>
                    </td>
                    <td align="center"  class="tdbgleft" style="height: 24px">
                        <strong>选择模型表</strong>
    ...
    <tr class="tdbg">
        <td height="26" colspan="2" class="tdbgleft" align="center">
            <asp:HiddenField ID="txtID" runat="server" />
            <asp:Button ID="Button1" runat="server" Text="添加角色" OnClick="Button1_Click" class="C_input"/>
            <asp:Button ID="Button2" runat="server" Text="返回列表" OnClientClick="location.href='PermissionInfo.aspx';return false;" class="C_input"/>
        </td>
    </tr>
</table>
</form>
