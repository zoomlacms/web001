<%@ page language="C#" autoeventwireup="true" inherits="manage_User_PointGroup, App_Web_d0ltifsq" enableEventValidation="false" viewStateEncryptionMode="Never" %>
<!DOCTYPE HTML>
<html>
<head runat="server">
<title>用户积分等级</title>
...
<span>后台管理</span> &gt;&gt;<span>会员管理</span> &gt;&gt; 积分等级管理 &gt;&gt;【<a href="AddPointGroup.aspx" style="color:Red">添加积分等级</a>】</div>
    ...
    <asp:Repeater ID="repter" runat="server" onitemcommand="repter_ItemCommand" >
        <ItemTemplate>
            <tr class="tdbg" onmouseover="this.className='tdbgmouseover'" onmouseout="this.className='tdbg'">
                ...
                <td align="center"><img src='<%#Eval("ImgUrl")%>' name="urlImg"/></td>
                <td align="center">
