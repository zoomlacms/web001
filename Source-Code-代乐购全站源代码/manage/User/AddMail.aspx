<%@ page language="C#" autoeventwireup="true" inherits="manage_Qmail_AddMail, App_Web_d0ltifsq" enableEventValidation="false" viewStateEncryptionMode="Never" %>
        ...
        <div>
            <table width="100%" border="0" cellpadding="2" cellspacing="1" class="border">
                    ...
                    <td>
                        <table>
                            ...
                            <tr onmouseover="this.className='tdbgmouseover'" onmouseout="this.className='tdbg'">
                                ...
                                <td align="left">
                                    <asp:TextBox ID="txtType" runat="server" class="l_input" ></asp:TextBox></td>
                                <td align="left">
                                    <asp:Panel ID="Panel1" Visible="false" runat="server" Width="300px" Height="20px">
                                        ...
                                        ~
                                        <asp:TextBox ID="txtEndTime" onfocus="setday(this)" runat="server" class="l_input"></asp:TextBox>&nbsp;<br />
                                        &nbsp;
                                ...
                                <td align="left" onmouseover="this.className='tdbgmouseover'" onmouseout="this.className='tdbg'">
                                    <asp:Button ID="Button1" runat="server" OnClick="Button1_Click" CausesValidation="false"  Text="查 询" />
                                </td>
                                </tr>
                        </table>
                                </td>
                            ...
                            <tr onmouseover="this.className='tdbgmouseover'" onmouseout="this.className='tdbg'">
                                <td colspan="5">
                                    <asp:TextBox ID="txtSend" TextMode="MultiLine" Width="476px" Rows="10" runat="server"
                                        Enabled="False"  class="x_input"></asp:TextBox></td>
                            </tr>
                            <tr onmouseover="this.className='tdbgmouseover'" onmouseout="this.className='tdbg'">
                                <td colspan="5">
                                    <asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server" ControlToValidate="txtSend"
                                        ErrorMessage="没有收件人信息。"></asp:RequiredFieldValidator></td>
                            </tr>
                        </table>
                    </td>
                </tr>
                ...
                <tr class="tdbg" onmouseover="this.className='tdbgmouseover'" onmouseout="this.className='tdbg'">
                    ...
                    <td>
                        <asp:TextBox ID="TxtSubject" runat="server" Width="400px" class="l_input"></asp:TextBox>
                ...
                <tr class="tdbg" onmouseover="this.className='tdbgmouseover'" onmouseout="this.className='tdbg'">
                    ...
                    <td>
    <textarea runat="server" id="HiddenField1" style="width:100%;height:300px;visibility:hidden;" ></textarea>
                ...
                <tr class="tdbg" onmouseover="this.className='tdbgmouseover'" onmouseout="this.className='tdbg'">
                    <td align="right" class="tdbgleft" width="15%">
                    <strong>签  名：</strong>
                    </td>
                    <td>
                ...
                <tr class="tdbg" onmouseover="this.className='tdbgmouseover'" onmouseout="this.className='tdbg'">
                    ...
                    <td id="td1" runat ="server" visible="false">
                        ...
                        </asp:DropDownList>时<asp:DropDownList ID="ddlMinute" runat="server">
                ...
                <tr class="tdbgbottom">
                    <td colspan="2">
                        <asp:Button ID="BtnSend" runat="server" Text="发送" Width="60px" 
                            OnClick="BtnSend_Click" Height="20px" class="C_input" />
                        &nbsp;&nbsp; &nbsp;
