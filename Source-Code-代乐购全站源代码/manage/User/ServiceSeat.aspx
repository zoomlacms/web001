<%@ page language="C#" autoeventwireup="true" inherits="manage_User_ServiceSeat, App_Web_pwasdykj" enableEventValidation="false" viewStateEncryptionMode="Never" %>
...
<body>
    ...
    <div class="r_navigation">
        ...
        <span>后台管理 </span>&gt;&gt;<span> 附件管理</span> &gt;&gt;<span> 客服管理</span> &gt;&gt;<span>
            客服席位</span>&nbsp;&nbsp;<a href='AddSeat.aspx'>[<font color="red">添加席位</font>]</a> </div>
    <div class="clearbox">
    </div>
    <div>
        <asp:GridView ID="gvUser" runat="server" CssClass="tdbg" AutoGenerateColumns="False"  DataKeyNames="S_ID"
            Width="100%" >
            <Columns>
                ...
                <asp:TemplateField HeaderText="管理员" ItemStyle-HorizontalAlign="Center" ItemStyle-Height="26px" HeaderStyle-Height="26px">
                    <ItemTemplate>
                    <%#GetAdminName(DataBinder.Eval(Container.DataItem, "S_AdminID").ToString())%>
                    </ItemTemplate>
                </asp:TemplateField>
                <asp:TemplateField HeaderText="显示位置" ItemStyle-HorizontalAlign="Center">
                    <ItemTemplate>
                     <%#DataBinder.Eval(Container.DataItem, "S_Index")%>
                    </ItemTemplate>
                </asp:TemplateField>
                ...
                <asp:TemplateField HeaderText="默认客服" ItemStyle-HorizontalAlign="Center">
                    <ItemTemplate>
                     <%#(DataBinder.Eval(Container.DataItem, "S_Default","{0}") == "1") ? "是" : "否"%>
                    </ItemTemplate>
                </asp:TemplateField>
