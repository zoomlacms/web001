<%@ page language="C#" autoeventwireup="true" inherits="manage_Qmail_MailIdiographList, App_Web_d0ltifsq" enableEventValidation="false" viewStateEncryptionMode="Never" %>
...
<body>
    <form id="form1" runat="server">
        <div class="r_navigation">
            ...
            <span>签名列表</span>  <a href="AddMailIdiograph.aspx">【添加签名】</a>
        </div>
        <div class="clearbox">
        </div>
        <div>
                    ...
                    <td valign="top" class="tdbg">
                        <asp:GridView ID="GridView1" DataKeyNames="ID" Width="100%" runat="server" AutoGenerateColumns="False" OnRowDeleting="GridView1_RowDeleting">
                            <Columns>
                                ...
                                <asp:TemplateField HeaderText="签名名称"><HeaderStyle Width="100px" />
                                    <ItemStyle HorizontalAlign="Center" />
                                    <ItemTemplate>
                                ...
                                <asp:TemplateField HeaderText="添加时间"><HeaderStyle Width="115px" />
                                    <ItemStyle HorizontalAlign="Center" />
                                    <ItemTemplate>
                                ...
                                <asp:TemplateField HeaderText="签名状态"><HeaderStyle Width="55px" />
                                    <ItemTemplate>
