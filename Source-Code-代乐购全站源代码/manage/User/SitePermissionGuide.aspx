<%@ page language="C#" autoeventwireup="true" inherits="manage_User_SitePermissionGuide, App_Web_d0ltifsq" enableEventValidation="false" viewStateEncryptionMode="Never" %>
...
<body>
    ...
    <div class="r_navigation">
        ...
        <span>后台管理</span> &gt;&gt; <span><a href="PermissionInfo.aspx">角色管理</a></span> &gt;&gt; <span>添加角色</span>
    </div>
    <div class="clearbox">
    </div>
    <table class="border" cellspacing="1" cellpadding="0" width="100%" border="0" align="center">
        <tr class="gridtitle" align="center" style="height: 25px;">
            <td height="26" colspan="2">
                <strong>
                    <asp:Label ID="Label1" runat="server" Text="添加角色"></asp:Label></strong>
            </td>
        </tr>
