<%@ page language="C#" autoeventwireup="true" inherits="manage_Polymeric_ClassManage, App_Web_ozzcvrzi" enableEventValidation="false" viewStateEncryptionMode="Never" %>
...
<body>
    ...
    <div style="text-align: center">
        <div class="r_navigation">
            ...
            <span>后台管理</span> &gt;&gt; <span>用户管理</span>  &gt;&gt; <span>分类管理</span> [<a href="AddClass.aspx">添加分类</a>]
        </div>
    </div>
    <div class="clearbox">
    </div>
