<%@ page language="C#" autoeventwireup="true" inherits="manage_Search_SearchFunc, App_Web_tobwcfks" enableEventValidation="false" viewStateEncryptionMode="Never" %>
...
<body>
    ...
    <div class="r_navigation">
        ...
        <span>后台管理</span> &gt;&gt; <span>扩展功能</span> &gt;&gt; <span>便捷导航</span> <a href="AddSearch.aspx">[新增导航]</a>
    </div>
    <div class="clearbox">
    </div>
    ...
    <table width="100%" border="0" cellpadding="2" cellspacing="1" class="border" style="margin: 0 auto;">
        <tr align="left">
            <td width="10%" class="tdbg">
                ...
                <font style="color: Red">凡是文件未启用，站内链接不存在该文件则无法链接到指定的页面
                --<a href="../Profile/Worktable.aspx"  style="cursor:pointer">点此返回工作台首页</a>
                </font>
            </td>
        </tr>
    </table>
    ...
    <div>
        <asp:GridView ID="gvCard" runat="server" AutoGenerateColumns="False" class="border"
            Width="100%" OnRowDataBound="gvCard_RowDataBound" RowStyle-CssClass='tdbg'>
            <Columns>
                ...
                <asp:TemplateField HeaderText="名称" ItemStyle-HorizontalAlign="Center" ItemStyle-VerticalAlign="Middle">
                    <ItemTemplate>
                        <asp:HyperLink ID="lblName" runat="server" NavigateUrl='<%#Eval("id","AddSearch.aspx?menu=edit&id={0}") %>'  Text='<%# Eval("Name") %>' title="点击编辑导航"></asp:HyperLink>
                    </ItemTemplate>
                </asp:TemplateField>
