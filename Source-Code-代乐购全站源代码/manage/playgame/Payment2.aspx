<%@ page language="C#" autoeventwireup="true" inherits="ZoomLa.WebSite.User.Payment, App_Web_hbztkd4i" enableEventValidation="false" viewStateEncryptionMode="Never" %>
...
<body>
    ...
    <div class="r_navigation">
        ...
        <span>游戏管理</span> &gt;&gt; 订单<span><a href="AreaManage.aspx">管理</a>&gt;&gt;所有订单记录</span>
        <br />     
