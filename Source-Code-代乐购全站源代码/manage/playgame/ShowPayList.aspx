<%@ page language="C#" autoeventwireup="true" inherits="manage_playgame_ShowPayList, App_Web_njcqrjs5" enableEventValidation="false" viewStateEncryptionMode="Never" %>
...
<body>
    ...
    <div class="r_navigation">
        ...
        <span>结算管理</span> &gt;&gt; <span>结算记录</span></div>
    <div class="clearbox">
    </div>
    <div>
        <table width="100%">
                ...
                <td>
                    <table width="100%">
                        <tr>
                            ...
                            <td>
                                <asp:TextBox ID="txtStartTime" onclick="calendar();selectnum();" runat="server" Width="100px"></asp:TextBox>
                            </td>
                            <td align="right">
                                结束时间：
                            </td>
                            <td>
                                <asp:TextBox ID="txtEndTime" runat="server"  onclick="calendar();selectnum();" Width="100px"></asp:TextBox>
                            </td>
                            <td>
                                <asp:Button ID="Button1" runat="server" Text="立即查询" Width="100px" 
        ...
        <tr>
            <td>
                <asp:GridView ID="gvPayList" runat="server" Width="100%" 
                    ...
                    <ItemTemplate>
                    <a href='Pay.aspx?uid=<%#Eval("userID") %>'>支付</a>
                    </ItemTemplate>
                    </asp:TemplateField>
                    </Columns>
                </asp:GridView>
