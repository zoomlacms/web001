<%@ page language="C#" autoeventwireup="true" inherits="manage_Panoramic_MusicManage, App_Web_mzrso5tv" enableEventValidation="false" viewStateEncryptionMode="Never" %>
<!DOCTYPE HTML>
<html>
...
<div class="r_navigation">
	<span>后台管理</span> &gt;&gt; <span>扩展功能</span> &gt;&gt; <span>全景管理</span> &gt;&gt;
	<span>音乐库管理</span> <span>[<a href="AddMusic.aspx">添加音乐</a>]</span>
</div>
<br />
<div>
		...
		<asp:Repeater ID="Repeater1" runat="server">
			<ItemTemplate>
				<tr class="tdbg" height="25px" onmouseover="this.className='tdbgmouseover'" onmouseout="this.className='tdbg'">
					...
					<td align="center">
						<a href="AddMusic.aspx?menu=edit&id=<%#Eval("ID") %>">修改</a> <a href="?menu=delete&id=<%#Eval("ID") %>" onclick="return confirm('确实要删除吗？删除后该信息无法恢复!')">删除</a>
					</td>
				</tr>
			</ItemTemplate>
		</asp:Repeater>
		<tr class="tdbg">
			<td height="22" colspan="8" align="center" class="tdbg">
			   ...
			   <asp:TextBox ID="txtPage" runat="server" AutoPostBack="true" class="l_input" Width="16px" 
						Height="16px" OnTextChanged="txtPage_TextChanged"></asp:TextBox> 条信息/页 转到第<asp:DropDownList ID="DropDownList1"
