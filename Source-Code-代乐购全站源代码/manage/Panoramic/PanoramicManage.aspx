<%@ page language="C#" autoeventwireup="true" inherits="manage_Panoramic_PanoramicManage, App_Web_mzrso5tv" enableEventValidation="false" viewStateEncryptionMode="Never" %>
    ...
    <div>
        <div class="r_navigation">
            <span>后台管理</span> &gt;&gt; <span>扩展功能</span> &gt;&gt; <span><a href="PanoramicManage.aspx">
                全景管理</a></span> <span>[<a href="AddPanoramic.aspx">添加全景</a>]</span>
        </div>
        <br />
        <div>
            <table width="100%" border="0" cellpadding="0" cellspacing="1" class="border">
                ...
                <tr class="tdbgleft">
                    ...
                    <td class="tdbgleft" align="center" style="width: 25%">
                        调用标签
                    </td>
                ...
                <asp:Repeater ID="Repeater1" runat="server">
                    <ItemTemplate>
                        <tr class="tdbg" height="25px" onmouseover="this.className='tdbgmouseover'" onmouseout="this.className='tdbg'">
                            ...
                            <td align="center">
                                <a href="AddPanoramic.aspx?menu=edit&id=<%#Eval("ID") %>">
                                    <%#Eval("PanoramicName")%></a>
                            </td>
                            <td align="center">
                            ...
                            <td align="center">
                                <a href="AddPanoramic.aspx?menu=edit&id=<%#Eval("ID") %>">修改</a> <a href="javascript:void(0);"
                                    onclick="Open_Select(<%#Eval("ID") %>)">预览</a> <a href="?menu=delete&id=<%#Eval("ID") %>"
