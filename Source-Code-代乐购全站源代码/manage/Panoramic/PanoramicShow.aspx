<%@ page language="C#" autoeventwireup="true" inherits="manage_Panoramic_PanoramicShow, App_Web_mzrso5tv" enableEventValidation="false" viewStateEncryptionMode="Never" %>
<!DOCTYPE HTML>
<html>
...
<center><a href="PanoramicShow.aspx?id=<%=Request.QueryString["id"] %>"  target="_blank">新窗口打开本页</a></center>
标签调用：
 <textarea name="tb_Dmcontent1" rows="2" cols="20" id="tb_Dmcontent1" class="tb_dm scrollbar" style="height:20px">
{ZL:Panoramic(<%=Request.QueryString["id"] %>,600,500)/}
 </textarea>
<div class="user_ac">
