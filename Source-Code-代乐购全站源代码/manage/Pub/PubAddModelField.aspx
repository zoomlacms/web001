<%@ page language="C#" autoeventwireup="true" inherits="manage_Pub_PubAddModelField, App_Web_sczrssus" enableEventValidation="false" viewStateEncryptionMode="Never" %>
...
<body>
    ...
    <div class="r_navigation">
        ...
        <span>后台管理</span> &gt;&gt; <span>内容管理</span> &gt;&gt; <a href="pubModel.aspx">互动模型管理</a> &gt;&gt; <a href="PubModelField.aspx?ModelId=<%=Request.QueryString["ModelID"] %>">字段列表</a> &gt;&gt; 添加[<asp:Label ID="lblModel" runat="server" Text="Label"></asp:Label>模型]字段
    </div>
    <div class="clearbox">
    </div>
    <table class="border" cellspacing="1" cellpadding="0" width="99%" border="0" align="center">
        ...
        <tr class="tdbg" onmouseover="this.className='tdbgmouseover'" onmouseout="this.className='tdbg'">
            ...
            <td>
                <asp:TextBox ID="Description" class="l_input" runat="server" Columns="40" 
                    Rows="6" TextMode="MultiLine" Height="68px"></asp:TextBox>
            </td>
        </tr>
        <tr class="tdbg" onmouseover="this.className='tdbgmouseover'" onmouseout="this.className='tdbg'">
            <td class="tdbgleft">
        ...
        <tbody id="DivOptionType" style="display: none">
            <tr class="tdbg" onmouseover="this.className='tdbgmouseover'" onmouseout="this.className='tdbg'">
                ...
                <td>
                    <input id="Button3" class="C_input"  style="width:150px;"  type="button" value="从数据字典中选择选项"  onclick="SelectDictionary('RadioType_Content')" /><input id="Button5" type="button"class="C_input"  style="width:150px;"  value="添加数据字段" onclick='SubPage("RadioType_Content")' /><br />
                    <asp:TextBox ID="RadioType_Content" runat="server" class="l_input" 
                        TextMode="MultiLine" Columns="40" Rows="6" Height="66px" Width="305px"></asp:TextBox>
            ...
            <tr class="tdbg" onmouseover="this.className='tdbgmouseover'" onmouseout="this.className='tdbg'">
                ...
                <td>
                    <asp:TextBox ID="RadioType_Default" runat="server" class="l_input"></asp:TextBox>
        ...
        <tbody id="DivListBoxType" style="display: none">
            <tr class="tdbg" onmouseover="this.className='tdbgmouseover'" onmouseout="this.className='tdbg'">
                ...
                <td>
                    <input id="Button4" type="button" value="从数据字典中选择选项" class="C_input"  style="width:150px;"  onclick="SelectDictionary('ListBoxType_Content')" /><input id="Button6" type="button"  class="C_input"  style="width:150px;"  value="添加数据字段" onclick='SubPage("ListBoxType_Content")' /><br />
                        ...
                        <tr class="tdbg" onmouseover="this.className='tdbgmouseover'" onmouseout="this.className='tdbg'">
                            <td>
                                <asp:TextBox ID="DateSearchRang" class="l_input" runat="server" 
                                    TextMode="MultiLine" Columns="40" Rows="6" Height="68px"></asp:TextBox><br />
        ...
        <tbody id="DivMultiPicType" style="display: none">
            ...
            <tr class="tdbg" onmouseover="this.className='tdbgmouseover'" onmouseout="this.className='tdbg'">
                ...
                <td>
                    <asp:TextBox ID="TextImageType" runat="server" class="l_input" Columns="30"></asp:TextBox>
                        ...
                        <tr class="tdbg" onmouseover="this.className='tdbgmouseover'" onmouseout="this.className='tdbg'">
                            <td>
                                <asp:TextBox ID="NumSearchRange" class="l_input" runat="server" 
                                    TextMode="MultiLine" Columns="40" Rows="6" Height="64px"></asp:TextBox><br />
                            </td>
                            <td>
                                <font color="red">选择了自定范围时请输入此项内容,格式：范围名|范围<br />
                                    分行输入范围如：<br />
        ...
        <tr class="tdbg">
            ...
            <td height="50">
                <asp:Button ID="Button1" style="width:110px;" class="C_input"  runat="server" Text=" 添加字段 " OnClientClick="return isok()" OnClick="Button1_Click" />
                &nbsp;&nbsp;
                <input id="Button2" type="button" style="width:110px;"  class="C_input" value=" 返回字段列表 " onclick="javascript:window.location.href='PubModelField.aspx?ModelID=<%=Request.QueryString["ModelID"] %>'" />
