<%@ page language="C#" autoeventwireup="true" inherits="ZoomLa.WebSite.Manage.Plus.ADZoneManage, App_Web_0f1xyepu" enableEventValidation="false" viewStateEncryptionMode="Never" %>
<!DOCTYPE HTML>
<html>
...
<form id="form1" runat="server">
 <div class="r_navigation">后台管理 &gt;&gt; 扩展功能 &gt;&gt; <a href="ADZoneManage.aspx">广告管理</a> &gt;&gt; 版位管理&nbsp;<span style="color:Red">[<a href="ADZone.aspx" style="color: Red">添加版位</a>]</span>&nbsp;<span class="line"><asp:TextBox ID="TxtADName" runat="server" class="l_input" style="vertical-align:middle;"> 版位名称</asp:TextBox><asp:Button ID="BntSearch" runat="server" Text="查询" OnClick="BntSearch_Click" class="C_input"  style="vertical-align:middle;"/></span>
    </div>
    <div>
