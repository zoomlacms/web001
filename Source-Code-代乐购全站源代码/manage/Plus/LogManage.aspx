<%@ page language="C#" autoeventwireup="true" inherits="ZoomLa.WebSite.Manage.Log.LogManage, App_Web_0f1xyepu" enableEventValidation="false" viewStateEncryptionMode="Never" %>
...
<body>
    ...
    <div class="r_navigation">
        ...
        <span>后台管理</span> &gt;&gt; <span>扩展功能</span> &gt;&gt; <span>日志管理</span><asp:Label
            ID="LblCate" runat="server" Text="Label"></asp:Label>
    </div>
    <div class="clearbox">
    </div>
    <asp:GridView ID="Egv" DataKeyNames="LogID" runat="server" AutoGenerateColumns="False"
    ...
    <asp:CheckBox ID="CheckBox2" runat="server" AutoPostBack="True" OnCheckedChanged="CheckBox2_CheckedChanged"
        Text="全选" />
    &nbsp; &nbsp;
    <asp:Button ID="btndelete" class="C_input" runat="server" OnClientClick="return confirm('确定要删除选中的日志吗？')"
        Text="删除选定的日志" OnClick="btndelete_Click" />
