<%@ page language="C#" autoeventwireup="true" inherits="ZoomLa.WebSite.Manage.AddOn.JSTemplate, App_Web_0f1xyepu" enableEventValidation="false" viewStateEncryptionMode="Never" %>
...
<body>
    <form id="form1" runat="server">
     <div class="r_navigation">
		...
		<span>后台管理</span> &gt;&gt; <span>扩展功能</span> &gt;&gt; <span>
         <a href="ADZoneManage.aspx" title="广告版位管理">版位管理</a></span> &gt;&gt; <span>广告模板管理</span>
	</div>
