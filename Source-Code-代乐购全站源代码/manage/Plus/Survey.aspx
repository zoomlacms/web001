<%@ page language="C#" autoeventwireup="true" inherits="ZoomLa.WebSite.Manage.Plus.Survey, App_Web_0f1xyepu" enableEventValidation="false" viewStateEncryptionMode="Never" %>
...
<body>
    ...
    <div class="r_navigation">
		...
		<span>后台管理</span>&gt;&gt;<span>问卷投票管理</span> &gt;&gt;<a href="SurveyManage.aspx">问卷投票管理</a>&gt;&gt;<span>编辑问卷投票项目</span>
	</div>
    ...
    <table class="border" width="100%" cellpadding="2" cellspacing="1">
        ...
        <tr class="tdbg" onmouseover="this.className='tdbgmouseover'" onmouseout="this.className='tdbg'">
            ...
            <td>
                <asp:TextBox ID="TxtSurveyName" class="l_input" runat="server" Width="156" MaxLength="200" /><font color="red">*</font>
        ...
        <tr class="tdbg" onmouseover="this.className='tdbgmouseover'" onmouseout="this.className='tdbg'">
            ...
            <td>
                <asp:TextBox ID="txtEndTime" class="l_input" runat="server" onblur="setday(this);" onclick="setday(this);"></asp:TextBox></td>
        </tr>  
        <tr class="tdbg" onmouseover="this.className='tdbgmouseover'" onmouseout="this.className='tdbg'">
            <td class="tdbgleft">
            ...
            <td>
                <asp:TextBox ID="txtIPRepeat" class="l_input" runat="server" Text="1"></asp:TextBox>0为无限制</td>
        </tr>       
        <tr class="tdbg">
            <td class="tdbgleft">
                <strong>是否需登陆：</strong>
        ...
        <tr class="tdbgbottom">
            ...
            <asp:HiddenField ID="HdnSurveyID" runat="server" />
                ...
                &nbsp;&nbsp;
                <input name="Cancel" type="button" class="C_input" id="Cancel" value="取消"  onclick="window.location.href='SurveyManage.aspx';" />                
            </td>
        </tr>
    </table>
    </form>
