<%@ page language="C#" autoeventwireup="true" inherits="ZoomLa.WebSite.Manage.Plus.SurveyResult, App_Web_0f1xyepu" enableEventValidation="false" viewStateEncryptionMode="Never" %>
...
<body>
    ...
    <div class="r_navigation">
		...
		<span>后台管理</span>&gt;&gt;<a href="SurveyManage.aspx"><span>问卷投票管理</span> </a>&gt;&gt;<span>问卷投票结果</span>
	</div>
        ...
        <tr class="tdbgbottom">
            <td colspan="3">            
                ...
                <input name="Cancel" type="button" 
                 id="Cancel" class="C_input"  value="取消" onclick="window.location.href='SurveyManage.aspx';" />                
            </td>
        </tr>
    </table>
    </form>
