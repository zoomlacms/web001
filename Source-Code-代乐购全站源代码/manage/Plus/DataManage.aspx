<%@ page language="C#" autoeventwireup="true" inherits="manage_Plus_DataManage, App_Web_0f1xyepu" enableEventValidation="false" viewStateEncryptionMode="Never" %>
    ...
    <table style="width: 421px; height: 210px" id="TABLE1">
            ...
            <tr>
                ...
                <td style="width: 30px; height: 38px;">
                    <asp:Button ID="Button7" class="C_input" runat="server" Text="删除选择项" OnClick="Button7_Click1" OnClientClick="return confirm('是否删除全部所选的内容');" /></td>
