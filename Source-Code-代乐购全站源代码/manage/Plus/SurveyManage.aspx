<%@ page language="C#" autoeventwireup="true" inherits="ZoomLa.WebSite.Manage.Plus.SurveyManage, App_Web_0f1xyepu" enableEventValidation="false" viewStateEncryptionMode="Never" %>
...
<body>
    ...
    <div class="r_navigation">
        ...
        <span>后台管理</span>&gt;&gt;<span>问卷投票管理</span>
    </div>
    ...
    <table class="TableWrap" border="0" cellpadding="0" cellspacing="0" width="100%"
        ...
        <tr>
            <td style="height: 21px">
                问卷投票名：<asp:TextBox ID="txtSurKey" class="l_input" runat="server"></asp:TextBox>&nbsp;&nbsp;&nbsp;
    ...
    <asp:GridView ID="Gdv" RowStyle-HorizontalAlign="Center" DataKeyNames="SurveyID"
        ...
        <Columns>
            ...
            <asp:TemplateField HeaderText="问卷投票名">
                <ItemTemplate>
                    <a href="survey.aspx?SID=<%# Eval("SurveyID")%>">
                        <%# Eval("SurveyName")%></a>
                </ItemTemplate>
            ...
            <asp:TemplateField HeaderText="操作">
                <ItemTemplate>
                    ...
                    |
                    <asp:LinkButton ID="LinkButton2" runat="server" CommandName="Del" CommandArgument='<%# Eval("SurveyID") %>'
        ...
        <HeaderStyle Font-Bold="True" ForeColor="#def2dd" BorderStyle="None"
        ...
        <tr>
            <td style="height: 21px">
                <asp:CheckBox ID="CheckBox1" runat="server" AutoPostBack="True" OnCheckedChanged="CheckBox1_CheckedChanged"
                    Text="全选" />
                &nbsp; &nbsp; 
                <asp:Button ID="btndelete" runat="server" OnClientClick="return confirm('确定要删除选中的项目吗？')"
