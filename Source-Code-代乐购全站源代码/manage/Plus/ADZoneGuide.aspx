<%@ page language="C#" autoeventwireup="true" inherits="manage_Plus_ADZoneGuide, App_Web_0f1xyepu" enableEventValidation="false" viewStateEncryptionMode="Never" %>
...
<body>
    <form id="form1" runat="server">
      <div class="guideexpand"> 版位管理</div>
        <div class="guide">
            <ul>
                <li><a id="EahADManage" href="javascript:gotourl('Plus/ADZoneManage.aspx');">
                    <span style="color: #000000">版位管理</span></a> </li>
                <li><a id="EahADAdd" href="javascript:gotourl('Plus/ADZone.aspx');">
                <span style="color: #000000">添加版位</span></a> </li>
                <li><a id="A1" href="javascript:gotourl('Plus/Advertisement.aspx');">
                    <span style="color: #000000">JS版位</span></a> </li>
            </ul>
        </div>
