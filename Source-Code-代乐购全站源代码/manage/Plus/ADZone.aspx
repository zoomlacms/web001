<%@ page language="C#" autoeventwireup="true" inherits="ZoomLa.WebSite.Manage.Plus.ADZone, App_Web_0f1xyepu" enableEventValidation="false" viewStateEncryptionMode="Never" %>
<!DOCTYPE HTML>
<html>
<head runat="server">
<title>添加广告版位</title>
    ...
    <form id="form1" runat="server">
       ...
       <div class="r_navigation">
		...
		<span>后台管理</span> &gt;&gt; <span>扩展功能</span> &gt;&gt; 
           <a href="ADZoneManage.aspx" title="广告版位管理">版位管理</a> &gt;&gt; <span>版位编辑</span></div> 
        ...
        <table border="0" cellpadding="2" cellspacing="1" class="border" width="100%">
            ...
            <tr class="tdbg" onmouseover="this.className='tdbgmouseover'" onmouseout="this.className='tdbg'">
                <td align="left" class="tdbgleft"style="width:200px;">
            ...
            <tr class="tdbg" onmouseover="this.className='tdbgmouseover'" onmouseout="this.className='tdbg'">
                <td align="left" class="tdbgleft" style="height: 24px; width:200px">
                ...
                <td align="left"  style="color: red;  height: 24px;">
                    ...
                    <asp:RegularExpressionValidator ID="RegularExpressionValidator1" runat="server" ControlToValidate="TxtZoneJSName"
                        Display="Dynamic" ErrorMessage="JS文件名不正确或者为空！" ValidationExpression="[0-9]{6}\/[0-9]{1,4}\.js"></asp:RegularExpressionValidator></td>
            </tr>
            ...
            <tr onmouseover="this.className='tdbgmouseover'" onmouseout="this.className='tdbg'" class="tdbg">
                <td align="left" class="tdbgleft" style="height: 46px; width:200px">
                            ...
                            <td>
                                <table border="0" cellpadding="2" cellspacing="1">
                                    ...
                                    <tr class="tdbg" onmouseover="this.className='tdbgmouseover'" onmouseout="this.className='tdbg'">
                                        ...
                                        <td>
                                            <asp:TextBox ID="TxtPopLeft" class="l_input" runat="server" Text="100" MaxLength="4" TextMode="SingleLine"
                                                Width="36px" />
                                        </td>
                                    </tr>
                                    <tr class="tdbg" onmouseover="this.className='tdbgmouseover'" onmouseout="this.className='tdbg'">
                                        ...
                                        <td>
                                            <asp:TextBox ID="TxtPopTop" class="l_input" runat="server" Text="100" MaxLength="4" TextMode="singleLine"
                                                Width="36px" />
                                        </td>
                                    </tr>
                                    <tr class="tdbg" onmouseover="this.className='tdbgmouseover'" onmouseout="this.className='tdbg'">
                            ...
                            <td>
                                <table border="0" cellpadding="2" cellspacing="1">
                                    ...
                                    <tr class="tdbg" onmouseover="this.className='tdbgmouseover'" onmouseout="this.className='tdbg'">
                                        ...
                                        <td>
                                            <asp:TextBox ID="TxtMoveLeft" class="l_input" MaxLength="4" Width="36px" Text="15" TextMode="singleLine"
                                                runat="server" />
                                        </td>
                                    </tr>
                                    <tr class="tdbg" onmouseover="this.className='tdbgmouseover'" onmouseout="this.className='tdbg'">
                                        ...
                                        <td>
                                            <asp:TextBox ID="TxtMoveTop" class="l_input" MaxLength="4" Width="36px" Text="200" TextMode="singleLine"
                                                runat="server" />
                                        </td>
                                    </tr>
                                    <tr class="tdbg" onmouseover="this.className='tdbgmouseover'" onmouseout="this.className='tdbg'">
                            ...
                            <td>
                                <table border="0" cellpadding="2" cellspacing="1">
                                    ...
                                    <tr class="tdbg" onmouseover="this.className='tdbgmouseover'" onmouseout="this.className='tdbg'">
                                        ...
                                        <td>
                                            <asp:TextBox ID="TxtFixedTop" class="l_input" MaxLength="4" Text="100" TextMode="singleLine" Width="36px"
                                                runat="server" />
                                        </td>
                                    </tr>
                                    <tr class="tdbg" onmouseover="this.className='tdbgmouseover'" onmouseout="this.className='tdbg'">
                            ...
                            <td>
                                <table border="0" cellpadding="2" cellspacing="1">
                                    ...
                                    <tr class="tdbg" onmouseover="this.className='tdbgmouseover'" onmouseout="this.className='tdbg'">
                                        ...
                                        <td>
                                            <asp:TextBox ID="TxtFloatLeft" class="l_input" MaxLength="4" Text="100" TextMode="singleLine" Width="36px"
                                                runat="server" />
                                        </td>
                                    </tr>
                                    <tr class="tdbg" onmouseover="this.className='tdbgmouseover'" onmouseout="this.className='tdbg'">
                                        ...
                                        <td>
                                            <asp:TextBox ID="TxtFloatTop" class="l_input" MaxLength="4" Text="100" TextMode="singleLine" Width="36px"
                                                runat="server" />
                                        </td>
                                    </tr>
                                    <tr class="tdbg" onmouseover="this.className='tdbgmouseover'" onmouseout="this.className='tdbg'">
                    ...
                    <table class="tdbg">
                        ...
                        <tr onmouseover="this.className='tdbgmouseover'" onmouseout="this.className='tdbg'">
                            <td style="width: 226px; height: 22px;" >
                                宽度：
                                <asp:TextBox ID="TxtZoneWidth" runat="server" class="l_input" MaxLength="4" Text="468" TextMode="singleLine"
                                    Width="24px"></asp:TextBox>
                                &nbsp; &nbsp; 高度：
                                <asp:TextBox ID="TxtZoneHeight" class="l_input" runat="server" MaxLength="4" Text="60" TextMode="singleLine"
            ...
            <tr class="tdbg" onmouseover="this.className='tdbgmouseover'" onmouseout="this.className='tdbg'">
                <td align="left" class="tdbgleft" style="width:200px;">
                    <strong>是否开放用户申请：</strong></td>
                <td style="height: 49px;">
                    <asp:CheckBox ID="CheckApply" runat="server" />是
                </td>
            </tr>
        </table>
        <asp:Button ID="EBtnAdZone" runat="server" OnClick="EBtnAdZone_Click" Text="保存" class="C_input"/>
        &nbsp;&nbsp; &nbsp;
        <input id="Cancel"  name="Cancel" onclick="GoBack();" style="cursor: hand"
            type="button" value="取消" class="C_input" />        
