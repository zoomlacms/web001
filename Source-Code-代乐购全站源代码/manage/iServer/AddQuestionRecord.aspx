<%@ page language="C#" autoeventwireup="true" validaterequest="false" inherits="manage_iServer_AddQuestionRecord, App_Web_tufelx2k" enableEventValidation="false" viewStateEncryptionMode="Never" %>
...
<body>
    ...
    <div class="r_navigation">
        ...
        <span>后台管理</span> &gt;&gt; <span><asp:Literal ID="Literal1"
            runat="server" Text="有问必答"></asp:Literal></span> &gt;&gt; <span>添加问题</span>
    </div>
    <div class="clearbox">
    </div>
    ...
    <table width="100%" border="0" cellpadding="0" cellspacing="0" class="border">
        ...
        <tr class="tdbg" onmouseover="this.className='tdbgmouseover'" onmouseout="this.className='tdbg'">
            ...
            <script type="text/javascript">
                ...
                <textarea rows="20" runat="server" id="textarea1" style="width:100%;height:300px;visibility:hidden;" ></textarea>
            </td>
        </tr>
        <tr class="tdbg" onmouseover="this.className='tdbgmouseover'" onmouseout="this.className='tdbg'">
            <td class="tdbgleft">
