<%@ page language="C#" autoeventwireup="true" inherits="manage_iServer_BiServerInfo, App_Web_tufelx2k" validaterequest="false" enableEventValidation="false" viewStateEncryptionMode="Never" %>
<!DOCTYPE HTML>
<html>
...
<body>
 <div class="r_navigation">后台管理&gt;&gt;<a href="BiServer.aspx">有问必答</a>&gt;&gt;<span>问题详情</div>
    <form id="frm_supportticket" runat="server" style="text-align:center;">
		...
		<%--发送E-mail回复给：--%><input  type="text" visible="false" runat="server" id="UserEmail" name="reply_to" value="" />
