<%@ page language="C#" autoeventwireup="true" inherits="Common_Upload, App_Web_mzkq0xte" enableEventValidation="false" viewStateEncryptionMode="Never" %>
            ...
            <tr class="tdbg">
                <td valign="top">
                    ...
                    <asp:HiddenField ID="HdnCID" runat="server" 
                        onvaluechanged="HdnCID_ValueChanged" />
                    <asp:HiddenField ID="HdnType" runat="server" 
                        onvaluechanged="HdnType_ValueChanged" />
               </td>
            </tr>
        </table>
    </form>
