<%@ page language="C#" autoeventwireup="true" inherits="Common_KeyList, App_Web_d4vroayz" enableEventValidation="false" viewStateEncryptionMode="Never" %>
<!DOCTYPE HTML>
<html>
  ...
  <div>
    <table width="100%" border="0" cellpadding="2" cellspacing="0" class="border">
      ...
      <tr class="tdbg" onmouseover="this.className='tdbgmouseover'" onmouseout="this.className='tdbg'">
        <td align="left"><input type="text" id="UserNameList" size="60" class="l_input" maxlength="200" readonly="readonly"
                        class="inputtext" />
