<%@ page language="C#" autoeventwireup="true" inherits="ZoomLa.WebSite.Commons.FileUpload, App_Web_d4vroayz" enableEventValidation="false" viewStateEncryptionMode="Never" %>
<!DOCTYPE HTML>
<html>
<head runat="server">
<title>上传文件</title>
